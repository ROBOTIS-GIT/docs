...
1. PWM 모드는 다이나믹셀 DYNAMIXEL [AX](/docs/dxl/model_reference/ax_series/ax-12w#cw-compliance-margin) 및 [RX](/docs/dxl/model_reference/rx_series/rx-10#moving-speed-32) 시리즈의 바퀴모드와 유사합니다.

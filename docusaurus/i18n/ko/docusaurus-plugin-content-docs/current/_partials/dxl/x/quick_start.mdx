...
- 다이나믹셀과 호환되는 제어기나 [리튬이온 배터리(LB-020)](https://www.robotis.com/shop/item.php?it_id=903-0277-000) 또는 별도의 파워 서플라이
  - [제어기 다이나믹셀 호환표](/docs/parts/controller/controller_compatibility#다이나믹셀-호환표)
...
- [U2D2 파워 허브 보드](/docs/parts/interface/u2d2_power_hub) 사용시, 안정적인 전원 공급 및 다수의 다이나믹셀을 관리할수 있습니다.
...
- [제어기 다이나믹셀 호환표](/docs/parts/controller/controller_compatibility#다이나믹셀-호환표)
- [제어기 소프트웨어 호환표](/docs/parts/controller/controller_compatibility#소프트웨어-호환표)
...
[다니아믹셀 위자드 2.0]: /docs/software/dynamixel/dynamixel_wizard2

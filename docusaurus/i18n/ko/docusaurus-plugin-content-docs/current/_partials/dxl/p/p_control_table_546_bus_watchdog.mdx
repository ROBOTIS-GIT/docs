...
측정된 통신 간격(시간)이 Bus Watchdog(546)의 설정값 보다 클 경우, 장치는 정지합니다.  
...
**참고** : Data Range Error에 대한 자세한 사항은 [프로토콜]을 참고해주세요.

:::


[프로토콜]: /docs/dxl/protocol/protocol2#status-packet
...
6. Goal Velocity(552)에 ‘150’을 쓰면, Status Packet을 통해 Data Range Error를 회신합니다.

...
Please follow the [PC Setup](/docs/systems/turtlebot3/quick_start) instructions if you did not install required packages and dependent packages.
...
2. TurtleBot3 World  
![](/img/systems/turtlebot3/simulation/gazebo_world.webp)
```bash
...
<details>
<summary>
![](/img/icon_unfold.webp) Read more about **How to visualize Simulation data(RViz2)**
</summary>

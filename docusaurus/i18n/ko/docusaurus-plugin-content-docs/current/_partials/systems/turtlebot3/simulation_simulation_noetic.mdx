...
<details>
<summary>
![](/img/icon_unfold.webp) Read more about **TurtleBot3 Simulation**
</summary>
...
Please follow the [PC Setup](/docs/systems/turtlebot3/quick_start) instructions if you did not install all required packages and dependent packages.  
**[Remote PC]**  
```bash
$ cd ~/catkin_ws/src/
...
1. Empty World  
![](/img/systems/turtlebot3/simulation/turtlebot3_empty_world.webp)  
**[Remote PC]**  
```bash
...
2. TurtleBot3 World  
![](/img/systems/turtlebot3/simulation/turtlebot3_world_bugger.webp)  
**[Remote PC]**  
```bash
...
3. TurtleBot3 House  
![](/img/systems/turtlebot3/simulation/turtlebot3_house.webp)  
**[Remote PC]**  
```bash
...
<details>
<summary>
![](/img/icon_unfold.webp) Read more about **How to run Autonomous Collision Avoidance**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.webp) Read more about **How to visualize Simulation data(RViz)**
</summary>
...
![](/img/systems/turtlebot3/simulation/turtlebot3_gazebo_rviz.webp)
</details>

...
```
![](/img/systems/turtlebot3/simulation/turtlebot3_empty_world_sim.webp)
...
```
![](/img/systems/turtlebot3/simulation/turtlebot3_world_sim.webp)
...
```
![](/img/systems/turtlebot3/simulation/turtlebot3_house_sim.webp)

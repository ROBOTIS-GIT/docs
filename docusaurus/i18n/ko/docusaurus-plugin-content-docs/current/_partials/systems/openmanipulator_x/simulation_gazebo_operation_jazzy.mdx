In order to control the simulated OpenMANIPULATOR-X, launch the [OpenMANIPULATOR-X control GUI](/docs/systems/openmanipulator_x/ros_operation#gui-program) or [Keyboard teleoperation](/docs/systems/openmanipulator_x/ros_operation#keyboard)  

...
- For easy maintanence and configuration of DYNAMIXEL, it is recommended to use [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0/introduction) or [R+ Manager 2.0](/docs/software/dynamixel_wizard_2_0/introduction)

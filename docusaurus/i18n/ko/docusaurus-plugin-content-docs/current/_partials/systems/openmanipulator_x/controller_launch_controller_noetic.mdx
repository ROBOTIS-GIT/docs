...
- `use_platform` : Condition to run the [Simulation](/docs/systems/openmanipulator_x/ros_simulation#ros-simulation). 
  - Set **true** when operating the actual OpenMANIPULATOR. 
  - Set **false** when running a virtual OpenMANIPULATOR in [Gazebo](/docs/systems/openmanipulator_x/ros_simulation#controller-for-gazebo) (3D robotics simulator).

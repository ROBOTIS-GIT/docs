...
1. Go to boot manager : Press **F10**  
	![](/img/systems/op3/op3_recovery_01.webp)  
2. Select the boot device : Recovery USB media  
	![](/img/systems/op3/op3_recovery_02.webp)  
3. Select the image : clonezilla live with img ROBOTIS-OP3_Transcend (Default settings, VGA 1024x768)  
	![](/img/systems/op3/op3_recovery_03.webp)  
4. Confirm to continue : enter `y`  
	![](/img/systems/op3/op3_recovery_04.webp)  
5. Confirm to continue : enter `y`  
	![](/img/systems/op3/op3_recovery_05.webp)  
6. Check the progress  
	![](/img/systems/op3/op3_recovery_06.webp)  
7. Turn off or reboot ROBOTIS-OP3  
	![](/img/systems/op3/op3_recovery_08.webp)  
...
[How to use Web Setting Tool]: /docs/systems/op3/tutorials#how-to-use-web-setting-tool

...
<img src="/img/platform/omy/omy_gui1.png" width="700"/>

2. Check the status of OMY.  
<img src="/img/platform/omy/omy_gui2.png" width="700"/>
...
<img src="/img/platform/omy/omy_gui3.png" width="700"/>
...
<img src="/img/platform/omy/omy_gui4.png" width="700"/>
...
<img src="/img/platform/omy/omy_gui5.png" width="700"/>

6. Press the `Play` button to make the manipulator move sequentially according to the saved tasks. Completed tasks will have their status changed to <span>Done</span>  
<img src="/img/platform/omy/omy_gui6.png" width="700"/>

#### OMY GUI Demo
<img src="/img/platform/omy/omy_f3m_gui.gif" width="700"/>

...
1. Go to boot manager : Press **F10**  
	![](/img/platform/op3/op3_recovery_01.jpg)  
2. Select the boot device : Recovery USB media  
	![](/img/platform/op3/op3_recovery_02.jpg)  
3. Select the image : clonezilla live with img ROBOTIS-OP3_Transcend (Default settings, VGA 1024x768)  
	![](/img/platform/op3/op3_recovery_03.jpg)  
4. Confirm to continue : enter `y`  
	![](/img/platform/op3/op3_recovery_04.jpg)  
5. Confirm to continue : enter `y`  
	![](/img/platform/op3/op3_recovery_05.jpg)  
6. Check the progress  
	![](/img/platform/op3/op3_recovery_06.jpg)  
7. Turn off or reboot ROBOTIS-OP3  
	![](/img/platform/op3/op3_recovery_08.jpg)  
...
[ROBOTIS-Framerowk]: https://emanual.robotis.com/docs/en/software/robotis_framework_packages/#robotis-framework
[ROBOTIS-Framerowk-msgs]: https://emanual.robotis.com/docs/en/software/robotis_framework_packages/#robotis-framework-msgs
...
[How to use Web Setting Tool]: /docs/platform/op3/tutorials#how-to-use-web-setting-tool

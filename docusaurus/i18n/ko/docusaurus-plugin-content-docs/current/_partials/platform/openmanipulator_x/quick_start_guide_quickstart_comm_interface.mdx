...
**NOTE** : Please refer to [U2D2 e-Manual](https://emanual.robotis.com/docs/en/parts/interface/u2d2/) and [U2D2 power hub board e-manual](https://emanual.robotis.com/docs/en/parts/interface/u2d2_power_hub/) for detailed connection of U2D2 and U2D2 power hub board.
...
1. Set up the Arduino IDE for OpenCR ([Instructions](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#arduino-ide))

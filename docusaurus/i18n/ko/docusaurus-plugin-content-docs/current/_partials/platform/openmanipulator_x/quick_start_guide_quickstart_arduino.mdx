...
This API supports DYNAMIXEL, DYNAMIXEL-X including protocol 1.0 and 2.0. Furthermore, this code can be used for [OpenMANIPULATOR Friends](/docs/platform/openmanipulator_x/friends).  
...
1. Install Arduino IDE and setup OpenCR developing environment.
  - [Setup Arduino IDE for OpenCR 1.0 (Windows)](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#install-on-windows)
  - [Setup Arduino IDE for OpenCR 1.0 (Linux)](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#install-on-linux)
  - [Setup Arduino IDE for OpenCR 1.0 (Mac)](https://emanual.robotis.com/docs/en/parts/controller/opencr10/#install-on-mac)
...
4. Upload the example to OpenCR.  
  ![](/img/platform/openmanipulator_x/upload_chain_example.png)
...
1. Download and install the Processing.
    ...
    - ![](/img/icon_download.png) [https://processing.org/download/](https://processing.org/download/)
...
2. Launch Processing and go to `Tools` > `Add Tool..`.
    ...
    ![](/img/platform/openmanipulator_x/processing_add_tools.png)

3. In the `Libraries` tab, search for `ControlP5` and install it.

    ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_1.png)

4. Download processing source code for OpenMANIPULATOR.

    - ![](/img/icon_download.png) [Direct Download(Zip)](https://github.com/ROBOTIS-GIT/open_manipulator_processing/archive/refs/heads/master.zip)
    - or use Git tool
    ```bash

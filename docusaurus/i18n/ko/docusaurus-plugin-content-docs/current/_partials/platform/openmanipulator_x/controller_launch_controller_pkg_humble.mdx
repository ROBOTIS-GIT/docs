...
**NOTE**:
- Make sure ROS dependencies are installed before performing these instructions. - [Install ROS Packages](/docs/platform/openmanipulator_x/quick_start_guide#install-ros-packages)

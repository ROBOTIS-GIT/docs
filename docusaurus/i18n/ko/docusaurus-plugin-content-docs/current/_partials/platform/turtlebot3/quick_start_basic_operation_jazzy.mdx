...
$ rqt
  ```  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_1.png)
...
2. When the topic monitor is loaded, the topic values are not monitored by default. Click the checkbox next to each topic to monitor the topic.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_2.png)

3. To see more detailed topic messages, click the `▶` icon next to the checkbox.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_3.png)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_4.png)

  - `/odom` indicates a message containing the odometry of the TurtleBot3. This topic has orientation and position encoder data.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_5.png)

  - `/sensor_state` indicates a message containing encoder values, battery and torque status.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_6.png)

  - `/scan` indicates a message containing LDS data, such as angle_max and min, and range_max and min.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/rqt_7.png)

[topic_monitor]: https://emanual.robotis.com/docs/en/platform/turtlebot3/topic_monitor/

...
<details>
<summary>
![](/img/icon_unfold.png) **Read more about How to predefine the TURTLEBOT3_MODEL**
</summary>
...
![](/img/platform/turtlebot3/quick_start/basic_operation/rc100b_with_bt410.png)
...
<details>
<summary>
![](/img/icon_unfold.png) **Read more about Topic Monitor**
</summary>
...
$ rqt
  ```  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_1.png)
...
2. When the topic monitor is opened, the topic values are not monitored by default. Click the checkbox next to each topic to monitor the topic.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_2.png)

3. To see more detailed topic messages, click the `▶` icon next to the checkbox.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_3.png)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_4.png)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_5.png)
  ...
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_6.png)

  - `/sensor_state` indicates a message containing encoder values, battery and torque.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_7.png)

  - `/scan` indicates a message with LDS data.  
  ![](/img/platform/turtlebot3/quick_start/basic_operation/legacy/rqt_8.png)


[teleoperation]: /docs/platform/turtlebot3/teleoperation
[basic_examples]: /docs/platform/turtlebot3/basic_examples
[additional_sensors]: /docs/platform/turtlebot3/additional_sensors
[bringup]: /docs/platform/turtlebot3/bringup#bringup
[rqt]: http://wiki.ros.org/rqt
[rc100]: /docs/parts/communication/rc-100
[bt410]: /docs/parts/communication/bt-410
[appendix_opencr1_0]: /docs/platform/turtlebot3/appendix_opencr1_0

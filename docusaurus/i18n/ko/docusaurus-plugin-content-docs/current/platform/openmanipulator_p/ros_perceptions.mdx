...
- See more details about [Raspberry Pi Camera V2](/docs/platform/turtlebot3/appendix_raspi_cam#overview)

- See more details about [Camera Sepecification](/docs/platform/turtlebot3/appendix_raspi_cam#specifications)

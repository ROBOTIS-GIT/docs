...
Run **Moveit!** with the following command.
  ...
  ![](/img/platform/openmanipulator_p/moveit_launch.png)  
...
For more information on Gazebo, See [Simulation](/docs/platform/openmanipulator_p/ros_simulation#ros-simulation)

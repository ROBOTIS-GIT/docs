...
![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_01.png)

### Assembly Manual
1. Fix FRP42_A110K to the tip of OpenMANIPUALTOR-P with eight WB_M3X08_NYLOK_K screws.
 
    ![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_02.png)

2. Assemble RH-P12-RN Gripper on fixed frame(FRP42_A110K) and tighten four WB_M3X08_NYLOK_K screws.
  
    ![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_03.png)
...
3. Connect OpenMANIPULATOR-P and RH-P12-RN with CABLE_4P_180MM Cable.
    ...
    ![](/img/platform/openmanipulator_p/open_manipulator_gripper_assembly_04.png)
...
![](/img/platform/openmanipulator_p/open_manipulator_gripper_operation_01.png)


To activate RH-P12-RN (Gripper), Click the `Gripper open` button.


![](/img/platform/openmanipulator_p/open_manipulator_gripper_operation_02.png)


- [GUI Program e-Manual](/docs/platform/openmanipulator_p/ros_operation#ros-operation)  
...
- [Teleoperation e-Manual](/docs/platform/openmanipulator_p/ros_operation#teleoperation)

#### MoveIt!
```bash 
$ roslaunch open_manipulator_p_controllers joint_trajectory_controller.launch sim:=false with_gripper:=true
```
- [MoveIt! e-Manual](/docs/platform/openmanipulator_p/ros_operation#moveit)
...
- [Launch Gazebo e-Manual](/docs/platform/openmanipulator_p/ros_simulation#launch-gazebo)
...
```
- [Controller for Gazebo e-Manual](/docs/platform/openmanipulator_p/ros_simulation#controller-for-gazebo)

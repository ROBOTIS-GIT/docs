...
Load OpenManipulator-PRO on Gazebo simulator and click on Play `▶` button.
  ...
  ![](/img/platform/openmanipulator_p/launch_gazebo.png)
...
Open an [open_manipulator_p_control_gui](/docs/platform/openmanipulator_p/ros_operation#gui-program) to control OpenMANIPULATOR-P

---
id: ros_controller_package
title: "[ROS] Controller Package"
sidebar_position: 5
...
You can control each joint of OpenMANIPULATOR-P and check states of OpenMANIPULATOR-P through [messages](/docs/platform/openmanipulator_p/ros_controller_package#message-list) by utilizing an exclusive controller program.
...
`use_platform`  
- Sets to **true/false** to use [Simulation](/docs/platform/openmanipulator_p/ros_simulation#ros-simulation) feature. 
  - **true** for using an actual robot. 
  - **false** for using an virtual robot in [Gazebo](/docs/platform/openmanipulator_p/ros_simulation#controller-for-gazebo) (3D robotics simulator).
...
- More information on these parmeters is available at [MoveIt!](/docs/platform/openmanipulator_p/ros_operation#moveit).

## Launch Controller
After setting those parameters, launch OpenMANIPULATOR-P controller to start [[ROS] Operation](/docs/platform/openmanipulator_p/ros_operation#ros-operation).
...
<img src="/img/platform/openmanipulator_p/open_manipulator_start_pose.png" width="250" />
...
if DYNAMIXEL aren't recoginized, please check firmware with ROBOTIS software ([R+ Manager 2.0](https://emanual.robotis.com/docs/en/software/rplus2/manager/) or [DYNAMIXEL Wizard 2.0](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#firmware-update))
...
**NOTE**: OpenMANIPULATOR-P controller is compatible with [Protocol 2.0](https://emanual.robotis.com/docs/en/dxl/protocol2/). [Protocol 1.0](https://emanual.robotis.com/docs/en/dxl/protocol1/) doesn't support SyncRead instructions that access to multiple DYNAMIXEL's simultaneously. Protocol 2.0 supports `MX 2.0`, `X`, `Pro`, `Pro +` series, but it does not support `AX`, `RX` and `EX`.
...
**NOTE**:
- If you launched the [OpenMANIPULATOR-P controller](/docs/platform/openmanipulator_p/ros_controller_package#launch-controller) before launching the open_manipulator_p_controller file, the robot model on RViz would be synchronized with the actual robot.
...
![](/img/platform/openmanipulator_p/rviz.png)
...
- The test is done on `ROS Melodic Morenia`installed in `Ubuntu 18.04`.
- Make sure ROS dependencies are installed before performing these instructions - [Install ROS Packages](/docs/platform/openmanipulator_p/ros_setup#install-ros-packages) 
- Make sure to launch the [OpenMANIPULATOR-P controller](/docs/platform/openmanipulator_p/ros_controller_package#launch-controller) before use of the instruction
...
![](/img/platform/openmanipulator_p/rqt1.png)  
...
[std_msgs/Empty]: https://emanual.robotis.com/docs/en/popup/std_msgs_Empty_msg/
[moveit_msgs/DisplayTrajectory]: https://emanual.robotis.com/docs/en/popup/moveit_msgs_DisplayTrajectory_msg/
[moveit_msgs/MoveGroupActionGoal]: https://emanual.robotis.com/docs/en/popup/moveit_msgs_MoveGroup_action/
[moveit_msgs/ExecuteTrajectoryActionGoal]: https://emanual.robotis.com/docs/en/popup/moveit_msgs_ExecuteTrajectory_action/

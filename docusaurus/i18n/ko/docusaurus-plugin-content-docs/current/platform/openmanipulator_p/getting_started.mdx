...
![](/img/platform/openmanipulator_p/wiring.png)
...
### U2D2
[U2D2](https://emanual.robotis.com/docs/en/parts/interface/u2d2/) is a small size USB communication converter that enables to control and operate DYNAMIXEL with PC. Connect the [U2D2](https://emanual.robotis.com/docs/en/parts/interface/u2d2/) to the PC via USB hub.

![](/img/platform/openmanipulator_p/u2d2.png)
...
|:------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| PH54-200-S500-R<br />PH54-100-S500-R | -180 ~ 180 (deg) → -501923 ~ 501923<br />![](/img/platform/openmanipulator_p/h54p_goal_position.png)<br />![](/img/platform/openmanipulator_p/h54p_goal_angle.png) |
|           PH42-020-S300-R            | -180 ~ 180 (deg) → -303750 ~ 303750<br />![](/img/platform/openmanipulator_p/h42p_goal_position.png)<br />![](/img/platform/openmanipulator_p/h42p_goal_angle.png) |

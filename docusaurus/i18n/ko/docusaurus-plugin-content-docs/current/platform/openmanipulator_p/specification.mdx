...
| DYNAMIXEL Pro<br />Model Name |                                                                                         Joint 1, 2 : [PH54-200-S500-R](https://emanual.robotis.com/docs/en/dxl/p/ph54-200-s500-r/) (200W)<br />Joint 3, 4 : [PH54-100-S500-R](https://emanual.robotis.com/docs/en/dxl/p/ph54-100-s500-r/)(100W)<br />Joint 5, 6 : [PH42-020-S300-R](https://emanual.robotis.com/docs/en/dxl/p/ph42-020-s300-r/) (20W)                                                                                         |
...
## Dimension
![](/img/platform/openmanipulator_p/dimension.png)

If you have a gripper([RH-P12-RN(A)](https://emanual.robotis.com/docs/en/platform/rh_p12_rna/)), see below.

![](/img/platform/openmanipulator_p/dimension_with_gripper.png)

## Workspace
![](/img/platform/openmanipulator_p/ws1.png)
  
![](/img/platform/openmanipulator_p/ws2.png)  

## Home Position
The diagram below shows the “home position” of DYNAMIXEL-P from OpenMANIPULATOR-P.

![](/img/platform/openmanipulator_p/home_position.jpg)

## D-H Configuration
![](/img/platform/openmanipulator_p/d_h_configuration.jpg)
...
|:----:|:---------------:|:---------------:|:----------------:|:----------------:|:---------------------------------------------------------------:|
|  1   |        0        |     -&pi;/2     |        0         |        0         |                                0                                |
|  2   |     265.69      |        0        |        0         |        0         | ![](/img/platform/openmanipulator_p/d_h_eq_001.gif) |
|  3   |       30        |     -&pi;/2     |        0         |        0         | ![](/img/platform/openmanipulator_p/d_h_eq_002.gif) |
|  4   |        0        |     -&pi;/2     |       258        |        0         |                                0                                |
|  5   |        0        |     -&pi;/2     |        0         |        0         |                                0                                |
|  6   |        0        |        0        |        0         |        0         |                                0                                |
...
![](/img/platform/openmanipulator_p/mass1.png)

Total Mass : 5,324g

### Link 1

![](/img/platform/openmanipulator_p/mass2.png)
...
![](/img/platform/openmanipulator_p/mass3.png)
...
![](/img/platform/openmanipulator_p/mass4.png)
...
![](/img/platform/openmanipulator_p/mass5.png)
...
![](/img/platform/openmanipulator_p/mass6.png)

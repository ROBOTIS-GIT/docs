---
id: StepPositionData_msg
title: "StepPositionData_msg"
sidebar_position: 13
tags: [msgs]
---
...
Position related Step Data Parameters
  ...
  * `float32     foot_z_swap`  
  ...
  &emsp;&emsp;
  !<a href="/img/platform/op3/op3_walking_module_image152.jpg" target="_blank">foot_z_wap</a>

  * `float32     body_z_swap`  
  &emsp;&emsp; The swept distance by the body on the Z axis while THORMANG3 is walking. Unit in meter.  
  &emsp;&emsp;
  !<a href="/img/platform/op3/op3_walking_module_image154.jpg" target="_blank">body_z_wap</a>
...
[thormang3_walking_module_msgs/PoseXYZRPY]: https://emanual.robotis.com/docs/en/popup/PoseXYZRPY.msg/
[thormang3_walking_module_msgs/PoseZRPY]: https://emanual.robotis.com/docs/en/popup/PoseZRPY.msg/

...
import FccClassA from '@site/docs/_partials/platform/op/fcc_class_a.mdx';
...
![](/img/platform/op/op_system_blockdiagram.jpg)
...
For more information on the connector, please refer to the [MX-28 Connector Information](/docs/dxl/mx/mx-28#connector-information).
...
![](/img/platform/op/op_256.jpg)

> The positions of central axis and sensor at Dawin

![](/img/platform/op/op_257.jpg)

> Gyroscope

![](/img/platform/op/op_258.jpg)

> Accelerometer

| ![](/img/platform/op/op_259.jpg) | ![](/img/platform/op/op_260.jpg) |
|:------------------------------------------:|:------------------------------------------:|
...
![](/img/platform/op/op_dimension.jpg)
...
![](/img/platform/op/op_dynamics.jpg)

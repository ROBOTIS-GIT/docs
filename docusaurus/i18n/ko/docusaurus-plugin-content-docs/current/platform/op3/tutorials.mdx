...
import TutorialsRev2 from '@site/docs/_partials/platform/op3/tutorials_rev2.mdx';
...
1. execution result screen  
    ...
    ![](/img/platform/op3/op3_bringup_ros2.png)  
...
- rviz2 screen  
  ...
  ![](/img/platform/op3/op3_bringup_visualization_01_ros2.png)  
...
- Execution result  
  ![](/img/platform/op3/op3_gui_ros2.png)
...
![](/img/platform/op3/op3_gui_initial_pose_ros2.png)
...
- Follow the below procedure to configure modules that control the corresponding joints of ROBOTIS-OP3.  
    ...
    2. Confirm from the joint status table below the module buttons that corresponding joints are set correctly.  
      ![](/img/platform/op3/op3_gui_set_module_ros2.png)

- `Get Mode` button will report which module is assigned for each joint.  

  ![](/img/platform/op3/op3_gui_get_module_ros2.png)
...
![](/img/platform/op3/op3_gui_walking_tuner_01_ros2.png)
...
2. `stop` button : Stop walking. When stopped, walking related parameters will be reset.  
  ...
  ![](/img/platform/op3/op3_gui_walking_tuner_03_ros2.png)
...
3. `Apply` button : Apply modified parameters from the GUI to the `walking_module`.  
  ...
  ![](/img/platform/op3/op3_gui_walking_tuner_04_ros2.png)
...
2. Select `Motion` tab of the gui demo program.
    ...
    ![](/img/platform/op3/op3_gui_action_01_ros2.png)

3. Click the action button to play  

    ![](/img/platform/op3/op3_gui_action_02_ros2.png)
...
2. Select `Head Control` tab of the gui demo program.  
  ![](/img/platform/op3/op3_gui_control_head_01_ros2.png)
...
3. Change the value for the specific joint.  
   ...
   3. Bring the head joint to center position.  
    ...
    ![](/img/platform/op3/op3_gui_control_head_02_ros2.png)  
...
!<a href="/img/platform/op3/op3_tuner_execution_ros2.png" target="_blank">launch image</a>
...
![](/img/platform/op3/op3_action_editor_tui.png)
...
![](/img/platform/op3/op3_action_editor_command_list.png)
...
1. Dynamic Reconfigure and Image View  
    ...
    - Open `Dynamic Reconfigure`   
      ...
      ![](/img/platform/op3/ball_detector_node_01_rev3.png)

    - Open `Image View`  
      Select `Plugins -> Visualization -> Image View`  

      ![](/img/platform/op3/ball_detector_node_02_rev3.png)
...
3. Description  
    ...
    - How to calibrate  
        ...
        - If you check the `use_second_filter` you can get an image which is detected with two HSV variations.   
          ...
          ![](/img/platform/op3/ball_detector_node_04_rev3.png)

        - If you check the `debug_image` you can check the HSV filtered, binary image.   

          ![](/img/platform/op3/ball_detector_node_05_rev3.png)
...
```  
 ...
 - rqt_graph  
   ![](/img/platform/op3/op3_read_write_graph_rev3.png)

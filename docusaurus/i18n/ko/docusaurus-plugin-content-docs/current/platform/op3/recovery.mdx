...
import RecoveryRev2 from '@site/docs/_partials/platform/op3/recovery_rev2.mdx';
...
1. Go to boot manager : Press **F10**  
	![](/img/platform/op3/op3_recovery_01_nuc10.jpg)  
2. Select the boot device : Recovery USB media  
	![](/img/platform/op3/op3_recovery_02_nuc10.jpg)  
3. Select the image : `Clonezilla live (VGA 800x600)`  
	![](/img/platform/op3/op3_recovery_03_nuc10.jpg)  
4. Recovery will automatically start, and the PC will turn off when it's done.  
	![](/img/platform/op3/op3_recovery_04_nuc10.jpg)  


[How to Install Linux Mint]: https://linuxmint-installation-guide.readthedocs.io/en/latest/index.html
[ROS Installation]: /docs/platform/common/op3_robot_operating_system#how-to-install-ros
[ROS Environment and Network Settings]: /docs/platform/common/op3_robot_operating_system#setup
[Setting for automatic startup]: /docs/platform/op3/getting_started#how-to-kill-the-demo-program
[sourceforge.net]: https://sourceforge.net/projects/darwinop/files/Software/Main%20Controller/Recovery%20USB/

[humanoid_navigation]: /docs/platform/thormang3/thormang3_ros_packages#humanoid_navigation
[How to Use the Web Setting Tool]: /docs/platform/op3/tutorials#how-to-use-web-setting-tool
[Running the demo at the startup]: /docs/platform/op3/getting_started#running-the-demo-at-startup
</TabItem>
...
[DYNAMIXEL SDK]: https://emanual.robotis.com/docs/en/software/robotis_framework_packages/#dynamixelsdk
[ROBOTIS-Framework]: https://emanual.robotis.com/docs/en/software/robotis_framework_packages/#robotis-framework
[ROBOTIS-Framework-msgs]: https://emanual.robotis.com/docs/en/software/robotis_framework_packages/#robotis-framework-msgs
[ROBOTIS-Math]: /docs/platform/common/robotis_math#robotis-math
[e-manual]: /docs/platform/op3/recovery#recovery-of-robotis-op3
[ROBOTIS-OP3]: /docs/platform/op3/robotis_ros_packages#robotis-op3
[ROBOTIS-OP3-Common]: /docs/platform/op3/robotis_ros_packages#robotis-op3-common
[ROBOTIS-OP3-Demo]: /docs/platform/op3/robotis_ros_packages#robotis-op3-demo
[ROBOTIS-OP3-msgs]: /docs/platform/op3/robotis_ros_packages#robotis-op3-msgs
[ROBOTIS-OP3-Tools]: /docs/platform/op3/robotis_ros_packages#robotis-op3-tools

...
<img src="/img/platform/openmanipulator_x/OpenManipulator_friends.png" width="760" />
...
:::
  ...
  **Friends List**
  ...
  - [OpenMANIPULATOR SCARA](/docs/platform/openmanipulator_x/friends#openmanipulator-scara)
  - [OpenMANIPULATOR Link](/docs/platform/openmanipulator_x/friends#openmanipulator-link)
  - [OpenMANIPULATOR Planar](/docs/platform/openmanipulator_x/friends#openmanipulator-planar)
  - [OpenMANIPULATOR Delta](/docs/platform/openmanipulator_x/friends#openmanipulator-delta)
  - [OpenMANIPULATOR Stewart](/docs/platform/openmanipulator_x/friends#openmanipulator-stewart)
  - [OpenMANIPULATOR Linear](/docs/platform/openmanipulator_x/friends#openmanipulator-linear)

## OpenMANIPULATOR SCARA
![](/img/platform/openmanipulator_x/OpenManipulator_SCARA.png)

### Specification

![](/img/platform/openmanipulator_x/OpenManipulator_SCARA_Capture.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_SCARA_spec_side.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_SCARA_OnShape.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_SCARA_Processing.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Link.png)

### Specification

![](/img/platform/openmanipulator_x/OpenManipulator_Link_Capture.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Link_spec.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Link_OnShape.png)
...
#### OpenCR
First of all, set the OpenCR board referring to [[OpenCR] setup](https://emanual.robotis.com/docs/en/platform/openmanipulator_x/opencr-setup/#opencr-setup).
...
#### Processing
Set the Processing IDE referring to [Processing Setup](https://emanual.robotis.com/docs/en/platform/openmanipulator_x/opencr-setup/#opencr-setup).
...
![](/img/platform/openmanipulator_x/OpenManipulator_Link_Processing.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Planar.png)

### Specification

![](/img/platform/openmanipulator_x/OpenManipulator_Planar_Capture.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Planar_spec.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Planar_OnShape.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Delta.png)

### Specification

![](/img/platform/openmanipulator_x/OpenManipulator_Delta_Capture.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Delta_spec.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Delta_OnShape.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Stewart.png)

### Specification

![](/img/platform/openmanipulator_x/OpenManipulator_Stewart_Capture.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Stewart_spec_side.png)
![](/img/platform/openmanipulator_x/OpenManipulator_Stewart_spec_bottom.png)
![](/img/platform/openmanipulator_x/OpenManipulator_Stewart_spec_top.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Stewart_OnShape.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Linear.png)

### Specification

![](/img/platform/openmanipulator_x/OpenManipulator_Linear_Capture.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Linear_spec.png)
...
![](/img/platform/openmanipulator_x/OpenManipulator_Linear_OnShape.png)
...
[open_manipulator_msgs/GetJointPosition]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_GetJointPosition/
[open_manipulator_msgs/GetKinematicsPose]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_GetKinematicsPose/
[open_manipulator_msgs/SetJointPosition]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_SetJointPosition/
[open_manipulator_msgs/SetKinematicsPose]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_SetKinematicsPose/
[open_manipulator_msgs/SetActuatorState]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_SetActuatorState/
[open_manipulator_msgs/SetDrawingTrajectory]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_SetDrawingTrajectory/
[sensor_msgs/JointState]: https://emanual.robotis.com/docs/en/popup/sensor_msgs_JointState_msg/
[open_manipulator_msgs/KinematicsPose]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_KinematicsPose/
[open_manipulator_msgs/OpenManipulatorState]: https://emanual.robotis.com/docs/en/popup/open_manipulator_msgs_OpenManipulatorState/

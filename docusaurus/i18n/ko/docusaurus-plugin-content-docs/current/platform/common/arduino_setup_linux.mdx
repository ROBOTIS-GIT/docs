...
[USB port settings]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#usb-port-settings
[Compiler Settings]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#complier-settings
[Install the Arduino IDE]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#install-the-arduino-ide
[Run the Arduino IDE]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#run-the-arduino-ide
[Porting the OpenCR board to the Arduino IDE]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#porting-the-opencr-board-to-the-arduino-ide
[Install the OpenCR package via Boards Manager]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#install-the-opencr-package-via-boards-manager
[Modemmanager removal]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#modemmanager-removal
[Bootloader writing]: https://emanual.robotis.com/docs/en/platform/common/arduino_arduino_setup_linux/#bootloader-writing

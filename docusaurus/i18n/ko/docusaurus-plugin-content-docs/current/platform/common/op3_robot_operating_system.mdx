...
![](/img/platform/op3/ros_image.png)
...
## Additional ROS Package
 ...
 3. usb_cam  
    ...
    - Additional Installation : The following package must be manually installed in order to modify camera parameters.  
      ...
      ```  
[std_msgs/Int32MultiArray]: https://emanual.robotis.com/docs/en/popup/std_msgs_Int32MultiArray_msg/
...
[ROBOTIS-OP3]: https://emanual.robotis.com/docs/en/platform/op3/robotis_ros_packages/#robotis-op3
[ROBOTIS-OP3-Demo]: https://emanual.robotis.com/docs/en/platform/op3/robotis_ros_packages/#robotis-op3-demo
[ROBOTIS-OP3-msgs]: https://emanual.robotis.com/docs/en/platform/op3/robotis_ros_packages/#robotis-op3-msgs
[ROBOTIS-OP3-Tools]: https://emanual.robotis.com/docs/en/platform/op3/robotis_ros_packages/#robotis-op3-tools
[ROBOTIS-OP3-Common]: https://emanual.robotis.com/docs/en/platform/op3/robotis_ros_packages/#robotis-op3-common

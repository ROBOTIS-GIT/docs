...
!<a href="/img/platform/rh_p12_rn/linux_example_execute.png" target="_blank">img</a>

장치(RH-P12-RN)가 전류기반 위치 제어 모드로 실행 중일 경우 아래와 같은 화면이 표시 됨.  

!<a href="/img/platform/rh_p12_rn/linux_example_position_mode.png" target="_blank">img</a>

장치가 전류제어 모드로 실행 중일 경우 아래와 같은 화면이 표시 됨.  

!<a href="/img/platform/rh_p12_rn/linux_example_current_mode.png" target="_blank">img</a>
...
!<a href="/img/platform/rh_p12_rn/ros_example_position_mode.png" target="_blank">img</a>

장치가 전류제어 모드로 실행 중일 경우 ROS GUI 예제 화면은 아래와 같음.  

!<a href="/img/platform/rh_p12_rn/ros_example_current_mode.png" target="_blank">img</a>

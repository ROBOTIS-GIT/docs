...
3. 솔루션을 빌드 후 실행 하세요.
    - Windows SDK 버전이 달라서 아래의 **에러메세지가 발생**한 경우 
      ...
      !<a href="/img/platform/rh_p12_rn/windows_sdk_ver.png" target="_blank">img</a>  
...
- **연결후 실행화면** : 포트이름 및 Baudrate 정보 표시. 키보드의 아무키를 누르면, 제어모드 화면으로 넘어갑니다.  
    !<a href="/img/platform/rh_p12_rn/rh_p12_rna/windows_example_execute.png" target="_blank">img</a>  
- **전류기반 위치 제어 모드** 실행화면  
    !<a href="/img/platform/rh_p12_rn/rh_p12_rna/windows_example_position_mode.png" target="_blank">img</a>  
- **전류제어 모드** 실행화면  
    !<a href="/img/platform/rh_p12_rn/rh_p12_rna/windows_example_current_mode.png" target="_blank">img</a>
...
$ sudo make install
```
- [다이나믹셀 SDK e-Manaul](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_sdk/overview/)
...
- **연결후 실행화면** : 포트이름 및 Baudrate 정보 표시. 키보드의 아무키를 누르면, 제어모드 화면으로 넘어갑니다.  
    !<a href="/img/platform/rh_p12_rn/rh_p12_rna/linux_example_execute.png" target="_blank">img</a>
- **전류기반 위치 제어 모드** 실행화면  
    !<a href="/img/platform/rh_p12_rn/rh_p12_rna/linux_example_position_mode.png" target="_blank">img</a>
- **전류제어 모드** 실행 화면  
    !<a href="/img/platform/rh_p12_rn/rh_p12_rna/linux_example_current_mode.png" target="_blank">img</a>
...
- **전류기반 위치 제어 모드** 실행화면  
  !<a href="/img/platform/rh_p12_rn/rh_p12_rna/ros_example_position_mode.png" target="_blank">img</a>

- **전류제어 모드** 실행화면  
  !<a href="/img/platform/rh_p12_rn/rh_p12_rna/ros_example_current_mode.png" target="_blank">img</a>

- 각 입력란의 **동작 및 입력 방법은 윈도우 예제를 참고**하세요.
  - [동작](#동작)
  - [입력방법](#입력방법)

[R+ Manager 2.0]: https://emanual.robotis.com/docs/kr/software/rplus2/manager/
[다이나믹셀 위자드 2.0]: https://emanual.robotis.com/docs/kr/software/dynamixel/dynamixel_wizard2/

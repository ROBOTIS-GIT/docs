...
![](/img/platform/turtlebot3/faq/computer_name.png)
...
![](/img/platform/turtlebot3/faq/connection_ssh.png)
...
2. Press and hold the `SW2` button and click the `Reset` button. If the `Status` LED is blinking, release the `SW2` button. See [Boot Sequence](/docs/parts/controller/opencr10#boot-sequence) for more information.
...
As shown in the below image, find `Examples` > `turtlebot3` > `turtlebot3_setup` > `turtlebot3_setup_motor` and open the example.  
    ...
    ![](/img/platform/turtlebot3/faq/dynamixel_setup_1.png)
...
Click the `Serial Monitor` icon in the upper right corner as shown in the below image.  
    ...
    ![](/img/platform/turtlebot3/faq/dynamixel_setup_2.png)
...
When the setup is completed, `OK` message is printed on the screen.
    ...
    ![](/img/platform/turtlebot3/faq/dynamixel_setup_5.png)
...
For example, to test the left DYNAMIXEL, enter `3` as shown in below, or enter `4` for the right wheel test.
    ...
    ![](/img/platform/turtlebot3/faq/dynamixel_setup_6.png)
...
- [Locomotion (TurtleBot3 Friends)](/docs/platform/turtlebot3/locomotion#turtlebot3-friends-car)
...
![](/img/platform/turtlebot3/faq/download_the_stl_files_01.png)

![](/img/platform/turtlebot3/faq/download_the_stl_files_02.png)
...
![](/img/platform/turtlebot3/faq/nvstorage.png)

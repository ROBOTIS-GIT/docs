...
![](/img/platform/manipulator_h/manipulator_h_006.jpg)

### Power Cable
The power cable supplies power to the Manipulator.

![](/img/platform/manipulator_h/manipulator_h_007.jpg)
...
![](/img/platform/manipulator_h/manipulator_h_008.jpg)
...
![](/img/platform/manipulator_h/manipulator_h_009.jpg)

- Rest and fix joint 1 of the Manipulator.

![](/img/platform/manipulator_h/manipulator_h_010.jpg)

![](/img/platform/manipulator_h/manipulator_h_011.png)
...
![](/img/platform/manipulator_h/manipulator_h_012.png)

![](/img/platform/manipulator_h/manipulator_h_013.png)

![](/img/platform/manipulator_h/manipulator_h_014.png)

![](/img/platform/manipulator_h/manipulator_h_015.png)
...
![](/img/platform/manipulator_h/manipulator_h_016.jpg)
...
![](/img/platform/manipulator_h/manipulator_h_017.png)
...
:::
  ...
  ![](/img/platform/manipulator_h/manipulator_h_018.jpg)

- Install and run RoboPlus; click on DYNAMIXEL Wizard button to start DYNAMIXEL Wizard.

  ![](/img/platform/manipulator_h/manipulator_h_019.jpg)
...
- USB2DYNAMIXEL to the PC after wiring is complete. From the PC check the COM port number of USB2DYNAMIXEL.
  ...
  ![](/img/platform/manipulator_h/manipulator_h_020.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_021.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_022.jpg)
...
**CAUTION** : Always ensure before powering on. While power is on do not change wires; otherwise it may cause undesired operations.
  ...
  ![](/img/platform/manipulator_h/manipulator_h_023.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_024.jpg)
...
- The picture on the left is the COM port number of USB2DYNAMIXEL (which should be connected to the arm). Click on the   to continue
  ...
  ![](/img/platform/manipulator_h/manipulator_h_025.jpg)
...
- Once connected make sure that 1000000bps box is checked and “DXL 2.0” is selected. Then click on Search. The arm’s default baud rate is 1 Mbps.
  ...
  ![](/img/platform/manipulator_h/manipulator_h_026.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_027.jpg)
...
- Once search is complete the arm’s components (DYNAMIXEL PROs) are listed on the left. Click on an individual DYNAMIXEL PRO to display the contents of its Control Table.
  ...
  ![](/img/platform/manipulator_h/manipulator_h_028.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_029.jpg)
...
- DYNAMIXEL Pro will only move (operate) when Torque Mode is on. So always make sure the Torque Mode is on prior to sending moving commands.  
  ...
  ![](/img/platform/manipulator_h/manipulator_h_030.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_031.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_032.jpg)

  ![](/img/platform/manipulator_h/manipulator_h_033.jpg)
...
- Turn ‘Torque Enable’ on to all joints. The pose of the arm will become rigid (check by applying a small force). Afterwards click on joint 6.
  ...
  ![](/img/platform/manipulator_h/manipulator_h_034.jpg)
...
- Set Goal Position back to 0 to set position to its original position.
  ...
  ![](/img/platform/manipulator_h/manipulator_h_035.jpg)
...
|:----------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| H54-200-S500-R<br />H54-100-S500-R | -180 ~ 180 (deg) → -251000 ~ 251000<br />![](/img/platform/manipulator_h/manipulator_h_036.jpg)<br />![](/img/platform/manipulator_h/manipulator_h_037.gif) |
|           H42-20-S300-R            | -180 ~ 180 (deg) → -151875 ~ 151875<br />![](/img/platform/manipulator_h/manipulator_h_038.jpg)<br />![](/img/platform/manipulator_h/manipulator_h_039.gif) |
|           L54-50-S500-R            | -180 ~ 180 (deg) → -125700 ~ 125700<br />![](/img/platform/manipulator_h/manipulator_h_040.jpg)<br />![](/img/platform/manipulator_h/manipulator_h_041.gif) |
|           L54-30-S500-R            | -180 ~ 180 (deg) → -144180 ~ 144180<br />![](/img/platform/manipulator_h/manipulator_h_042.jpg)<br />![](/img/platform/manipulator_h/manipulator_h_043.gif) |
|           L42-20-S300-R            |   -180 ~ 180 (deg) → -2048 ~ 2048<br />![](/img/platform/manipulator_h/manipulator_h_044.jpg)<br />![](/img/platform/manipulator_h/manipulator_h_045.gif)   |

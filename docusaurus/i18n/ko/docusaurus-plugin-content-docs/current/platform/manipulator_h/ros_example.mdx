...
```
![](/img/platform/manipulator_h/manipulator_h_rviz.png)
...
**TIP**:
- If you can't load DYNAMIXEL's, please check your DYNAMIXEL's settings using [this page](/docs/platform/manipulator_h/getting_started#prerequisite).
...
![](/img/platform/manipulator_h/manipulator_h_gui.png)  
...
- Make sure ROS dependencies are installed before performing these instructions - [Install ROS Packages](https://emanual.robotis.com/docs/en/platform/openmanipulator_h/ros_setup/#install-ros-packages)
...
```
![](/img/platform/manipulator_h/manipulator_h_gazebo.png)  

...
1. Restoring firmware
  ...
  - Select the corresponding COM port number for USB2DYNAMIXEL.
    ...
    ![](/img/platform/manipulator_h/manipulator_h_076.jpg)

2. Firmware restore process steps explained.

    ![](/img/platform/manipulator_h/manipulator_h_077.jpg)

3. Always connect one DYNAMIXEL at a time.

    ![](/img/platform/manipulator_h/manipulator_h_078.jpg)
...
4. Pick the COM port number
  ...
  - Click on Search.
    ...
    ![](/img/platform/manipulator_h/manipulator_h_079.jpg)

5. Disconnect and connect DYNAMIXEL
  - The Next button should become clickable

    ![](/img/platform/manipulator_h/manipulator_h_080.jpg)

6. Upon successful detection the Next button is clickable

    ![](/img/platform/manipulator_h/manipulator_h_081.jpg)

7. Pick the right model
  - Pick the right type from the list. If not it may result in problems

    ![](/img/platform/manipulator_h/manipulator_h_082.jpg)

    ![](/img/platform/manipulator_h/manipulator_h_083.jpg)

    ![](/img/platform/manipulator_h/manipulator_h_084.jpg)

8. During restoration
  - While restoring, the LED will blink. Do not cut power off during this stage.

    ![](/img/platform/manipulator_h/manipulator_h_085.jpg)

    ![](/img/platform/manipulator_h/manipulator_h_086.jpg)

...
| Bit 5 (0x40)<br /><br />Bit 4 (0x40) | Profile Type(H)<br /><br />Profile Type(L)   | 현재 사용 중인 프로파일의 타입<br />11 : Trapezoidal Profile<br />10 : Triangular Profile<br />01 : Rectangular Profile<br />00 : Profile Not Used(Step) |

...
| Bit 6(0x40) |     Dynamic Brake ON     | **[0]** Dynamic Brake OFF: Torque OFF State에서 Dynamic Brake 비활성화 <br />**[1]** Dynamic Brake ON: Torque OFF State에서 Dynamic Brake 활성화                                     |
...
| Bit 2(0x04) |  Profile Configuration   | **[0]** Velocity-based Profile<br />**[1]** Time-based Profile<br />※ 자세한 사항은 [Profile](#profile)를 참고하세요. |

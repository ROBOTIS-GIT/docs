...
Bus Watchdog Error Status가 되면, Goal Value(Goal PWM(524), Goal Current(526), Goal Velocity(528), Goal Position(532))의 Access(접근 속성)은 읽기 전용(Read Only)로 변경됩니다.
...
**참고** : Data Range Error에 대한 자세한 사항은 [프로토콜](/docs/dxl/protocol/protocol2/#status-packet)을 참고해주세요.
...
3. Bus Watchdog(8)의 값을 ‘100’(2,000 [ms])으로 변경합니다.(Bus Watchdog 기능 활성화)

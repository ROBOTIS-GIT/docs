|           항목           |                            RS-485                            |                                           Power                                            |                               외부 포트                                    |
|:------------------------:|:------------------------------------------------------------:|:------------------------------------------------------------------------------------------:|:--------------------------------------------------------------------------:|
|        핀 번호          |         `1` GND<br />`2` VDD<br />`3` DATA+<br />`4` DATA-         |                                    `1` GND<br /> `2` VDD                                     | `1` GND<br />`2` VDD<br />`3` PORT 1<br />`4` PORT 2<br />`5` PORT 3<br />`6` PORT 4 |
|       다이어그램         |        ![](/img/common/jst_b4beha_diagram.webp)        |                     ![](/img/common/molex_39281023_diagram.webp)                     |             ![](/img/common/molex_5304706_diagram.webp)              |
|         하우징           |    ![](/img/common/JST_EHR-4.webp)<br />[JST EHR-4]    |             ![](/img/common/molex_39012020.webp)<br />[MOLEX 39-01-2020]             |    ![](/img/common/molex_510210600.webp)<br />[MOLEX 51021-0600]     |
|        PCB Header        | ![](/img/common/JST_B4B-EH-A.webp)<br />[JST B4B-EH-A] | ![](/img/common/molex_39281023.webp)<br />[MOLEX 39-28-1023]<br />[MOLEX 87427-0242] |    ![](/img/common/molex_530470610.webp)<br />[MOLEX 53047-0610]     |
|      Crimp Terminal      |                        [JST SEH-001T]                        |                                     [MOLEX 39-00-0038]                                     |                             [MOLEX 50079-8100]                             |
| DYNAMIXEL 전선 규격      |                            21 AWG                            |                                           20 AWG                                           |                                   26 AWG                                   |

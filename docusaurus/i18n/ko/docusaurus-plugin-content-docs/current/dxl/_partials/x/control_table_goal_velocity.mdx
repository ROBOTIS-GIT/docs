...
**참고** : Goal Velocity(104) 은 [Velocity Limit(44)](#velocity-limit44)보다 클 수 없습니다.
...
**참고** : [Profile Acceleration(108)](#profile-acceleration108)과 Goal Velocity(104)를 동시에 변경할 경우, 변경된 [Profile Acceleration(108)](#profile-acceleration108)이 적용되어 Goal Velocity(104)가 수행됩니다.

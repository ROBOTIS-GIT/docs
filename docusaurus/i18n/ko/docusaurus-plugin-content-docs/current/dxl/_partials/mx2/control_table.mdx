...
**주의**
1. MX(2.0) Firmware는 기존 MX 시리즈와 컨트롤 테이블 및 Address가 다릅니다. 사용 전에 컨트롤 테이블 Address를 확인하세요.
2. MX(2.0) Firmware는 DYNAMIXEL-X의 기능을 계승합니다. 따라서 [DYNAMIXEL Protocol 1.0](/docs/dxl/protocol/protocol1)과 [DYNAMIXEL Protocol 2.0](/docs/dxl/protocol/protocol2), 다양한 동작 모드, Secondary ID, Drive Mode, Bus Watchdog 등을 지원합니다. 자세한 내용은 컨트롤 테이블을 참고하세요.

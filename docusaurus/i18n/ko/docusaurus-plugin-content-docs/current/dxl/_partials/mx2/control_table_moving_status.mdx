{/*
mx2 (mx-64-2 / mx-106-2) — includes Current-based Position Control Mode.
mx-28-2 omits the "Current-based Position Control Mode" reference; that
page renders this content inline (no Current row).
*/}
...
**NOTE** : The Triangular velocity profile is configured when Rectangular velocity profile cannot reach to the [Profile Velocity(112)](#profile-velocity112).

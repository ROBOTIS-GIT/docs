...
그러므로 ID가 같은 다이나믹셀이 존재하지 않도록 ID설정을 해야 합니다. ID 설정을 위해서는, 다이나믹셀 위자드 2.0에서 [컨트롤 테이블](/docs/software/dynamixel_wizard_2_0/basic_features#다이나믹셀-컨트롤-테이블)을 참고 하세요.
...
### Reboot
장치를 재부팅 시킵니다.
- 지원 모델 : 다이나믹셀 [MX-12W(V41), MX-28/64/106(V40), MX(2.0)](/docs/dxl/model_reference/mx_series), [X 시리즈](/docs/dxl/model_reference/x_series)
...
- 지원 모델 : 다이나믹셀 [MX, MX(2.0)](/docs/dxl/model_reference/mx_series), [X 시리즈](/docs/dxl/model_reference/x_series) (XL-320 제외)

...
| 0x02 | 고정값<br />(0x45 0x52 0x43 0x4C) | DYNAMIXEL에 발생한 Error를 Clear.<br />Clear가 불가능한 Error가 있거나 Clear 조건이 아닌 경우 Error는 Clear 되지 않으며 Status Packet의 Error 필드에 Result Fail(0x01) 발생.<br />DYNAMIXEL Y시리즈만 지원합니다.        |
| ...  |                 -                 | 사용하지 않습니다                                                                                                                                                                                                 |
| 0xFF |                 -                 | 사용하지 않습니다                                                                                                                                                                                                 |

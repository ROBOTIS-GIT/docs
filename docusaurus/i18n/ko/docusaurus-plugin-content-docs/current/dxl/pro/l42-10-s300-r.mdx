...
| <a href="/img/dxl/axial_radial_load_pro.png" target="_blank">반경방향 하중</a> | 280 [N] (혼으로부터 10 [mm])         |
| <a href="/img/dxl/axial_radial_load_pro.png" target="_blank">축방향 하중</a>   | 100 [N]          |
...
|:-------------:|:---------------:|:-----------:|:--------------------------------------------------------------------------------------------------------------:|
| L42-10-S300-R | 0 ~ 360 [&deg;] |  0 ~ 4,095  | ![](/img/dxl/pro/l42_angle_position.png)<br />![](/img/dxl/pro/l42_goal_angle_formula.png) |
...
[프로토콜]: /docs/dxl/protocol2#reboot

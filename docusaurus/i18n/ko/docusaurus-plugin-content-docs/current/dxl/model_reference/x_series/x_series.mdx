...
- 높은 토크와 컴팩트한 크기
- 향상된 내구성과 확장성
- 케이블 스트레스를 최소화하는 중공형 백 케이스
- 케이스에 직접 액세서리 조립 가능
- 일체형 알루미늄 케이스로 방열 성능 향상

### 다양한 제어 기능
- 전류 기반 토크 제어
- 부드러운 모션 계획을 위한 Profile 제어
- 실시간 Trajectory Data 및 Moving Status 피드백
- 최저 40mA 수준의 에너지 효율적인 대기 전류
- 다양한 Operating Mode 지원
  - Current-based Position Control (XW/XH/XM/X330만 지원)
  - Current Control (XW/XH/XM/X330만 지원)
  - Velocity Control
  - Position Control
...
XL320 서보는 다른 XL-Series 모델과 사양이 다릅니다. 자세한 내용은 [XL-320 사양](/docs/dxl/model_reference/x_series/xl_series/xl320) 문서를 참고하세요.
...
[XH430-V350-R]: /docs/dxl/model_reference/x_series/xh_series/xh430-v350
[XH430-W350-T/R]: /docs/dxl/model_reference/x_series/xh_series/xh430-w350
[XH430-V210-R]: /docs/dxl/model_reference/x_series/xh_series/xh430-v210
[XH430-W210-T/R]: /docs/dxl/model_reference/x_series/xh_series/xh430-w210
...
[XM430-W350-T/R]: /docs/dxl/model_reference/x_series/xm_series/xm430-w350
[XM430-W210-T/R]: /docs/dxl/model_reference/x_series/xm_series/xm430-w210
[XM335-T323-T]: /docs/dxl/model_reference/x_series/xm_series/xm335-t323

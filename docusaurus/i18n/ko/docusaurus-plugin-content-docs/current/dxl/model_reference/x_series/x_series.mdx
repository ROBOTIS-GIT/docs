...
- 6가지 제어 모드 지원
  - 전류제어 (XW/XD/XH/XM/XC330/XL330 시리즈만 지원)
  - 전류기반 위치제어 (XW/XD/XH/XM/XC330/XL330 시리즈만 지원)
  - 속도제어
  - 위치제어
  - 확장 위치제어
  - PWM제어
...
XL-320의 사양은 다른 XL 모델들과 차이가 있습니다. 자세한 내용은 [XL-320 주요사양](/docs/dxl/model_reference/x_series/xl_series/xl320#주요-사양)을 참고해주세요.

...
|:----------------------------------------------:|:----------------------------------------------:|:----------------------------------------------:|:--------------------------------------------:|
| ![](/img/dxl/model_reference/mx_series/mx-106t_product.webp) | ![](/img/dxl/model_reference/mx_series/mx-64ar_product.webp) | ![](/img/dxl/model_reference/mx_series/mx-28ar_product.webp) | ![](/img/dxl/model_reference/mx_series/mx-12_product.webp) |

- 새롭게 적용된 CONTACTLESS ABSOLUTE ENCODER로 내구성, 정밀도, 제어 영역이 향상되었습니다.
...
- PID CONTROL을 통해 위치 제어의 신뢰성과 정확도가 향상되었습니다.
...
| Protocol 1.0     | Protocol 2.0          | Stall Torque                                                                                           | 무부하 속도                                                                        |
|:-----------------|:----------------------|:-------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------|
...
[MX-28T/R/AT/AR]: /docs/dxl/model_reference/mx_series/mx-28
[MX-64T/R/AT/AR]: /docs/dxl/model_reference/mx_series/mx-64
[MX-106T/R]: /docs/dxl/model_reference/mx_series/mx-106

...
## Reboot
장치를 재부팅 시킵니다.
- 지원 모델 : 다이나믹셀 [MX-12W(V41), MX-28/64/106(V40), MX(2.0)](https://emanual.robotis.com/docs/kr/dxl/mx/), [X 시리즈](https://emanual.robotis.com/docs/kr/dxl/x/)
...
- 지원 모델 : 다이나믹셀 [MX, MX(2.0)](https://emanual.robotis.com/docs/kr/dxl/mx/), [X 시리즈](https://emanual.robotis.com/docs/kr/dxl/x/) (XL-320 제외)
...
**주의**: [DYNAMIXEL Protocol 2.0의 Bulk Read](https://emanual.robotis.com/docs/kr/dxl/protocol2/#bulk-read) 패킷과 Parameter 필드의 구성이 다르므로 주의하세요.
...
[다이나믹셀 ID설정]: https://emanual.robotis.com/docs/kr/software/rplus1/manager/#id-설정
[Ping]: #ping
[Read]: #read
[Write]: #write
[Reg Write]: #reg-write

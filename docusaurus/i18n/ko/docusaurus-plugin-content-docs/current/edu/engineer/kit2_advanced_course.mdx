---
id: kit2_advanced_course
title: "ENGINEER Kit2 Advanced Course"
sidebar_label: "ENGINEER Kit2 Advanced Course"
sidebar_position: 50
tags: [edu, engineer]
---
...
## 앱 설치하기
엔지니어 키트2 는 엔지니어 키트 1와 동일한 소프트웨어(R+Task 3.0) 및 앱(STEAMCUP ENGINEER) 을 사용합니다. 다음과 같은 소프트웨어 및 앱을 설치 하지 경우, [앱 설치하기](/docs/edu/engineer/kit1#작동하기)를 참고하세요

...
sidebar_label: "CM-550 MicroPython API"
sidebar_position: 60
tags: [edu, engineer]
---
...
- direction : const.V or const.H   
  ...
  ![cm550_const_v](/img/edu/engineer/kit2/pycm_api/cm550_const_v.webp)
  > const.V (vertical)
    

  ![cm550_const_h](/img/edu/engineer/kit2/pycm_api/cm550_const_h.webp)
  > const.H (horizontal)
...
- acceleration value of range -32768 ~ 32767 (unit: 0.001G)  
  ![cm550_accel_range](/img/edu/engineer/kit2/pycm_api/cm550_accel_range.webp)
...
- Gyro value of range -32768 ~ 32767 (unit: 0.01&deg;/s)  
  ![cm550_image_gyro_range](/img/edu/engineer/kit2/pycm_api/cm550_image_gyro_range.webp)
...
- roll value of range -18000 ~ 18000 (unit: 0.01&deg;)  
  ![cm550_rpy_roll_range](/img/edu/engineer/kit2/pycm_api/cm550_rpy_roll_range.webp)
...
[OLLO_WHEEL_SPEED]: https://emanual.robotis.com/docs/en/parts/motor/gm-10a/


[OLLO_MOISTURE]: https://emanual.robotis.com/docs/en/parts/sensor/tms-10/
[OLLO_MOISTURE_TEMP]: https://emanual.robotis.com/docs/en/parts/sensor/tms-10/


[OLLO_LED]: /docs/parts/display/lm-10

[OLLO_TEMPERATURE]: /docs/parts/sensor/tps-10
[OLLO_MAGNET]: /docs/parts/sensor/mgss-10
[OLLO_MOTION_DETECTION]: /docs/parts/sensor/pir-10
[OLLO_COLOR]: /docs/parts/sensor/cs-10
[OLLO_BRIGHTNESS]: https://emanual.robotis.com/docs/en/parts/sensor/cds-10/
#### Example

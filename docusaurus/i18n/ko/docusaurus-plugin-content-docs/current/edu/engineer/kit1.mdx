...
## 부품 목록
![](/img/edu/engineer/kit1/kit1_parts_list_kr.webp)
...
![](/img/edu/engineer/kit1/cm550_2_kr.webp)
...
![](/img/edu/engineer/kit1/rivet_assembly_6mm_kr.webp)  
...
![](/img/edu/engineer/kit1/rivet_assembly_12mm_kr.webp)
...
# 작동하기
## 앱 설치하기
- STEAMCUP ENGINEER는 [R+ Task 3.0]를 지원합니다.
...
- **참고**: [로보플러스 엔지니어 다운로드 방법](/docs/popup/engineer/engineer_app_installation)
...
1. [제어기와 PC 연결하기]
2. [PC에서 태스크 예제 다운로드 하기]
3. [PC에서 모션 예제 다운로드 하기]
...
1. [제어기와 스마트기기 연결하기]
2. [스마트기기에서 태스크 예제 다운로드 하기]
3. [스마트기기에서 모션 예제 다운로드 하기]
...
![](/img/edu/engineer/kit1/engineer_app_configuration_kr.webp)
...
6. 확인한 문자를 왼쪽 상자에 입력한 후 `검색` 을 누릅니다.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_6_kr.webp)

7. 검색된 목록 중 제어기의 주소와 일치하는 항목을 선택하면 블루투스 통신 연결이 완료되고, 로봇이 실행됩니다.  
  ![](/img/edu/engineer/kit1/bluetooth_connection_7_kr.webp)
...
![](/img/edu/engineer/kit1/engineer_app_emotion_3_kr.webp)

##### 모드 메뉴

|                        아이콘                         | 모드 설명                                                                                                                                                       |
|:-----------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  ![](/img/edu/engineer/kit1/icon_demo.webp)  | **DEMO : 감성인식 모드**<br />기본 데모 모드로 스마트 기기 화면을 통해 감정상태를 표현합니다.<br />로봇이나 스마트 기기를 터치하면 다양한 반응을 합니다.            |
|  ![](/img/edu/engineer/kit1/icon_face.webp)  | **FACE : 얼굴인식 모드**<br />스마트 기기의 카메라로 얼굴을 인식하고 추적하는 모드입니다.<br />AR 기술을 적용해 추적하는 얼굴 위에 스티커를 입힙니다.               |
| ![](/img/edu/engineer/kit1/icon_object.webp) | **OBJECT : 객체인식 모드**<br />사전에 등록된 물건을 카메라로 인식하고 말하는 모드입니다.<br />바나나, 볼펜, 차 열쇠, 지갑, 지폐 등 12종의 물건을 말할 수 있습니다. |
| ![](/img/edu/engineer/kit1/icon_voice.webp)  | **VOICE : 음성인식 모드**<br />등록된 음성 명령을 인식하고 실행하는 모드입니다.<br />모드 변경 및 옵션 메뉴 실행, 종료 등의 명령을 인식합니다.                      |
|  ![](/img/edu/engineer/kit1/icon_clap.webp)  | **CLAP : 박수감지 모드**<br />제어기의 마이크 센서를 통해 박수소리를 인식하는 모드입니다.<br />인식한 박수소리의 숫자만큼 Dr.R이 따라서 박수를 칩니다.              |

##### 옵션메뉴

|                        아이콘                         | 옵션 설명                                                                                    |
|:-----------------------------------------------------:|:---------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_motor.webp)  | **MOTOR : 다이나믹셀 점검**<br />로봇의 다이나믹셀 상태를 각각 테스트해 볼 수 있는 메뉴입니다. |
| ![](/img/edu/engineer/kit1/icon_offset.webp) | **OFFSET : 모션오프셋**<br />모션 동작시 각 관절의 기본 위치를 설정하는 기능입니다.            |
...
![](/img/edu/engineer/kit1/max_controller_kr.webp)
...
|                         아이콘                         | 메뉴 설명                                                                    |
|:------------------------------------------------------:|:-----------------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.webp)  | **REMOTE** : 기본 조종 모드 화면을 불러오는 버튼입니다.                      |
| ![](/img/edu/engineer/kit1/icon_gesture.webp) | **GESTURE** : 등록된 스마트 기기의 동작 제스처로 로봇을 조종하는 기능입니다. |
|  ![](/img/edu/engineer/kit1/icon_clap.webp)   | **CLAP** : 박수소리를 감지하고 감지한 횟수만큼 MAX-E1이 박수를 칩니다.       |

### SPI
#### 리모컨 화면

![](/img/edu/engineer/kit1/spi_controller_kr.webp)
...
|:-----------------------------------------------------:|:-------------------------------------------------------------------|
| ![](/img/edu/engineer/kit1/icon_remote.webp) | **REMOTE** : 기본 조종 모드 화면을 불러오는 버튼입니다.            |
| ![](/img/edu/engineer/kit1/icon_music.webp)  | **MUSIC** : 스마트 기기를 통해 로봇과 함께 연주를 하는 기능입니다. |
|  ![](/img/edu/engineer/kit1/icon_clap.webp)  | **CLAP** : 박수소리를 감지하고 감지한 횟수만큼 SPI가 움직입니다.   |
...
# 튜토리얼
## 머신러닝 기반의 사물인식
STEAMCUP ENGINEER는 머신러닝(Tensor Flow)기반의 사물학습 및 객체인식 기능을 사용할 수 있습니다.  
...
`Ctrl` + `Shift` 를 누른 상태에서 `명령 프롬프트` 를 클릭해도 됩니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_cmd_01_kr.webp)

2. 명령 프롬프트가 실행되면 아래와 같은 화면이 나타납니다.

    ![](/img/edu/engineer/kit1/obj_classification_cmd_02_kr.webp)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_cmd_03_kr.webp)

4. pip패키지가 성공적으로 업그레이드되면 아래와 같이 표시됩니다.

    ![](/img/edu/engineer/kit1/obj_classification_cmd_04_kr.webp)
...
1. `D 드라이브`에 `!R+Smart` 폴더를 만들어 주세요.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_01_kr.webp)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_02_kr.webp)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_mkdir_03_kr.webp)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_01_kr.webp)

2. 진행여부를 묻습니다. `y` 입력후, `Enter Key`를 눌러 패키지 설치를 진행합니다.

    ![](/img/edu/engineer/kit1/obj_classification_tensor_02_kr.webp)

3. 성공적으로 설치되면 아래의 사진과 같이 나옵니다.

    ![](/img/edu/engineer/kit1/obj_classification_tensor_03_kr.webp)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_04_kr.webp)
...
:::
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_05_kr.webp)
...
2. `!R+Smart` 폴더에 다운로드받은 `retrain.py` 파일을 복사한 다음, 객체 추가를 위한 `photos` 폴더를 만듭니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_tensor_retrain_kr.webp)

3. `photos` 폴더 안에 `001 dummy`, `002 banana` 그리고 `003 pineapple`과 같이 객체 이미지를 추가할 하위 폴더를 만들고 객체와 관련된 이미지를 각각의 폴더에 추가합니다.

    ![](/img/edu/engineer/kit1/obj_classification_image_01_kr.webp)
...
```
    ...
    ![](/img/edu/engineer/kit1/obj_classification_img_learning_01_kr.webp)
...
2. 학습이 완료되면 아래와 같이 `Smart_OC.txt` 와 `Smart_OC.pb` 파일이 `!R+Smart` 폴더에 생성됩니다.
   ...
   ![](/img/edu/engineer/kit1/obj_classification_oc_kr.webp)
...
2. 스마트 기기의 저장공간에서 `RoboPlus` > `ROBOTIS ENGINEER` > `CUSTOM` 폴더를 찾아 들어갑니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_application_01_kr.webp)  
    ![](/img/edu/engineer/kit1/obj_classification_application_02_kr.webp)  
    ![](/img/edu/engineer/kit1/obj_classification_application_03_kr.webp)
...
4. 데이터베이스를 사용하기 위해서 `Db` 폴더를 생성합니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_application_05_kr.webp)

5. `!R+Smart` 에서 생성된 학습파일인 `Smart_OC.txt` 와 `Smart_OC.pb` 을 `Db` 폴더에 복사합니다.  

    ![](/img/edu/engineer/kit1/obj_classification_application_06_kr.webp)
...
7. `User` 탭으로 이동합니다.
    ...
    ![](/img/edu/engineer/kit1/obj_classification_test_01_kr.webp)

8. 3번 단계에서 생성한 `Project 1` 프로젝트 폴더의 `설정` 아이콘을 클릭합니다.   

    ![](/img/edu/engineer/kit1/obj_classification_test_02_kr.webp)

9. `비전` > `객체 분류` 를 선택합니다.

    ![](/img/edu/engineer/kit1/obj_classification_test_03_kr.webp)

10. 이미지 폴더가 추가되었는지 확인합니다.

    ![](/img/edu/engineer/kit1/obj_classification_test_04_kr.webp)
...
아래의 링크에서 STEAMCUP ENGINEER 키트의 다양한 교육자료를 받을 수 있습니다.
- [**교육자료 신청하기**](https://www.robotis.com/pdf_project/register.php)

:::


![](/img/edu/engineer/kit1/engineer_edu_metarials_kr.webp)
...
[CM-550 매뉴얼 바로가기]: /docs/parts/controller/cm-550
[2XL430-W250 매뉴얼 바로가기]: /docs/dxl/model_reference/x_series/2xl430-w250
...
[동작 모드]: /docs/parts/controller/cm-550#동작-모드
[제어기와 PC 연결하기]: /docs/popup/engineer/connect_controller_pc
[PC에서 태스크 예제 다운로드 하기]: /docs/popup/engineer/task_download_pc
[PC에서 모션 예제 다운로드 하기]: /docs/popup/engineer/motion_download_pc
[제어기와 스마트기기 연결하기]: /docs/popup/engineer/connect_controller_mobile
[스마트기기에서 태스크 예제 다운로드 하기]: /docs/popup/engineer/task_download_mobile
[스마트기기에서 모션 예제 다운로드 하기]: /docs/popup/engineer/motion_download_mobile

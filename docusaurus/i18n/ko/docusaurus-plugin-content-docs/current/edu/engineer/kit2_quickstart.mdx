...
- 예제 다운로드 하기 전, 로보플러스 매니저를 사용하여, CM-550의 펌웨어를 업데이트 하세요. [펌웨어 업데이트](/docs/software/dynamixel_wizard_2_0/basic_features#펌웨어-업데이트) 따라하기.
...
|                          아이콘                          | 모드 설명                                                                                                                                          |
|:--------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------|
|  ![](/img/edu/engineer/kit2_quickstart/icon_remote.webp)   | **REMOTE : 조종 모드**<br />MAX-E2 로봇을 조종하는 모드이며 FIGHT, SOCCER 등의 모드 변경을 통해 MAX-E2를 다양한 모션으로 조종할 수 있습니다.         |

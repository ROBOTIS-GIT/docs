...
sidebar_label: "BIOLOID Comprehensive"
sidebar_position: 20
tags: [edu, bioloid]
---
...
# 시작하기
## 부품 목록
![](/img/edu/bioloid/comprehensivekit_partlist_kr.webp)
...
### 중급 레벨
관절 수 8개 이하의 로봇들입니다. 바이올로이드 초급에 4개의 AX-12A 를 추가로 구입하거나 바이올로이드 종합으로 만들 수 있습니다. 조립 방법 및 작동 방법은 바이올로이드 종합의 조립서를 참고하세요.
...
### 고급 레벨
관절 수 18개 이하의 로봇들입니다. 바이올로이드 종합으로 만들 수 있습니다. 바이올로이드 초급의 경우 프레임세트와 14개의 AX-12+를 추가로 구매하면 만들 수 있습니다. 조립 방법 및 작동 방법은 바이올로이드 종합의 조립서를 참고하세요.
...
[RoboPlus Task]: https://emanual.robotis.com/docs/en/software/rplus1/task/getting_started
[로보플러스 태스크]: https://emanual.robotis.com/docs/en/software/rplus1/task/getting_started
[제어기 선택]: https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc#제어기-선택
[BIO_CMP_AttackingDuck_KR.tsk]: http://www.robotis.com/service/download.php?no=1181
[RoboPlus Manager]: https://emanual.robotis.com/docs/en/software/rplus1/manager
[물체 감지 기준 값과 물체 감지 유무]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#물체감지
[BIO_CMP_ObstacleDetectionCarExam_KR.tsk]: http://www.robotis.com/service/download.php?no=1214
...
[파라미터에 대한 설명]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#제어기-파라미터
[태스크 코드 다운로드 방법]: https://emanual.robotis.com/docs/en/software/rplus1/task/getting_started#프로그램-다운로드
[보행 드로이드 제작 1 - 모션만들기]: /docs/edu/bioloid/comprehensive#보행-드로이드-제작-1모션-만들기
[RC-100]: /docs/parts/communication/rc-100
[ZIG-100]: /docs/parts/communication/zig-110
[보행 드로이드 제작 2 - 태스크 코드]: /docs/edu/bioloid/comprehensive#보행-드로이드-제작-2태스크-코드
[BIO_CMP_WalkingDroidExam_KR.tsk]: http://www.robotis.com/service/download.php?no=1243
[BIO_CMP_WalkingDroidExam_KR.mtn]: http://www.robotis.com/service/download.php?no=1242
...
[ZIG-100/110]: /docs/parts/communication/zig-110
[상대 로봇 무선 ID]: https://emanual.robotis.com/docs/en/software/rplus1/manager#상대-로봇-무선-id

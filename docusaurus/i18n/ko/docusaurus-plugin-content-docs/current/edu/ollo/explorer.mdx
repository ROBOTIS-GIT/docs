...
# 부품 목록
 ![](/img/edu/ollo/edu_2nd_partlist_kr.webp)
...
- 제어기의 버튼을 연속으로 누르면 도,레,미와 같은 음계 소리가 나며 누른 횟수에 따라 내장된 프로그램을 선택할 수 있습니다.  
 ...
 ![](/img/edu/ollo/ollo_2ndoperation_kr.webp)
...
|버튼 누름 횟수|교재 내용|로봇|
| :-----: | :-----: | :-----: |
|1(도)|단원 1,2 예제| ![](/img/edu/ollo/2-1.elephant_kr.webp) ![](/img/edu/ollo/2-2._windmill_kr.webp)|
|2(레)|단원 3예제| ![](/img/edu/ollo/2-3._introduce_robot_kr.webp)|
|3(미)|단원 4예제|나만의 로봇을 만들어요|
|4(파)|단원 5예제| ![](/img/edu/ollo/2-4._fur_seal_kr.webp)|
|5(솔)|단원 6예제| ![](/img/edu/ollo/2-6._car_kr.webp)|
|6(라)|단원 7예제| ![](/img/edu/ollo/2-9._howitzer_kr.webp)|
|7(시)|단원 8예제|나만의 로봇을 만들어요|
|8(높은 도)|단원 9예제| ![](/img/edu/ollo/2-11._linetracing_ladybird_kr.webp)|
...
[교육키트 3단계]: /docs/edu/ollo/inventor

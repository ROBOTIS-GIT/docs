...
[Creating new motion module]: /docs/software/robotis_framework_packages/tutorials#creating-new-motion-module/
[Creating new sensor module]: /docs/software/robotis_framework_packages/tutorials#creating-new-sensor-module/
...
[robotis_controller_msgs/WriteControlTable]: /docs/popup/WriteControlTable_msg
...
[robotis_controller]: https://emanual.robotis.com/docs/en/software/robotis_framework_packages/#robotis-controller/
[JointCtrlModule.msg]: /docs/popup/JointCtrlModule_msg
[StatusMsg.msg]: /docs/popup/StatusMsg_msg
[SyncWriteItem.msg]: /docs/popup/SyncWriteItem_msg
[GetJointModule.srv]: /docs/popup/GetJointModule_srv

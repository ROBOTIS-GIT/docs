...
![img](/img/software/rplus1/task/syntax_error.png)
...
- 파라미터 설정을 하지 않았습니다.
  ...
  ![img](/img/software/rplus1/task/load_error_1.png)

#### 해결책

- 설정되지 않은 파라미터를 찾아 적절히 설정합니다.

  ![img](/img/software/rplus1/task/load_error_2.png)
...
- 구간이 필요한 명령문에서 구간이 없는 경우 발생합니다.
  ...
  ![img](/img/software/rplus1/task/interval_error_1.png)

#### 해결책

- 구간을 적절히 설정 해 주십시오.

  ![img](/img/software/rplus1/task/interval_error_2.png)
...
- 구간이 필요한 명령문이 구간 없이 중복으로 나올 경우 발생합니다.
  ...
  ![img](/img/software/rplus1/task/interval_error_3.png)

#### 해결책

- 구간을 적절히 설정 해 주십시오.

  ![img](/img/software/rplus1/task/interval_error_4.png)
...
- 프로그램 시작이 2개 이상일 때 발생합니다.
  ...
  ![img](/img/software/rplus1/task/program_start_error_1.png)

#### 해결책

- 프로그램 시작을 1개만 만듭니다.

  ![img](/img/software/rplus1/task/program_start_error_2.png)
...
- 프로그램 시작이 구간 안에 존재합니다.
  ...
  ![img](/img/software/rplus1/task/program_start_error_3.png)

#### 해결책

- 프로그램 시작을 구간 안에서 뺍니다.

  ![img](/img/software/rplus1/task/program_start_error_4.png)
...
- 함수가 구간 안에 있습니다.
  ...
  ![img](/img/software/rplus1/task/function_in_interval_1.png)

#### 해결책

- 함수를 구간 안에서 뺍니다.

  ![img](/img/software/rplus1/task/function_in_interval_2.png)
...
- 명령, 조건문 없이 구간만 있습니다.
  ...
  ![img](/img/software/rplus1/task/interval_no_command_1.png)

#### 해결책

- 누락된 명령을 추가하거나, 구간이 필요없으면 삭제 해 주십시오.

  ![img](/img/software/rplus1/task/interval_no_command_2.png)
...
- 구간 없이 가장 바깥에 명령문이 존재합니다.
  ...
  ![img](/img/software/rplus1/task/command_out_interval_1.png)

#### 해결책

- 명령문을 적절한 위치로 이동하거나, 잘못 정의된 경우 삭제해야 합니다.

  ![img](/img/software/rplus1/task/command_out_interval_2.png)
...
- 구간의 시작과 끝이 맞지 않는 경우 발생합니다.
  ...
  ![img](/img/software/rplus1/task/interval_matching_error_1.png)

#### 해결책

- 구간을 적절히 설정 해 주십시오.

  ![img](/img/software/rplus1/task/interval_matching_error_2.png)
...
- 프로그램 시작이 없습니다.
  ...
  ![img](/img/software/rplus1/task/program_not_start_1.png)

#### 해결책

- 프로그램 시작을 만듭니다.

  ![img](/img/software/rplus1/task/program_not_start_2.png)
...
- 같은 이름의 함수가 이미 있습니다.
  ...
  ![img](/img/software/rplus1/task/same_function_name_1.png)

#### 해결책

- 중복되는 함수 이름을 적절히 바꾸거나, 필요없는 경우 삭제합니다.

  ![img](/img/software/rplus1/task/same_function_name_2.png)
...
- 복귀 명령을 함수 이외의 곳에서 사용할 때 발생합니다.
  ...
  ![img](/img/software/rplus1/task/return_in_function_1.png)

#### 해결책

- 함수 내부에 복귀명령을 만들거나, 필요없는 경우 삭제합니다.

  ![img](/img/software/rplus1/task/return_in_function_2.png)
...
- 레이블 이름이 중복됩니다.
  ...
  ![img](/img/software/rplus1/task/same_lable_name_1.png)

#### 해결책

- 이름을 다르게 설정하거나, 필요없는 경우 삭제합니다.

  ![img](/img/software/rplus1/task/same_lable_name_2.png)
...
- 함수 내부에서 자기 자신을 호출할 때 발생합니다.
  ...
  ![img](/img/software/rplus1/task/self_fuction_call_1.png)

#### 해결책

- 적절한 명령문으로 대체하거나, 필요없는 경우 삭제합니다.

  ![img](/img/software/rplus1/task/self_fuction_call_2.png)
...
- "만약" 없이 "아니면 만약" 혹은 "아니면"이 사용되었습니다.
  ...
  ![img](/img/software/rplus1/task/wrong_condition_1.png)

#### 해결책

- "만약", "아니면 만약", "아니면"의 용법대로 수정합니다.

  ![img](/img/software/rplus1/task/wrong_condition_2.png)
...
- 반복문이 아닌 곳에서 '반복 끝내기'명령을 사용한 경우 발생합니다.
  ...
  ![img](/img/software/rplus1/task/loop_return_error_1.png)

#### 해결책

- 반복 끝내기 명령은 반복문 안에서 사용하며, 필요없는 경우 삭제합니다.

  ![img](/img/software/rplus1/task/loop_return_error_2.png)
...
- 존재하지 않는 함수를 호출합니다.
  ...
  ![img](/img/software/rplus1/task/function_name_1.png)

#### 해결책

- 해당 함수를 만들거나, 필요없는 경우 삭제합니다.

  ![img](/img/software/rplus1/task/function_name_2.png)
...
- 콜백 함수가 2개 이상 존재할 때 발생합니다.
  ...
  ![img](/img/software/rplus1/task/double_callback_1.png)

#### 해결책

- 콜백함수를 하나만 만듭니다.

  ![img](/img/software/rplus1/task/double_callback_2.png)
...
- 콜백이 구간 안에 존재합니다.
  ...
  ![img](/img/software/rplus1/task/callback_in_main_1.png)

#### 해결책

- 콜백을 구간 안에서 뺍니다.

  ![img](/img/software/rplus1/task/callback_in_main_2.png)
...
- 콜백에서 사용할 수 없는 명령문이 있습니다.
  ...
  ![img](/img/software/rplus1/task/callback_syntax_1.png)

#### 해결책

- 해당 명령문을 삭제합니다.

  ![img](/img/software/rplus1/task/callback_syntax_2.png)
...
- 콜백에서 사용할 수 없는 파라미터가 있습니다.
  ...
  ![img](/img/software/rplus1/task/callback_in_error_1.png)

#### 해결책

- 해당 파라미터를 삭제합니다.

  ![img](/img/software/rplus1/task/callback_in_error_2.png)
...
- 현재 설정된 제어기에서 지원하지 않는 명령문을 사용합니다.
  ...
  ![img](/img/software/rplus1/task/callback_in_cm100_1.png)

#### 해결책

- 해당 명령문을 삭제하거나, 지원하는 제어기로 설정합니다.

  ![img](/img/software/rplus1/task/callback_in_cm100_2.png)
...
- 현재 설정된 제어기에서 쓸 수 없는 파라미터를 사용합니다.
  ...
  ![img](/img/software/rplus1/task/controller_param_error_1.png)

#### 해결책

- 해당 파라미터를 삭제하거나, 지원하는 제어기로 설정합니다.

  ![img](/img/software/rplus1/task/controller_param_error_2.png)
...
[파라미터 입력 방법 1]: /img/software/rplus1/task/parameter_38.gif
[파라미터 입력 방법 2]: /img/software/rplus1/task/parameter_39.gif
[파라미터 입력 방법 3]: /img/software/rplus1/task/parameter_40.gif
[파라미터 입력 방법 4]: /img/software/rplus1/task/parameter_41.gif
[파라미터 입력 방법 5]: /img/software/rplus1/task/parameter_42.gif
[파라미터 입력 방법 6]: /img/software/rplus1/task/parameter_43.gif
[디버그 정보 표시 예제_1]: /img/software/rplus1/task/parameter_44.gif
[디버그 정보 표시 예제_2]: /img/software/rplus1/task/parameter_45.gif
[화면 회전 예제 1]: /img/software/rplus1/task/parameter_46.gif
[화면 회전 예제 2]: /img/software/rplus1/task/parameter_47.gif
[화면 회전 예제 3]: /img/software/rplus1/task/parameter_48.gif
[카메라 선택 예제 1]: /img/software/rplus1/task/parameter_49.gif
[카메라 선택 예제 2]: /img/software/rplus1/task/parameter_50.gif
[카메라 선택 예제 3]: /img/software/rplus1/task/parameter_51.gif
[카메라 줌 예제 1]: /img/software/rplus1/task/parameter_52.gif
[카메라 줌 예제 2]: /img/software/rplus1/task/parameter_53.gif
[카메라 줌 예제 3]: /img/software/rplus1/task/parameter_54.gif
[얼굴 감지 파라메터 1]: /img/software/rplus1/task/parameter_55.gif
[얼굴 감지 파라메터 2]: /img/software/rplus1/task/parameter_56.gif
[얼굴 감지 예제 1]: /img/software/rplus1/task/parameter_57.gif
[얼굴 감지 예제 2]: /img/software/rplus1/task/parameter_58.gif
[얼굴 감지 예제 3]: /img/software/rplus1/task/parameter_59.gif
[감지된 색상 예제 1]: /img/software/rplus1/task/parameter_69.gif
[감지된 색상 예제 2]: /img/software/rplus1/task/parameter_70.gif
[감지된 색상 예제 3]: /img/software/rplus1/task/parameter_71.gif
[동작 감지 위치 파라메터 1]: /img/software/rplus1/task/parameter_72.gif
[동작 감지 위치 파라메터 2]: /img/software/rplus1/task/parameter_73.gif
[동작 감지 위치 예제 1]: /img/software/rplus1/task/parameter_74.gif
[동작 감지 위치 예제 2]: /img/software/rplus1/task/parameter_75.gif
[라인 감지 위치 파라메터 1]: /img/software/rplus1/task/parameter_77.gif
[라인 감지 위치 파라메터 2]: /img/software/rplus1/task/parameter_78.gif
[라인 감지 위치 예제 1]: /img/software/rplus1/task/parameter_79.gif
[라인 감지 위치 예제 2]: /img/software/rplus1/task/parameter_80.gif
[동영상 녹화 예제 1]: /img/software/rplus1/task/parameter_81.gif
[동영상 녹화 예제 2]: /img/software/rplus1/task/parameter_82.gif
[사진 촬영 예제 1]: /img/software/rplus1/task/smart_app.gif
[사진 촬영 예제 2]: /img/software/rplus1/task/parameter_84.gif
[배경 표시 예제 1]: /img/software/rplus1/task/parameter_86.gif
[배경 표시 예제 2]: /img/software/rplus1/task/parameter_87.gif
[그림 표시 예제 1]: /img/software/rplus1/task/parameter_88.gif
[그림 표시 예제 2]: /img/software/rplus1/task/parameter_89.gif
[그림 표시 예제 3]: /img/software/rplus1/task/parameter_90.gif
[감지된 얼굴 그림 표시 파라메터 1]: /img/software/rplus1/task/parameter_91.gif
[감지된 얼굴 그림 표시 파라메터 2]: /img/software/rplus1/task/parameter_92.gif
[감지된 얼굴 그림 표시 파라메터 3]: /img/software/rplus1/task/parameter_93.gif
[도형 표시 예제 1]: /img/software/rplus1/task/parameter_94.gif
[도형 표시 예제 2]: /img/software/rplus1/task/parameter_95.gif
[도형 표시 예제 3]: /img/software/rplus1/task/parameter_96.gif
[문자 표시 예제 1]: /img/software/rplus1/task/parameter_97.gif
[문자 표시 예제 2]: /img/software/rplus1/task/parameter_98.gif
[문자 표시 예제 3]: /img/software/rplus1/task/parameter_99.gif
[문자 표시 예제 4]: /img/software/rplus1/task/parameter_100.gif
[문자 표시 예제 5]: /img/software/rplus1/task/parameter_101.gif
[숫자 표시 예제 1]: /img/software/rplus1/task/parameter_102.gif
[숫자 표시 예제 2]: /img/software/rplus1/task/parameter_103.gif
[숫자 표시 예제 3]: /img/software/rplus1/task/parameter_104.gif
[문자음성 자동변환 예제]: /img/software/rplus1/task/parameter_105.gif
[악기 연주 예제]: /img/software/rplus1/task/parameter_106.gif
[오디오 재생 1.2]: /img/software/rplus1/task/parameter_107.gif
[동영상 일시 정지 예제]: /img/software/rplus1/task/parameter_108.gif
[음성 인식 결과 예제 1]: /img/software/rplus1/task/parameter_109.gif
[음성 인식 결과 예제 2]: /img/software/rplus1/task/parameter_110.gif
[음성 인식 결과 예제 3]: /img/software/rplus1/task/parameter_111.gif
[볼륨 예제 1]: /img/software/rplus1/task/parameter_0.gif
[볼륨 예제 2]: /img/software/rplus1/task/parameter_1.gif
[흔들림 정도 예제 1]: /img/software/rplus1/task/parameter_2.gif
[흔들림 정도 예제 2]: /img/software/rplus1/task/parameter_3.gif
[흔들림 정도 예제 3]: /img/software/rplus1/task/parameter_4.gif
[기울기 각도 예제 1]: /img/software/rplus1/task/parameter_5.gif
[기울기 각도 예제 2]: /img/software/rplus1/task/parameter_6.gif
[조도 센서 예제 1]: /img/software/rplus1/task/parameter_7.gif
[조도 센서 예제 2]: /img/software/rplus1/task/parameter_8.gif
[조도 센서 예제 3]: /img/software/rplus1/task/parameter_9.gif
[자기장 센서 예제 1]: /img/software/rplus1/task/parameter_10.gif
[자기장 센서 예제 2]: /img/software/rplus1/task/parameter_11.gif
[자기장 센서 예제 3]: /img/software/rplus1/task/parameter_12.gif
[방향(각도값) 예제 1]: /img/software/rplus1/task/parameter_13.gif
[방향(각도값) 예제 2]: /img/software/rplus1/task/parameter_14.gif
[소음 측정 예제 1]: /img/software/rplus1/task/parameter_15.gif
[소음 측정 예제 2]: /img/software/rplus1/task/parameter_16.gif
[터치 위치 1,2 예제 1]: /img/software/rplus1/task/parameter_17.gif
[터치 위치 1,2 예제 2]: /img/software/rplus1/task/parameter_18.gif
[SMS(내용) 예제 1]: /img/software/rplus1/task/parameter_19.gif
[SMS(내용) 예제 2]: /img/software/rplus1/task/parameter_20.gif
[알림바 이벤트 예제 1]: /img/software/rplus1/task/parameter_21.gif
[알림바 이벤트 예제 2]: /img/software/rplus1/task/parameter_22.gif
[알림바 이벤트 예제 3]: /img/software/rplus1/task/parameter_23.gif
[타이머 예제]: /img/software/rplus1/task/parameter_24.gif
[진동 시간 예제]: /img/software/rplus1/task/parameter_25.gif
[플래시 LED 예제]: /img/software/rplus1/task/parameter_26.gif
[앱 실행 예제]: /img/software/rplus1/task/parameter_27.gif
[현재 시간 예제 1]: /img/software/rplus1/task/parameter_28.gif
[현재 시간 예제 2]: /img/software/rplus1/task/parameter_29.gif
[메일 발송 예제 1]: /img/software/rplus1/task/parameter_30.gif
[메일 발송 예제 2]: /img/software/rplus1/task/parameter_31.gif
[메일 발송 예제 3]: /img/software/rplus1/task/parameter_32.gif
[화면 출력, 화면 출력 후 줄 바꿈 예제 1]: /img/software/rplus1/task/parameter_33.gif
[화면 출력, 화면 출력 후 줄 바꿈 예제 2]: /img/software/rplus1/task/parameter_34.gif
[제스처 인식 예제 1]: /img/software/rplus1/task/parameter_35.gif
[제스처 인식 예제 2]: /img/software/rplus1/task/parameter_36.gif
[제스처 인식 예제 3]: /img/software/rplus1/task/parameter_37.gif
[select_controller]: /img/software/rplus1/task/controler_select.png
...
[CM-700]: https://emanual.robotis.com/docs/kr/parts/controller/cm-700
[OpenCm9.04]: https://emanual.robotis.com/docs/kr/parts/controller/opencm9.04

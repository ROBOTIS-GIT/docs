...
프로그램에서 출력 명령을 사용하면 프로그램 출력용 모니터에 값을 표시할 수 있습니다. 줄바꿈 출력은 출력 후 다음 줄로 커서를 이동합니다.

### 오류: 다음 내용을 확인하세요

출력이 보이지 않으면 프로그램 출력용 모니터가 열려 있는지, 제어기와 PC가 정상적으로 연결되어 있는지 확인하세요.

### 화면 지우기

화면 지우기 명령을 사용하면 프로그램 출력용 모니터의 내용을 지울 수 있습니다.
...
[에러 메시지]: /docs/software/rplus_1_0/rplus_task/task_misc#에러-메세지
[R+task]: /img/sw/rplus1/task/roboplus_task_001.png
[명령어-선택]: /img/sw/rplus1/task/roboplus_task_002.png
[제어기-선택]: /img/sw/rplus1/task/roboplus_task_003.png
[param]: /img/sw/rplus1/task/roboplus_task_004.png
[edit]: /img/sw/rplus1/task/roboplus_task_005.png
[select]: /img/sw/rplus1/task/roboplus_task_006.png
[select-window]: /img/sw/rplus1/task/roboplus_task_007.png
[port-select]: /img/sw/rplus1/task/roboplus_task_008.png
[error-message]: /img/sw/rplus1/task/roboplus_task_009.png
[download]: /img/sw/rplus1/task/roboplus_task_010.png
[download-run]: /img/sw/rplus1/task/roboplus_task_011.png
[terminal]: /img/sw/rplus1/task/roboplus_task_012.png
[output-monitor]: /img/sw/rplus1/task/roboplus_task_013.png
[monitor-btn]: /img/sw/rplus1/task/monitor_btn.png
[code]: /img/sw/rplus1/task/roboplus_task_014.png
[print]: /img/sw/rplus1/task/roboplus_task_015.png
[newline]: /img/sw/rplus1/task/roboplus_task_016.png
[start-message]: /img/sw/rplus1/task/roboplus_task_017.png
[error-code]: /img/sw/rplus1/task/roboplus_task_018.png
[print-num]: /img/sw/rplus1/task/roboplus_task_019.png
[print-sensor]: /img/sw/rplus1/task/roboplus_task_020.png
[clear-screen]: /img/sw/rplus1/task/roboplus_task_021.png
[virtual-rc100]: /img/sw/rplus1/task/virtual_rc100.png

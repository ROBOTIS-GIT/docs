...
![img](/img/software/rplus1/manager/roboplus_manager.png)
...
2. 사용할 통신 포트를 선택합니다.
   ...
   ![img](/img/software/rplus1/manager/connection.png)

   만약, 해당 통신 포트가 사용중으로 나타나면 사용중인 프로그램을 찾아 사용을 해제해야 합니다.
   ![img](/img/software/rplus1/manager/connection_in_use.png)

   RoboPlus Manager가 제어기를 찾지 못하면 아래와 같은 에러 메시지가 나타납니다.
   ![img](/img/software/rplus1/manager/connection_not_find.png)
...
1. 제품을 컴퓨터에 연결시 장치 관리자에게 연결장치(LN101, USB2DXL, 제어기 등)의 포트가 생기는지 확인해주세요.
    ...
    ![img](/img/software/rplus1/manager/manege_controller.jpg)
...
![img](/img/software/rplus1/manager/update_2.png)

1. 제어기와 연결되면 자동으로 제어기의 펌웨어를 검색하며 버전이 낮다면 업데이트 여부를 묻습니다.

   ![img](/img/software/rplus1/manager/update_5.png)

2.  '예(Y)'를 누르면 다음과 같이 제어기 펌웨어 업데이트 마법사를 시작합니다.

   ![img](/img/software/rplus1/manager/update_6.png)

3. 현재 연결된 제어기의 모델명과 펌웨어 버전을 확인할 수 있습니다.

   ![img](/img/software/rplus1/manager/update_7.png)

4. 다음을 누르면 펌웨어 업데이트를 시작합니다. 완료될 때 까지 전원이 꺼지거나 케이블이 빠지지 않도록 유의합니다.

   ![img](/img/software/rplus1/manager/update_8.png)

5. 제어기 펌웨어 설치 결과를 확인합니다.

   ![img](/img/software/rplus1/manager/update_9.png)
...
1. LN-101을 이용해서 제어기와 PC를 연결합니다.
    ...
    ![img](/img/parts/controller/cm-200/cm_200_pc.jpg)

2. 제어기 펌웨어 복구 마법사 실행
  도구 모음의 제어기 복구 버튼을 눌러 제어기 펌웨어 마법사를 실행합니다. (CM150, CM-200의 경우 별도의 복구모드 진입과정이 있습니다. 아래 메세지를 참고하세요)

    ![img](/img/software/rplus1/manager/recovery_1.png)

    ![img](/img/software/rplus1/manager/cap_2013-12-13_13-12-36-391.png)
...
2. 드라이버가 설치되는 동안 대기합니다.
    ...
    ![img](/img/software/rplus1/manager/fw_bluetooth_1.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_2.png)
...
5. PC에서 주변의 블루투스 장치를 검색합니다.
    ...
    ![img](/img/software/rplus1/manager/fw_bluetooth_3.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_4.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_5.png)

6. 검색된 장치들의 ID로 제어기에 연결된 BT-110A(또는 BT-210)이 맞는지 확인 합니다.  
  (BT-110A(또는 BT-210)의ID는 모듈 윗면에 적혀 있습니다.)

    ![img](/img/software/rplus1/manager/fw_bluetooth_6.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_7.png)

7. 장치가 확인 되면 장치에 연결합니다.

    ![img](/img/software/rplus1/manager/fw_bluetooth_8.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_9.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_10.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_11.png)

8. COM 포트 번호를 기억합니다.(펌웨어 복구 시 필요합니다.)

    ![img](/img/software/rplus1/manager/fw_bluetooth_12.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_13.png)

    ![img](/img/software/rplus1/manager/fw_bluetooth_14.png)

9. 로보플러스 프로그램을 실행하고 매니저를 실행합니다.

    ![img](/img/software/rplus1/manager/fw_bluetooth_15.png)

10. 제어기 펌웨어 복구 마법사 실행

    ![img](/img/software/rplus1/manager/fw_bluetooth_16.png)

11. 제어기 연결 포트 선택  
  STEP8에서 찾은 포트 번호를 선택하고 찾기 버튼을 누르십시오.

    ![img](/img/software/rplus1/manager/fw_bluetooth_17.png)

12. 제어기 정보 확인  
  제어기를 찾으면 현재 제어기의 정보가 나옵니다. 모델명이 사용자가 연결한 제어기가 맞는지 확인하십시오. (제어기 정보의 버전은 펌웨어 버전이 아니고 부트로더(Boot Loader)의 버전입니다.)

    ![img](/img/software/rplus1/manager/fw_bluetooth_18.png)

13. 복구할 펌웨어 정보확인  
  제어기의 정보와 다운로드 할 펌웨어 정보가 나옵니다.

    ![img](/img/software/rplus1/manager/fw_bluetooth_19.png)

14. 펌웨어 복구  
  다음 버튼을 클릭하면 펌웨어 복구를 시작합니다. 완료될 때까지 전원이 꺼지거나 케이블이 빠지지 않도록 주의하십시오.

    ![img](/img/software/rplus1/manager/fw_bluetooth_20.png)

15. 제어기 펌웨어 복구 결과를 확인합니다.

    ![img](/img/software/rplus1/manager/fw_bluetooth_21.png)
...
![img](/img/software/rplus1/manager/cm5_roboplusmanager.png)
...
**참고** : 상세 검색 후 인식되던 다이나믹셀이 인식되지 않는다면 ID 충돌이 일어났을 수 있습니다. 이 경우, 인식되지 않는 장치를 하나만 연결한 후, 사용하지 않는 ID로 바꾸어 주시기 바랍니다. ([ID 바꾸기])

[ID 바꾸기]: https://emanual.robotis.com/docs/kr/edu/bioloid/beginner/#다이나믹셀-관리하기
...
[버튼]: /docs/software/rplus_1_0/rplus_task/programming_02#버튼
...
[타이머]: /docs/software/rplus_1_0/rplus_task/programming_02#타이머
...
[상대로봇 무선 ID]: /docs/software/rplus_1_0/rplus_task/programming_02#상대-로봇-무선id
...
[내 로봇 무선 ID]: /docs/software/rplus_1_0/rplus_task/programming_02#내-로봇-무선id

### CM-510

로보플러스 매니저와 CM-510 제어기가 연결되면 다음과 같은 화면을 볼 수 있습니다.

![img](/img/software/rplus1/manager/cm510_roboplusmanager.png)
...
[버저 종류]: /docs/software/rplus_1_0/rplus_task/programming_02#버저-종류
...
[버저 울림 시간]: /docs/software/rplus_1_0/rplus_task/programming_02#버저-울림시간
...
[소리 감지 횟수]: /docs/software/rplus_1_0/rplus_task/programming_02#최종-소리감지-횟수
...
[현재 소리 감지 횟수]: /docs/software/rplus_1_0/rplus_task/programming_02#실시간-소리감지-횟수
...
[사용자 장치]: /docs/software/rplus_1_0/rplus_task/programming_02#사용자-장치
[적외선 센서]: https://emanual.robotis.com/docs/kr/parts/sensor/irss-10/
[터치 센서]: https://emanual.robotis.com/docs/kr/parts/sensor/ts-10/
[거리 센서]: https://emanual.robotis.com/docs/kr/parts/sensor/dms-80/

### CM-530

로보플러스 매니저와 CM-530 제어기가 연결되면 다음과 같은 화면을 볼 수 있습니다.

![img](/img/software/rplus1/manager/cm530_roboplusmanager.jpg)
...
[정밀타이머]: /docs/software/rplus_1_0/rplus_task/programming_02#정밀타이머
...
![img](/img/software/rplus1/manager/fig01.png)
...
[동작모드 바꾸기]: https://emanual.robotis.com/docs/kr/edu/bioloid/beginner/#다이나믹셀-관리하기
...
[온도]: /docs/software/rplus_1_0/rplus_task/programming_02#온도
...
[전압]: /docs/software/rplus_1_0/rplus_task/programming_02#전압
...
[모터 켜기]: /docs/software/rplus_1_0/rplus_task/programming_02#모터-켜기
...
[목표 위치]: /docs/software/rplus_1_0/rplus_task/programming_02#목표-위치
...
[이동 속도]: /docs/software/rplus_1_0/rplus_task/programming_02#이동-속도
...
[힘 조절]: /docs/software/rplus_1_0/rplus_task/programming_02#힘-조절
...
[현재 위치]: /docs/software/rplus_1_0/rplus_task/programming_02#현재-위치
...
[현재 속도]: /docs/software/rplus_1_0/rplus_task/programming_02#현재-속도
...
[현재 하중]: /docs/software/rplus_1_0/rplus_task/programming_02#현재-하중
...
[움직임 유무]: /docs/software/rplus_1_0/rplus_task/programming_02#움직임-유무
...
[PID Gain]: /docs/software/rplus_1_0/rplus_task/programming_02#pid-제어
...
[왼쪽/중앙/오른쪽 거리센서값]: /docs/software/rplus_1_0/rplus_task/programming_02#거리센서-값
...
[왼쪽/중앙/오른쪽 조명 밝기]: /docs/software/rplus_1_0/rplus_task/programming_02#조명-밝기
...
[물체 감지]: /docs/software/rplus_1_0/rplus_task/programming_02#물체감지
...
[물체 감지 기준값]: /docs/software/rplus_1_0/rplus_task/programming_02#물체감지-기준값
...
[조명 감지]: /docs/software/rplus_1_0/rplus_task/programming_02#조명감지
...
[조명 감지 기준값]: /docs/software/rplus_1_0/rplus_task/programming_02#조명감지-기준값
...
[소리 크기]: /docs/software/rplus_1_0/rplus_task/programming_02#소리-크기
...
[최대 소리 크기]: /docs/software/rplus_1_0/rplus_task/programming_02#최대-소리-크기
...
[소리 감지 횟수]: /docs/software/rplus_1_0/rplus_task/programming_02#소리감지-횟수
...
[버저 음계]: /docs/software/rplus_1_0/rplus_task/programming_02#부저-음계
...
[버저 울림 시간]: /docs/software/rplus_1_0/rplus_task/programming_02#부저-울림시간
...
[적외선 센서값]: /docs/software/rplus_1_0/rplus_task/programming_02#적외선-센서-값
...
- 꺼짐을 누르면 종료합니다.
  ...
  ![img](/img/software/rplus1/manager/ir_array_auto_setting.png)

#### RoboPlus Task 참고 명령어

파라미터 : [감지 기준값 자동 설정]

[감지 기준값 자동 설정]: /docs/software/rplus_1_0/rplus_task/programming_02#감지-기준값-자동설정
...
[적외선 물체 감지 유무]: /docs/software/rplus_1_0/rplus_task/programming_02#적외선-물체감지
...
- 값의 범위는 0 ~ 1023입니다.
  ...
  ![img](/img/software/rplus1/manager/ir_array_threshold.png)
...
1. 먼저 Zig2Serial에 Zig-100을 장착한 후, PC의 시리얼 포트를 Zig2Serial과 연결합니다. ([Zig2Serial - Zig100 연결하기])  
  다음 그림과 같이 시리얼 포트가 없는 경우 USB2DYNAMIXEL을 이용할 수 있습니다.
    ...
    ![img](/img/software/rplus1/manager/zig2serial_u2d.png)

2. Zig2Serial이 연결된 포트를 선택하고 Zig2Serial 관리 아이콘을 클릭합니다.   (제어기와 달리 자동 찾기가 되지 않습니다.)

     ![img](/img/software/rplus1/manager/zig2serial_inite.png)

3. Zig2Serial 관리 아이콘을 클릭하면 다음과 같은 화면을 볼 수 있습니다. "Zigbee 설정" 버튼을 클릭합니다.

     ![img](/img/software/rplus1/manager/zig2serial_manage.png)

4. OK버튼을 누른 후 3초 이내에 리셋 버튼을 누르십시오.

     ![img](/img/software/rplus1/manager/zig2serial_connection.png)
...
5. Zigbee모듈이 정상적으로 인식되면 다음과 같은 화면을 볼 수 있으며, 기능을 설정할 수 있습니다.
    ...
    ![img](/img/software/rplus1/manager/zig2serial_setting.png)

6. 만약 Zig100모듈을 찾지 못한 경우, 모듈이 정상적으로 연결되었는지 확인 해 보십시오.

    ![img](/img/software/rplus1/manager/zig2serial_connection_fail.png)

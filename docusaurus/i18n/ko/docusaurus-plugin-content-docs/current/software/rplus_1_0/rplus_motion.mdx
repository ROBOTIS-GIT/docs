...
![img](/img/sw/rplus1/motion/roboplusmotion_icon.png)
...
![img](/img/sw/rplus1/motion/roboplus_motion.png)
...
![img_install](/img/sw/roboplus_install.png)
...
![img](/img/sw/rplus1/motion/rmfm_robotmotion.png)
...
![img](/img/sw/rplus1/motion/rmfm_filemotion.png)
...
2. 통신 포트를 선택합니다.
    ...
    ![img](/img/sw/rplus1/motion/conn_portselection.png)

3. 로봇에 연결합니다. 연결 메뉴를 선택합니다.

    ![img](/img/sw/rplus1/motion/conn_connecticon.png)

    ![img](/img/sw/rplus1/motion/conn_connectmenu.png)
...
4. 로봇의 연결을 끊습니다.
    ...
    ![img](/img/sw/rplus1/motion/conn_disconnecticon.png)
...
- 다운로드 버튼을 누르고 완료되기를 기다립니다.
  ...
  ![img](/img/sw/rplus1/motion/down_menu.png)

- 파일 모션의 내용이 로봇 모션에 옮겨진 것을 확인합니다.

  ![img](/img/sw/rplus1/motion/down_result.png)
...
![img](/img/sw/rplus1/motion/playstop_motion_play.png)
...
- 모션 실행 시도시 다음과 같은 문제가 발생할 수 있습니다.
  - 이 경우는 로봇 모션 창에서 작업할 경우 나타납니다. 이 문제는 Next나 Exit로 연결된 페이지가 수정되었고, 제어기 메모리가 작아서 임시로 저장할 수 없기  때문입니다.
    ...
    ![img](/img/sw/rplus1/motion/playstop_motion_robot_play_error.png)
  ...
  - 이 경우는 파일 모션 창에서 작업할 경우 나타납니다. 제어기가 아닌 PC에 데이터가 있는 경우 제어기 메모리가 작아서 Next나 Exit로 연결된 페이지를 임시로 저장할 수 없기 때문입니다.
    ...
    ![img](/img/sw/rplus1/motion/playstop_motion_file_play_error.png)
...
![img](/img/sw/rplus1/motion/playstop_motion_stop.png)
...
![img](/img/sw/rplus1/motion/playstop_e_stop.png)
...
![img](/img/sw/rplus1/motion/poseedit_concept.png)
...
![img](/img/sw/rplus1/motion/basic_motion_edit.png)
...
- 연속적으로 여러 관절을 선택
  ...
  ![img](/img/sw/rplus1/motion/basic_joint_selection_3.png)
...
- 개별적으로 여러 관절을 선택
  ...
  ![img](/img/sw/rplus1/motion/basic_joint_selection_4.png)
...
- 전체 관절 선택
  - 버튼을 눌러서 선택
    ...
    ![img](/img/sw/rplus1/motion/basic_joint_selection_1.png)

  - 메뉴를 선택

    ![img](/img/sw/rplus1/motion/basic_joint_selection_2.png)
...
![img](/img/sw/rplus1/motion/basic_torque_1.png)

토크를 On/Off시키는 방법은 다음과 같습니다.
- "켜기"버튼을 누르면 선택된 관절의 토크가 On됩니다.

  ![img](/img/sw/rplus1/motion/basic_torque_2.png)

- "끄기"버튼을 누르면 선택된 관절의 토크가 Off됩니다.

  ![img](/img/sw/rplus1/motion/basic_torque_3.png)

- 토크 토글(Toggle) 기능은 선택된 관절의 토크 On/Off상태를 전환시킵니다.

  ![img](/img/sw/rplus1/motion/basic_torque_4.png)

#### 관절 값 바꾸기

포즈에서 관절을 선택하면 해당 모터의 위치 값을 바꿀 수 있습니다.

![img](/img/sw/rplus1/motion/basic_joint_value_1.png)


#### 포즈 실행
포즈 실행은 스텝의 포즈를 로봇의 포즈로 옮겨서 로봇이 해당 포즈를 취하게 합니다.

![img](/img/sw/rplus1/motion/stepwritebutton.png)

![img](/img/sw/rplus1/motion/basic_pose_1.png)

#### 포즈 캡쳐
포즈 캡쳐(Capture)란, 로봇의 포즈를 스텝의 포즈로 옮겨서 데이터에 저장합니다.

![img](/img/sw/rplus1/motion/stepgobutton.png)

![img](/img/sw/rplus1/motion/basic_pose_2.png)
...
![img](/img/sw/rplus1/motion/pose_copy_from_pose.png)

![img](/img/sw/rplus1/motion/pose_copy_from_memo.png)

- 포즈 복사: 메뉴를 선택하거나 Ctrl+C를 눌러서 실행합니다.

  ![img](/img/sw/rplus1/motion/pose_copy.png)

- 포즈 붙여넣기: 메뉴를 선택하거나 Ctrl+V를 눌러서 실행합니다.

  ![img](/img/sw/rplus1/motion/pose_paste.png)
...
![img](/img/sw/rplus1/motion/pose_mask.png)

![img](/img/sw/rplus1/motion/pose_mask_pic.png)
...
![img](/img/sw/rplus1/motion/poseutility.png)
...
![img](/img/sw/rplus1/motion/poseutility_robotselect.png)
...
![img](/img/sw/rplus1/motion/poseutility_3dview.png)
...
![img](/img/sw/rplus1/motion/poseutility_3djoint1.png)

해당 관절을 마우스로 클릭하면 관절 값이 나타납니다. 관절 값은 모터 값이 아닌 각도로 표시됩니다.

![img](/img/sw/rplus1/motion/poseutility_3djoint2.png)
...
1. 교환하기
    ...
    ![img](/img/sw/rplus1/motion/poseutility_mirror_exchange.jpg)

    ![img](/img/sw/rplus1/motion/poseutility_mirror1.png)

2. 대칭
    대칭은 좌/우 한 쪽의 포즈를 기준으로 좌/우 대칭이 되도록 반대쪽의 포즈를 만들어 주기 위해 사용합니다.

    ![img](/img/sw/rplus1/motion/poseutility_mirror_symmetry.png)

    ![img](/img/sw/rplus1/motion/poseutility_mirror2.png)
...
![img](/img/sw/rplus1/motion/poseutility_vieworigin.png)
...
![img](/img/sw/rplus1/motion/poseutility_ik_kinematics.png)
...
![img](/img/sw/rplus1/motion/poseutility_ik_inversekinematics.png)
...
- Left Foot : 왼쪽 발만 움직이는 끝점이며 발바닥 가운데에 위치합니다.
  ...
  ![img](/img/sw/rplus1/motion/poseutility_ik_selectendpoint.png)
...
- 마우스로 더블 클릭을 하거나 `Enter`키를 누르면 값을 변경할 수 있는 컨트롤이 나타납니다.
  ...
  ![img](/img/sw/rplus1/motion/poseutility_ik_descrip.png)

- X(mm): X축 방향으로 mm단위로 이동합니다.

  ![img](/img/sw/rplus1/motion/poseutility_ik_xmove.png)

- Y(mm): Y축 방향으로 mm단위로 이동합니다.

  ![img](/img/sw/rplus1/motion/poseutility_ik_ymove.png)

- Z(mm): Z축 방향으로 mm단위로 이동합니다.

  ![img](/img/sw/rplus1/motion/poseutility_ik_zmove.png)

- &phi;(&deg;): X축을 기준으로 각도 단위로 회전합니다.

  ![img](/img/sw/rplus1/motion/poseutility_ik_xamove.png)

- &theta;(&deg;): Y축을 기준으로 각도 단위로 회전합니다.

  ![img](/img/sw/rplus1/motion/poseutility_ik_yamove.png)

- &psi;(&deg;): Z축을 기준으로 각도 단위로 회전합니다.

  ![img](/img/sw/rplus1/motion/poseutility_ik_zamove.png)
...
![img](/img/sw/rplus1/motion/poseutility_gowritestep.png)
...
![img](/img/sw/rplus1/motion/step_concept_1.png)

모션 스텝에는 모션의 실행 속도를 결정하는 재생 시간이 추가되어 있습니다. 스텝 편집기는 스텝을 보다 편리하게 편집할 수 있는 기능을 제공합니다.

![img](/img/sw/rplus1/motion/step_editor.png)
...
![img](/img/sw/rplus1/motion/step_add.png)

#### 스텝 삽입

선택한 스텝 앞에 새로운 스텝을 삽입합니다.

![img](/img/sw/rplus1/motion/step_insert.png)

#### 스텝 삭제

선택한 스텝을 리스트에서 삭제합니다.

![img](/img/sw/rplus1/motion/step_delete.png)

#### 스텝 이동

선택한 스텝의 순서를 바꿉니다.

![img](/img/sw/rplus1/motion/step_move.png)
...
- 아래쪽의 스크롤바로 시간을 바꿀 수 있습니다.
  ...
  ![img](/img/sw/rplus1/motion/step_stop_time.png)
...
- 아래쪽의 스크롤바로 시간을 바꿀 수 있습니다.
  ...
  ![img](/img/sw/rplus1/motion/step_play_time.png)
...
- 선택한 스텝을 복사할 수 있습니다.
  ...
  ![img](/img/sw/rplus1/motion/step_copy.png)

#### 스텝 잘라내기

- 선택한 스텝을 잘라냅니다.

  ![img](/img/sw/rplus1/motion/step_cut.png)

#### 스텝 붙여넣기

- 복사 혹은 잘라내기한 스텝을 붙여넣습니다. 붙여넣기할 때 선택한 스텝의 내용은 대체됩니다.

  ![img](/img/sw/rplus1/motion/step_paste.png)
...
![img](/img/sw/rplus1/motion/pageeditor.png)
...
- 연속적으로 여러 페이지를 선택
  ...
  ![img](/img/sw/rplus1/motion/page_selection_2.png)
...
- 개별적으로 여러 페이지를 선택
  ...
  ![img](/img/sw/rplus1/motion/page_selection_1.png)
...
- 전체 페이지 선택
  - 버튼을 눌러서 선택
    ...
    ![img](/img/sw/rplus1/motion/page_selection_3.png)
...
![img](/img/sw/rplus1/motion/page_next_concept.png)

이어지는 페이지는 연결될 페이지 번호를 사용합니다.

![img](/img/sw/rplus1/motion/page_next.png)

#### 마무리(Exit) 페이지

모션 정지를 명령했을 때, 대부분 현재 실행 중인 모션으로 인해 로봇은 매우 불안한 상태에 놓입니다. 보다 안정적인 상태로 로봇을 만들고 모션을 정지하고 싶을 때 마무리 페이지 기능을 사용합니다.

![img](/img/sw/rplus1/motion/page_exit_concept.png)

마무리 페이지는 연결될 페이지 번호를 사용합니다.

![img](/img/sw/rplus1/motion/page_exit.png)
...
- 선택한 페이지를 복사합니다.
  ...
  ![img](/img/sw/rplus1/motion/page_copy.png)

#### 페이지 잘라내기

- 선택한 페이지를 잘라냅니다.

  ![img](/img/sw/rplus1/motion/page_cut.png)

#### 페이지 붙여넣기

- 복사하거나 잘라낸 페이지를 붙여넣습니다. 붙여넣기할 때 선택된 페이지의 내용은 대체됩니다.

  ![img](/img/sw/rplus1/motion/page_paste.png)

<a id="set-page-repeattime"></a>
### 페이지 반복/속도 설정
...
- 모션 실행시 현재 페이지를 반복할 횟수입니다.
  ...
  ![img](/img/sw/rplus1/motion/page_repeat.png)
...
- 모션 실행시 현재 페이지의 재생 배속입니다. "스텝 실행 시간"과 달리 페이지 전체에 영향을 줍니다..
  ...
  - 1.0배속보다 크면 전체적으로 빨라집니다.
    ...
    ![img](/img/sw/rplus1/motion/page_play_speed.png)
...
- 관성력은 0 ~ 127까지 값을 설정해서 조절할 수 있습니다.(기본 값은 32입니다.)
  ...
  ![img](/img/sw/rplus1/motion/page_compliance.png)
...
- 7단계: 매우 높음
  ...
  ![img](/img/sw/rplus1/motion/page_compliance_2.png)
...
2. 로봇 모션 창을 선택한 후, 다른 이름으로 저장하기 메뉴를 선택합니다.
  ...
  ![img](/img/sw/rplus1/motion/saveas.png)
...
![img](/img/sw/rplus1/motion/offset_menu.png)
...
- -값은 모터를 기준으로 CW방향으로 더 움직인다는 뜻입니다.
  ...
  ![img](/img/sw/rplus1/motion/offset_edit3.png)

### 모션 오프셋 초기화

- 모션 오프셋 값을 모두 0으로 초기화시킵니다.

  ![img](/img/sw/rplus1/motion/offset_reset.png)

### 모션 오프셋 저장

- 현재 수정한 오프셋을 저장시킵니다. 이 기능은 오프셋 정보를 제어기 내부에 저장시킵니다.

  ![img](/img/sw/rplus1/motion/offset_save.png)

### 모션 오프셋 파일로 저장

- 현재 로봇의 오프셋 정보를 파일로 저장하여 PC에 보관할 수 있습니다. PC상에 모션 오프셋 파일은 확장자가 ofs인 형태로 존재합니다.

  ![img](/img/sw/rplus1/motion/offset_file_save.png)

### 모션 오프셋 다운로드

- PC에 보관중인 모션 오프셋 파일(ofs)을 로봇에 다운로드할 수 있습니다.

  ![img](/img/sw/rplus1/motion/offset_download.png)
...
- 페이지 편집창, 스텝 편집창, 포즈 편집창을 방향키로 포커스를 이동시킬 수 있습니다.
  ...
  ![img](/img/sw/rplus1/motion/arrow_move.png)
...
- `Enter`키를 누르면 설정창으로 포커스가 이동되고, 수정한 뒤 다시 `Enter`를 누르면 돌아갑니다.
  ...
  ![img](/img/sw/rplus1/motion/joint_move.png)
...
- 로봇의 포즈 편집창
  ...
  ![img](/img/sw/rplus1/motion/robot_move.png)

- 모션 오프셋 편집창

  ![img](/img/sw/rplus1/motion/offset_move.png)
...
![img](/img/sw/rplus1/motion/robotinfo_xml.png)
...
| 이름        | 모양                                                    | 파일            |
|:------------|:--------------------------------------------------------|:----------------|
| F1          | ![img](/img/sw/rplus1/motion/f1.png)          | f1.igs          |
| F2          | ![img](/img/sw/rplus1/motion/f2.png)          | f2.igs          |
| F3          | ![img](/img/sw/rplus1/motion/f3.png)          | f3.igs          |
| F4          | ![img](/img/sw/rplus1/motion/f4.png)          | f4.igs          |
| F5          | ![img](/img/sw/rplus1/motion/f5.png)          | f5.igs          |
| F6          | ![img](/img/sw/rplus1/motion/f6.png)          | f6.igs          |
| F7          | ![img](/img/sw/rplus1/motion/f7.png)          | f7.igs          |
| F8          | ![img](/img/sw/rplus1/motion/f8.png)          | f8.igs          |
| F9          | ![img](/img/sw/rplus1/motion/f9.png)          | f9.igs          |
| F10         | ![img](/img/sw/rplus1/motion/f10.png)         | f10.igs         |
| F11         | ![img](/img/sw/rplus1/motion/f11.png)         | f11.igs         |
| F12         | ![img](/img/sw/rplus1/motion/f12.png)         | f12.igs         |
| F15 + F16   | ![img](/img/sw/rplus1/motion/f15+16.png)      | f15.igs         |
| F51         | ![img](/img/sw/rplus1/motion/f51.png)         | f51.igs         |
| F52         | ![img](/img/sw/rplus1/motion/f52.png)         | f52.igs         |
| F53         | ![img](/img/sw/rplus1/motion/f53.png)         | f53.igs         |
| F56         | ![img](/img/sw/rplus1/motion/f56.png)         | f56.igs         |
| F57         | ![img](/img/sw/rplus1/motion/f57.png)         | f57.igs         |
| F58         | ![img](/img/sw/rplus1/motion/f58.png)         | f58.igs         |
| F60         | ![img](/img/sw/rplus1/motion/f60.png)         | f60.igs         |
| WA          | ![img](/img/sw/rplus1/motion/wa.png)          | wa,igs          |
| BU          | ![img](/img/sw/rplus1/motion/bu.png)          | bu.igs          |
| CM-5        | ![img](/img/sw/rplus1/motion/cm5.png)         | cm-5.igs        |
| ADAPTOR-CM5 | ![img](/img/sw/rplus1/motion/adaptor_cm5.png) | adaptor_cm5.igs |
| BATTERY     | ![img](/img/sw/rplus1/motion/battery.png)     | battery.igs     |
| AX-12       | ![img](/img/sw/rplus1/motion/ax12.png)        | ax-12.igs       |
| AX-12 Horn  | ![img](/img/sw/rplus1/motion/ax12_horn.png)   | ax-12_horn.igs  |
| AX-S1       | ![img](/img/sw/rplus1/motion/axs1.png)        | ax-s1.igs       |

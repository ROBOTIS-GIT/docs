...
제품에 사용되는 제어기의 [소프트웨어 호환표](/docs/parts/controller/controller_compatibility#로보플러스-20)를 참고하세요.
...
[XL-320, XM 시리즈, XH 시리즈]: /docs/dxl/x
[PRO 시리즈]: /docs/dxl/pro
[P 시리즈]: /docs/dxl/p
[ROBOTIS DREAM]: /docs/edu
[ROBOTIS SMART]: /docs/edu
[ROBOTIS SMART2]: /docs/edu
[ROBOTIS IoT]: /docs/edu
[ROBOTIS MINI]: /docs/edu
[CM-150, CM-200, OpenCM9.04, OpenCM7.0]: /docs/parts/controller/controller_compatibility
[USB 드라이버 설치]: /docs/popup/usb_driver_install
[LN-101 드라이버 설치]: /docs/parts/interface/ln-101#드라이버-설치-확인/

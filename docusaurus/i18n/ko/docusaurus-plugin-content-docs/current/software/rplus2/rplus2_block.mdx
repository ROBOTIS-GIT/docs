...
![](/img/software/rplus2/block/block_search_kr.png)
> Play 스토어에서 `로보티즈` 검색 및 선택

![](/img/software/rplus2/block/block_install_kr.png)
> 설치
...
![](/img/software/rplus2/block/menu_kr.png)
...
![](/img/software/rplus2/block/block_delete_01_kr.png)  
![](/img/software/rplus2/block/block_delete_02_kr.png)

## Undo/Redo 기능
블록을 이동 또는 삭제 하였을 때 취소하거나 다시 실행할 수 있습니다.  
undo / redo 기능의 사용이 가능한 상태가 되면 아래와 같이 버튼이 비활성화 된 상태에서 활성화 된 상태가 됩니다.

![](/img/software/rplus2/block/block_undoredo_kr.png)
...
![](/img/software/rplus2/block/block_run_01_kr.png)

제품에 연결된 블루투스의 마지막 두자리를 입력하고 검색 버튼을 클릭합니다.  
블루투스가 검색되면 검색된 블루투스를 클릭하고 다시 `실행 버튼`을 클릭합니다.

![](/img/software/rplus2/block/block_run_02_kr.png)

제품에 연결된 블루투스와 연결되면 `대기 중...` 메시지가 표시됩니다.

![](/img/software/rplus2/block/block_run_03_kr.png)

블록이 실행되면 `실행 중...` 메시지가 표시되며 블록이 실행됩니다. 현재 실행 중인 블록은 붉은색으로 표시됩니다.

![](/img/software/rplus2/block/block_run_04_kr.png)
...
![](/img/software/rplus2/block/block_stop_kr.png)

## 저장
현재의 작품을 저장합니다. `추가 메뉴` -> `작품` -> `저장하기` 를 클릭하여 저장할 수도 있습니다.

![](/img/software/rplus2/block/block_save_kr.png)

## 끝내기
스마트 기기의 뒤로가기 버튼을 누르면 R+Block 앱이 종료됩니다.

![](/img/software/rplus2/block/block_quit_kr.png)
...
![](/img/software/rplus2/block/block_option_menu_kr.png)

## 설정
`블루투스`, `e-매뉴얼`, `버전정보` 등을 확인할 수 있습니다.

![](/img/software/rplus2/block/block_option_setting_kr.png)

### 블루투스
제품에 연결된 블루투스를 설정, 변경 하거나 연결된 블루투스를 연결 해제 할 수 있습니다.  
블루투스 검색시에는 블루투스 모듈이나 제품에 표시된 주소 중 마지막 두 자리를 입력 후 검색 버튼을 클릭해야 합니다.

![](/img/software/rplus2/block/block_option_bluetooth_kr.png)

### e-매뉴얼
온라인 매뉴얼을 확인할 수 있습니다.

![](/img/software/rplus2/block/block_option_emanual_kr.png)

### 버전 정보
현재의 앱 버전을 확인할 수 있습니다.

![](/img/software/rplus2/block/block_option_version_kr.png)

## 작품
작업 중인 내용을 저장하거나 불러오기 등의 기능을 사용할 수 있습니다.

![](/img/software/rplus2/block/block_option_project_kr.png)

### 저장하기
현재 작업 중인 내용을 저장할 수 있습니다.

![](/img/software/rplus2/block/block_option_save_01_kr.png)

![](/img/software/rplus2/block/block_option_save_02_kr.png)
> 작품 이름을 입력하고 OK 버튼을 클릭합니다.

![](/img/software/rplus2/block/block_option_save_03_kr.png)
> 작품 이름이 표시됩니다.
...
![](/img/software/rplus2/block/block_option_load_kr.png)

### 지우기
작업 중인 블록들을 삭제할 수 있습니다. 시작 블록을 제외한 모든 블록들이 지워지고 작품 이름은 그대로 사용합니다.

![](/img/software/rplus2/block/block_option_erase_kr.png)

### 새로만들기
새로운 작품을 만듭니다.

![](/img/software/rplus2/block/block_option_create_01_kr.png)

> 새로 만들 작품 이름을 입력하고 OK 버튼을 누릅니다.

![](/img/software/rplus2/block/block_option_create_02_kr.png)

### 삭제하기
저장된 작품의 목록이 표시됩니다. 지울 작품 이름을 누르고 있으면 삭제됩니다.

![](/img/software/rplus2/block/block_option_delete_kr.png)

## 태스크
블록으로 작성된 코드를 Task 코드로 변환하거나 다운로드 할 수 있습니다.

![](/img/software/rplus2/block/block_option_task_kr.png)

R+Task 가 설치되어 있지 않으면 구글 플레이로 이동합니다. R+Task 앱을 설치해주세요.

![](/img/software/rplus2/block/block_option_task_search_kr.png)
> Play 스토어에서 `로보티즈` 검색 후 R+mTask2 선택

![](/img/software/rplus2/block/block_option_task_install_kr.png)
> 설치
...
![](/img/software/rplus2/block/block_option_convert_kr.png)
...
![](/img/software/rplus2/block/block_option_download_kr.png)

...
1. 설치 언어를 설정합니다.
    ...
    ![](/img/software/sdk/embedded_001.png)

2. 설치 초기 화면입니다.

    ![](/img/software/sdk/embedded_002.png)

3. 라이센스 관련 내용입니다. 동의 하여야 설치를 진행할 수 있습니다.

    ![](/img/software/sdk/embedded_003.png)

4. 설치 폴더를 설정합니다. 사용자가 원하는 곳으로 설정하고 Next버튼을 누릅니다.

    ![](/img/software/sdk/embedded_004.png)

5. 설치할 프로그램 및 환경 옵션을 선택합니다. 특별한 사유가 없다면 모두 설치하는 것이 좋습니다.

    ![](/img/software/sdk/embedded_005.png)

6. WinAVR 설치를 시작합니다.

    ![](/img/software/sdk/embedded_006.png)

7. WinAVR설치가 완료되었습니다.

    ![](/img/software/sdk/embedded_007.png)
...
1. Atmel Studio설치 시작화면입니다.
    ...
    ![](/img/software/sdk/embedded_008.png)

2. 라이센스 관련 내용입니다. 동의 하여야 설치를 진행할 수 있습니다.

    ![](/img/software/sdk/embedded_009.png)

3. 설치 폴더를 설정합니다. 사용자가 원하는 곳으로 설정하고 Next버튼을 누릅니다.

    ![](/img/software/sdk/embedded_010.png)

4. Next를 클릭하여 설치를 진행합니다.

    ![](/img/software/sdk/embedded_011.png)

5. Atmel Studio 설치를 시작합니다.

    ![](/img/software/sdk/embedded_012.png)

6. Atmel Studio 설치가 완료되었습니다.

    ![](/img/software/sdk/embedded_013.png)
...
![img](/img/software/sdk/embedded_030.png)
...
- 아래와 같이 5개의 핀 중, 1번 OUT핀이 마이크로 컨트롤러의 PORTA2 ~ PORTA7과 대응되어 있습니다.  
  ...
  ![img](/img/software/sdk/embedded_031.png)
...
5. NC : 사용하지 않음
  ...
  ![img](/img/software/sdk/embedded_032.png)

#### CM-700

![img](/img/software/sdk/embedded_033.png)
...
- 아래와 같이 5개의 핀 중, 1번 OUT핀이 마이크로 컨트롤러의 PORTA2 ~ PORTA7과 대응되어 있습니다.
  ...
  ![img](/img/software/sdk/embedded_034.jpg)
...
5. NC : 사용하지 않음
  ...
  ![img](/img/software/sdk/embedded_035.png)
...
![img](/img/software/sdk/embedded_041.png)
...
![img](/img/software/sdk/embedded_044.png)
...
![img](/img/software/sdk/embedded_045.png)
...
1. 부트로더에서 L명령(혹은 Load)을 입력합니다.
    ...
    ![img](/img/software/sdk/embedded_042.png)

2. 로보플러스 터미널의 Files메뉴에서 Transmit file을 선택하고, 준비된 펌웨어(hex 파일)를 선택합니다.

    ![img](/img/software/sdk/embedded_043.png)
...
```
    ...
    ![img](/img/software/sdk/embedded_046.png)
...
- 결과
  - 키보드로 'u'키를 입력하면 제어기에서 현재 기억된 숫자에 1을 더하여 출력하며, 'd'키를 입력하면 1을 빼서 출력합니다.
    ...
    ![img](/img/software/sdk/embedded_047.png)
...
```
  ...
  ![img](/img/software/sdk/embedded_048.png)
...
- 소스
  ...
  ![img](/img/software/sdk/embedded_049.png)
...
[다이나믹셀 패킷 구조]: /docs/dxl/protocol1
...
[로보플러스 터미널]: /docs/software/rplus1/terminal/
[제어기 부트로더]: #부트로더

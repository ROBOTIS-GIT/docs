...
sidebar_label: "Embedded C (CM-510/700)"
sidebar_position: 2
tags: [software, embedded_sdk]
---
...
1. 설치 언어를 설정합니다.
    ...
    ![](/img/software/sdk/embedded_001.webp)

2. 설치 초기 화면입니다.

    ![](/img/software/sdk/embedded_002.webp)

3. 라이센스 관련 내용입니다. 동의 하여야 설치를 진행할 수 있습니다.

    ![](/img/software/sdk/embedded_003.webp)

4. 설치 폴더를 설정합니다. 사용자가 원하는 곳으로 설정하고 Next버튼을 누릅니다.

    ![](/img/software/sdk/embedded_004.webp)

5. 설치할 프로그램 및 환경 옵션을 선택합니다. 특별한 사유가 없다면 모두 설치하는 것이 좋습니다.

    ![](/img/software/sdk/embedded_005.webp)

6. WinAVR 설치를 시작합니다.

    ![](/img/software/sdk/embedded_006.webp)

7. WinAVR설치가 완료되었습니다.

    ![](/img/software/sdk/embedded_007.webp)
...
1. Atmel Studio설치 시작화면입니다.
    ...
    ![](/img/software/sdk/embedded_008.webp)

2. 라이센스 관련 내용입니다. 동의 하여야 설치를 진행할 수 있습니다.

    ![](/img/software/sdk/embedded_009.webp)

3. 설치 폴더를 설정합니다. 사용자가 원하는 곳으로 설정하고 Next버튼을 누릅니다.

    ![](/img/software/sdk/embedded_010.webp)

4. Next를 클릭하여 설치를 진행합니다.

    ![](/img/software/sdk/embedded_011.webp)

5. Atmel Studio 설치를 시작합니다.

    ![](/img/software/sdk/embedded_012.webp)

6. Atmel Studio 설치가 완료되었습니다.

    ![](/img/software/sdk/embedded_013.webp)
...
![img](/img/software/sdk/embedded_030.webp)
...
- 아래와 같이 5개의 핀 중, 1번 OUT핀이 마이크로 컨트롤러의 PORTA2 ~ PORTA7과 대응되어 있습니다.  
  ...
  ![img](/img/software/sdk/embedded_031.webp)
...
5. NC : 사용하지 않음
  ...
  ![img](/img/software/sdk/embedded_032.webp)

#### CM-700

![img](/img/software/sdk/embedded_033.webp)
...
- 아래와 같이 5개의 핀 중, 1번 OUT핀이 마이크로 컨트롤러의 PORTA2 ~ PORTA7과 대응되어 있습니다.
  ...
  ![img](/img/software/sdk/embedded_034.webp)
...
5. NC : 사용하지 않음
  ...
  ![img](/img/software/sdk/embedded_035.webp)
...
![img](/img/software/sdk/embedded_041.webp)
...
![img](/img/software/sdk/embedded_044.webp)
...
![img](/img/software/sdk/embedded_045.webp)
...
1. 부트로더에서 L명령(혹은 Load)을 입력합니다.
    ...
    ![img](/img/software/sdk/embedded_042.webp)

2. 로보플러스 터미널의 Files메뉴에서 Transmit file을 선택하고, 준비된 펌웨어(hex 파일)를 선택합니다.

    ![img](/img/software/sdk/embedded_043.webp)
...
```
    ...
    ![img](/img/software/sdk/embedded_046.webp)
...
- 결과
  - 키보드로 'u'키를 입력하면 제어기에서 현재 기억된 숫자에 1을 더하여 출력하며, 'd'키를 입력하면 1을 빼서 출력합니다.
    ...
    ![img](/img/software/sdk/embedded_047.webp)
...
```
  ...
  ![img](/img/software/sdk/embedded_048.webp)
...
- 소스
  ...
  ![img](/img/software/sdk/embedded_049.webp)
...
[다이나믹셀 패킷 구조]: /docs/dxl/protocol/protocol1
[zgb_rx_data()]: /docs/software/embedded_sdk/zigbee_sdk#zgb-rx-data/
[Zig-100/110]: /docs/parts/communication/zig-110
[RC-100]: /docs/parts/communication/rc-100
[CM-510 제어기]: /docs/parts/controller/cm-510
[CM-700 제어기]: /docs/parts/controller/cm-700
[로보플러스 터미널]: https://emanual.robotis.com/docs/en/software/rplus1/terminal/
[제어기 부트로더]: #부트로더

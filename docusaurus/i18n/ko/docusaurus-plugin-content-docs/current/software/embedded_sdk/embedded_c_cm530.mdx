...
sidebar_label: "Embedded C (CM-530)"
sidebar_position: 3
...
![img](/img/software/sdk/embedded_050.png)

JRE는 다음 사이트에서 다운로드 받을 수 있습니다.

[http://www.oracle.com/technetwork/java/javase/downloads/index.html](http://www.oracle.com/technetwork/java/javase/downloads/index.html)

![img](/img/software/sdk/embedded_051.png)

![img](/img/software/sdk/embedded_052.png)
...
![img](/img/software/sdk/embedded_058.png)

![img](/img/software/sdk/embedded_059.png)
...
[펌웨어 복구하기]: /docs/software/rplus1/manager#펌웨어-복구/
## 프로그래밍
### 하드웨어 포트맵
...
![img](/img/software/sdk/embedded_066.png)

![img](/img/software/sdk/embedded_067.png)
...
![img](/img/software/sdk/embedded_068.png)

![img](/img/software/sdk/embedded_069.png)
...
![img](/img/software/sdk/embedded_070.png)
...
![img](/img/software/sdk/embedded_071.png)

'Browse..' 버튼을 누르고, 압축을 풀어 놓은 폴더중 “01 LED”를 선택하고 "확인"을 눌러 완료합니다.

![img](/img/software/sdk/embedded_072.png)

프로젝트 생성 후에는 ‘Project – Clean, Build’를 한 번씩 실행 해 주십시오.

![img](/img/software/sdk/embedded_073.png)

위와 같이 실행 후에, Console창에서 제대로 수행 되었는지 확인 할 수 있습니다.  
아래와 다르게 제대로 실행되지 않았을 경우에는, 개발환경 설치를 다시 한번 확인해 주시기 바랍니다.

![img](/img/software/sdk/embedded_074.png)
...
![img](/img/software/sdk/embedded_075.png)
...
![img](/img/software/sdk/embedded_076.png)
...
![img](/img/software/sdk/embedded_077.png)
...
1. 부트로더에서 L명령(혹은 Load)을 입력합니다.
    ...
    ![img](/img/software/sdk/embedded_078.png)

2. 로보플러스 터미널의 Files메뉴에서 Transmit file을 선택하고, 준비된 펌웨어(hex 파일)를 선택합니다.

    ![img](/img/software/sdk/embedded_079.png)
...
1. stm32.ld 변경
    ...
    ![img](/img/software/sdk/embedded_082.png)

2. Vector table 변경

    ![img](/img/software/sdk/embedded_083.png)
...
- 결과
  - PC에서 'w' 버튼을 누르면 "Welcome!", 'g'버튼을 누르면 "Goodbye!"가 출력됩니다.
    ...
    ![img](/img/software/sdk/embedded_084.png)
...
- 이론
  - 제어기는 마이크로 컨트롤러의 SIG_MOT1+와 SIG+MOT1- 핀을 통해 1번 외부포트의 MOT1+ 와 MOT1-핀의 값을 제어함으로써 올로 서보모터의 회전방향을 제어합니다.
    ...
    ![img](/img/software/sdk/embedded_085.png)

    ![img](/img/software/sdk/embedded_086.png)
...
- 이론
  ...
  - 포트번호와 핀번호는 "06 OLLO MOTOR ROTATE\APP\src\main.c" 또는 [제어기 포트맵]을 확인하시기 바랍니다.
    ...
    ![img](/img/software/sdk/embedded_087.png)
    
    ![img](/img/software/sdk/embedded_088.png)
...
- 결과
  ...
  - 아래 그림은 3번 외부포트에 올로 서보모터를 연결했을 때 출력화면입니다.
    ...
    ![img](/img/software/sdk/embedded_089.png)
...
- 이론
  ...
  - 마이크로 컨트롤러와 다이나믹셀의 통신은 USART1 채널을 통해 이루어집니다
    ...
    ![img](/img/software/sdk/embedded_090.png)
...
- 이론
  ...
  - 마이크로 컨트롤러와 RC100의 통신은 UART5 채널을 통해 이루어집니다.
    ...
    ![img](/img/software/sdk/embedded_091.png)
...
[Zigbee SDK]: /docs/software/embedded_sdk/zigbee_sdk/
[Zig-100/110]: /docs/parts/communication/zig-110
[RC-100]: /docs/parts/communication/rc-100
[CM-530 제어기]: /docs/parts/controller/cm-530

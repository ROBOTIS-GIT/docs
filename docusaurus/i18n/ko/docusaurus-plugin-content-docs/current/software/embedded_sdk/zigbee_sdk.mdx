...
1. 제어판 > 시스템 > 고급 탭에 들어가면 다음과 같이 환경 변수 버튼을 찾을 수 있습니다.
    ...
    ![img](/img/software/sdk/env1.png)

2. 시스템 변수에서 Path 항목을 찾고, 편집 버튼을 클릭합니다.

    ![img](/img/software/sdk/env2.png)
...
1. 메뉴에서 도구->옵션을 선택합니다.
    ...
    ![img](/img/software/sdk/c++_config.png)

2. 프로젝트 및 솔루션 > VC++ 디렉터리를 클릭 합니다.

    ![img](/img/software/sdk/c++_config1.png)
...
![img](/img/software/sdk/c++_config2.png)
...
1. 솔루션 탐색기에서 Projct File 이름 위 에서 마우스 우클릭을 하여 추가 - > 기존항목을 선택합니다.
    ...
    ![img](/img/software/sdk/vb_config.png)
...
3. zigbee.vb가 추가 된것을 확인 합니다.
    ...
    ![img](/img/software/sdk/vb_config1.png)

4. ZigbeeAPI 함수를 사용 합니다. Zigbee 각 함수 사용법은 [API Reference]를 참고하시기 바랍니다.

    ![img](/img/software/sdk/vb_config2.png)
...
[RC100과 ZigBee]: /docs/software/embedded_sdk/embedded_c_cm510#rc100과-zigbee/
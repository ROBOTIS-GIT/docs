...
- Control Panel
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/sample_code/labview/read_write1/read_write1.png)

- Block Diagram

  ![](/img/software/dynamixel/dynamixel_sdk/sample_code/labview/read_write1/block_diagram.png)

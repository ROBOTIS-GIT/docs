...
- Control Panel
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/sample_code/labview/read_write2/read_write2.png)

- Block Diagram

  ![](/img/software/dynamixel/dynamixel_sdk/sample_code/labview/read_write2/block_diagram.png)

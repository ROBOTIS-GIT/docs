...
- Open Visual Studio and create a new project as a Console Application.
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/makeproject.png)
...
<details>
<summary>
  ![](/img/icon_unfold.png) **ERROR LOGGING**
</summary>
...
```
  ...
  - `address` : The address of the data you want to write. Refer to the [**Control Table**](/docs/dxl/x/xc430-w240#control-table) of your DYNAMIXEL model, which can be found in its **specification manual** or **Dynamixel Wizard 2.0**. In this example, we use XL series.
...
- Set build properties.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/buildproperties.png)
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/buildproperties2.png)
...
- **Build properties setup is complete. You can now build and run the project.**
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/buildandrun.png)

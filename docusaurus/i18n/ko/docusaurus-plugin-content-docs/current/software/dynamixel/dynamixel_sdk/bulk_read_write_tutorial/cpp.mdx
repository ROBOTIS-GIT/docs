---
id: cpp
title: "Bulk Read/Write Tutorial (C++)"
sidebar_label: "C++"
sidebar_position: 2
tags: [dynamixel_sdk, tutorial, bulk_read_write, cpp]
---
...
- Open Visual Studio and create a new project as a Console Application.
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/makeproject.webp)
...
<details>
<summary>
  ![](/img/icon_unfold.webp) **ERROR LOGGING**
</summary>
...
```
  ...
  - `address` : The address of the data you want to write. Refer to the [**Control Table**](/docs/dxl/model_reference/x_series/xc430-w240#control-table) of your DYNAMIXEL model, which can be found in its **specification manual** or **Dynamixel Wizard 2.0**. In this example, we use XL series.
...
## Add parameter to GroupBulkWrite and Write Data
...
- Set build properties.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/buildproperties.webp)
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/buildproperties2.webp)
...
- **Build properties setup is complete. You can now build and run the project.**
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/buildandrun.webp)

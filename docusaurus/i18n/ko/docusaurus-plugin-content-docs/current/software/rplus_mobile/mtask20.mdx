...
![](/img/software/rplus_mobile/r+m_task2_1_kr.gif)

## 시작화면
시작 화면에서는 편집기와 리모컨을 선택할 수 있습니다.

![](/img/software/rplus_mobile/r+m_task2_2_kr.gif)

## 홈 탭
프로그램 시작 시 첫 화면으로 기본 예제, 파일 관련 메뉴, 업데이트, 설정 메뉴, 리모컨을 포함합니다.

![](/img/software/rplus_mobile/r+m_task2_3_kr.gif)

![](/img/software/rplus_mobile/r+m_task2_4_kr.gif)

## 프로그래밍 탭
태스크 소스 코드를 편집하는 영역으로 프로그래밍 툴바, 소스뷰, 아웃라인 메뉴, 다운로드 기능을 제공합니다.

![](/img/software/rplus_mobile/r+m_task2_5_kr.gif)

![](/img/software/rplus_mobile/r+m_task2_6_kr.gif)
...
![](/img/software/rplus_mobile/r+m_task2_7_kr.gif)

![](/img/software/rplus_mobile/r+m_task2_8_kr.gif)
...
4. “확인” 버튼을 클릭합니다.
  ...
  ![](/img/software/rplus_mobile/r+m_task2_61_kr.gif)

## 새 파일 만들기
1. 홈 탭으로 이동합니다. (프로그램 시작시 홈 탭에서 시작됩니다)  
2. “새로 만들기”버튼을 클릭합니다.

    ![](/img/software/rplus_mobile/r+m_task2_9_kr.gif)

3. 제어기와 제어기의 펌웨어 버전을 선택합니다. (구1.0, 신규2.0)  
4. “확인”버튼을 클릭하면 새로운 Task 파일이 생성됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_10_kr.gif)
...
3. “반복문” 카테고리를 클릭합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_11_kr.gif)

4. “무조건 반복” 명령어를 드래그(drag)하여,

5. 원하는 라인에 드롭(drop)하여 명령어가 추가합니다.

    ![](/img/software/rplus_mobile/r+m_task2_12_kr.gif)
...
4. 원하는 라인에 드롭(drop)하여 명령어를 추가합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_13_kr.gif)

5. 추가된 명령어의 “좌변 블록”을 두 번 터치합니다.

    ![](/img/software/rplus_mobile/r+m_task2_14_kr.gif)
...
9. “확인” 버튼을 클릭하여 명령어 편집을 완료합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_15_kr.gif)

10. 추가된 명령어의 “우변 블록”을 두 번 터치합니다.

    ![](/img/software/rplus_mobile/r+m_task2_16_kr.gif)
...
14. “확인” 버튼을 클릭하여 명령어 편집을 완료합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_17_kr.gif)

15. 편집이 적용된 명령어 블록을 확인합니다.

    ![](/img/software/rplus_mobile/r+m_task2_18_kr.gif)
...
4. 창이 닫히면 “다운로드”버튼을 클릭합니다.(BT-210을 사용할 경우 PIN번호[0000]를 입력해야 합니다.)
    ...
    ![](/img/software/rplus_mobile/r+m_task2_19_kr.gif)

5. 다운로드가 완료되면 제어기가 Task를 실행합니다.(일부 제어기의 경우 제어기가 Task를 실행하는 대신 종료합니다.)

    ![](/img/software/rplus_mobile/r+m_task2_20_kr.gif)
...
5. 창이 닫히면 “시작” 버튼을 클릭합니다. (BT-210을 사용할 경우 PIN번호[0000]를 입력해야 합니다.)
    ...
    ![](/img/software/rplus_mobile/r+m_task2_21_kr.gif)

6. 로봇이 연결되면 “출력 모니터”와 “가상 리모컨”이 활성화 됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_22_kr.gif)

7. 소스 코드상에서 “화면출력 후 줄 바꿈(혹은 화면출력)”을 사용한 경우,

    ![](/img/software/rplus_mobile/r+m_task2_23_kr.gif)

8. 다음과 같이 “출력용 모니터”에 값이 출력됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_24_kr.gif)
...
5. 창이 닫히면 “리모컨” 버튼을 클릭합니다.(BT-210을 사용할 경우 PIN번호[0000]를 입력해야 합니다.)
    ...
    ![](/img/software/rplus_mobile/r+m_task2_25_kr.gif)

6. 초기에 리모컨이 실행되면 “버튼”모드로 로봇을 조종할 수 있습니다.

    ![](/img/software/rplus_mobile/r+m_task2_26_kr.gif)

7. “조이스틱”모드를 선택하면 방향키가 조이스틱 형태로 변경됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_27_kr.gif)

8. “센서”모드를 선택하면 방향키가 기울기 센서 형태로 변경됩니

    ![](/img/software/rplus_mobile/r+m_task2_28_kr.gif)
...
2. 명령어를 드래그(drag)하여 원하는 위치에 드롭(drop)합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_29_kr.gif)

3. 명령어 블록을 두 번 터치하면 다른 명령어로 변경할 수 있습니다.

    ![](/img/software/rplus_mobile/r+m_task2_30_kr.gif)

## 여러 줄 선택
1. 줄 번호를 드래그(drag)하여 여러 줄을 선택합니다.

    ![](/img/software/rplus_mobile/r+m_task2_31_kr.gif)

2. 이미 선택된 라인의 번호를 드래그(drag)하면 부분적으로 취소할 수 있습니다.

    ![](/img/software/rplus_mobile/r+m_task2_32_kr.gif)

3. 소스코드를 직접 클릭하면 라인선택이 취소됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_33_kr.gif)
...
3. “줄 지우기(-)”를 클릭하면 선택된 줄이 삭제됩니다.
  ...
  ![](/img/software/rplus_mobile/r+m_task2_34_kr.gif)

## 줄 활성/비활성
1. 활성/비활성을 진행할 위치를 터치하여 선택합니다.
2. “줄 활성/비활성”버튼을 클릭하면 선택된 줄의 활성/비활성 상태가 전환됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_35_kr.gif)

3. 비활성화된 코드는 회색으로 표시되며 컴파일시 제외됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_36_kr.gif)

## 복사/잘라내기/붙여넣기
1. 복사(혹은 잘라내기)를 진행할 줄 번호를 드래그하여 선택합니다.
2. “추가 메뉴”버튼을 클릭합니다.

    ![](/img/software/rplus_mobile/r+m_task2_38_kr.gif)

3. “복사(혹은 잘라내기)”를 클릭하면 선택된 줄이 클립보드에 복사됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_37_kr.gif)

4. 붙여넣기를 진행할 줄을 터치하여 선택합니다.
5. “추가 메뉴”버튼을 클릭합니다.

    ![](/img/software/rplus_mobile/r+m_task2_39_kr.gif)

6. “붙여넣기”를 클릭하면 클립보드에 복사된 내용이 붙여집니다.

    ![](/img/software/rplus_mobile/r+m_task2_40_kr.gif)

7. 그림과 같이 복사한 코드가 삽입됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_41_kr.gif)

## 실행취소/다시실행
1. 코드를 편집하던 중에 “실행취소”버튼을 클릭하면 코드를 되돌릴 수 있습니다.

    ![](/img/software/rplus_mobile/r+m_task2_42_kr.gif)

2. 상단 툴바의 “다시실행”버튼을 클릭하면 되돌린 코드를 다시 실행할 수 있습니다.

    ![](/img/software/rplus_mobile/r+m_task2_43_kr.gif)

# 프로그래밍(명령어)
R+ m.Task 2.0에서 사용하는 명령어는 R+ Task 2.0과 동일합니다.  
R+ Task 2.0 매뉴얼의 [프로그래밍(명령어)]를 참고하세요.

[프로그래밍(명령어)]: /docs/software/rplus2/task#프로그래밍명령어/
# 프로그래밍(파라미터)
R+ m.Task 2.0에서 사용하는 파라미터는 R+ Task 2.0과 동일합니다.  
R+ Task 2.0 매뉴얼의 [프로그래밍(파라미터)]를 참고하세요.

[프로그래밍(명령어)]: /docs/software/rplus2/task#프로그래밍파라미터/
# 유용한 정보
## 변수, 함수 참조 찾기
...
3. 변수 목록 하단의 “참조 찾기(돋보기)” 버튼을 클릭합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_44_kr.gif)

4. “참조 결과”에서 항목을 선택하면 위치를 찾아갈 수 있습니다.
5. 다시 “참조 찾기”버튼을 클릭하여 창을 닫습니다.

    ![](/img/software/rplus_mobile/r+m_task2_45_kr.gif)

6. 변수 목록 하단에 “이름 변경”버튼을 클릭하면 해당 변수(함수)의 이름을 일괄적으로 변경할 수 있습니다.

    ![](/img/software/rplus_mobile/r+m_task2_46_kr.gif)
...
2. 상단에 검색어를 입력하세요.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_47_kr.gif)

3. 태스크 코드에서 “찾기 결과”가 하단에 목록으로 표시됩니다.
4. 목록의 아이템을 클릭하면 해당 줄로 이동합니다.

    ![](/img/software/rplus_mobile/r+m_task2_48_kr.gif)
...
![](/img/software/rplus_mobile/r+m_task2_49_kr.gif)

## 안드로이드 기기에 태스크파일 복사하기
...
2. 탐색기에서 “스마트 기기의 장치” → “내부 저장소” → “RoboPlus”로 이동합니다. (만약 “RoboPlus” 폴더가 존재하지 않으면 RoboPlus 폴더를 직접 생성합니다.)
    ...
    ![](/img/software/rplus_mobile/r+m_task2_50_kr.gif)

3. “RoboPlus”폴더 내에 원하는 태스크 파일(\*.tsk)을 복사합니다.

    ![](/img/software/rplus_mobile/r+m_task2_51_kr.gif)

4. 파일 복사가 완료되면 안드로이드 기기에서 R+ m.Task 2.0를 실행하여 상단의 “열기”버튼을 클릭합니다.

    ![](/img/software/rplus_mobile/r+m_task2_52_kr.gif)

5. 열기 창에 복사한 파일을 선택하여 “확인”버튼을 클릭하면 복사한 파일이 실행됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_53_kr.gif)

## Apple 기기에 태스크파일 복사하기
...
3. iTunes가 실행되면 상단에 연결된 장치를 선택합니다.
    ...
    ![](/img/software/rplus_mobile/r+m_task2_55_kr.gif)

4. 좌측에 “App” 카테고리를 선택합니다.

    ![](/img/software/rplus_mobile/r+m_task2_56_kr.gif)

5. App 목록이 로딩될 때까지 잠시 기다린 후, 화면을 아래로 스크롤합니다.

    ![](/img/software/rplus_mobile/r+m_task2_57_kr.gif)

6. App 목록에서 R+ Task2를 선택한 후, 좌측 도큐멘트 폴더 내에 원하는 태스크 파일(*.tsk)을 복사합니다.*

    ![](/img/software/rplus_mobile/r+m_task2_58_kr.gif)

7. 파일 복사가 완료되면 iOS 기기에서 R+ m.Task 2.0를 실행하여 상단의 “열기”버튼을 클릭합니다.

    ![](/img/software/rplus_mobile/r+m_task2_59_kr.gif)

8. 열기 창에 복사한 파일을 선택하여 “확인”버튼을 클릭하면 복사한 파일이 실행됩니다.

    ![](/img/software/rplus_mobile/r+m_task2_60_kr.gif)

# 자주 묻는 질문
## 지원 가능한 제품 군은?

- [제어기호환표](/docs/parts/controller/controller_compatibility)를 참고하여, 제공된 제어기와 호환이 되는지 확인 하세요.
...
[ROBOTIS IoT]: https://emanual.robotis.com/docs/kr/edu/iot/iot-1/
[BT-110]: /docs/parts/communication/bt-110
[BT-210]: /docs/parts/communication/bt-210
[BT-410]: /docs/parts/communication/bt-410
[로보플러스 매니저 1.0 펌웨어 업데이트]: /docs/software/rplus1/manager#펌웨어-업데이트/
[R+ Manager 2.0 펌웨어 업데이트]: /docs/software/rplus2/manager#펌웨어-업데이트/
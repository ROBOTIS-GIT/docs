...
# 메뉴 설명
![](/img/software/rplus_mobile/01_001_kr.jpg)  
...
![](/img/software/rplus_mobile/01_002_kr.jpg)  
...
![](/img/software/rplus_mobile/01_003_kr.jpg)
...
1. 연결 버튼을 클릭하여 로봇 연결 창을 호출합니다.
  ...
  ![](/img/software/rplus_mobile/02_001_kr.jpg)
...
2. 확인버튼을 클릭합니다. (위 과정은 이미 페어링된 블루투스 장치일 경우, 생략됩니다.)
  ...
  ![](/img/software/rplus_mobile/02_003_kr.jpg)

1. 스마트폰과 로봇이 연결된 후 장치를 읽어오는 동안 잠시 대기합니다.

  ![](/img/software/rplus_mobile/02_004_kr.jpg)

1. 연결에 성공하면 좌측에 연결 아이콘이 활성화 됩니다.

  ![](/img/software/rplus_mobile/02_005_kr.jpg)

## 예제 프로젝트 열기
1. 홈 탭으로 이동합니다.
2. 툴바에서 프로젝트 열기 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/03_001_kr.jpg)

1. 스마트폰에 저장된 모션 파일을 선택합니다.
2. 확인 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/03_002_kr.jpg)

1. 프로젝트를 불러오는 동안 잠시 대기합니다.

  ![](/img/software/rplus_mobile/03_003_kr.jpg)

## 모션 유닛 재생하기
1. 모션 유닛 탭으로 이동합니다.
2. 모션 유닛 목록을 클릭합니다.

  ![](/img/software/rplus_mobile/04_001_kr.jpg)

1. 재생할 모션 유닛을 선택합니다.
2. 확인 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/04_002_kr.jpg)

1. 상단의 모션 유닛 재생 메뉴를 클릭합니다.

  ![](/img/software/rplus_mobile/04_003_kr.jpg)

1. 앞서 선택한 모션 유닛이 잘 동작하는지 3D 로봇을 보며 확인합니다.

  ![](/img/software/rplus_mobile/04_004_kr.jpg)

1. 동기화 모드를 클릭합니다.
2. 모션 유닛을 재생하여 3D 로봇과 실제 로봇이 잘 동작하는지 확인합니다.

  ![](/img/software/rplus_mobile/04_005_kr.jpg)

## 모션 유닛 편집하기
1. 모션 유닛 목록을 클릭합니다.
2. “새 모션 유닛 만들기” 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/05_001_kr.jpg)

1. 새로 만들 모션 유닛의 이름을 입력합니다.
2. 확인버튼을 클릭하면 빈 모션 유닛이 생성됩니다.

  ![](/img/software/rplus_mobile/05_002_kr.jpg)

1. 앞서 생성한 모션 유닛을 선택합니다.
2. 확인버튼을 클릭하여 모션 유닛 목록을 닫습니다.

  ![](/img/software/rplus_mobile/05_003_kr.jpg)

1. 3D 로봇의 관절을 클릭하여 조작할 대상을 선택합니다.
2. 추가로 3D 로봇의 관절을 클릭하여 여러 관절을 선택할 수 있습니다.
3. 토크 끄기 버튼을 클릭하여 선택된 관절을 토크를 끕니다.

  ![](/img/software/rplus_mobile/05_004_kr.jpg)

1. 토크가 꺼진 관절을 손으로 움직여서 원하는 로봇 자세를 만듭니다.

  ![](/img/software/rplus_mobile/05_005_kr.jpg)

1. 토크 켜기 버튼을 클릭합니다.
2. 앞서 실제 로봇으로 만든 자세를 3D 로봇이 따라 하게 됩니다.

  ![](/img/software/rplus_mobile/05_006_kr.jpg)

1. 상단의 타임라인 영역을 드래그하여 25번 프레임에 커서를 위치시킵니다.
2. 키프레임 삽입 버튼을 클릭합니다.(위 과정을 통해 3D 로봇의 자세가 25번 위치에 저장됩니다.)

  ![](/img/software/rplus_mobile/05_007_kr.jpg)

1. 타임라인 영역에서 51번 위치로 커서를 이동시킵니다.
2. 토크 끄기 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/05_008_kr.jpg)

1. 토크가 꺼진 관절을 손으로 움직여서 새로운 자세를 만듭니다.

  ![](/img/software/rplus_mobile/05_009_kr.jpg)

1. 토크 켜기 버튼을 클릭합니다.
2. 앞서 실제 로봇으로 만든 자세를 3D 로봇이 따라하게 됩니다.
3. 키프레임 삽입 버튼을 클릭하여 해당 자세를 51번 프레임에 저장합니다.

  ![](/img/software/rplus_mobile/05_010_kr.jpg)

1. 마찬가지로 0.6초, 0.8초, 1초 위치에 추가로 키프레임 자세를 저장합니다.

  ![](/img/software/rplus_mobile/05_011_kr.jpg)

1. 동기화 모드를 클릭합니다.
2. 모션 유닛 재생 메뉴를 활용하여 실제 로봇이 잘 움직이는지 확인합니다.

  ![](/img/software/rplus_mobile/05_012_kr.jpg)

## 모션 재생하기
1. 모션 탭으로 이동합니다.
2. 모션 목록을 클릭합니다.

  ![](/img/software/rplus_mobile/06_001_kr.jpg)

1. 원하는 모션을 선택합니다.
2. 확인버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/06_002_kr.jpg)
...
3. “F_WALK_READ”를 1.0배속으로 1회 재생한 후 “F_WALK”를 1배속으로 3회 반복 재생합니다.
  ...
  ![](/img/software/rplus_mobile/06_003_kr.jpg)

1. 동기화 모드를 클릭합니다.
2. 모션 재생 메뉴를 활용하여 선택된 모션이 잘 실행되는지 확인합니다.

  ![](/img/software/rplus_mobile/06_004_kr.jpg)

1. 상단의 링크 영역에 삽입되어있는 모션 유닛을 선택합니다.
2. “연결된 모션 유닛 편집” 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/06_005_kr.jpg)

1. 재생 파라미터 탭을 클릭합니다.

  ![](/img/software/rplus_mobile/06_006_kr.jpg)

1. 해당 링크의 재생 속도를 수정해봅니다.
2. 해당 링크의 반복 횟수를 수정해봅니다.
3. 확인 버튼을 클릭하여 설정을 완료합니다.

  ![](/img/software/rplus_mobile/06_007_kr.jpg)

1. 앞서 변경한 재생 파라미터가 적용되었음을 확인합니다.

  ![](/img/software/rplus_mobile/06_008_kr.jpg)

1. 동기화 모드를 클릭합니다.
2. 모션 재생 메뉴를 활용하여 선택된 모션이 잘 실행되는지 확인합니다.

  ![](/img/software/rplus_mobile/06_009_kr.jpg)

## 모션 편집하기
1. 모션 목록을 클릭합니다.
2. 새 모션 만들기 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/07_001_kr.jpg)

1. 새로 만들 모션의 이름을 입력합니다.
2. 확인 버튼을 클릭하면 빈 모션이 생성됩니다.

  ![](/img/software/rplus_mobile/07_002_kr.jpg)

1. 앞서 생성한 모션을 선택합니다.
2. 확인버튼을 클릭하여 모션 목록을 닫습니다.

  ![](/img/software/rplus_mobile/07_003_kr.jpg)

1. 모션유닛 삽입 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/07_004_kr.jpg)

1. 연결할 모션유닛을 선택합니다.
2. 확인버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/07_005_kr.jpg)

1. 앞서 선택한 모션유닛이 연결되었습니다.
2. 다시 모션유닛 삽입 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/07_006_kr.jpg)

1. 연결할 모션유닛을 선택합니다.
2. 확인버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/07_007_kr.jpg)

1. 앞서 선택한 모션유닛이 연이어 연결됩니다.
2. 동기화 모드를 클릭합니다.
3. 모션 재생 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/07_008_kr.jpg)

1. 첫 번째로 연결한 모션유닛이 선택되고
2. 해당 모션유닛이 재생됩니다.

  ![](/img/software/rplus_mobile/07_009_kr.jpg)

1. 연이어 두 번째로 연결한 모션유닛이 선택되고
2. 해당 모션유닛이 재생됩니다.

  ![](/img/software/rplus_mobile/07_010_kr.jpg)

## 모션 다운로드하기
1. 모션 다운로드 탭으로 이동합니다.
2. 새 모션그룹 만들기 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/08_001_kr.jpg)

1. 새로 만들 모션그룹의 이름을 입력합니다.
2. 확인버튼을 클릭합니다

  ![](/img/software/rplus_mobile/08_002_kr.jpg)
...
4. 모션그룹에 원하는 모션을 모두 담은 후 확인버튼을 클릭합니다.
  ...
  ![](/img/software/rplus_mobile/08_003_kr.jpg)

1. 앞서 만든 모션그룹을 선택합니다.
2. 모션그룹 다운로드 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/08_004_kr.jpg)

1. 해당 모션그룹이 로봇 제어기에 다운로드 되는 동안 잠시 대기합니다.

  ![](/img/software/rplus_mobile/08_005_kr.jpg)

## 모션 프로젝트 저장하기
1. 홈 탭으로 이동합니다.
2. 다른 이름으로 저장 버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/09_001_kr.jpg)

1. 저장할 모션 프로젝트 파일의 이름을 입력합니다.
2. 확인버튼을 클릭합니다.

  ![](/img/software/rplus_mobile/09_002_kr.jpg)

1. 로그 메시지를 확인합니다.
2. 좌측 상단에 저장된 모션 프로젝트의 파일명이 표기됩니다.

  ![](/img/software/rplus_mobile/09_003_kr.jpg)
...
# 기타 정보
## 3D 카메라 조작
![](/img/software/rplus_mobile/10_001_kr.jpg)

> 3D 화면을 한 손가락으로 드래그하면 시점이 회전됩니다.

![](/img/software/rplus_mobile/10_002_kr.jpg)

> 3D 화면을 두 손가락으로 펼치며 드래그하면 시점이 확대됩니다.

![](/img/software/rplus_mobile/10_003_kr.jpg)

> 3D 화면을 두 손가락으로 모으며 드래그하면 시점이 축소됩니다.

![](/img/software/rplus_mobile/10_004_kr.jpg)

> 3D 화면을 두 손가락으로 위쪽 방향으로 드래그하면 시점이 내려갑니다.(시점이 내려감에 따라 로봇이 위로 올려져 보입니다.)

![](/img/software/rplus_mobile/10_005_kr.jpg)

---
id: python
title: "Basic Read/Write Tutorial (Python)"
sidebar_label: "Python"
sidebar_position: 3
tags: [dynamixel_sdk, tutorial, basic_read_write, python]
---
...
- Open the Visual Studio Code and create a python file in your workspace.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/vscodepython.webp)
...
- Run the code through Visual Studio Code.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/runbutton.webp)

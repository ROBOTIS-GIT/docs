...
3. 해당 변수(또는 함수)가 사용된 위치를 “참조 결과”에서 확인할 수 있습니다.
    ...
    ![](/img/sw/rplus_task3_kr/motion_info_01.png)

4. “참조 결과”에서 항목을 선택하면 위치를 찾아갈 수 있습니다.
5. 상단에 “이름 변경”버튼을 클릭하면 해당 변수(함수)의 이름을 일괄적으로 변경할 수 있습니다.

    ![](/img/sw/rplus_task3_kr/motion_info_02.png)
    ![](/img/sw/rplus_task3_kr/motion_info_03.png)
...
2. 상단에 검색어를 입력하세요.
    ![](/img/sw/rplus_task3_kr/motion_info_04.png)
3. 태스크 코드에서 “찾기 결과”가 하단에 목록으로 표시됩니다.
4. 목록의 아이템을 클릭하면 해당 줄로 이동합니다.
    ![](/img/sw/rplus_task3_kr/motion_info_05.png)
...
![](/img/sw/rplus_task3_kr/motion_info_06.png)
...
![](/img/sw/rplus_task3_kr/motion_keyframe_insert_kr.png)

### 삭제

아래 사진은 `Delete` 키 와 `Ctrl` 키의 활용의 차이점을 보여줍니다.

![](/img/sw/rplus_task3_kr/motion_keyframe_delete_kr.png)


### 프레임 선택 재생
지정한 프레임 선택하여 재생 할 수 있습니다. 아래 그림은 빨간색 네모박스 안의 선택된 프레임만 재생되며, 나머지 프레임은 재생되지않습니다.

![](/img/sw/rplus_task3_kr/motion_keyframe_selected_play.png)
...
![](/img/sw/rplus_task3_kr/motion_musicplay.png)

- 음원재생버튼을 클릭시 음원만 재생이됩니다.
![](/img/sw/rplus_task3_kr/motion_musicplay_03.png)

- 음원 재생 시작-종료 구간에서 시간값을 입력하여 선택재생 가능합니다.
![](/img/sw/rplus_task3_kr/motion_musicplay_02.png)
...
1. 홈탭에서, “자유 형태 로봇”목록을 클릭, 사용할 제어기를 선택한 후 “관절 추가”버튼을 클릭합니다.
    ![](/img/sw/rplus_task3_kr/motion_user_01.png)

2. 사용할 ID와 모터 종류를 선택한 후 “확인”버튼을 클릭하면 관절목록에 추가됩니다.

    ![](/img/sw/rplus_task3_kr/motion_user_02.png)
    ![](/img/sw/rplus_task3_kr/motion_user_03.png)
...
3. 이와 같이 사용할 모터 목록을 작성한 후 프로젝트를 생성하면 아래 그림과 같이 자유 형태 로봇이 생성됩니다.
  자유 형태 로봇은 3D 로봇만으로 실제 로봇의 움직임을 유추하기 어려우나 연결된 실제 로봇의 움직임을 확인하며 모션 편집이 가능해집니다.
    ![](/img/sw/rplus_task3_kr/motion_user_04.png)
...
1. 홈 탭으로 이동한 후, 좌측 메뉴 중 “3D 로봇”버튼을 클릭합니다.
    ...
    ![](/img/sw/rplus_task3_kr/motion_3d_01.png)

2. 중앙 하단의 “3D 로봇 변경하기”버튼을 클릭하여 변경을 원하는 로봇을 선택한 후 확인버튼을 클릭합니다.

    ![](/img/sw/rplus_task3_kr/motion_3d_02.png)
...
2. “미러링”버튼을 클릭합니다.
    ...
    ![](/img/sw/rplus_task3_kr/motion_mirror_02.png)

3. 선택한 관절의 값이 대칭되는 관절에 대입되었음을 확인합니다.

    ![](/img/sw/rplus_task3_kr/motion_mirror_03.png)
...
2. “미러링”버튼을 클릭합니다.
    ...
    ![](/img/sw/rplus_task3_kr/motion_mirror_04.png)

3. 선택한 관절의 값이 서로 교환되었음을 확인합니다.

    ![](/img/sw/rplus_task3_kr/motion_mirror_05.png)
...
1. 홈 탭을 클릭한 후 오프셋 편집을 클릭합니다.
    ![](/img/sw/rplus_task3_kr/motion_offset_01.png)
2. 로봇을 연결합니다. ([로봇 연결하기](/docs/software/rplus_task_3_0/motion_programming/#로봇-연결하기) 참조)
3. 동기화 모드를 활성화 합니다.
    ![](/img/sw/rplus_task3_kr/motion_offset_02.png)
4. 초기 포즈를 잡아준 후 로봇을 확인하며 오프셋 포즈를 편집합니다.
    ![](/img/sw/rplus_task3_kr/motion_offset_03.png)
...
7. “오프셋 다운로드“버튼을 클릭하여 오프셋을 로봇 제어기에 저장합니다.
    ![](/img/sw/rplus_task3_kr/motion_offset_04.png)
...
![](/img/sw/rplus_task3_kr/motion_offset_edit_01.png)
3. 오프셋 다운로드를 해주세요. 그후 수정된 오프셋 자세로 동작합니다
4. 저장전 위치 초기화를 클릭면 수정된 자세가 취소됩니다.
![](/img/sw/rplus_task3_kr/motion_offset_edit_02.png)

## 구 버전 파일(*.mtn) 변환하기

  ![](/img/sw/rplus2/motion/motion_40.gif)
...
1. 로보플러스 모션을 실행합니다.
    ...
    ![](/img/sw/rplus2/motion/motion_41.gif)

2. 로봇을 연결한 후 로봇 모션을 mtn파일로 저장하기 위해 “다른 이름으로 저장” 메뉴를 실행합니다.

    ![](/img/sw/rplus2/motion/motion_42.gif)

3. 저장할 파일명을 입력한 후 “저장”버튼을 클릭합니다.

    ![](/img/sw/rplus2/motion/motion_43.gif)

4. R+ Motion 3.0을 실행후, “프로젝트 열기” 버튼을 클릭합니다.

    ![](/img/sw/rplus_task3_kr/motion_trans_01.png)

5. 변환을 진행할 대상 mtn 파일을 선택한 후 “열기"버튼을 클릭합니다.

   ![](/img/sw/rplus_task3_kr/motion_trans_02.png)

6. 아래 그림과 같이 파일 변환 창이 활성화되면 “확인”버튼을 클릭합니다.

    ![](/img/sw/rplus_task3_kr/motion_trans_03.png)

7. 모션 데이터를 사용할 3D 로봇을 선택한 후 확인 버튼을 클릭합니다.

    ![](/img/sw/rplus_task3_kr/motion_trans_04.png)

8. 컨버팅이 완료되면 좌측 상단의 “모션 유닛 목록”을 클릭하여 제대로 변환되었는지 확인합니다.

9. 변환이 완료된 mtn3 파일을 저장합니다

    ![](/img/sw/rplus_task3_kr/motion_trans_05.png)

## 3D 카메라 조작

1. 마우스 오른쪽 버튼을 클릭한 채 드래그하면 시점이 회전됩니다.

    ![](/img/sw/rplus_task3_kr/motion_angle_01.png)

2. `Home` 키를 누르거나 마우스 휠 버튼을 위로 올리면 시점이 확대됩니다.

    ![](/img/sw/rplus_task3_kr/motion_angle_02.png)

3. `End` 키를 누르거나 마우스 휠 버튼을 아래로 내리면 시점이 축소됩니다.

    ![](/img/sw/rplus_task3_kr/motion_angle_03.png)

4. `Page Down` 키를 누르면 시점이 내려갑니다. (시점이 내려감에 따라 로봇이 위로 올려져 보입니다.)

    ![](/img/sw/rplus_task3_kr/motion_angle_04.png)

5. `Page Up` 키를 누르면 시점이 올라갑니다. (시점이 올라감에 따라 로봇이 아래로 내려져 보입니다.)

    ![](/img/sw/rplus_task3_kr/motion_angle_05.png)


## 화면에 각도 출력하기

"각도 값" 표시버튼을 클릭하여 3D로봇과 실제로봇 모터의 각도값을 출력할 수 있습니다.
  ![](/img/sw/rplus_task3_kr/motion_anglemark_01.png)
  ![](/img/sw/rplus_task3_kr/motion_anglemark_02.png)
...
1. 배경삽입 버튼을 클릭후, 원하는 배경을 삽입하세요.
  ![](/img/sw/rplus_task3_kr/motion_background_01.png)

2. 아래 사진과 같이 배경 위로 모터를 배치할 수 있습니다.
  ![](/img/sw/rplus_task3_kr/motion_background_02.png)

3. 제작시, 자유 배치 잠금 버튼을 클릭하여, 모터가 움직이지 않도록 고정시켜 주세요.
  ![](/img/sw/rplus_task3_kr/motion_background_03.png)

## 초기위치 이동

모터전체의 위치를 0점으로 이동시킵니다.
![](/img/sw/rplus_task3_kr/motion_position_init.png)

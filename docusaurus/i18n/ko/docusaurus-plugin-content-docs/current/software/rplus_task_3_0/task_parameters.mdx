...
![](/img/software/rplus_task3_kr/port_nickname_01.png)  

아래는 포트 닉네임이 적용된 예제입니다.  

![](/img/software/rplus_task3_kr/port_nickname_02.png)  
![](/img/software/rplus_task3_kr/port_nickname_03.png)
...
- 출력 : 값 범위는 0~1023이며, 0일 때 정지, 1023일 때 100% 출력으로 설정됩니다.  
  ![](/img/software/rplus_task3_kr/task3_070.png)

- 아래는 감속 모터를 제어하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_071.png)

- 아래는 감속 모터를 사용하여 로봇을 전진 시키는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_072.png)
...
- 서보모터 동작모드 : 속도모드와 관절모드를 선택할 수 있습니다.  
  ![](/img/software/rplus_task3_kr/servo_mode_selection.png)

- 속도모드 : 서보모터의 이동속도를 설정할 수 있습니다.  
  ![](/img/software/rplus_task3_kr/task3_073.png)

- 관절모드 : 서보모터의 위치를 설정할 수 있습니다.  
  ![](/img/software/rplus_task3_kr/task3_074.png)

- 아래는 서보모터를 바퀴형태로 제어하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/servo_velocity.png)

- 아래는 서보모터를 관절형태로 제어하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/servo_joint.png)

- CM-550은 서보모터를 속도모드와 관절모드로 선택해서 사용할 수 있습니다. 그러므로 다른 제어기와 같이 동작모드에 속도모드 또는 관절모드를 지정해줄 필요없이 바로 사용 가능합니다.  
  ![](/img/software/rplus_task3_kr/cm550_servo_selection.png)  
  ![](/img/software/rplus_task3_kr/cm550_servo_ex.png)
...
- LED 모듈의 오른쪽 LED와 왼쪽 LED를 켜거나 끌 수 있습니다.  
  ![](/img/software/rplus_task3_kr/task3_077.png)

- 아래는 LED 모듈을 제어하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_078.png)
...
- 모션이 실행되는 도중이라면 현재 실행 중인 모션 번호를 읽어올 수 있습니다.  
  ![](/img/software/rplus_task3_kr/motion_control_namelist.png)  
- 아래는 모션 호출 번호를 이용한 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_090.png)  
...
키프레임, 모션유닛, 모션에 대한 정보는 [모션 프로그래밍](/docs/software/rplus_task_3_0/motion_programming#모션-프로그래밍)을 참조하세요.

#### 모션 연결

현재 모션 이후, 실행될 모션을 지정합니다. 현재 모션과 다음 실행 모션을 자연스럽게 연결할 수 있습니다.

![Motion_Link](/img/software/rplus_task3_kr/motion_next_page_kr.png)

#### 모션 상태
모션이 실행되고 있으면 True, 모션이 실행되고 있지 않으면 False값을 반환합니다.
- 아래는 모션 상태를 이용하여 모션이 종료될 때까지 대기하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_091.png)
...
- 아래는 특정 관절에 오프셋 값을 적용하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_092.png)

- 아래는 특정 관절에 모션 데이터 값의 영향을 받지 않도록 설정하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_093.png)
...
- 아래는 모션 실행 시 “관절 LED 자동 켜기” 기능을 활용하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_094.png)

- 아래는 제어기에 저장된 모션을 실행하는 예제입니다. 리모컨 버튼 눌림에 따라 해당하는 모션이 실행됩니다.  
  ![](/img/software/rplus_task3_kr/task3_095.png)
...
- 아래는 시작 버튼 눌림 횟수를 사용하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_099.png)

#### 제어기 버튼 / 버튼
제어기의 버튼 상태를 읽어올 때 사용합니다. 제어기에 따라 사용할 수 있는 버튼이 달라집니다.
- 지원 제어기 : [CM-5], [CM-50], [CM-100A], [CM-150], [CM-200], [CM-510], [CM-530], [CM-700], [OpenCM 7.0], [OpenCM 9.04]
- 아래는 CM-5, CM-510, CM-530 제어기의 버튼을 사용하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_100.png)

- 아래는 OpenCM9.04의 버튼을 사용하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_101.png)
...
- 아래는 최종 소리감지 횟수를 이용한 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_096.png)

#### 실시간 소리 감지 횟수
제어기에 내장된 마이크를 사용하여 일정 수준 이상의 큰 소리가 날 경우 1회씩 카운트하는 기능입니다. 대표적인 예로 박수 소리를 카운트하여 로봇을 동작시킬 때 많이 사용합니다.  
실시간으로 감지된 소리 횟수를 카운트합니다. 0.8초간 소리가 입력되지 않으면 0으로 초기화 됩니다.
- 아래는 실시간 소리감지 횟수를 이용한 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_097.png)
...
- 아래는 제어기의 적외선 센서 값을 사용하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_098.png)
...
- 받은 무선 데이터 : 제어기가 외부로부터 데이터를 전달받을 때 사용합니다.  
  ![](/img/software/rplus_task3_kr/task3_105.png)

##### 보낼 무선 데이터
제어기가 외부로 데이터를 내보낼 때 사용합니다.  
![](/img/software/rplus_task3_kr/task3_106.png)

##### 새 무선 데이터 도착
제어기에 외부로부터 데이터가 전달되었을 때 값이 True가 됩니다.  
![](/img/software/rplus_task3_kr/task3_107.png)

##### 내 로봇 무선 ID
지그비를 사용할 때 지그비 ID를 확인합니다.  
![](/img/software/rplus_task3_kr/task3_108.png)

##### 상대로봇 무선 ID
지그비를 사용할 때 패어링할 지그비의 ID를 설정합니다.  
![](/img/software/rplus_task3_kr/task3_109.png)

##### RC-100 채널
적외선 수신기를 사용할 때 채널 값을 설정합니다. (값이 255일경우 블루투스/지그비 모드로 동작합니다.)  
![](/img/software/rplus_task3_kr/task3_110.png)

- 아래는 제어기에서 받은 무선 데이터를 처리하는 예제입니다.
  
  ![](/img/software/rplus_task3_kr/task3_111.png)

- 아래는 제어기가 외부로 데이터를 내보내는 예제입니다.
  
  ![](/img/software/rplus_task3_kr/task3_112.png)
...
- 아래는 타이머를 사용하여 약 1초(1.024초)만큼 대기하는 예제입니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_113.png)

#### 정밀 타이머
타이머와 같은 기능을 하며 시간을 더 정밀하게 카운트 합니다. 정밀 타이머의 값 범위는 0 ~ 65,535이며, 단위는 0.001초 입니다.  
- 아래는 정밀 타이머를 사용하여 정확히 1초(1.000초)만큼 대기하는 예제입니다.
 
  ![](/img/software/rplus_task3_kr/task3_114.png)

#### 딜레이
CM-550에서는 타이머와 조건대기가 결합된 딜레이 기능을 사용할수 있습니다.  
![](/img/software/rplus_task3_kr/cm550_delay_01.png)  
![](/img/software/rplus_task3_kr/cm550_delay_02.png)  

- 아래 태스크 코드 중 우측의 코드는 CM-550에서 딜레이를 간단하게 사용할 수 있는 예시입니다.  
  ![](/img/software/rplus_task3_kr/cm550_delay_03.png)
...
- 아래는 자동꺼짐 타이머를 이용하여 제어기의 절전 모드를 설정하는 예제입니다. 5분내에 새 무선 데이터가 도착하면 자동꺼짐 타이머 값을 다시 초기화합니다.
  ...
  ![](/img/software/rplus_task3_kr/task3_115.png)
...
- 아래는 “화면 출력”과 “화면 출력 후 줄바꿈”을 사용하여 센서 값을 출력하는 예제입니다.  
  ![](/img/software/rplus_task3_kr/task3_118.png)  
  ![](/img/software/rplus_task3_kr/task3_119.png)
...
- 아래 그림과 같이 `모터 위치 값` 컨트롤을 사용하여 각도 위치를 설정할 수 있습니다.  
  ![](/img/software/rplus_task3_kr/task3_121.png)

#### 목표 속도
다이나믹셀의 이동 속도를 읽어오거나 설정하기 위해 사용합니다.  
- 아래 그림과 같이 `모터 제어 값` 컨트롤을 사용하여 회전 방향과 출력 값을 설정할 수 있습니다.  
  ![](/img/software/rplus_task3_kr/task3_122.png)

#### 프로파일 가속도
다이나믹셀-X 시리즈에서 프로파일의 가속도를 설정합니다. 자세한 내용은 X 시리즈의 [Profile Acceleration(108)](https://emanual.robotis.com/docs/kr/dxl/x/xm430-w210/#profile-acceleration)을 참고하세요.  
![](/img/software/rplus_task3_kr/task3_214.png)

#### 프로파일 속도
다이나믹셀-X 시리즈가 Position Control 또는 Extended Position Control 모드일 때 프로파일의 최대 속도를 설정합니다. 자세한 내용은 X 시리즈의 [Profile Velocity(112)](https://emanual.robotis.com/docs/kr/dxl/x/xm430-w210/#profile-velocity)을 참고하세요.  
![](/img/software/rplus_task3_kr/task3_215.png)

#### 목표 전류 / 토크
다이나믹셀의 전류 / 토크 한계를 설정하기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_207.png)

#### 현재 위치
다이나믹셀의 현재 위치를 읽어오기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_208.png)

#### 현재 속도
다이나믹셀의 현재 속도를 읽어오기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_209.png)

#### 현재 하중
다이나믹셀의 출력축이 받고있는 하중값과 하중의 방향을 읽어오기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_210.png)

#### 현재 입력 전압
다이나믹셀의 내부 전압을 읽어오기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_211.png)

#### 현재 온도
다이나믹셀의 내부 온도를 읽어오기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_212.png)

#### 움직임 유무
다이나믹셀의 움직임 유무를 읽어오기 위해 사용합니다. True일 때 움직이는 상태, False일 때 움직이지 않는 상태를 나타냅니다.  
![](/img/software/rplus_task3_kr/task3_213.png)

### SyncWrite

CM-550 제어기를 사용할 경우 [프로토콜 2.0 - SyncWrite](https://emanual.robotis.com/docs/kr/dxl/protocol2/#sync-write) 명령어를 사용할 수 있습니다.
...
| 파라미터 |          동작           |                          예시                           |
|:--------:|:-----------------------:|:-------------------------------------------------------:|
|    0     | SyncWrite 패킷 시작하기 | ![](/img/software/rplus_task3_kr/sync_write_01.png) |
|    1     | SyncWrite 패킷 입력하기 | ![](/img/software/rplus_task3_kr/sync_write_02.png) |
|    2     | SyncWrite 패킷 전송하기 | ![](/img/software/rplus_task3_kr/sync_write_03.png) |

#### SyncWrite Address

데이터가 전송될 주소를 나타냅니다.

![](/img/software/rplus_task3_kr/sync_write_04.png)  
...
![](/img/software/rplus_task3_kr/sync_write_05.png)  
...
![](/img/software/rplus_task3_kr/sync_write_06.png)  
...
![](/img/software/rplus_task3_kr/sync_write_07.png)  
...
![](/img/software/rplus_task3_kr/sync_write_example.png)
...
![](/img/software/rplus_task3_kr/task3_123.png)
...
![](/img/software/rplus_task3_kr/task3_217.png)
...
![](/img/software/rplus_task3_kr/task3_124.png)  
![](/img/software/rplus_task3_kr/task3_125.png)

#### 카메라 확대
스마트 기기의 카메라를 확대할 때 사용합니다 (값의 범위는 0~255 입니다).  
아래는 카메라를 1.024초에 한번씩 확대하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_126.png)  
![](/img/software/rplus_task3_kr/task3_127.png)![](/img/software/rplus_task3_kr/task3_128.png)

#### 카메라 센서
스마트 기기의 카메라를 센서모드로 동작시키기 위해 사용합니다.  
![](/img/software/rplus_task3_kr/task3_129.png)
...
![](/img/software/rplus_task3_kr/task3_130.png)  
![](/img/software/rplus_task3_kr/task3_131.png)
...
![](/img/software/rplus_task3_kr/task3_132.png)
...
![](/img/software/rplus_task3_kr/task3_133.png)  
![](/img/software/rplus_task3_kr/task3_134.png)

#### 얼굴 감지 영역
“카메라 센서”의 “얼굴 감지 모드”를 사용하는 경우, 감지된 얼굴의 위치를 확인하기 위해 사용합니다.  
아래는 얼굴이 감지되면 해당 위치에 빨간색 원을 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_135.png)  
![](/img/software/rplus_task3_kr/task3_136.png)

#### 동작 감지 영역
“카메라 센서”의 “동작 감지 모드”를 사용하는 경우, 감지된 동작의 위치를 확인하기 위해 사용합니다.  
아래는 동작이 감지되면 해당 위치에 빨간색 원을 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_137.png)  
![](/img/software/rplus_task3_kr/task3_138.png)
...
![](/img/software/rplus_task3_kr/task3_139.png)  
![](/img/software/rplus_task3_kr/task3_140.png)![](/img/software/rplus_task3_kr/task3_141.png)

#### 배경 표시
스마트 기기의 화면에 그림 배경을 설정할 때 사용합니다.(스마트 기기 앱에 미리 등록해놓은 배경만 사용할 수 있습니다.)  
아래는 스마트 기기의 그림 배경을 아이템1로 설정하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_142.png)  
![](/img/software/rplus_task3_kr/task3_143.png)

#### 그림 표시
스마트 기기의 화면에 그림을 배치할 때 사용합니다.(스마트 기기 앱에 미리 등록해놓은 그림만 사용할 수 있습니다.)  
아래는 스마트 기기의 위치2,3과 위치 4,3에 그림을 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_144.png)  
![](/img/software/rplus_task3_kr/task3_145.png)
...
![](/img/software/rplus_task3_kr/task3_146.png)  
![](/img/software/rplus_task3_kr/task3_147.png)

#### 도형 표시
스마트 기기의 화면에 도형을 배치할 때 사용합니다. (1 : 원, 2 : 사각형, 3 : 삼각형)  
아래는 위치3,3에 파란색 원형과 회색 삼각형을 번갈아 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_148.png)  
![](/img/software/rplus_task3_kr/task3_149.png)![](/img/software/rplus_task3_kr/task3_150.png)

#### 문자 표시
스마트 기기의 화면에 문자를 배치할 때 사용합니다. (스마트 기기 앱에 미리 등록해놓은 문자만 사용할 수 있습니다.)  
아래는 위치1,3~5,3에 차례로 문자를 표시했다가 지우는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_151.png)  
![](/img/software/rplus_task3_kr/task3_152.png)
![](/img/software/rplus_task3_kr/task3_153.png)
![](/img/software/rplus_task3_kr/task3_154.png)
![](/img/software/rplus_task3_kr/task3_155.png)

#### 숫자 표시
스마트 기기의 화면에 숫자를 배치할 때 사용합니다. (별도의 문자 등록 없이 0~255 사이의 숫자를 사용할 수 있습니다.)  
아래는 위치3,3에 숫자를 증가하며 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_156.png)  
![](/img/software/rplus_task3_kr/task3_157.png)![](/img/software/rplus_task3_kr/task3_158.png)
...
![](/img/software/rplus_task3_kr/task3_159.png)

#### 악기 연주
스마트 기기로 악기 소리를 낼 때 사용합니다.  
아래는 어쿠스틱 피아노로 도, 레, 미를 반복해서 출력하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_160.png)
...
![](/img/software/rplus_task3_kr/task3_161.png)
...
![](/img/software/rplus_task3_kr/task3_162.png)
...
![](/img/software/rplus_task3_kr/task3_163.png)  
![](/img/software/rplus_task3_kr/task3_164.png)![](/img/software/rplus_task3_kr/task3_165.png)

#### 기울기 센서
스마트 기기의 기울기 센서를 활용하기 위해 사용합니다. (왼쪽), (오른쪽), (위쪽), (아래쪽)의 기울기를 각각 0~90도로 출력됩니다.  
아래는 스마트 기기의 기울기에 따라 화면에 기울어진 방향에 원을 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_166.png)  
![](/img/software/rplus_task3_kr/task3_167.png)![](/img/software/rplus_task3_kr/task3_168.png)![](/img/software/rplus_task3_kr/task3_169.png)
...
![](/img/software/rplus_task3_kr/task3_170.png)  
![](/img/software/rplus_task3_kr/task3_171.png)![](/img/software/rplus_task3_kr/task3_172.png)

#### 자기장 센서
스마트 기기의 자기장 센서를 활용하기 위해 사용합니다. 주위 자기장에 따라 0~65535의 값이 출력됩니다.  
아래는 스마트 기기 주위의 자기장을 측정하여 값을 화면에 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_173.png)  
![](/img/software/rplus_task3_kr/task3_174.png)![](/img/software/rplus_task3_kr/task3_175.png)
...
![](/img/software/rplus_task3_kr/task3_176.png)  
![](/img/software/rplus_task3_kr/task3_177.png)

#### 소음 센서
스마트 기기의 소음 센서를 활용하기 위해 사용합니다. 소음에 따라 dB 단위로 0~255 사이의 값을 출력합니다.  
아래는 소음의 크기에 따라 도형을 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_178.png)  
![](/img/software/rplus_task3_kr/task3_179.png)![](/img/software/rplus_task3_kr/task3_180.png)
...
![](/img/software/rplus_task3_kr/task3_181.png)  
![](/img/software/rplus_task3_kr/task3_182.png)![](/img/software/rplus_task3_kr/task3_183.png)

#### 터치 위치
스마트 기기의 화면 터치 위치를 활용하기 위해 사용합니다. 터치 위치1은 첫 번째로 터치된 손가락을 의미하며 터치 위치2는 두 번째로 터치된 손가락을 의미합니다.  
아래는 터치한 위치에 도형을 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_184.png)  
![](/img/software/rplus_task3_kr/task3_185.png)![](/img/software/rplus_task3_kr/task3_186.png)

#### 제스처 인식
스마트 기기의 제스처 인식 기능을 활용하기 위해 사용합니다.  
아래는 제스처를 인식하여 해당 제스처의 번호를 화면에 출력하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_187.png)  
![](/img/software/rplus_task3_kr/task3_188.png)![](/img/software/rplus_task3_kr/task3_189.png)
...
![](/img/software/rplus_task3_kr/task3_190.png)  
![](/img/software/rplus_task3_kr/task3_191.png)
...
![](/img/software/rplus_task3_kr/task3_192.png)
...
![](/img/software/rplus_task3_kr/task3_193.png)

#### 현재 시간
스마트 기기로부터 현재시간을 읽어오기 위해 사용합니다.  
아래는 현재시간을 화면에 표시하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_194.png)  
![](/img/software/rplus_task3_kr/task3_195.png)

#### 플래시 LED
스마트 기기의 카메라 플래시 LED를 켜거나 끄기 위해 사용합니다.  
아래는 조도센서로 주위 밝기를 측정하여 어두우면 플래시 LED를 켜는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_196.png)

#### 앱 실행하기
스마트 기기에 설치된 앱을 실행하기 위해 사용합니다.  
아래는 화면을 터치하면 등록된 앱을 실행하는 예제입니다.  
![](/img/software/rplus_task3_kr/task3_197.png)
...
![](/img/software/rplus_task3_kr/task3_202.png)
...
![](/img/software/rplus_task3_kr/task3_203.png)
...
![](/img/software/rplus_task3_kr/task3_204.png)
...
![](/img/software/rplus_task3_kr/task3_205.png)
...
![](/img/software/rplus_task3_kr/task3_206.png)

### 모터 모드
SM-10 서보모터의 속도모드, 관절모드를 전환할 경우 사용합니다.  
![](/img/software/rplus_task3_kr/task3_219.png)

## 모션 목록
모션 예제가 열려있는 경우 해당 예제의 모션 목록이 여기에 나타납니다.  
모션 예제가 열려있지 않은 경우 이 항목은 메뉴에 표시되지 않습니다.  
![](/img/software/rplus_task3_kr/task3_218.png)

[제어기 호환표]: https://emanual.robotis.com/docs/kr/parts/controller/controller_compatibility/
[접촉 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/ts-10/
[적외선 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/irss-10/
[컬러 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/cs-10/
[자석 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/mgss-10/
[온도 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/tps-10/
[절대 거리 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/dms-80/
[조도 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/cds-10/
[온습도 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/tms-10/
[동작감지 센서 부품 정보]: https://emanual.robotis.com/docs/kr/parts/sensor/pir-10/
[사용자 센서 제작]: https://emanual.robotis.com/docs/kr/edu/bioloid/premium/#사용자-센서-제작
[CM-50]: https://emanual.robotis.com/docs/kr/parts/controller/cm-100/
[CM-100A]: https://emanual.robotis.com/docs/kr/parts/controller/cm-100/
[CM-150]: https://emanual.robotis.com/docs/kr/parts/controller/cm-150/
[CM-200]: https://emanual.robotis.com/docs/kr/parts/controller/cm-200/
[CM-5]: https://emanual.robotis.com/docs/kr/parts/controller/cm-5/
[CM-510]: https://emanual.robotis.com/docs/kr/parts/controller/cm-510/
[CM-530]: https://emanual.robotis.com/docs/kr/parts/controller/cm-530/
[CM-550]: https://emanual.robotis.com/docs/kr/parts/controller/cm-550/
[CM-700]: https://emanual.robotis.com/docs/kr/parts/controller/cm-700/
[OpenCM 7.0]: https://emanual.robotis.com/docs/kr/parts/controller/opencm7/
[R+ Smart 컨트롤 테이블]: https://emanual.robotis.com/docs/kr/software/mobile_app/rplussmart/#r-smart-control-table
[ROBOTIS DREAM]: https://emanual.robotis.com/docs/kr/edu/dream/dream1-1/
[ROBOTIS SMART]: https://emanual.robotis.com/docs/kr/edu/smart/smart1-1/
[ROBOTIS STEM]: https://emanual.robotis.com/docs/kr/edu/bioloid/stem/
[ROBOTIS PREMIUM]: https://emanual.robotis.com/docs/kr/edu/bioloid/premium/
[ROBOTIS GP]: https://emanual.robotis.com/docs/kr/edu/bioloid/gp/
[ROBOTIS MINI]: https://emanual.robotis.com/docs/kr/edu/mini/
[OpenCM 9.04]: https://emanual.robotis.com/docs/kr/parts/controller/opencm904/
[BT-110]: https://emanual.robotis.com/docs/kr/parts/communication/bt-110/
[BT-210]: https://emanual.robotis.com/docs/kr/parts/communication/bt-210/
[BT-410]: https://emanual.robotis.com/docs/kr/parts/communication/bt-410/
[제어기펌웨어 업데이트]: /docs/software/rplus_manager_2_0#펌웨어-업데이트

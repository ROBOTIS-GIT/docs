...
2. `새로 만들기` 버튼을 클릭합니다.
    ...
    ![](/img/software/rplus_task3_kr/task3_008.png)

3. 프로토콜 버전과 제어기를 선택합니다.
4. `확인` 버튼을 클릭하면 새로운 태스크 파일이 생성됩니다.

    ![](/img/software/rplus_task3_kr/task3_009.png)
...
4. `확인` 버튼을 클릭합니다.
    ...
    ![](/img/software/rplus_task3_kr/task3_010.png)
...
4. 세부 명령어를 드래그하여 원하는 위치에 드롭합니다.
    ...
    ![](/img/software/rplus_task3_kr/task3_011.png)

## 여러 줄 선택

1. 줄 번호를 드래그(drag)하여 여러 줄을 선택합니다.

    ![](/img/software/rplus_task3_kr/task3_012.png)

2. 소스코드를 직접 클릭하면 라인선택이 취소됩니다.

    ![](/img/software/rplus_task3_kr/task3_013.png)
...
2. `줄 삽입`을 선택하면 선택된 줄의 위쪽에 새로운 줄이 삽입됩니다. (단축키 : `Space`)  
  ...
  `줄 내용 지우기`를 선택하면 줄을 남겨두고 코드만 삭제됩니다. (단축키 : `Backspace`)
    ...
    ![](/img/software/rplus_task3_kr/task3_014.png)
...
2. `줄 활성/비활성`을 클릭하면 선택된 줄의 활성/비활성 상태가 전환됩니다. (단축키 : `Ctrl` + `E`)
    ...
    ![](/img/software/rplus_task3_kr/task3_015.png)

3. 비활성화된 코드는 주석처리되어 회색으로 표시되며 컴파일시 제외됩니다.

    ![](/img/software/rplus_task3_kr/task3_016.png)
...
3. 상단 툴바의 `잘라내기`, `복사` 버튼을 사용할 수도 있습니다. (단축키 : `Ctrl` + `C`, `Ctrl` + `X`)
    ...
    ![](/img/software/rplus_task3_kr/task3_017.png)
...
6. 상단 툴바의 `붙여넣기` 버튼을 사용할 수도 있습니다. (단축키 : `Ctrl` + `V`)
    ...
    ![](/img/software/rplus_task3_kr/task3_018.png)

7. 그림과 같이 복사한 코드가 삽입됩니다.

    ![](/img/software/rplus_task3_kr/task3_019.png)
...
2. 상단 툴바의 `실행취소` 버튼을 클릭하면 한 단계 이전으로 되돌릴 수 있습니다. (단축키 : `Ctrl` + `Z`)
    ...
    ![](/img/software/rplus_task3_kr/task3_020.png)

3. 추가 메뉴의 `다시실행`을 선택하거나
4. 상단 툴바의 `다시실행` 버튼을 클릭하면 되돌린 코드를 다시 실행할 수 있습니다. (단축키 : `Ctrl` + `Shift` + `Z`)

    ![](/img/software/rplus_task3_kr/task3_021.png)
...
4. 제어기에 연결이 완료되고 창이 닫히면 `터미널 시작 / 정지` 버튼을 클릭합니다. (단축키 : `Ctrl` + `F6`)
    ...
    ![](/img/software/rplus_task3_kr/task3_024.png)

6. 로봇이 연결되면 `출력 모니터`와 `가상 리모컨`이 활성화 됩니다.

    ![](/img/software/rplus_task3_kr/task3_025.png)

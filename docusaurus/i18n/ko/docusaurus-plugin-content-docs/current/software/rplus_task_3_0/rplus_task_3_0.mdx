...
![](/img/sw/rplus_task3_kr/task3_001.png)
...
4. 모션유닛 탭
  모션 예제를 선택하거나 자유 형태 로봇 모션을 만들 수 있는 화면입니다.
    ...
    ![](/img/sw/rplus_task3_kr/task3_005.png)

5. 모션 탭
  모션 유닛을 선택해서 재생해 볼 수 있는 화면입니다.

    ![](/img/sw/rplus_task3_kr/task3_006.png)

6. 모션 다운로드 탭
  저장된 모션을 선택적으로 다운로드 할 수 있는 화면입니다.

    ![](/img/sw/rplus_task3_kr/task3_007.png)

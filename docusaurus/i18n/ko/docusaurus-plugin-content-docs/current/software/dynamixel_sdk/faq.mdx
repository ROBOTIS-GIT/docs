...
For more information on the DYNAMIXEL protocol refer to the [Protocol 1.0](http://emanual.robotis.com/docs/en/dxl/protocol/protocol1/) and [Protocol 2.0](http://emanual.robotis.com/docs/en/dxl/protocol/protocol2/) documentation for full technical details.

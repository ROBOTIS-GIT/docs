...
- Control Panel
  ...
  ![](/img/software/dynamixel_sdk/sample_code/labview/protocol_combined/protocol_combined.webp)

- Block Diagram

  ![](/img/software/dynamixel_sdk/sample_code/labview/protocol_combined/block_diagram.webp)

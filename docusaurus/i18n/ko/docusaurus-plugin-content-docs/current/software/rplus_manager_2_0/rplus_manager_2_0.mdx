...
![](/img/sw/rplus2/manager/rplusmanager2_01_kr.jpg)
...
![](/img/sw/rplus2/manager/rplusmanager2_02_kr.jpg)
...
1. 홈 탭에서 업데이트 및 테스트를 진행할 제품을 선택합니다. (예시에서는 ROBOTIS MINI를 선택함)
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_07_kr.jpg)

2. “업데이트 및 테스트” 메뉴를 선택합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_08_kr.jpg)

3. 안내에 따라 제품과 PC를 연결한 후 제품을 켭니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_09_kr.jpg)

4. 연결할 포트를 선택한 후 “다음”버튼을 클릭합니다. (예시에서는 블루투스 시리얼 포트를 사용함)

    ![](/img/sw/rplus2/manager/rplusmanager2_10_kr.jpg)

5. 검색할 통신속도를 선택한 후 “다음”버튼을 클릭합니다.(블루투스 시리얼 포트 사용시 57600bps만 가능함)

    ![](/img/sw/rplus2/manager/rplusmanager2_11_kr.jpg)

6. 관리할 대상이 정상적으로 검색되었는지 확인한 후 다음 버튼을 클릭합니다. (만약, 제품 검색이 정상적으로 이뤄지지 않을 경우 다시 시도 버튼을 클릭하세요.)

    ![](/img/sw/rplus2/manager/rplusmanager2_12_kr.jpg)

7. 업데이트할 내용이 감지되면 아래의 “지금 업데이트” 버튼이 활성화됩니다. 업데이트 내용을 확인한 후 “지금 업데이트”버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_13_kr.jpg)

8. 업데이트가 정상적으로 완료될 때까지 기다린 후, “다음” 버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_14_kr.jpg)

9. 업데이트가 완료되면 “컨트롤 테이블 테스트” 기능이 실행됩니다. (일부 제어기는 업데이트 완료 후 전원이 꺼지며, 대화창이 종료됩니다.)

    ![](/img/sw/rplus2/manager/rplusmanager2_15_kr.jpg)

## 펌웨어 복구

1. 홈 탭에서 펌웨어 복구를 진행할 제품을 선택합니다. (예시에서는 ROBOTIS MINI를 선택함)

    ![](/img/sw/rplus2/manager/rplusmanager2_21_kr.jpg)

2. “펌웨어 복구” 메뉴를 선택합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_22_kr.jpg)

3. 안내 메시지를 확인한 후 “다음” 버튼을 클릭하세요.

    ![](/img/sw/rplus2/manager/rplusmanager2_23_kr.jpg)

4. 복구를 진행할 제품을 선택한 후 “다음” 버튼을 클릭합니다. (예시에서는 OpenCM9.04를 선택함.)

    ![](/img/sw/rplus2/manager/rplusmanager2_24_kr.jpg)

5. 안내를 순서대로 따라서 진행합니다. 노란색 경고 문구를 반드시 숙지하세요!
6. 모든 준비를 마치면 “다음” 버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_25_kr.jpg)

7. 연결할 포트를 선택한 후 “다음”버튼을 클릭합니다. (예시에서는 블루투스 시리얼 포트를 사용함)

    ![](/img/sw/rplus2/manager/rplusmanager2_26_kr.jpg)

8. 장치가 연결되면 펌웨어 설치를 위해 부트로더를 감지합니다. “다음” 버튼이 활성화되면 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_27_kr.jpg)

9. 설치할 펌웨어 정보를 확인한 후 “다음” 버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_28_kr.jpg)

10. 복구가 정상적으로 완료되면 “마침” 버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_29_kr.jpg)
...
2. 컨트롤 테이블 창은 장치를 통신속도, 장치, 순으로 분류합니다. 테스트할 통신속도 그룹과 장치를 선택합니다. (예시에서는 XL-320을 선택함.)
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_16_kr.jpg)
...
3. 좌측 메뉴에서 “팩토리 리셋” 버튼을 클릭하면 제품을 공장 초기화 상태로 되돌릴 수 있습니다. (이때, ID와 Baudrate 값은 변경하지 않습니다.) 좌측 메뉴에서 “리부팅” 버튼을 클릭하면 해당 다이나믹셀을 재부팅할 수 있습니다. 좌측 메뉴에서 “토크 켜기” 버튼을 클릭하면 해당 다이나믹셀의 토크를 켜거나 끌 수 있습니다.
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_17_kr.jpg)
...
6. 우측 하단의 위치 값 컨트롤을 사용하여 모터를 움직여봅니다.(값을 조정하는 과정에서 모터가 갑작스럽게 움직일 수 있으니 주의하세요.)
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_18_kr.jpg)
...
9. 좌측 하단의 “하드웨어 알람” 메시지를 통해 하드웨어의 에러상태를 확인할 수 있습니다.
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_19_kr.jpg)
...
10. 일부 다이나믹셀의 경우 프로파일 타입 상태 보기 기능을 제공합니다. 특정 Operating Mode에서 Profile Acceleration 값과 Profile Velocity 값에 따라 프로파일 타입이 결정됩니다. 자세한 사항은 해당 다이나믹셀의 E-Manual을 참고하세요. (지원 가능한 제품 : XM시리즈와 XH시리즈)
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_20_kr.jpg)
...
1. 마우스 왼쪽 버튼 드래그로 변경하기 (값을 크게 변경할 때 사용합니다.)
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_35_kr.jpg)

2. 마우스 휠로 변경하기 (값을 조금 키우거나 줄일 때 사용합니다.)

    ![](/img/sw/rplus2/manager/rplusmanager2_36_kr.jpg)

3. 키보드 방향키로 변경하기 (값을 미세하게 키우거나 줄일 때 사용합니다.)

    ![](/img/sw/rplus2/manager/rplusmanager2_37_kr.jpg)

4. 값 직접 입력하기 (간단한 연산 식(덧셈, 뺄셈)의 입력이 가능합니다.)

    ![](/img/sw/rplus2/manager/rplusmanager2_38_kr.jpg)
...
2. 우측 상단의 “펌웨어 정보” 버튼을 클릭합니다.
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_39_kr.jpg)

3. 선택된 제품의 펌웨어 버전, 배포일, 업데이트 노트를 확인할 수 있습니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_40_kr.jpg)
...
2. 윈도우 시작 버튼을 클릭한 후, 설정 메뉴를 클릭합니다.
    ...
    ![](/img/sw/rplus2/manager/rplusmanager2_41_kr.jpg)

3. 장치 메뉴를 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_42_kr.jpg)

4. 좌측의 Bluetooth를 선택한 후, Bluetooth 장치를 켭니다.
5. 검색된 블루투스 모듈을 찾아 선택한 후, 연결 버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_43_kr.jpg)

6. 장치 암호입력란에 0000을 입력한 후, 다음 버튼을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_44_kr.jpg)

7. 페어링이 완료되면 페어링된 장치를 선택한 후, 하단의 “추가 Bluetooth 옵션”을 클릭합니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_45_kr.jpg)

8. COM 포트 탭을 클릭한 후, 송신 포트의 포트 번호를 확인합니다. (아래 그림에서는 COM7)

    ![](/img/sw/rplus2/manager/rplusmanager2_46_kr.jpg)

9. R+ Manager 2.0에서 설치된 블루투스 포트를 선택하면 무선으로 관리 기능을 사용할 수 있습니다.

    ![](/img/sw/rplus2/manager/rplusmanager2_47_kr.jpg)
...
[XL-320, XM 시리즈, XH 시리즈]: /docs/dxl/model_reference/x_series/x_series
[PRO 시리즈]: /docs/dxl/model_reference/pro_series/pro_series
[P 시리즈]: /docs/dxl/model_reference/p_series/p_series
[ROBOTIS DREAM]: https://docs.robotis.com/docs/edu/
[ROBOTIS SMART]: https://docs.robotis.com/docs/edu/
[ROBOTIS SMART2]: https://docs.robotis.com/docs/edu/
[ROBOTIS IoT]: https://docs.robotis.com/docs/edu/
[ROBOTIS MINI]: https://docs.robotis.com/docs/edu/
[USB 드라이버 설치]: https://docs.robotis.com/docs/popup/usb_driver_install/
[LN-101 드라이버 설치]: https://docs.robotis.com/docs/parts/interface/ln-101/#드라이버-설치-확인

---
id: getting_started
title: "OpenCM IDE - Getting Started"
sidebar_label: "Getting Started"
sidebar_position: 1
tags: [software, opencm_ide]
---
...
**주의** : OpenCM IDE는 더이상 업데이트되지 않습니다. [Arduino IDE](/docs/software/arduino_ide)사용을 권장드립니다.
...
![img](/img/software/opencm_ide/opencm9.04_windows1.jpg)
...
![img](/img/software/opencm_ide/opencm9.04_windows2.png)
...
![img](/img/software/opencm_ide/opencm9.04_windows3.png)          
...
![img](/img/software/opencm_ide/opencm9.04_windows4.png)

그 장치를 선택하고 “마우스 오른쪽 버튼  드라이버 소프트웨어 업데이트”를 실행 합니다.

![img](/img/software/opencm_ide/opencm9.04_windows5.png)

다음으로 “컴퓨터에서 드라이버 소프트웨어 찾아보기”를 선택한다.

![img](/img/software/opencm_ide/opencm9.04_windows6.png)

“찾아보기”를 클릭해서 위에서 압축을 해제한 디렉토리(ROBOTIS\drivers)를 지정한다

![img](/img/software/opencm_ide/opencm9.04_windows7.png)

다음을 클릭하면 설치가 진행된다.

![img](/img/software/opencm_ide/opencm9.04_windows8.png)

성공적으로 USB 드라이버를 설치하였다면 아래와 같이 “드라이버 소프트웨어를 업데이트했습니다”라는 창이 나타난다.

![img](/img/software/opencm_ide/opencm9.04_windows9.png)
...
![img](/img/software/opencm_ide/opencm9.04_windows10.png)

#### ROBOTIS OpenCM.exe 실행

압축을 푼 디렉토리(\ROBOTIS)에 ROBOTIS_OpenCM.exe 파일을 더블클릭 한다.

![img](/img/software/opencm_ide/opencm9.04_windows11.png)

그러면 아래와 같이 ROBOTIS OpenCM 툴이 실행된다.

![img](/img/software/opencm_ide/opencm9.04_windows12.png)

##### Blink 예제를 Open

파일 → 예제 → 01.Basics → b_Blinlk 순으로 선택한다.

![img](/img/software/opencm_ide/opencm9.04_windows13.png)

##### 보드 선택

도구 → 보드에서 ROBOTIS OpenCM9.04를 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_windows14.png)

##### 시리얼 포트 선택

반드시 이전 단계에서 확인했던 COM 포트 번호를 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_windows15.png)

##### 다운로드 수행

아래에서 표시된 다운로드 버튼을 클릭합니다. 다운로드가 시작되는 동안 보드의 녹색 LED가 계속 켜집니다. 다운로드가 끝나면 보드가 리셋되고 Blink 예제가 실행되면서 LED가 깜빡입니다.

![img](/img/software/opencm_ide/opencm9.04_windows16.png)
...
![img](/img/software/opencm_ide/opencm9.04_26.jpg)
...
![img](/img/software/opencm_ide/opencm9.04_mac1.png)

다운로드가 완료되면 아래 dmg파일을 더블 클릭해서 Mount를 진행합니다.

![img](/img/software/opencm_ide/opencm9.04_mac2.png)

마운트 후 설치창이 뜨면 마우스로 ROBOTIS 아이콘을 Application 쪽으로 드래그 합니다.

![img](/img/software/opencm_ide/opencm9.04_mac3.png)

그러면 다음과 같이 설치가 진행됩니다.

![img](/img/software/opencm_ide/opencm9.04_mac4.png)

#### ROBOTIS OpenCM 실행

Finder를 이용해서 Application 폴더를 보면 ROBOTIS.app 응용프로그램 패키지가 있고 이것을 더블클릭해서 실행합니다.

![img](/img/software/opencm_ide/opencm9.04_mac5.png)

아래와 같은 그림에서 Open 버튼을 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_mac6.png)

아래와 같이 ROBOTIS OpenCM이 실행됩니다.

![img](/img/software/opencm_ide/opencm9.04_mac7.png)

#### Blink 예제 Open

파일 → Examples → 01. Basics → b_Blink 순으로 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_mac8.png)

#### 보드 선택

ROBOTIS OpenCM9.04를 선택합니다.

![img](/img/software/opencm_ide/opencm9.04_mac9.png)

#### 시리얼 포트 선택

tty.usbmodemXXX로 선택합니다. 뒤의 숫자는 PC마다 다릅니다.

![img](/img/software/opencm_ide/opencm9.04_mac10.png)
...
![img](/img/software/opencm_ide/opencm9.04_mac11.png)
...
![img](/img/software/opencm_ide/opencm_ide_027.png)

압축을 풀면 아래와 같이 ROBOTIS 폴더가 생성됩니다.

![img](/img/software/opencm_ide/opencm_ide_028.png)
...
![img](/img/software/opencm_ide/opencm_ide_029.png)
...
![img](/img/software/opencm_ide/opencm_ide_030.png)
...
![img](/img/software/opencm_ide/opencm_ide_031.png)

#### ROBOTIS OpenCM 실행

아래와 같이 ROBOTIS_OpenCM를 더블 클릭하거나 터미널에서 ./ROBOTIS_OpenCM을 입력후 엔터를 하면 실행합니다.

![img](/img/software/opencm_ide/opencm_ide_032.png)

실행 버튼을 클릭합니다.

![img](/img/software/opencm_ide/opencm_ide_033.png)

그러면 아래와 같이 실행됩니다.

![img](/img/software/opencm_ide/opencm_ide_034.png)

#### Blink 예제 열기

파일 → 예제 → 01. Basics → b_Blink 순으로 선택합니다.

![img](/img/software/opencm_ide/opencm_ide_035.png)

#### 보드선택

도구 → 보드에서 ROBOTIS OpenCM9.04를 선택합니다.

![img](/img/software/opencm_ide/opencm_ide_036.png)
...
![img](/img/software/opencm_ide/opencm_ide_037.png)
...
![img](/img/software/opencm_ide/opencm_ide_038.png)
...
![img](/img/software/opencm_ide/opencm_ide_039.png)

|항목|설명|
|:---:|:---:|
|Menu |  파일, 편집, 스케치, 도구, 도움말 선택 할 수 있는 영역 입니다.|
|Toolbar | 자주 쓰는 버튼을 단축 아이콘으로 표시한 영역 입니다.|
|![img](/img/software/opencm_ide/opencm_ide_040.gif) | 컴파일만 수행하고 실패하거나 성공할 경우 상태바 또는 콘솔에 해당 메시지가 출력됩니다.|
|![img](/img/software/opencm_ide/opencm_ide_041.gif) | 컴파일을 수행한 후 곧바로 다운로드를 수행합니다. 보드가 반드시 연결된 상태로 실행해야 합니다.|
|![img](/img/software/opencm_ide/opencm_ide_042.gif) | 새 파일을 시작합니다.|
|![img](/img/software/opencm_ide/opencm_ide_043.gif) |파일 불러오기를 수행합니다.|
|![img](/img/software/opencm_ide/opencm_ide_044.gif) |현재 상태를 저장합니다.|
|![img](/img/software/opencm_ide/opencm_ide_045.gif) |시리얼 모니터를 실행 합니다.|
...
![img](/img/software/opencm_ide/opencm9.04_ide2.png)
...
![img](/img/software/opencm_ide/opencm9.04_ide3.png)

그리고 이러한 자동 하이라이트(Auto highlight) 기능은 아래 경로의 keyword.txt 파일을 이용해서 얼마든지 수정하거나 추가할 수 있습니다,

![img](/img/software/opencm_ide/opencm9.04_ide4.png)

![img](/img/software/opencm_ide/opencm9.04_ide5.png)

#### 자동포맷 기능 사용
도구 →자동포맷 기능을 활용하면 뒤죽박죽으로 타이핑한 코드들이 보기 좋게 정렬이 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide6.jpg)

아래와 같은 코드가 Ctrl+T만 누르면 한번에 보기 좋게 코드가 정렬이 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide7.jpg)

#### 주석 처리 및 해제
아래 편집→주석추가/주석삭제를 선택하거나 단축키 Ctrl+/를 누르면 주석처리가 되고 다시 한번 더 누르면 주석이 해제 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide8.jpg)

![img](/img/software/opencm_ide/opencm9.04_ide9.png)

위와 같이 블록 처리를 하고 나서 Ctrl+/를 누르면 아래와 같이 주석 처리가 됩니다.

![img](/img/software/opencm_ide/opencm9.04_ide10.png)
...
![img](/img/software/opencm_ide/opencm9.04_ide11.jpg)

Ctrl+&#125;를 계속해서 눌러보면 아래와 같이 오른쪽으로 한 탭씩 이동합니다.

![img](/img/software/opencm_ide/opencm9.04_ide12.png)

### 컴파일 및 다운로드 하기

코드를 작성하고 나면 컴파일 메뉴를 이용해 자신이 구현한 코드가 문법에 맞는지 오류가 없는지 체크하면서 프로그래밍을 하는 것이 좋습니다.

![img](/img/software/opencm_ide/opencm9.04_ide13.png)
...
![img](/img/software/opencm_ide/opencm9.04_ide15.png)

모든 코드가 에러 없이 컴파일이 잘된다면 다운로드를 해보자. 간단히 아래쪽 방향의 화살표를 누르면 컴파일과 다운로드를 한번에 수행하게 된다.

![img](/img/software/opencm_ide/opencm9.04_ide16.jpg)
...
![img](/img/software/opencm_ide/opencm9.04_ide19.jpg)

선택된 COM1번 포트를 통해 통신하고 싶다면 툴바 상단 오른쪽 시리얼 모니터 아이콘을 클릭하면 시리얼 모니터가 실행된다. 참고로 Ctrl + Shift + M 단축키를 눌러서 실행시킬 수 있습니다.

![img](/img/software/opencm_ide/opencm9.04_ide20.jpg)

![img](/img/software/opencm_ide/opencm9.04_ide21.jpg)
...
1. 스케치북 위치 : 사용자 기본 작업 디렉토리입니다. 기본적인 스케치 파일의 저장하기 및 불러오기 경로입니다.
    ...
    ![img](/img/software/opencm_ide/opencm9.04_ide24.png)

2. Editor language: 글꼴을 변경합니다.

    ![img](/img/software/opencm_ide/opencm9.04_ide25.png)
...
![img](/img/software/opencm_ide/opencm9.04lib1.png)
...
![img](/img/software/opencm_ide/opencm9.04lib2.png)

![img](/img/software/opencm_ide/opencm9.04lib3.png)
...
![img](/img/software/opencm_ide/opencm9.04lib4.jpg)

![img](/img/software/opencm_ide/opencm9.04lib5.png)
...
![img](/img/software/opencm_ide/opencm9.04restore1.png)
...
![img](/img/software/opencm_ide/opencm9.04restore2.jpg)
...
![img](/img/software/opencm_ide/opencm9.04_sensor.jpg)

주의할 점은 5핀에 할당된 핀들이 양쪽 40핀 IO에도 공유가 되어 있으므로 아래 쓰고 있는 포트에 할당된 IO핀은 헤더에서 쓰지 않아야 합니다.

![img](/img/software/opencm_ide/opencm9.04_sensor1.jpg)
...
2. 동작 확인
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor8.jpg)

3. 동작 코드
    DMS 센서 모듈과 같이 5핀 중에 3핀으로 구성된 센서는 그냥 아날로그 입력 핀만 계속 Read하면 됩니다. 별다른 초기 코드가 필요 없습니다.

    ![img](/img/software/opencm_ide/opencm9.04_sensor9.png)

### Gyro 센서
1. 연결도 및 센서 내부 구조
    로보티즈 자이로 센서도 마찬가지로 OpenCM9.04의 5핀 포트에 연결해서 X, Y 각속도(회전 가속도)를 측정할 수 있습니다.

    ![img](/img/software/opencm_ide/opencm9.04_sensor3.png)
...
2. 동작 코드
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor13.png)

    DMS 센서 모듈과 동일하게 루프에서 단순히 아날로그 핀값을 읽기만 하면 됩니다.

    ![img](/img/software/opencm_ide/opencm9.04_sensor14.jpg)
...
2. 동작 확인
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor15.png)
...
2. 동작 코드
    ...
    ![img](/img/software/opencm_ide/opencm9.04_sensor16.png)

    ![img](/img/software/opencm_ide/opencm9.04_sensor17.png)
...
![opencm9.04_digita1.jpg](/img/software/opencm_ide/opencm9.04_digita1.jpg)
...
![opencm9.04_digita2.jpg](/img/software/opencm_ide/opencm9.04_digita2.jpg)
...
![opencm9.04_digita9.png](/img/software/opencm_ide/opencm9.04_digita9.png)
...
![opencm9.04_digita3.jpg](/img/software/opencm_ide/opencm9.04_digita3.jpg)
...
![opencm9.04_digita4.jpg](/img/software/opencm_ide/opencm9.04_digita4.jpg)
...
![opencm9.04_digita5.jpg](/img/software/opencm_ide/opencm9.04_digita5.jpg)
...
![opencm9.04_digita6.jpg](/img/software/opencm_ide/opencm9.04_digita6.jpg)
...
![opencm9.04_digita7.jpg](/img/software/opencm_ide/opencm9.04_digita7.jpg)
...
![opencm9.04_digita8.png](/img/software/opencm_ide/opencm9.04_digita8.png)

## 아날로그 입출력
아날로그 입력은 반드시 OpenCM9.04 실크스크린의 ANALOG IN 영역에 위치한 0번~9번핀만 아날로그 입력이 됩니다.  
아날로그 출력은 TIMER를 활용한 PWM출력을 통해 아날로그 출력을 대신합니다.

![opencm9.04_analog1.jpg](/img/software/opencm_ide/opencm9.04_analog1.jpg)

### 핀3번에 가변저항으로 아날로그 입력을 받습니다.

아래와 같이 3번핀에 가변저항을 연결하고 전압은 3.3V를 연결합니다.

![opencm9.04_analog2.jpg](/img/software/opencm_ide/opencm9.04_analog2.jpg)

![opencm9.04_analog3.jpg](/img/software/opencm_ide/opencm9.04_analog3.jpg)
...
![opencm9.04_analog4.jpg](/img/software/opencm_ide/opencm9.04_analog4.jpg)

![opencm9.04_analog5.jpg](/img/software/opencm_ide/opencm9.04_analog5.jpg)
...
![opencm9.04_analog6.jpg](/img/software/opencm_ide/opencm9.04_analog6.jpg)
...
![opencm9.04_analog7.jpg](/img/software/opencm_ide/opencm9.04_analog7.jpg)

OpenCM9.04에 다운로드 해보면 Status LED가 반복적으로 천천히 켜졌다가 꺼지는 동작을 합니다.

![img](/img/software/opencm_ide/opencm9.04_analog8.png)
...
![opencm9.04_serial1.jpg](/img/software/opencm_ide/opencm_ide_107.png)
...
![opencm9.04_serial2.jpg](/img/software/opencm_ide/opencm_ide_108.png)
...
![opencm9.04_serial3.png](/img/software/opencm_ide/opencm_ide_109.png)
...
![opencm9.04_serial4.png](/img/software/opencm_ide/opencm_ide_110.png)
...
![opencm9.04_serial5.jpg](/img/software/opencm_ide/opencm_ide_111.png)
...
![opencm9.04_interruption1.jpg](/img/software/opencm_ide/opencm9.04_interruption1.jpg)

![opencm9.04_interruption2.jpg](/img/software/opencm_ide/opencm9.04_interruption2.jpg)
...
![opencm9.04_interruption3.png](/img/software/opencm_ide/opencm9.04_interruption3.png)
...
![opencm9.04_dynamixel.png](/img/software/opencm_ide/opencm9.04_dynamixel.png)
...
![opencm9.04_dynamixel1.png](/img/software/opencm_ide/opencm9.04_dynamixel1.png)
...
![opencm9.04_dynamixel2.png](/img/software/opencm_ide/opencm9.04_dynamixel2.png)
...
![opencm9.04_dynamixel3.png](/img/software/opencm_ide/opencm9.04_dynamixel3.png)
...
![opencm9.04_dynamixel4.png](/img/software/opencm_ide/opencm9.04_dynamixel4.png)
...
![opencm9.04_dynamixel5.png](/img/software/opencm_ide/opencm9.04_dynamixel5.png)
...
![opencm9.04_dynamixel6.png](/img/software/opencm_ide/opencm9.04_dynamixel6.png)

E-manual에서 150도에 해당하는 위치는 아래의 그림과 같이 512 와 매칭됨을 확인할 수 있습니다.   

![opencm9.04_dynamixel7.png](/img/software/opencm_ide/opencm9.04_dynamixel7.png)
...
![opencm9.04_dynamixel8.png](/img/software/opencm_ide/opencm9.04_dynamixel8.png)
...
![opencm9.04_dynamixel9.png](/img/software/opencm_ide/opencm9.04_dynamixel9.png)
...
![opencm9.04_dynamixel10.png](/img/software/opencm_ide/opencm9.04_dynamixel10.png)
...
![opencm9.04_dynamixel11.png](/img/software/opencm_ide/opencm9.04_dynamixel11.png)
...
![opencm9.04_dynamixel12.png](/img/software/opencm_ide/opencm9.04_dynamixel12.png)
...
![opencm9.04_dynamixel13.png](/img/software/opencm_ide/opencm9.04_dynamixel13.png)
...
![opencm9.04_dynamixel14.png](/img/software/opencm_ide/opencm9.04_dynamixel14.png)
...
RC-100 통신 패킷에 대해서는 [RC-100](/docs/parts/communication/rc-100)을 참고하세요

### RC-100B + BT-100 or BT-210 을 이용한 블루투스 연결

![img](/img/software/opencm_ide/opencm9.04_rc100_2.jpg)

> 블루투스를 이용해서 RC100 조종기와 연결하기

### RC-100B + ZIG-100/ZIG-110A를 이용한 지그비 연결

![img](/img/software/opencm_ide/opencm9.04_20.png)
...
![img](/img/software/opencm_ide/opencm904_04.png)

![img](/img/software/opencm_ide/opencm9.04_rc100_4.png)
...
![img](/img/software/opencm_ide/opencm9.04_rc100_5.jpg)

![img](/img/software/opencm_ide/opencm9.04_rc100_6.png)
...
![img](/img/software/opencm_ide/opencm9.04_rc100_7.png)
...
![img](/img/software/opencm_ide/opencm9.04_bkp1.jpg)

예제를 선택하면 아래와 같은 코드가 나타납니다.

![img](/img/software/opencm_ide/opencm9.04_bkp2.jpg)
...
![img](/img/software/opencm_ide/opencm9.04_bkp3.jpg)

![img](/img/software/opencm_ide/opencm9.04_bkp4.jpg)

![img](/img/software/opencm_ide/opencm9.04_bkp5.jpg)

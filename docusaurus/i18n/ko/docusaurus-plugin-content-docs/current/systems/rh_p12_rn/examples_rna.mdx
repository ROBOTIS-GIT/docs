...
3. 솔루션을 빌드 후 실행 하세요.
    - Windows SDK 버전이 달라서 아래의 **에러메세지가 발생**한 경우 
      ...
      ![img](/img/systems/rh_p12_rn/windows_sdk_ver.webp)  
...
- **연결후 실행화면** : 포트이름 및 Baudrate 정보 표시. 키보드의 아무키를 누르면, 제어모드 화면으로 넘어갑니다.  
    ![img](/img/systems/rh_p12_rn/rh_p12_rna/windows_example_execute.webp)  
- **전류기반 위치 제어 모드** 실행화면  
    ![img](/img/systems/rh_p12_rn/rh_p12_rna/windows_example_position_mode.webp)  
- **전류제어 모드** 실행화면  
    ![img](/img/systems/rh_p12_rn/rh_p12_rna/windows_example_current_mode.webp)

...
[R+ Manager 2.0](/docs/software/dynamixel_wizard_2_0/basic_features#펌웨어-복구)으로 펌웨어 복구하기.  
[다이나믹셀 위자드 2.0](/docs/software/dynamixel_wizard_2_0/basic_features#펌웨어-복구)으로 펌웨어 복구하기.
...
|  1  | ![](/img/systems/rh_p12_rn/rh_p12_rn/rh-p12-rn_finger_new.webp) | 0 ~ 106 mm | 2019.11.04 |
...
|  다이어그램  |       ![](/img/common/jst_b4beha_diagram.webp)       |             ![](/img/common/molex_5304706_diagram.webp)              |
|    하우징    |                        [JST EHR-04]                        |    ![](/img/common/molex_510210600.webp)<br />[MOLEX 51021-0600]     |
|   PCB 헤더   | ![](/img/systems/rh_p12_rn/rh_p12_rn/jst_b4beha.webp)<br />[JST B4B-EH-A] |    ![](/img/common/molex_530470610.webp)<br />[MOLEX 53047-0610]     |

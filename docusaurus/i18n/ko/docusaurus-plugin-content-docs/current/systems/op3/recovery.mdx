...
import RecoveryRev2 from '@site/docs/systems/op3/_partials/recovery_rev2.mdx';
...
1. Go to boot manager : Press **F10**  
	![](/img/systems/op3/recovery/op3_recovery_01_nuc10.webp)  
2. Select the boot device : Recovery USB media  
	![](/img/systems/op3/recovery/op3_recovery_02_nuc10.webp)  
3. Select the image : `Clonezilla live (VGA 800x600)`  
	![](/img/systems/op3/recovery/op3_recovery_03_nuc10.webp)  
4. Recovery will automatically start, and the PC will turn off when it's done.  
	![](/img/systems/op3/recovery/op3_recovery_04_nuc10.webp)  

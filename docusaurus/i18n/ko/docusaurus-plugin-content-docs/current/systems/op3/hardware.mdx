...
import HardwareRev2 from '@site/docs/systems/op3/_partials/hardware_rev2.mdx';
...
![](/img/systems/op3/hardware/op3_assemble_data.webp)
...
![](/img/systems/op3/hardware/ROBOTIS_OP3-Skin_Ver1.webp)

![](/img/systems/op3/hardware/ROBOTIS-OP3-Skin_THORMANG3-Style.webp)

![](/img/systems/op3/hardware/ROBOTIS-OP3-Skin_OP2-style.webp)

...
import HardwareRev2 from '@site/docs/_partials/systems/op3/hardware_rev2.mdx';
...
![](/img/systems/op3/op3_assemble_data.webp)
...
![](/img/systems/op3/ROBOTIS_OP3-Skin_Ver1.webp)

![](/img/systems/op3/ROBOTIS-OP3-Skin_THORMANG3-Style.webp)

![](/img/systems/op3/ROBOTIS-OP3-Skin_OP2-style.webp)

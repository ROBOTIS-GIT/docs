...
import QuickStartRev2 from '@site/docs/_partials/systems/op3/quick_start_rev2.mdx';
...
![](/img/systems/op3/op3_010_rev2.webp)
...
![](/img/systems/op3/op3_011_rev2.webp)
...
![](/img/systems/op3/op3_013_rev2.webp)
...
![](/img/systems/op3/op3_014_rev2.webp)
...
![](/img/systems/op3/op3_015_rev2.webp)
...
![](/img/systems/op3/op3_016_rev2.webp)
...
- Start Autonomous Soccer Mode
  1. Press the `MODE` button until LED1 (red) is lit.  
    ...
    ![](/img/systems/op3/op3_017_rev2.webp)
...
- Start Interactive Motion Mode
  1. Press the `MODE` button until LED 3 (blue) is lit. ROBOTIS OP3 will verbally announce “Interactive motion mode”.  
    ![](/img/systems/op3/op3_019_rev2.webp)
  ...
  3. The ROBOTIS OP3 will perform the following actions sequentially.  
    ![](/img/systems/op3/op3_020_rev2.webp)
...
- Start Vision Processing Mode
  1. Press the `MODE` button until LED 2 (green) is lit. ROBOTIS OP3 will verbally announce “Vision processing mode”.  
    ![](/img/systems/op3/op3_018_rev2.webp)
...
1. Press PC power button which is located on the belly. ROBOTIS OP3 will verbally announce “bye-bye” and initiate shutdown process.  
  ![](/img/systems/op3/op3_021_rev2.webp)  
...
2. If ROBOTIS OP3 does not announce “bye-bye” then you may need to force shutdown by holding the power button until the blue LED in the chest turns off.  
  ![](/img/systems/op3/op3_022_rev2.webp)
...
![](/img/systems/op3/op3_026_rev3.webp)
...
![](/img/systems/op3/op3_029_rev3.webp)
...
![](/img/systems/op3/op3_030_rev2.webp)

### ROBOTIS-OP3 Revision
Different OP3 revisions can be identified by the included internal master PC.

![](/img/systems/op3/op3_rev1.webp)  

![](/img/systems/op3/op3_rev2.webp)  

![](/img/systems/op3/op3_rev3.webp)  
...
![](/img/systems/op3/opencr_gyro_axis.webp)
...
![](/img/systems/op3/opencr_angular_velocity_graph.webp)

#### Acceleration X/Y/Z
The following picture represents the direction of the accelerometer axes of OpenCR.

![](/img/systems/op3/opencr_acc_axis.webp)
...
![](/img/systems/op3/opencr_acc_graph.webp)
...
![](/img/systems/op3/opencr_gpio_pinout.webp)

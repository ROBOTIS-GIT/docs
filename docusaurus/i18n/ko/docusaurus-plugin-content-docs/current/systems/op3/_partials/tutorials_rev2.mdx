...
1. execution result screen  
    ...
    ![](/img/systems/op3/tutorials/op3_manager_01.webp)  
...
2. execution result of ROBOTIS-OP3(Init pose in RVIZ)  
    ...
    ![](/img/systems/op3/tutorials/op3_manager_02.webp)
...
- rviz screen  
  ...
  ![](/img/systems/op3/tutorials/op3_bringup_visualization_01.webp)  

  - TF Tree  

    ![](/img/systems/op3/tutorials/op3_bringup_visualization_04.webp)  
...
![](/img/systems/op3/tutorials/op3_gui_initial_pose.webp)
...
- Follow the below procedure to configure modules that control corresponding joint of ROBOTIS-OP3.  
    ...
    2. Confirm from the joint status table below the module buttons that corresponding joints are set correctly.  
      ![](/img/systems/op3/tutorials/op3_gui_set_module.webp)

- `Get Mode` button will report which module is assigned for each joint.  

  ![](/img/systems/op3/tutorials/op3_gui_get_module.webp)
...
![](/img/systems/op3/tutorials/op3_gui_walking_tuner_01.webp)

![](/img/systems/op3/tutorials/op3_gui_walking_tuner_02.webp)

##### Start / Stop Walking
1. `start` button : Initiate walking  
2. `stop` button : Stop walking. When stopped, walking related parameters will be reset.  

  ![](/img/systems/op3/tutorials/op3_gui_walking_tuner_03.webp)
...
3. `Apply` button : Apply modified parameters from the GUI to `walking_module`.  
  ...
  ![](/img/systems/op3/tutorials/op3_gui_walking_tuner_04.webp)
...
2. Select `Motion` tab of the gui demo program.
    ...
    ![](/img/systems/op3/tutorials/op3_gui_action_01.webp)

3. Click the action button to play  

    ![](/img/systems/op3/tutorials/op3_gui_action_02.webp)
...
2. Select `Head Control` tab of the gui demo program.  
  ![](/img/systems/op3/tutorials/op3_gui_control_head_01.webp)
...
3. Change the value for the specific joint.  
  ...
  ![](/img/systems/op3/tutorials/op3_gui_control_head_02.webp)  
  ![](/img/systems/op3/tutorials/op3_gui_control_head_03.webp)  
...
- Preparation : Set the module and move to the tab
  ...
  2. Select `Online Walking` tab of the gui demo program.
    ...
    ![](/img/systems/op3/tutorials/op3_online_walking_01.webp)
...
- Controlling walking of ROBOTIS-OP3
  ...
  4. Send a walking command to `op3_manager`
    ...
    ![](/img/systems/op3/tutorials/op3_online_walking_02.webp)
...
![](/img/systems/op3/tutorials/op3_offset_tuner_diagram.webp)  
...
![](/img/systems/op3/tutorials/op3_offset_tuner_diagram.webp)  
- After   
![](/img/systems/op3/tutorials/op3_tuner_diagram.webp)  
...
!<a href="/img/systems/op3/tutorials/op3_tuner_execution.webp" target="_blank">launch image</a>
...
![](/img/systems/op3/tutorials/op3_tuner_offset_01.webp)  
1. go `Initial Pose`   
...
![](/img/systems/op3/tutorials/op3_tuner_gain_01.webp)  
1. go `Initial Pose`   
2. Select tab of `Kinematics Group`  
3. Click the `Refresh` Button for getting current states of joints  
...
1. Dynamic Reconfigure and Image View  
    ...
    - Open `Dynamic Reconfigure`   
      ...
      ![](/img/systems/op3/tutorials/ball_detector_node_01.webp)
...
2. Parameters    
  The description for each parameter will pop up when hovering the mouse cursor over each parameter.  
    ...
    ![](/img/systems/op3/tutorials/ball_detector_node_03.webp)
...
3. Description  
    ...
    - How to calibrate  
        ...
        - If you check the `use_second_filter` you can get an image which is detected with two HSV variations.   
          ...
          ![](/img/systems/op3/tutorials/ball_detector_node_04.webp)

        - If you check the `debug_image` you can check the HSV filtered, binary image.   

          ![](/img/systems/op3/tutorials/ball_detector_node_05.webp)
...
3. Set the walking parameters     
    ...
    ![](/img/systems/op3/tutorials/op3_online_walking_footstep_01.webp)

4. Set a interactive marker in rviz 3d screen and Move the marker to the target pose of feet.   

    ![](/img/systems/op3/tutorials/op3_online_walking_footstep_02.webp)

    ![](/img/systems/op3/tutorials/op3_online_walking_footstep_04.webp)

5. plan the path and send a walking message to ROBOTIS-OP3     

    ![](/img/systems/op3/tutorials/op3_online_walking_footstep_03.webp)

    ![](/img/systems/op3/tutorials/op3_online_walking_footstep_05.webp)
...
![](/img/systems/op3/op3_web_setting_01.webp)
...
##### Ball Detector parameters
  ![](/img/systems/op3/tutorials/op3_web_setting_02.webp)
...
##### Camera Setting parameters
  ![](/img/systems/op3/tutorials/op3_web_setting_06.webp)
  > Modified parameter values will be saved automatically.  
...
![](/img/systems/op3/tutorials/op3_manager_03.webp)  
...
```  
 ...
 - rqt_graph  
   ![](/img/systems/op3/tutorials/op3_read_write_graph.webp)
...
[op3_demo]: /docs/systems/op3/robotis_ros_packages#robotis-op3-demo
...
[How to create the motions]: /docs/systems/op3/tutorials#how-to-create-the-motions
...
[Online walking using footstep planner]: /docs/systems/op3/tutorials#how-to-control-upgraded-walking-using-footstep-planner
...
[op3_tuner_client]: /docs/systems/op3/robotis_ros_packages#op3-tuner-client
[op3_how_to_control_upgraded_walking]: /docs/systems/op3/tutorials#how-to-control-upgraded-walkingonline-walking
[humanoid_navigation]: /docs/systems/common/humanoid_navigation#humanoid-navigation
[How to run op3_manager]: /docs/systems/op3/robotis_ros_packages#op3-manager
...
[How to connect]: /docs/systems/op3/quick_start#example--ssh-client-for-windows
[detail of parameter]: /docs/systems/op3/tutorials#how-to-use-ball-detector

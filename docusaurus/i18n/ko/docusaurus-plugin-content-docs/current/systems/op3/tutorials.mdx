...
import TutorialsRev2 from '@site/docs/_partials/systems/op3/tutorials_rev2.mdx';
...
1. execution result screen  
    ...
    ![](/img/systems/op3/op3_bringup_ros2.webp)  
...
- rviz2 screen  
  ...
  ![](/img/systems/op3/op3_bringup_visualization_01_ros2.webp)  
...
- Execution result  
  ![](/img/systems/op3/op3_gui_ros2.webp)
...
![](/img/systems/op3/op3_gui_initial_pose_ros2.webp)
...
- Follow the below procedure to configure modules that control the corresponding joints of ROBOTIS-OP3.  
    ...
    2. Confirm from the joint status table below the module buttons that corresponding joints are set correctly.  
      ![](/img/systems/op3/op3_gui_set_module_ros2.webp)

- `Get Mode` button will report which module is assigned for each joint.  

  ![](/img/systems/op3/op3_gui_get_module_ros2.webp)
...
![](/img/systems/op3/op3_gui_walking_tuner_01_ros2.webp)
...
2. `stop` button : Stop walking. When stopped, walking related parameters will be reset.  
  ...
  ![](/img/systems/op3/op3_gui_walking_tuner_03_ros2.webp)
...
3. `Apply` button : Apply modified parameters from the GUI to the `walking_module`.  
  ...
  ![](/img/systems/op3/op3_gui_walking_tuner_04_ros2.webp)
...
2. Select `Motion` tab of the gui demo program.
    ...
    ![](/img/systems/op3/op3_gui_action_01_ros2.webp)

3. Click the action button to play  

    ![](/img/systems/op3/op3_gui_action_02_ros2.webp)
...
2. Select `Head Control` tab of the gui demo program.  
  ![](/img/systems/op3/op3_gui_control_head_01_ros2.webp)
...
3. Change the value for the specific joint.  
   ...
   3. Bring the head joint to center position.  
    ...
    ![](/img/systems/op3/op3_gui_control_head_02_ros2.webp)  
...
!<a href="/img/systems/op3/op3_tuner_execution_ros2.webp" target="_blank">launch image</a>
...
![](/img/systems/op3/op3_action_editor_tui.webp)
...
![](/img/systems/op3/op3_action_editor_command_list.webp)
...
1. Dynamic Reconfigure and Image View  
    ...
    - Open `Dynamic Reconfigure`   
      ...
      ![](/img/systems/op3/ball_detector_node_01_rev3.webp)

    - Open `Image View`  
      Select `Plugins -> Visualization -> Image View`  

      ![](/img/systems/op3/ball_detector_node_02_rev3.webp)
...
3. Description  
    ...
    - How to calibrate  
        ...
        - If you check the `use_second_filter` you can get an image which is detected with two HSV variations.   
          ...
          ![](/img/systems/op3/ball_detector_node_04_rev3.webp)

        - If you check the `debug_image` you can check the HSV filtered, binary image.   

          ![](/img/systems/op3/ball_detector_node_05_rev3.webp)
...
```  
 ...
 - rqt_graph  
   ![](/img/systems/op3/op3_read_write_graph_rev3.webp)

...
<details open>
<summary>
![](/img/common/icon_unfold.webp) **Option 1(Recommended) : Use U2D2 as a communication interface**
</summary>
...
<img src="/img/systems/openmanipulator_x/quick_start_guide/quick_start_guide/OpenManipulator_u2d2_setup2.webp" width="800" />
...
<details>
<summary>
![](/img/common/icon_unfold.webp) **Option 2 : Use OpenCR as a communication interface**
</summary>
...
<img src="/img/systems/openmanipulator_x/quick_start_guide/OpenManipulator_opencr_setup2.webp" width="800" />
...
3. Open the example from `File > Examples > OpenCR > 10.Etc > usb_to_dxl`  
  ![](/img/systems/openmanipulator_x/quick_start_guide/quick_start_guide/OpenManipulator_opencr_utd_setup.webp)  
  > Open the `usb to dxl` example.

4. Upload the example to OpenCR.  
  ![](/img/systems/openmanipulator_x/quick_start_guide/quick_start_guide/upload_use_to_dxl.webp)

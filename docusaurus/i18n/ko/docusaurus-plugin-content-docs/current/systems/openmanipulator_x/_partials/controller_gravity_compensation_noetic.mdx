...
Set your DYNAMXEL's Operating Mode to Current Mode via [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0/introduction)

![](/img/systems/openmanipulator_x/ros_controller/ros_controller_experiment/OpenMANIPULATORX_gravity_current_mode_setting.webp)

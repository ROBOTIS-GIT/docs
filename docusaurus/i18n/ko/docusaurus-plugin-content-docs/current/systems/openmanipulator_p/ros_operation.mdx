...
- The test is done on `ROS Melodic Morenia`installed in `Ubuntu 18.04`.
- Make sure ROS dependencies are installed before performing these instructions - [Install ROS Packages](/docs/systems/openmanipulator_p/ros_setup#install-ros-packages)
- Make sure to run [OpenMANIPULATOR-P controller](/docs/systems/openmanipulator_p/ros_controller_package#launch-controller) instructions before use of the instruction

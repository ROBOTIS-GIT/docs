...
## DYNAMIXEL Examples
OpenMANIPULATOR-P (RM-P60-RNH) is composed of [DYNAMIXEL-P](/docs/dxl/p). DYNAMIXEL has a modular form and adopts the daisy chain method. It allows users to easily add or remove joints for their own use.  

...
| DYNAMIXEL Pro<br />Model Name |                                                                                         Joint 1, 2 : [PH54-200-S500-R](/docs/dxl/model_reference/p_series/ph54-200-s500-r) (200W)<br />Joint 3, 4 : [PH54-100-S500-R](/docs/dxl/model_reference/p_series/ph54-100-s500-r)(100W)<br />Joint 5, 6 : [PH42-020-S300-R](/docs/dxl/model_reference/p_series/ph42-020-s300-r) (20W)                                                                                         |
...
## Dimension
![](/img/systems/openmanipulator_p/specification/dimension.webp)

If you have a gripper([RH-P12-RN(A)](/docs/systems/rh_p12_rn/)), see below.

![](/img/systems/openmanipulator_p/specification/dimension_with_gripper.webp)

## Workspace
![](/img/systems/openmanipulator_p/specification/ws1.webp)
  
![](/img/systems/openmanipulator_p/specification/ws2.webp)  

## Home Position
The diagram below shows the “home position” of DYNAMIXEL-P from OpenMANIPULATOR-P.

![](/img/systems/openmanipulator_p/specification/home_position.webp)

## D-H Configuration
![](/img/systems/openmanipulator_p/specification/d_h_configuration.webp)
...
|:----:|:---------------:|:---------------:|:----------------:|:----------------:|:---------------------------------------------------------------:|
|  1   |        0        |     -&pi;/2     |        0         |        0         |                                0                                |
|  2   |     265.69      |        0        |        0         |        0         | ![](/img/systems/openmanipulator_p/specification/d_h_eq_001.gif) |
|  3   |       30        |     -&pi;/2     |        0         |        0         | ![](/img/systems/openmanipulator_p/specification/d_h_eq_002.gif) |
|  4   |        0        |     -&pi;/2     |       258        |        0         |                                0                                |
|  5   |        0        |     -&pi;/2     |        0         |        0         |                                0                                |
|  6   |        0        |        0        |        0         |        0         |                                0                                |
...
![](/img/systems/openmanipulator_p/specification/mass1.webp)

Total Mass : 5,324g

### Link 1

![](/img/systems/openmanipulator_p/specification/mass2.webp)
...
![](/img/systems/openmanipulator_p/specification/mass3.webp)
...
![](/img/systems/openmanipulator_p/specification/mass4.webp)
...
![](/img/systems/openmanipulator_p/specification/mass5.webp)
...
![](/img/systems/openmanipulator_p/specification/mass6.webp)

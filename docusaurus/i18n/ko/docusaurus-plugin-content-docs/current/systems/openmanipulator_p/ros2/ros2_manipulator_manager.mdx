...
**NOTE**:
If you have a gripper([RH-P12-RN(A)](/docs/systems/rh_p12_rn/rh_p12_rna)), download the [source code of RH-P12-RN](https://github.com/ROBOTIS-GIT/RH-P12-RN.git) from GitHub and integrate the gripper module following the RH-P12-RN repository instructions.

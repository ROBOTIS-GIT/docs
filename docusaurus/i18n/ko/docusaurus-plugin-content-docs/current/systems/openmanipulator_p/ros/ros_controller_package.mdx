...
if DYNAMIXEL aren't recoginized, please check firmware with ROBOTIS software ([R+ Manager 2.0](/docs/software/dynamixel/dynamixel_wizard2) or [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel/dynamixel_wizard2#firmware-update))

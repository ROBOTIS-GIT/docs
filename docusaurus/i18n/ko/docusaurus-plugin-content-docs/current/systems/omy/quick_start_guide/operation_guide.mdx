...
<div style={{textAlign: 'center'}}><em>Real-time synchronized motion between Leader and Follower.</em></div>
...
<div style={{textAlign: 'center'}}><em>Smooth, gravity-compensated motion of the Leader arm</em></div>

...
![](/img/systems/op3/arduino_examples_op3/op3_opencr_01.webp)
...
![](/img/systems/op3/arduino_examples_op3/op3_opencr_02.webp)
...
![](/img/systems/op3/arduino_examples_op3/op3_opencr_03.webp)
...
![](/img/systems/op3/arduino_examples_op3/op3_opencr_04.webp)
Since the example provided is Read-Only, select OK to save it as a new file.


![](/img/systems/op3/arduino_examples_op3/op3_opencr_05.webp)

Save it to a new folder and edit it. Once editing is complete, repeat the process of building and downloading the firmware.

![](/img/systems/op3/arduino_examples_op3/op3_opencr_06.webp)

[Install Arduino IDE and OpenCR]: /docs/systems/common/arduino_setup_linux#arduino-setup-linux

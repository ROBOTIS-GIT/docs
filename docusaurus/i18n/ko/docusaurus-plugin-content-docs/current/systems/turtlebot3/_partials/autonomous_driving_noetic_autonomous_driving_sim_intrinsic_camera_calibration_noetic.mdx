...
<details>
<summary>
![](/img/icon_unfold.webp) **Click to expand : Intrinsic Camera Calibration with an actual TurtleBot3**
</summary>
...
- For detailed information on the camera calibration, see [Camera Calibration manual](http://wiki.ros.org/camera_calibration) from ROS Wiki.
  ...
  ![](/img/systems/turtlebot3/autonomous_driving/autorace_checkerboard.webp)
...
4. Use the checkerboard to calibrate the camera, and click **CALIBRATE**.
   ...
   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_before_intrinsic_calibration.webp)

5. Click **Save** to save the intrinsic calibration data.

   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_after_intrinsic_calibration.webp)

6. **calibrationdata.tar.gz** folder will be created at **/tmp** folder.

   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_calibration_data_tar_gz.webp)

7. Extract **calibrationdata.tar.gz** folder, and open **ost.yaml**.

   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_ost_yaml_file.webp)

   > ost.yaml

   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_ost_yaml.webp)

   > Intrinsic Calibration Data in ost.yaml

8. Copy and paste the data from **ost.yaml** to **camerav2_320x240_30fps.yaml**.

   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_camerav2_yaml.webp)

   > camerav2_320x240_30fps.yaml

   ![](/img/systems/turtlebot3/autonomous_driving/noetic_rpi_camerav2_320x240.webp)

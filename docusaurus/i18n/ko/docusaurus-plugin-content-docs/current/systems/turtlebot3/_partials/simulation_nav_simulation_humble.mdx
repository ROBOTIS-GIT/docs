...
3. Repeat step 1 and 2 until the LDS sensor data is overlaid on the saved map. 
  ![](/img/systems/turtlebot3/tb3_navigation2_rviz_01.webp)
...
2. Click on the map to set the destination of the robot and drag the green arrow toward the direction where the robot will be facing. 
  ...
  ![](/img/systems/turtlebot3/tb3_navigation2_rviz_02.webp)
...
<details>
<summary>
![](/img/common/icon_unfold.webp) Read more about **Navigation2**
</summary>

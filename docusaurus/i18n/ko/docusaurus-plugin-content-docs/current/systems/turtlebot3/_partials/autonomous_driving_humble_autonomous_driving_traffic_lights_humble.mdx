...
7. In one window, select the `/detect/image_traffic_light/compressed` topic. In another window, select one of the four topics to view the masked images:   
   `/detect/image_red_light`, `/detect/image_yellow_light`, `/detect/image_green_light`, `/detect/image_traffic_light`.
    ...
    <img src="/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_detect_traffic_light_green.webp" width="800" />
    > Detecting the Yellow light. The image on the right displays `/detect/image_yellow_light` topic.

    <img src="/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_detect_traffic_light_yellow.webp" width="800" />
    > Detecting the Yellow light. The image on the right displays `/detect/image_yellow_light` topic.

    <img src="/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_detect_traffic_light_red.webp" width="800" />
...
9.  Adjust the parameters in `/detect/traffic_light` to adjust the configuration of each masked image topic.
    ...
    <img src="/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_traffic_light_reconfigure.webp" width="900" />
...
```
      ...
      ![](/img/systems/turtlebot3/autonomous_driving/autonomous_driving/humble_traffic_light_yaml.webp)

...
### Bumper
 * Device - [Touch_sensor (TS-10)](/docs/parts/sensor/ts-10)
...
**Tip :** If you want to use another PIN, refer to [OpenCR PIN Map](/docs/parts/controller/opencr10).
...
This example can be open [Arduino IDE](/docs/parts/controller/opencr10#arduino-ide).
...
**WARNING** : If you upload examples to OpenCR, you have to re-upload [turtlebot3_core](/docs/systems/turtlebot3/quick_start_guide/opencr_setup#opencr-setup).


### IR
* Device - [IR_sensor (IRSS-10)](/docs/parts/sensor/irss-10)

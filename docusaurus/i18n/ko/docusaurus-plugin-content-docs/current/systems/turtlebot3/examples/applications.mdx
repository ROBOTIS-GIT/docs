...
```
    ...
    ![](/img/systems/turtlebot3/basic_examples/panorama/panorama_view.webp)
...
```
    ...
    ![](/img/systems/turtlebot3/basic_examples/automatic_parking/scan.webp)

    - `/scan_spot`

    ![](/img/systems/turtlebot3/basic_examples/automatic_parking/scan_spot.webp)
...
```
    ...
    ![](/img/systems/turtlebot3/basic_examples/load_multiple_turtlebot3s/multi_turtlebot_rqt.webp)

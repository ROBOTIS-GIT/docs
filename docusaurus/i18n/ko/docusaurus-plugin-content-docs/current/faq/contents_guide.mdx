...
[performance graph]: /img/dxl/model_reference/x_series/xh430_w210_performance_graph.webp
```

![성능그래프][image reference]

[image reference]: /img/dxl/model_reference/x_series/xh430_w210_performance_graph.webp
...
[link reference]: /docs/faq
```text
[컨텐츠 작성방법][Contents Format]

[Contents Format]: /docs/faq
```

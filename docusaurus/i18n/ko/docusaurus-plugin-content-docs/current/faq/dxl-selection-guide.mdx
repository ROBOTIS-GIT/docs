...
<details>
<summary>
![](/img/icon_unfold.png) **팁**: **TTL과 RS-485를 같이 사용할 수 있는 방법이 있나요?**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) **팁**: **다이나믹셀 통신회로 (TTL)**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) **팁**: **다이나믹셀 통신 회로 (RS-485)**
</summary>
...
ROS 공식 플랫폼인 [TurtleBot3](/docs/platform/turtlebot3/overview)의 제어기로 사용되었습니다. 
...
## 기타 제어기
로보티즈는 [다이나믹셀 시스템](/docs/platform)과 [교육용 키트](/docs/edu)에서 사용되는 다양한 제어기를 제공하고 있습니다. 자세한 내용은, [제어기](https://emanual.robotis.com/docs/en/parts/all-controller/) 페이지를 참고하세요.
...
### R+ Manager 2.0
[R+ Manager 2.0](/docs/software/rplus2/manager)은 로보플러스 소프트웨어 중 하나입니다.  

...
### R+ Manager 2.0
[R+ Manager 2.0](https://emanual.robotis.com/docs/en/software/rplus2/manager)은 로보플러스 소프트웨어 중 하나입니다.  
...
[다이나믹셀 SDK](/docs/software/dynamixel/dynamixel_sdk/overview)는 주요 OS(Windows, Mac, Linux)에서, 다양한 개발언어(C, C++, C#, Python, Java, Matlab and LabVIEW)를 지원하는 개발 키트 라이브러리입니다.   
...
### 로보플러스
CM 시리즈와 교육용 키트에서 사용할 수 있는 소프트웨어인, R+ (로보플러스)는 유저 친화적 프로그래밍 환경을 지원합니다. 더 많은 정보는 [로보플러스](/docs/software#로보플러스)를 참고하세요. 

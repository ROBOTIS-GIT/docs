...
**참고**: 각 제품의 [다이나믹셀 프로토콜 호환표](/docs/popup/faq_protocol_compatibility_table) 참고하세요.
...
[DX]: /docs/dxl/model_reference/#dx-series/
[AX]: /docs/dxl/model_reference/#ax-series/
[RX]: /docs/dxl/model_reference/#rx-series/
[EX]: /docs/dxl/model_reference/#ex-series/
[MX]: /docs/dxl/model_reference/#mx-series/
[다이나믹셀-X]: /docs/dxl/model_reference/#x-series/
[다이나믹셀 PRO]: /docs/dxl/model_reference/#pro-series/
[다이나믹셀-P]: /docs/dxl/model_reference/#pro-plus-series/
[MX]: /docs/dxl/model_reference/#mx-series/
...
[펌웨어 복구]: /docs/software/dynamixel/dynamixel_wizard2#펌웨어-복구

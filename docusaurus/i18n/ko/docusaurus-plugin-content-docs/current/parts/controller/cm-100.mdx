...
![](/img/parts/controller/cm-100/cm100_figure.webp)
...
# 각 부 명칭
![](/img/parts/controller/cm-100/cm100_partname.webp)
...
![](/img/parts/controller/cm-100/cm100_port.webp)
...
- 전원 포트의 간단한 회로 구성은 다음과 같습니다. +부분에 전지의 +극을, -부분에 전지의 -극을 연결하면 됩니다.
  ...
  ![](/img/parts/controller/cm-100/cm100_vcc_gnd.webp)

# 작동 방법
 ![](/img/parts/controller/cm-100/ollo_2ndoperation.webp)
...
- PC와 연결하기 위한 자세한 정보는 [LN-101] 페이지에서 확인 할 수 있습니다.
 ...
 ![](/img/parts/controller/cm-100/ln101_connect.webp)
...
- CM-100A에는 ZIG-110 / BT-110 무선 통신 모듈을 연결할 수 있습니다.
 ...
 ![](/img/parts/controller/cm-100/cm100_zig110.webp)      

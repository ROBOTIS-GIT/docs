...
**참고**: [펌웨어 복구](/docs/software/dynamixel_wizard_2_0/basic_features#펌웨어-복구)
...
**참고**: 
- OpenCM 9.04의 [펌웨어를 최신으로 유지](/docs/software/dynamixel_wizard_2_0/basic_features#펌웨어-업데이트)해주세요.
...
[컨트롤 테이블 확인하기]: /docs/software/dynamixel_wizard_2_0/basic_features#다이나믹셀-컨트롤-테이블

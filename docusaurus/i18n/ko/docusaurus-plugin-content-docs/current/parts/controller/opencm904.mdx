...
![](/img/parts/controller/opencm904/dream_bat.webp)
...
#### OpenCM9.04를 아두이노 IDE에 포팅하기 (리눅스)
##### 환경설정 (리눅스)
...
##### 보드 매니저를 통해 OpenCM9.04 패키지 설치하기 (리눅스)
...
##### 보드 매니저를 통해 OpenCM9.04 패키지 설치하기 (맥)
Tools > Board > Boards Manager를 선택하고 아래와 같이 설치하십시오. (네트워크 사정에 따라 다르지만 20분정도 걸립니다.)
...
#### OpenCM9.04를 아두이노 IDE에 포팅하기 (윈도우즈)
##### 환경설정 (윈도우즈)
아두이노 IDE가 실행되면 File > Prefereneces를 클릭한 다음 아래의 주소를 Additional Boards Maanger URLs 텍스트상자에 입력하십시오.
...
##### 보드 매니저를 통해 OpenCM9.04 패키지 설치하기 (윈도우즈)
Tools > Board > Boards Manager를 선택하고 아래와 같이 설치하십시오. (네트워크 사정에 따라 다르지만 20분정도 걸립니다.)
...
**참고**: [펌웨어 복구](https://emanual.robotis.com/docs/en/software/rplus2/manager#펌웨어-복구)
...
## 다양한 X시리즈 사용하기
[DYNAMIXEL Channel](#dynamixel-channel-설정하기)을 설정하여, [다이나믹셀-X](/docs/dxl/model_reference/x_series/x_series#x-series)를 로보티즈가 제공하는 [소프트웨어](/docs/software#로보플러스) (R+ Task, R+ Motion 및 R+ Manager)에서 사용하실수 있습니다. 
...
**참고**: [OpenCM485 확장보드](/docs/parts/controller/opencm485exp)를 사용하면, 24V 다이나믹셀 및 RS485 통신이 사용 가능합니다.  
...
**참고**: 
- OpenCM 9.04의 [펌웨어를 최신으로 유지](https://emanual.robotis.com/docs/en/software/rplus2/manager#펌웨어-업데이트)해주세요.
...
1. R+ Manager를 실행 후, 홈 탭에서 **OpenCM 9.04**를 선택하세요.
    ...
    ![](/img/software/rplus2/manager/rplus_manager2_dxl_channel_setting_01_kr.webp)

2. **업데이트 & 테스트**를 클릭하세요.  

    ![](/img/software/rplus2/manager/rplus_manager2_dxl_channel_setting_02_kr.webp)
...
3. 컨트롤 테이블이 활성화 되면, 16번 **Dynamixel Channel** 주소에서 원하는 항목으로 변경 후 저장하세요. 예를 들어, 확장 보드에서 다이나믹셀 X시리즈를 사용하기 위해서는 **EXP Board(X-Series)** 을 선택 합니다. 
    ...
    ![](/img/software/rplus2/manager/rplus_manager2_dxl_channel_setting_03_kr.webp)
...
## 도면
![](/img/parts/controller/opencm904/floor_plan.webp)
...
[OpenCM9.04 C Type 펌웨어 복구하기]: https://emanual.robotis.com/docs/kr/edu/mini/#로보티즈-미니-제어기-펌웨어-업데이트/
[아두이노 IDE]: #아두이노-ide
...
[다이나믹셀 SDK]: /docs/software/dynamixel/dynamixel_sdk/overview
[DynamixelWorkbench]: /docs/software/dynamixel/dynamixel_workbench
[아두이노 라이브러리]: /docs/parts/controller/opencm904#라이브러리-api
[컨트롤 테이블 확인하기]: https://emanual.robotis.com/docs/en/software/rplus2/manager#다이나믹셀-컨트롤-테이블/
...
[USB 드라이버 설치]: /docs/popup/usb_driver_install

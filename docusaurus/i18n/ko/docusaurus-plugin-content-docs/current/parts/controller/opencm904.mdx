...
## 다양한 X시리즈 사용하기
[DYNAMIXEL Channel](#dynamixel-channel-설정하기)을 설정하여, [다이나믹셀-X](/docs/dxl/model_reference/x_series#x-series)를 로보티즈가 제공하는 [소프트웨어](/docs/software#로보플러스) (R+ Task, R+ Motion 및 R+ Manager)에서 사용하실수 있습니다. 

...
![](/img/parts/controller/opencm904/dream_bat.jpg)
...
**참고**: [펌웨어 복구](/docs/software/rplus2/manager#펌웨어-복구)
...
## 도면
![](/img/parts/controller/opencm904/floor_plan.png)
...
[컨트롤 테이블 확인하기]: /docs/software/rplus2/manager#다이나믹셀-컨트롤-테이블/

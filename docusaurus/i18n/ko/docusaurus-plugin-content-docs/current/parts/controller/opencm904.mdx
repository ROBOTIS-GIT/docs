...
**참고**: [펌웨어 복구](/docs/software/dynamixel_wizard_2_0#펌웨어-복구)
...
## 다양한 X시리즈 사용하기
[DYNAMIXEL Channel](#dynamixel-channel-설정하기)을 설정하여, [다이나믹셀-X](/docs/dxl/model_reference/x_series#x-series)를 로보티즈가 제공하는 [소프트웨어](/docs/software/overview#로보플러스) (R+ Task, R+ Motion 및 R+ Manager)에서 사용하실수 있습니다. 
...
**참고**: 
- OpenCM 9.04의 [펌웨어를 최신으로 유지](/docs/software/dynamixel_wizard_2_0#펌웨어-업데이트)해주세요.
...
[DynamixelWorkbench]: /docs/software/dynamixel_workbench
[아두이노 라이브러리]: /docs/parts/controller/opencm904#라이브러리-api
[컨트롤 테이블 확인하기]: /docs/software/dynamixel_wizard_2_0#다이나믹셀-컨트롤-테이블/

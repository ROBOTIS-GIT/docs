...
id: cm-150
title: "CM-150"
sidebar_label: "CM-150"
sidebar_position: 90
tags: [parts, controller]
---

![](/img/parts/controller/cm-150/cm-150_product.webp)

> CM-150 제어기

# 개요
- 드림에서 사용되는 제어기로, 드림의 각종 부품들([감속모터], [서보모터], [접촉센서], [LED모듈], [적외선센서] 등..)을 연결할 수 있습니다.
- [RoboPlus Manager] (1.0.30.0 이상 버전) 또는 [RoboPlus Manager 2.0]를 통해 펌웨어 복구를 할 수 있습니다.
- [RoboPlus Task] (1.1.0.0 이상 버전) 또는 [RoboPlus Task 2.0]를 통해 제어용 태스크 코드를 작성하여 각 부품들의 동작을 제어할 수 있습니다.
...
# 각 부 명칭
![](/img/parts/controller/cm-150/cm-150-2.webp)
...
![](/img/parts/controller/cm-150/8.webp)
...
![](/img/parts/controller/cm-150/cm-150-back_.webp)

# 작동 방법
![](/img/parts/controller/cm-150/ollo_2ndoperation.webp)
...
- PC와 연결하기 위한 자세한 정보는 [USB 드라이버 설치 페이지] 에서 확인 할 수 있습니다.

![](/img/parts/controller/cm-150/roboplus_4.webp)

> micro USB 케이블과 CM-150 제어기 연결 그림


# 무선 통신 모듈 연결하기
- CM-150 에는 [BT-210] / [BT-110] / [ZIG-110] / [BT-410] 무선 통신 모듈을 연결할 수 있습니다.

![](/img/parts/controller/cm-150/cm100_zig110.webp)
...
[RoboPlus Task 2.0]: https://emanual.robotis.com/docs/en/software/rplus2/task#시작하기/
...
[시작 버튼 눌림 횟수]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#시작버튼-눌림횟수/
[자동꺼짐타이머 바로가기]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#자동꺼짐-타이머/
[USB 드라이버 설치 페이지]: /docs/popup/usb_driver_install

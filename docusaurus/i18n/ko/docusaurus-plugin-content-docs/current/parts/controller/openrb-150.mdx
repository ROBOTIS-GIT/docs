...
|     다이어그램      |        ![](/img/common/jst_b3beha_diagram.webp)        |
|       하우징        |   ![](/img/common/JST_EHR-3.webp)<br />[JST EHR-03]    |
|      PCB 헤더       | ![](/img/common/JST_B3B_EH-A.webp)<br />[JST B3B-EH-A] |
...
1. 아두이노 공식 홈페이지에서, `Linux 64 bit` 버전을 다운로드 하세요.
  ![](/img/common/icon_download.webp) [https://www.arduino.cc/en/software](https://www.arduino.cc/en/software)
...
![](/img/parts/controller/openrb-150/oencm904_upload_01.webp)
...
[다이나믹셀 위자드 2.0]: /docs/software/dynamixel_wizard_2_0/introduction

...
`주의`
1. 배터리를 로봇이나 충전기에 연결된 상태로 보관하지 마세요.
2. 장기간 사용하지 않을 경우 배터리를 반 정도 충전된 상태로 보관하세요.
3. 고온 또는 다습한 환경에 배터리를 보관하지 마세요.
...
[충전하기]: https://docs.robotis.com/docs/edu/bioloid/beginner/#충전하기
[접촉센서]: https://docs.robotis.com/docs/parts/sensor/ts-10/
[LED모듈]: https://docs.robotis.com/docs/parts/display/lm-10/
[적외선센서]: https://docs.robotis.com/docs/parts/sensor/irss-10/

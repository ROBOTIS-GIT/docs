...
# 개요
![](/img/parts/controller/cm-510/cm510_2.webp)
...
# 각 부 명칭
![](/img/parts/controller/cm-510/cm510_partname.webp)
...
- 모드 표시 LED : 현재 CM-510 의 동작 모드를 나타내는 LED 입니다. 보다 자세한 내용은 아래에 설명이 있습니다.
  ...
  **[ MANAGE ]**  
    ...
    - RoboPlus Manager를 이용하여 CM-510, AX/MX 다이나믹셀 의 동작을 설정하거나 테스트하기 위해 사용합니다.
...
![](/img/parts/controller/cm-510/cm510_poweron.webp)
...
![](/img/parts/controller/cm-510/cm510_connectpc.webp)

# 무선 통신 모듈 연결
- CM-510에는 ZIG-110 무선 통신 모듈을 연결할 수 있습니다.

![](/img/parts/controller/cm-510/cm510_zig110.webp)

![](/img/parts/controller/cm-510/cm510_bt110.webp)
...
1. 배터리 분리
    ...
    ![](/img/parts/controller/cm-510/bp_battery_separate.webp)

2. 충전기 연결

    ![](/img/parts/controller/cm-510/bp_charger_conn.webp)

3. 츙전

    ![](/img/parts/controller/cm-510/bp_charging.webp)

    > 충전중 (붉은색 LED), 충전완료 (녹색 LED)

    ![](/img/parts/controller/cm-510/bp_smps.webp)  

    > SMPS 를 로봇에 직접 연결하면 외부 전원으로 로봇을 구동할 수도 있습니다.

    ![](/img/parts/controller/cm-510/bp_battery.webp)  
...
![](/img/parts/controller/cm-510/cm510_fusesize.webp)

1. CM-510/ CM530 뒷면의 퓨즈(FUSE) 를 확인한다.

    ![](/img/parts/controller/cm-510/cm510_fuse_01.webp)

2. 핀셋 등으로 퓨즈를 새 것으로 교체한다.

    ![](/img/parts/controller/cm-510/cm510_fuse_02.webp)
...
![](/img/parts/controller/cm-510/cm510_vccgnd.webp)

**외부 5핀 포트**

CM-510의 외부 포트 핀 구성은 다음과 같습니다.

![](/img/parts/controller/cm-510/mcs_cm510_external_io.webp)  
...
![](/img/parts/controller/cm-510/cm510commport.webp)  
...
![](/img/parts/controller/cm-510/3pin_config.webp)  
...
[충전하기]: /docs/edu/bioloid/beginner#충전하기/

...
# 부품 사진
 ![](/img/parts/controller/cm-5/cm-5.jpg)
...
# 각 부 명칭
 ![](/img/parts/controller/cm-5/cm5_figure.png)
...
# 전원 연결
![](/img/parts/controller/cm-5/cm5_poweron.png)
...
# 작동 방법
![](/img/parts/controller/cm-5/cm5_oprating1.png)
...
![](/img/parts/controller/cm-5/cm5_connectpc.png)

# 무선 통신 모듈 연결
- CM-5에는 ZIG-100 무선 통신 모듈을 연결할 수 있습니다.

![](/img/parts/controller/cm-5/cm5_zig100.png)


# 충전 하기
로봇을 SMPS 를 연결하지 않고 동작시키기 위해서는 배터리를 사용해야 합니다. 배터리가 방전되었을 경우에는 아래 순서에 따라 충전하여 사용하십시오.

![](/img/parts/controller/cm-5/bioloid_cm5_charging-01.png)

1. CM-5 에 SMPS 를 연결합니다.

    ![](/img/parts/controller/cm-5/bioloid_cm5_charging-02.png)
...
![](/img/parts/controller/cm-5/cm5_fuse.png)
...
[펌웨어 업데이트하기]: /docs/software/rplus1/manager#펌웨어-업데이트/

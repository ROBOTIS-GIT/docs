...
![](/img/parts/controller/cm-900/cm-900_03.webp)
...
# 각 부 명칭
![](/img/parts/controller/cm-900/cm900_description.webp)
...
2. ROBOTIS\divers 디렉토리를 선택
    ...
    ![](/img/parts/controller/cm-900/image11.webp)

3. "이 드라이버 소프트웨어를 설치합니다." 를 선택
  
    ![](/img/parts/controller/cm-900/image2.gif)

4. COM포트가 몇 번인지 확인
    
    ![](/img/parts/controller/cm-900/image3.gif)
...
3. ROBOTIS CM-9 SW 시리얼 포트 설정에서 CM-900이 연결된 COM포트를 선택(장치관리자 참조)
    ...
    ![](/img/parts/controller/cm-900/image4.gif)

4. CM-900 H/W 버전에 맞게 선택

    ![](/img/parts/controller/cm-900/image5.gif)

5. 간편하게 예제 접근

    ![](/img/parts/controller/cm-900/image6.gif)

6. 아래의 2개 버튼 중에 하나를 선택
  - 확인 버튼은 컴파일만 수행
  - 다운로드 버튼은 컴파일후 다운로드 수행

    ![](/img/parts/controller/cm-900/image7.gif)

    ![](/img/parts/controller/cm-900/image8.gif)
...
:::
    ...
    ![](/img/parts/controller/cm-900/capture1.webp)

7. 시리얼 모니터를 통해 USB 데이터를 바로 확인

    ![](/img/parts/controller/cm-900/image10.gif)

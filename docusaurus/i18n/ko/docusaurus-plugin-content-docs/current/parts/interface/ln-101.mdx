...
# 개요
![img](/img/parts/interface/ln101.webp)
...
![img](/img/parts/interface/ln101_to_cm700.webp)
...
1. PC 에 장치를 연결합니다.  
  드라이버가 설치되어 있지 않을 경우 새 하드웨어 검색 마법사 시작 창이 뜹니다. 목록 또는 특정 위치에서 설치(고급)(S) -> 다음(N)
    ...
    ![img](/img/parts/interface/ln101_04.webp)
...
2. 드라이버의 위치를 지정합니다.  
  RoboPlus 를 설치한 경우 드라이버는 RoboPlus 설치 폴더의 LN101 폴더에 있습니다. 또는 최신 버전의 드라이버를 설치하고자 하는 경우 [FTDI Driver Download](http://www.ftdichip.com/Drivers/VCP.htm) 페이지에서 VCP Drivers 의 최신 버전을 받으시면 됩니다.
    ...
    ![img](/img/parts/interface/ln101_05.webp)
    
    ![img](/img/parts/interface/ln101_06.webp)

3. 다음(N) 을 누르면 설치가 진행되며 USB Serial Converter 의 드라이버 설치가 완료됩니다.

    ![img](/img/parts/interface/ln101_07.webp)

4. 동일한 방법으로 USB Serial Port 드라이버도 설치해 줍니다.

    ![img](/img/parts/interface/ln101_08.webp)

# 커넥터 정보
|        항목         |                          LN101                                |
|:-------------------:|:------------------------------------------------------------:|
|      PCB 헤더       | ![](/img/parts/interface/20010wr_4p.webp)<br />[20010WR-04](http://www.yeonho.com/app/product/ca/20010-NN.pdf) |

# 동영상
<iframe width="560" height="315" src="https://www.youtube.com/embed/UlD4C1XMsgo" frameborder="0" allowfullscreen></iframe>

[PC 에서 작성한 태스크 코드를 제어기로 다운로드]: https://emanual.robotis.com/docs/en/software/rplus1/task/getting_started#프로그램-다운로드/
[제어기의 태스크 코드 실행 결과를 PC 의 화면에 출력]: https://emanual.robotis.com/docs/en/software/rplus1/task/getting_started#프로그램-결과-출력/
[RoboPlus 의 가상 로봇 조종]: https://emanual.robotis.com/docs/en/software/rplus1/task/getting_started#가상로봇-조종/

...
![img](/img/parts/interface/u2d2/u2d2_product.png)
...
![img](/img/common/u2d2_01.webp)

## PC to UART

U2D2는 OpenCM9.04, CM-150, CM-200 등과 같이 4핀 UART 통신을 사용하는 제어기를 PC의 USB포트에 연결하여 이용하는 경우에도 사용될 수 있습니다.

![img](/img/parts/interface/u2d2/u2d2_02.webp)

:::note

**참고**: U2D2의 통신이 불안정하다면 신호의 기준 전압 레벨 차이에 의한 것일 수 있습니다. 이 경우 PC의 전원과 주변 장비의 전원의 접지 여부를 확인해 주세요. 접지가 불안정할 경우 U2D2 고장의 원인이 될 수도 있습니다.

:::

# 제품 사양

![img](/img/parts/interface/u2d2/u2d2_03.webp)

|   항목    |                                                                             설명                                                                             |
| :-------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------: |
|   무게    |                                                                              9g                                                                              |
|   크기    |                                                                     48mm x 18mm x 14.9mm                                                                     |
...
![img](/img/parts/interface/u2d2/u2d2_04.webp)
...
| *Type-C USB  | PC의 USB 포트와 연결합니다.                                     |

:::note

**참고**: 2025년 8월부터 U2D2 제품의 USB 포트 타입이 Micro-B 에서 Type-C 로 변경되었습니다.
...
![img](/img/parts/interface/u2d2/u2d2_05.webp)
...
![img](/img/parts/interface/u2d2/u2d2_06.webp)
...
![img](/img/parts/interface/u2d2/u2d2_07.webp)

# 핀 배열

![img](/img/parts/interface/u2d2/u2d2_08.webp)

# 데이터 통신방법

![img](/img/parts/interface/u2d2/u2d2_09.webp)

![img](/img/parts/interface/u2d2/u2d2_10.webp)

![img](/img/parts/interface/u2d2/u2d2_11.webp)

![img](/img/parts/interface/u2d2/u2d2_12.webp)
...
- [다이나믹셀 워크벤치 매뉴얼](https://docs.robotis.com/docs/software/dynamixel_workbench/)
...
- [로보티즈 GitHub](https://github.com/ROBOTIS-GIT)
- [다이나믹셀 SDK 매뉴얼](https://docs.robotis.com/docs/software/dynamixel_sdk/overview)
...
![img](/img/parts/interface/u2d2/u2d2_13.webp)
...
![img](/img/parts/interface/u2d2/u2d2_14.webp)
...
![img](/img/parts/interface/u2d2/u2d2_15.webp)
...
**참고**: 이 장비는 FCC 규정 Part 15에 따라 Class A 디지털 장치의 제한 사항을 준수하는 것으로 테스트되었습니다. 이 제한 사항은 상업 환경에서 장비를 사용할 때 유해한 간섭으로부터 합리적인 보호를 제공하기 위한 것입니다. 이 장비는 무선 주파수 에너지를 생성, 사용 및 방출할 수 있으며, 사용 설명서에 따라 설치 및 사용하지 않으면 무선 통신에 유해한 간섭을 일으킬 수 있습니다. 주거 지역에서 이 장비를 작동하면 유해한 간섭이 발생할 수 있으며, 이 경우 사용자는 자신의 비용으로 간섭을 해결해야 합니다.
...
**경고**
제조사가 명시적으로 승인하지 않은 변경 또는 개조는 사용자의 장비 작동 권한을 무효화할 수 있습니다.

...
# 개요
![img](/img/parts/interface/usb2dynamixel_product.webp)
...
![img](/img/parts/interface/usb2dynamixel_01.webp)

## 시리얼 포트의 변환

![img](/img/parts/interface/usb2dynamixel_02.webp)

## 무선통신

![img](/img/parts/interface/usb2dynamixel_03.webp)
...
# 각 부 명칭
![img](/img/parts/interface/usb2dynamixel_04.webp)

![img](/img/parts/interface//usb2dynamixel_05.webp)
...
- 4P / 3P 케이블 커넥터의 핀 배치도
  ...
  ![img](/img/parts/interface//usb2dynamixel_07.webp)

- 시리얼 커넥터의 핀 배치도

  ![img](/img/parts/interface//usb2dynamixel_08.webp)

# 통신모드 선택 방법
아래 그림과 같이 USB2DYNAMIXEL의 스위치를 변경하여 통신 모드를 선택할 수 있습니다.

![img](/img/parts/interface/usb2dynamixel_06.webp)
...
![img](/img/parts/interface//usb2dynamixel_09.webp)
...
![img](/img/parts/interface//usb2dynamixel_10.webp)
...
1. PC 의 USB 포트에 USB 다운로더(LN-101 or USB2DYNAMIXEL) 를 연결합니다.
    ...
    ![img](/img/faq/cm_100_download_task/task_download_01.webp)

2. 내 컴퓨터 위에서 마우스 오른쪽 클릭으로 뜨는 팝업 메뉴의 관리를 선택합니다.

    ![img](/img/parts/interface//ln101_driververify_01.webp)

3. '장치 관리자'의 '범용 직렬 버스 컨트롤러' 장치 목록에서 'USB Serial Converter' 를 확인합니다.

    ![img](/img/parts/interface//ln101_driververify_02.webp)

4. '포트 (COM 및 LPT)' 장치 목록에서 `USB Serial Port(COMx)` 를 확인합니다.(COM 포트 번호는 시스템마다 다를 수 있습니다.)

    ![img](/img/parts/interface//ln101_driververify_03.webp)

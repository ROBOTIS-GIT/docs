...
|             케이블             | ![](/img/parts/interface/mkr_shield/dc_jack_polarity.png)<br />DC 잭 케이블. Type A, O.D: 5.5 [mm], I.D: 2.5 [mm]<br />XL-320 변환 케이블 |
|              크기              | 65 x 25 [mm]                                                                                                                                    |
|              무게              | 11 [g]                                                                                                                                          |
...
### 구성도
![개요](/img/parts/interface/mkr_shield/examples_rcpwm2dynamixel_diagram.png)

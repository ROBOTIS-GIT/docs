...
id: zig-110
title: "ZIG-110A"
sidebar_label: "ZIG-110A"
sidebar_position: 50
tags: [parts, communication]
---

# 개요
![img](/img/parts/communication/zig-110_product.jpg)
...
- 원하는 값을 설정한 후 적용 버튼을 누르면 값이 설정됩니다.
  ...
  ![](/img/parts/communication/zig-110_01.png)
...
- 설정창이 뜨면 원하는 값을 설정한 후 바꾸기 버튼을 누르면 값이 설정됩니다.
  ...
  ![img](/img/parts/communication/zig-110_02.png)
...
- ZIG2Serial이 연결된 PC의 시리얼 포트 번호를 이용해서 포트를 엽니다.
  ...
  ![img](/img/parts/communication/zig-110_03.png)
...
- 키보드의 '!'키(Shift+숫자1키)를 누르고 있는 상태에서 ZIG2Serial의 리셋 스위치를 누릅니다. ZIG-100은 부팅될 때 '!'가 입력되면 설정 모드가 실행되도록 되어 있습니다. 성공하면 다음과 같이 설정 화면이 나타납니다.
  ...
  - Dest.Addr : 통신할 상대 ZIG-100의 ID 입니다.
    ...
    ![img](/img/parts/communication/zig-110_04.png)
...
- 명령어를 이용해서 ZIG-100을 설정합니다. 사용할 수 있는 명령어는 다음과 같습니다.
  ...
  - `B`키: ZIG-100의 통신 속도를 바꿉니다. 반드시 16진수로 입력해야 합니다.
    ...
    ![img](/img/parts/communication/zig-110_05.png)
...
- 최초 연결된 모듈과 통신을하며, 이외 모듈들은 신호를 대기상태를 유지합니다.
  ...
  ![img](/img/parts/communication/zig-110_06.png)
...
![](/img/parts/communication/zig-110_07.png)
...
![img](/img/parts/communication/zig-110_08.jpg)
...
[RC-100]: https://emanual.robotis.com/docs/en/parts/controller/rc-100/

...
id: bt-410-dongle
title: "BT-410 Dongle"
sidebar_label: "BT-410 Dongle"
sidebar_position: 31
tags: [parts, communication]
---

# 개요
![img](/img/parts/communication/bt-410_dongle_product.jpg)
...
![img](/img/parts/communication/bt-410_dongle_01.png)
...
1. 시스템 리셋  
  ATZ를 입력 후 엔터를 누르면 아래와 같이 BT-410 동글이 재시작 됩니다. 만약 설정을 변경하였다면 변경된 모드로 재시작합니다.
    ...
    ![img](/img/parts/communication/bt-410_dongle_11.png)
...
1. PC 에 장치를 연결합니다. 드라이버가 설치되어 있지 않을 경우 새 하드웨어 검색 마법사 시작 창이 뜹니다.  
  목록 또는 특정 위치에서 설치(고급)(S) -> 다음(N)
    ...
    ![img](/img/parts/interface/ln101_04_kr.png)   
...
2. 드라이버의 위치를 지정합니다.  
  ...
  또는 최신 버전의 드라이버를 설치하고자 하는 경우 [FTDI Driver Download](http://www.ftdichip.com/Drivers/VCP.htm) 페이지에서 VCP Drivers 의 최신 버전을 받으시면 됩니다.
    ...
    ![img](/img/parts/interface/ln101_05_kr.png)

    ![img](/img/parts/interface/ln101_06_kr.png)

3. 다음(N) 을 누르면 설치가 진행되며 USB Serial Converter 의 드라이버 설치가 완료됩니다.

    ![img](/img/parts/interface/ln101_07_kr.png)

4. 동일한 방법으로 USB Serial Port 드라이버도 설치해 줍니다.

    ![img](/img/parts/interface/ln101_08_kr.png)
...
[OpenCM7.0]: https://emanual.robotis.com/docs/en/parts/controller/opencm70/

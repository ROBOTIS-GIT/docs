...
id: rc-100
title: "RC-100"
sidebar_label: "RC-100"
sidebar_position: 40
tags: [parts, communication]
---

# 개요
![img](/img/parts/communication/rc-100a_product.webp)
...
![img](/img/parts/communication/rc-100_01.webp)
...
![img](/img/parts/communication/rc-100_02.webp)

## RC-100A/100B 와 블루투스 모듈

BT-110A 모듈을 장착한 CM-100A, CM-510, CM-530, CM-700 으로 무선 통신 패킷을 전송할 수 있습니다.

![img](/img/parts/communication/rc-100_03.webp)


# 통신모드 확인하기
![img](/img/parts/communication/rc-100_04_kr.webp)
...
![img](/img/parts/communication/rc-100_05_kr.webp)

> 펌웨어 버전 1.4부터는 전원을 꺼도 채널번호가 유지됩니다.

# ZIG-100/BT-100 모듈 장착 방법
1. RC-100 의 건전지 뚜껑을 열면 아래와 같이 ZIG-100 이라고 적힌 곳이 ZIG-100 모듈을 장착할 위치입니다.(RC-100A 의 경우 ZIG-100과 BT-100을 선택적으로 장착할 수 있습니다.)

    ![img](/img/parts/communication/rc-100_06.webp)

2. 아래 그림에 표시된 붉은 동그라미 부분이 서로 맞닿도록 넣어줍니다.

    ![img](/img/parts/communication/rc-100_07.webp)

3. 손가락이나 길다란 막대 등으로 ZIG-100 / BT-100 모듈을 꾹 눌러 완전히 삽입되도록 합니다.

    ![img](/img/parts/communication/rc-100_08.webp)

    ![img](/img/parts/communication/rc-100_09.webp)

4. RC-100A 에 ZIG-100 / BT100 모듈 장착이 완료된 모습입니다.

    ![img](/img/parts/communication/rc-100_10.webp)

    ![img](/img/parts/communication/rc-100_11.webp)
...
![img](/img/parts/communication/rc-100_12.webp)
...
![img](/img/parts/communication/rc-100_13.gif)
...
1. 뒷 뚜껑을 연다.
    ...
    ![img](/img/parts/communication/rc-100_14.webp)

2. 건전지를 1개 넣는다. (극성에 주의)

    ![img](/img/parts/communication/rc-100_15.webp)

3. 다음 건전지를 넣는다.

    ![img](/img/parts/communication/rc-100_16.webp)

4. 꾹 눌러서 건전지 삽입을 완료한다.

    ![img](/img/parts/communication/rc-100_17.webp)
...
[로보플러스 태스크의 제어기 채널 설정]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#rc-100-채널/

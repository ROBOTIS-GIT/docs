...
# 핀 배열 정보
![](/img/parts/sensors/irss-10_pinout.webp)
...
![](/img/parts/sensors/ir_graph.webp)

# 튜토리얼
- RoboPlus Task : 로보플러스 태스크의 [적외선 센서] 섹션 참조

[적외선 센서]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#적외선센서/
# 동영상

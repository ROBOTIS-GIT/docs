...
![](/img/parts/sensors/ir-array_product_01.jpg)

![](/img/parts/sensors/ir-array_product_02.jpg)
...
# 사용법
## LED
![](/img/parts/sensors/ir-array_01.png)

적외선 센서 감지 값이 검은 색 감지 기준값보다 작을 경우 해당 LED가 켜집니다.

## 자동으로 검은색 감지 기준값 찾기
![](/img/parts/sensors/ir-array_02.png)
...
[다이나믹셀의 통신]: /docs/dxl/protocol1#communication-overview/
[통신 하드웨어 구성]: /docs/dxl/ax/ax-12w#pin-assignment/

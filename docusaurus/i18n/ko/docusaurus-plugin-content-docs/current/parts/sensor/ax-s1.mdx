...
**참고** : Instruction packet의 ID가 Broadcast ID(0xFE)인 경우, [Status Return Level (68)](#status-return-level)의 설정값과 무관하게 Read Instruction 또는 Write Instruction에 대한 Status Packet은 반환되지 않습니다. 더 자세한 설명은 [다이나믹셀 프로토콜 2.0]의 `Status Packet` 항목을 참조하세요.
...
**참고** : Instruction packet 의 ID가 Broadcast ID(0xFE) 인 경우는  Status Return Level (68)의 설정값과 무관하게 Read Instruction 또는 Write Instruction에 대한 Status Packet은 반환되지 않습니다. 더 자세한 설명은 [DYNAMIXEL Protocol 2.0]의 `Status Packet` 항목을 참조하세요.
...
![](/img/parts/sensors/ax-s1_sound1.webp)
...
![](/img/parts/sensors/ax-s1_sound2.webp)
...
![](/img/parts/sensors/ax-s1_sound3.webp)
...
![](/img/parts/sensors/ax-s1_sound4.webp)
...
![](/img/parts/sensors/ax-s1_sound5.webp)
...
![](/img/parts/sensors/ax-12_of.webp)

![](/img/parts/sensors/ax-12_of-12sh.webp)

![](/img/parts/sensors/ax-12_of_combination.webp)

 
# 참고자료
## Drawings
![](/img/parts/sensors/ax-12_dimension.webp)


[다이나믹셀 통신]: /docs/dxl/protocol/protocol1#communication-overview/
[하드웨어 구성 통신]: /docs/dxl/model_reference/ax_series/ax-12w#pin-assignment/

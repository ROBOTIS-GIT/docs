...
- [R+ Task 3.0]은 기존의 R+ Task 2.0과 R+ Motion 2.0이 통합된 프로그램입니다.
...
- **참고**: [로보플러스 엔지니어 다운로드 방법](/docs/edu/engineer/engineer_app_installation)
:::
...
|  ![](/img/edu/engineer/icon_face.webp)  | **FACE : 얼굴인식 모드**&lt;br /&gt;스마트 기기의 카메라로 얼굴을 인식하고 추적하는 모드입니다.&lt;br /&gt;AR 기술을 적용해 추적하는 얼굴 위에 스티커를 입힙니다.               |
...
|                        아이콘                         | 옵션 설명                                                                                    |
|:-----------------------------------------------------:|:---------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/icon_motor.webp)  | **MOTOR : 다이나믹셀 점검**&lt;br /&gt;로봇의 다이나믹셀 상태를 각각 테스트해 볼 수 있는 메뉴입니다. |
| ![](/img/edu/engineer/icon_offset.webp) | **OFFSET : 모션오프셋**&lt;br /&gt;모션 동작시 각 관절의 기본 위치를 설정하는 기능입니다.            |
...
|                         아이콘                         | 메뉴 설명                                                                    |
|:------------------------------------------------------:|:-----------------------------------------------------------------------------|
| ![](/img/edu/engineer/icon_remote.webp)  | **REMOTE** : 기본 조종 모드 화면을 불러오는 버튼입니다.                      |
...
[2XL430-W250 매뉴얼 바로가기]: /docs/dxl/model_reference/x_series/xl_series/2xl430-w250
[R+ Task 3.0]: /docs/software/rplus_task_3_0
[동작 모드]: /docs/parts/controller/cm-550#operating-mode
[제어기와 PC 연결하기]: /docs/edu/engineer/connect_controller_pc
[PC에서 태스크 예제 다운로드 하기]: /docs/edu/engineer/task_download_pc
[PC에서 모션 예제 다운로드 하기]: /docs/edu/engineer/motion_download_pc
[제어기와 스마트기기 연결하기]: /docs/edu/engineer/connect_controller_mobile
[스마트기기에서 태스크 예제 다운로드 하기]: /docs/edu/engineer/task_download_mobile
[스마트기기에서 모션 예제 다운로드 하기]: /docs/edu/engineer/motion_download_mobile

...
6. After the device connection is completed, press the `Download` button displayed to download the robot configuration program to the controller.
    ...
    ![](/img/edu/engineer/kit2/tsk3_python_code_download_04.webp)

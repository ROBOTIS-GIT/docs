...
|  ![](/img/edu/engineer/icon_face.webp)  | **FACE : Face Recognition**<br />The robot detects and tracks the face with the camera of the smart device.<br />AR technology will overlay an image on the detected face.                                              |
...
|:-----------------------------------------------------:|:------------------------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/icon_motor.webp)  | **MOTOR : DYNAMIXEL Inspection**<br />This feature inspects each joint of the robot.                          |
| ![](/img/edu/engineer/icon_offset.webp) | **OFFSET : Motion Offset**<br />This feature calibrates the offset position of each joint for proper motions. |
...
|                          Icon                          | Mode Description                                                                             |
|:------------------------------------------------------:|:---------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/icon_remote.webp)  | **REMOTE** : Use smart device as a remote controller.                                        |

---
id: kit2_quickstart
title: "ENGINEER Kit2 Quickstart"
sidebar_label: "ENGINEER Kit2 Quickstart"
sidebar_position: 30
tags: [edu, engineer]
---
...
## Download Examples
**NOTE**: Before downloading the example files for ENGINEER KIT 2, the firmware of the CM-550 controller must be updated. [Instructions to Update CM-550 firmware using R+ Manager 2.0 software](https://emanual.robotis.com/docs/en/software/rplus2/manager#firmware-update)

...
## Download Examples
**NOTE**: Before downloading the example files for ENGINEER KIT 2, the firmware of the CM-550 controller must be updated. [Instructions to Update CM-550 firmware using R+ Manager 2.0 software](/docs/software/dynamixel_wizard_2_0/basic_features#firmware-update)
...
|                           Icon                           | Description                                                                                                                      |
|:--------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------|
|  ![](/img/edu/engineer/kit2_quickstart/icon_remote.webp)   | **REMOTE**<br /> Control and change MAX-E2 to various modes as FIGHT/ SOCCER/ etc.                                                 |
| ![](/img/edu/engineer/kit2_quickstart/icon_streaming.webp) | **STREAMING**<br />Control the robot by watching videos taken from Raspberry Pi camera on your smart device and selecting buttons. |
|   ![](/img/edu/engineer/icon_face.webp)    | **FACE**<br />Certain motions as greetings is available by face detection using Raspberry PI camera.                               |

#### MAX-E2 Options
|                         Icon                          | Description                                                                  |
|:-----------------------------------------------------:|:-----------------------------------------------------------------------------|
| ![](/img/edu/engineer/icon_motor.webp)  | **MOTOR**<br /> Check the motor operation of the robot.                        |
| ![](/img/edu/engineer/icon_offset.webp) | **OFFSET**<br /> Alter the DYNAMIXEL's position value, posture of robots, etc. |
...
|                         아이콘                         | 메뉴 설명                                                                                                                                                                                                              |
|:------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](/img/edu/engineer/icon_remote.webp)  | **REMOTE** <br />Control Scorpi's moves, directions, speed, and various motions with the tail and the claws.                                                                                                             |
| ![](/img/edu/engineer/kit2_quickstart/icon_gesture.webp) | **GESTURE** <br />After running the gesture mode, hold the screen of the smart device upwards. In this state, tilt the device to move the robot. If you shake the device strongly, the robot attacks by moving its tail. |

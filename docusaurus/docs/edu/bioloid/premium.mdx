---
id: premium
title: "ROBOTIS PREMIUM"
sidebar_label: "ROBOTIS PREMIUM"
sidebar_position: 40
tags: [edu, bioloid]
---

# Introduction
![](/img/edu/bioloid/premium_product.webp)
...
# Getting Started
## Part List
![](/img/edu/bioloid/premium_partlist_en_01.webp)

![](/img/edu/bioloid/premium_partlist_en_02.webp)
...
![](/img/edu/bioloid/premium_operation_01.webp)

![](/img/edu/bioloid/premium_operation_02.webp)
...
| ![](/img/edu/bioloid/premium_operation_05.webp) | ![](/img/edu/bioloid/premium_operation_06.webp) | ![](/img/edu/bioloid/premium_operation_07.webp) |
|:--------------------------------------------------------:|:--------------------------------------------------------:|:--------------------------------------------------------:|
...
| ![](/img/edu/bioloid/premium_operation_08.webp) | ![](/img/edu/bioloid/premium_operation_06.webp) | ![](/img/edu/bioloid/premium_operation_09.webp) |
|:--------------------------------------------------------:|:--------------------------------------------------------:|:--------------------------------------------------------:|
...
![](/img/edu/bioloid/premium_operation_10.webp)
...
![](/img/edu/bioloid/premium_tutorial_01.webp)
...
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_02.webp) | ![](/img/edu/bioloid/premium_tutorial_03.webp) | ![](/img/edu/bioloid/premium_tutorial_04.webp) | ![](/img/edu/bioloid/premium_tutorial_05.webp) |

|                  Walk Sideways + Left                   |                  Walk Sideways + Right                  |                   Turn Left + Forward                   |                  Turn Right + Forward                   |
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_06.webp) | ![](/img/edu/bioloid/premium_tutorial_07.webp) | ![](/img/edu/bioloid/premium_tutorial_08.webp) | ![](/img/edu/bioloid/premium_tutorial_09.webp) |

|                     Backward + Left                     |                    Backward + Right                     |                       Avoid Left                        |                       Avoid Right                       |
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_10.webp) | ![](/img/edu/bioloid/premium_tutorial_11.webp) | ![](/img/edu/bioloid/premium_tutorial_12.webp) | ![](/img/edu/bioloid/premium_tutorial_13.webp) |

|                Forward + Left Diagonally                |               Forward + Right Diagonally                |               Backward + Left Diagonally                |               Backward + Right Diagonally               |
|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|:-------------------------------------------------------:|
| ![](/img/edu/bioloid/premium_tutorial_14.webp) | ![](/img/edu/bioloid/premium_tutorial_15.webp) | ![](/img/edu/bioloid/premium_tutorial_16.webp) | ![](/img/edu/bioloid/premium_tutorial_17.webp) |
...
![](/img/edu/bioloid/premium_tutorial_20.webp)
...
[Callback Function]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_01#callback-function
- [Joint Offset]
...
[Joint Offset]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#joint-offset
### Task Code Overview

1. `InitializationGyro` Call Function

  ![](/img/edu/bioloid/premium_tutorial_21.webp)
...
2. Execute `BalancePage` to Apply Joint Offset
  ...
  ![](/img/edu/bioloid/premium_tutorial_22.webp)
...
3. `InitializationGyro` Function
  ...
  ![](/img/edu/bioloid/premium_tutorial_23.webp)
...
4. Calculating the adjustment value in the `Callback Function`
  ...
  ![](/img/edu/bioloid/premium_tutorial_24.webp)
  ...
  ![](/img/edu/bioloid/premium_tutorial_25.webp)
...
1. Execute RoboPlus Motion, then connect it to the controller(Please refer to [Connect Robot](https://emanual.robotis.com/docs/en/software/rplus1/motion#connect-to-robot))

  ![](/img/edu/bioloid/premium_tutorial_26.webp)

  ![](/img/edu/bioloid/premium_tutorial_27.webp)

2. To add the “Block Ball” motion in page 14, input a name and step.

  ![](/img/edu/bioloid/premium_tutorial_28.webp)

3. Turn off all motors, then set the robot’s pose.  The "Block ball on the right" pose is shown below.

  ![](/img/edu/bioloid/premium_tutorial_29.webp)
...
4. Set the robot’s pose as above. When you press the "torque on" button, the robot’s current actuator values will automatically be saved. When you press the left arrow button, you can read the robot’s current input actuator values into Step’s Pose column.
  ...
  ![](/img/edu/bioloid/premium_tutorial_30.webp)

5. You can adjust the pause and play durations. (Please refer for more information about [STEP STOP/PLAY](https://emanual.robotis.com/docs/en/software/rplus1/motion#pause))

  ![](/img/edu/bioloid/premium_tutorial_31.webp)
...
6. Designating the NEXT page as itself(14) will cause the robot to enter an infinite loop and maintain its pose.  Also designate an EXIT page for the robot to smoothly transiton into when it exits the infinite loop.
  ...
  ![](/img/edu/bioloid/premium_tutorial_32.webp)
...
7. Make a motion to return to the standard position on the page designated as the Exit page (15). Add the following 3 steps and poses to page 15.
  ...
  ![](/img/edu/bioloid/premium_tutorial_33.webp)

8. Additional settings ([Number of Repeats, Play Speed, etc](https://emanual.robotis.com/docs/en/software/rplus1/motion#set-page-repeattime))

  You can also set the number of repeats, entire speed, etc. for each page.

  ![](/img/edu/bioloid/premium_tutorial_34.webp)
...
Code to execute user-defined motions has been added to the task code written in "Adjusting using the Gyro Sensor."
  ...
  ![](/img/edu/bioloid/premium_tutorial_38.webp)
...
(For more information, please refer to the [Motion Page](https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#motion-page)).
...
1. Initializing Gripper Control
  ...
  ![](/img/edu/bioloid/premium_tutorial_39.webp)
...
2. Revise Callback Function (Gyro Adjustment)
  ...
  ![](/img/edu/bioloid/premium_tutorial_40.webp)
...
3. Gripper/Arm Control Function
  ...
  ![](/img/edu/bioloid/premium_tutorial_41.webp)
...
4. Controlling the arm and gripper with a remote controller
  ...
  ![](/img/edu/bioloid/premium_tutorial_42.webp)
...
[img_ex_beginner_01]: /img/edu/bioloid/premium_crossinggate.webp
[img_ex_beginner_02]: /img/edu/bioloid/premium_universalgauge.webp
[img_ex_beginner_03]: /img/edu/bioloid/premium_crocodilemouth.webp
[img_ex_beginner_04]: /img/edu/bioloid/premium_pantilt.webp
[img_ex_beginner_05]: /img/edu/bioloid/premium_parkinggate.webp
[img_ex_beginner_06]: /img/edu/bioloid/premium_smartcar.webp
[img_ex_beginner_07]: /img/edu/bioloid/premium_clappingcrab.webp
[img_ex_beginner_08]: /img/edu/bioloid/premium_attackingduck.webp
[img_ex_beginner_09]: /img/edu/bioloid/premium_distancelevelmeter.webp
[img_ex_beginner_10]: /img/edu/bioloid/premium_linetracer.webp
[img_ex_beginner_11]: /img/edu/bioloid/premium_walkingdroid.webp
...
[img_ex_intermediate_01]: /img/edu/bioloid/premium_probingrobot.webp
[img_ex_intermediate_02]: /img/edu/bioloid/premium_excavator.webp
[img_ex_intermediate_03]: /img/edu/bioloid/premium_robotflower.webp
[img_ex_intermediate_04]: /img/edu/bioloid/premium_fawn.webp
[img_ex_intermediate_05]: /img/edu/bioloid/premium_turtle.webp
[img_ex_intermediate_06]: /img/edu/bioloid/premium_gerwalk.webp
[img_ex_intermediate_07]: /img/edu/bioloid/premium_battledroid.webp
[img_ex_intermediate_08]: /img/edu/bioloid/premium_quadrupedrobot.webp
[img_ex_intermediate_09]: /img/edu/bioloid/premium_bipedwalkingrobot.webp
[img_ex_intermediate_10]: /img/edu/bioloid/premium_robotarm.webp
...
[img_ex_advanced_01]: /img/edu/bioloid/premium_dinosaur.webp
[img_ex_advanced_02]: /img/edu/bioloid/premium_puppy.webp
[img_ex_advanced_03]: /img/edu/bioloid/premium_kingspider.webp
[img_ex_advanced_04]: /img/edu/bioloid/premium_scorpion.webp
[img_ex_advanced_05]: /img/edu/bioloid/premium_lizard.webp
...
| ![](/img/edu/bioloid/premium_skin_01.webp) | ![](/img/edu/bioloid/premium_skin_02.webp) |
|:---------------------------------------------------:|:---------------------------------------------------:|
| ![](/img/edu/bioloid/premium_skin_03.webp) | ![](/img/edu/bioloid/premium_skin_04.webp) |
| ![](/img/edu/bioloid/premium_skin_05.webp) | ![](/img/edu/bioloid/premium_skin_06.webp) |

Samples of customized head skins

![](/img/edu/bioloid/premium_skin_07.webp)

![](/img/edu/bioloid/premium_skin_08.webp)

Samples of robots with customized skins

| ![](/img/edu/bioloid/premium_skin_09.webp) | ![](/img/edu/bioloid/premium_skin_10.webp) | ![](/img/edu/bioloid/premium_skin_11.webp) |
|:---------------------------------------------------:|:---------------------------------------------------:|:---------------------------------------------------:|
| ![](/img/edu/bioloid/premium_skin_12.webp) | ![](/img/edu/bioloid/premium_skin_13.webp) | ![](/img/edu/bioloid/premium_skin_14.webp) |
...
![](/img/edu/bioloid/premium_gripper_assy_01.webp)

### Making a gripper

![](/img/edu/bioloid/premium_gripper_assy_02.webp)
...
![](/img/edu/bioloid/premium_gripper_assy_03.webp)
...
[RC-100]: /docs/parts/communication/rc-100
[ZIG-110]: https://emanual.robotis.com/docs/en/parts/communication/zig-100_110/
[How to Download of task code]: /docs/faq/download_task_code
[How to Download motion file]: https://emanual.robotis.com/docs/en/software/rplus1/motion#download-motion

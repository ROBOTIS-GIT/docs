...
These examples and tutorials are not an exhaustive representation of what the DYNAMIXEL SDK is capable of. For more details, see the [DYNAMIXEL SDK](/docs/software/dynamixel/dynamixel_sdk/overview) eManual page.
...
## Firmware Recovery
[Firmware Recovery](/docs/software/dynamixel/dynamixel_wizard2#firmware-recovery) returns your DYNAMIXEL to factory default configuration, and is ROBOTIS' recommended method to attempt to resolve many issues you may experience with DYNAMIXEL actuators.

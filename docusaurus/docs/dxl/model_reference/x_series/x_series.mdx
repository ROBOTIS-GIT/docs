...
XL320 servos have different specifications from other XL-Series models. Please refer to the [XL-320 Specifications](/docs/dxl/model_reference/x_series/xl320) documentation for more details.

...
|:-------:|:----------:|:--------------------------------------------|:-----------------------------------|:------:|:------------------:|
|    0    |     2      | [Model Number](#model-number-0)               | Model Number                       |   R    |        107         |
...
|    6    |     2      | [CW Angle Limit](#cwccw-angle-limit-6-8)           | Clockwise Angle Limit              |   RW   |         0          |
|    8    |     2      | [CCW Angle Limit](#cwccw-angle-limit-6-8)         | Counter-Clockwise Angle Limit      |   RW   |       4,095        |
...
|   56    |     2      | [Sensed Current](#sensed-current-56)               | Consuming Current            |   R    |         -          |

...
![](/img/dxl/model_reference/dyd/dyd/dyd_spec_01.png)
...
|:---:|:---:|:---:|:---:|:---:|
| Housing | i=(-1)1/R | Cathode (+) | Anode (-) | ![](/img/dxl/model_reference/dyd/dyd/dyd_housing_01.png) |
| Output flange | i=1/(R+1) | Cathode (+) | Cathode (+) | ![](/img/dxl/model_reference/dyd/dyd/dyd_output_flange_01.png) |
...
![](/img/dxl/model_reference/dyd/dyd/dyd_parts_number_update_01.jpg)
...
![](/img/dxl/model_reference/dyd/dyd/dyd_selection_flowchart_01.png)
...
![](/img/dxl/model_reference/dyd/dyd/dyd_duty_cycle.png)
...
![](/img/dxl/model_reference/dyd/dyd/dyd_average_output_torque.png)
...
![](/img/dxl/model_reference/dyd/dyd/dyd_average_input_speed.png)
...
|:---:|:---:|:---:|
| Shape | ![](/img/dxl/model_reference/dyd/dyd_c_type.png) | ![](/img/dxl/model_reference/dyd/dyd_sd_type.png) |

{/*
mx-106 protocol 1.0 Drive Mode (10).
Includes Bit 1 Master/Slave Mode (Dual Joint) and the Dual Mode section.
Time-based Profile and Torque On by Goal Update bits are NOT applicable
to protocol 1.0 mx-106.
*/}

...
When a Bus Watchdog Error screen is active, all Goal Values ([Goal PWM(100)], [Goal Velocity(104)], [Goal Position(116)]) will be changed to read-only-access until the error has been cleared.
If the value of Bus Watchdog(98) is changed to '0', active Bus Watchdog Errors will be cleared.

:::note

**NOTE** : For more information about Data Range Error, refer to [Protocol 2.0].
...
**NOTE** : Bus Watchdog(98) is supported from Firmware v38.

...
7. Results are stored at [Present Position(132)], [Present Velocity(128)], [Present PWM(124)] and {props.load ? <a href="#present-load126">Present Load(126)</a> : <a href="#present-current126">Present Current(126)</a>}.

{/*
control_table_indirect_data.mdx for the X330 / X335 family
(XL330, XC330, XM335). These models expose Indirect Address/Data 1~28 only and
their assignable range is 64 ~ 251, so the 64 ~ 661 range and the
"Indirect Address 29 ~ 56" note of the other X models do not apply.
*/}

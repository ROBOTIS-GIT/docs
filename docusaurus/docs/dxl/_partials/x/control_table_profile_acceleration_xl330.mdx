{/*
control_table_profile_acceleration.mdx for XL330, whose firmware line starts above V42, so the
"Time-based Profile is available from firmware V42" note does not apply.
*/}

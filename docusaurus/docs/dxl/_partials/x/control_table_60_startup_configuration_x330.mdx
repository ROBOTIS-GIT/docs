{/*
control_table_60_startup_configuration.mdx for the XL330 / XC330 groups, where this feature arrives in firmware V46, not V45.
*/}
...
**NOTE**: For more details about restoring the RAM area, see [Restoring RAM Area](/docs/software/dynamixel_wizard_2_0/advanced_features#restoring-ram-area).

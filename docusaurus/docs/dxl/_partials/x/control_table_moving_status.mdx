...
Following Error(0x08) and In-Position(0x01) are available under **Position Control Mode**, **Extended Position Control Mode**{props.currentBased !== false && <>, <strong>Current-based Position Control Mode</strong></>}.

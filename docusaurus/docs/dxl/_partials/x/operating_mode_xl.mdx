...
PWM Control Mode is similar to the Wheel Mode of [AX](/docs/dxl/model_reference/ax_series/ax-12w#cw-compliance-margin) and [RX](/docs/dxl/model_reference/rx_series/rx-10#moving-speed-32) series.

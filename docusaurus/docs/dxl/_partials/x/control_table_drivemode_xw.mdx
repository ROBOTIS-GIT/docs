{/*
control_table_drivemode.mdx for the XW series.
Only the Normal/Reverse Mode note differs: the e-Manual lists Position, Velocity,
Current and PWM as the inverted quantities for the XW group, not Goal/Present Position.
*/}

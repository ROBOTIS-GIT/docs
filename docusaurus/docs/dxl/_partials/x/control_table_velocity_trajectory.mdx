...
2. **Position Control Mode, Extended Position Control Mode{props.currentBased !== false && ', Current-based Position Control Mode'}** : Velocity Trajectory is used to create Position Trajectory(140). When Profile reaches to an endpoint, Velocity Trajectory(136) is cleared to '0'.

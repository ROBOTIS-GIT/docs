...
The following explains how the Profile processes [Goal Position(116)] instructions in {props.currentBased !== false && 'Current-based Position Control Mode, '}Position Control mode, and Extended Position Control Mode.

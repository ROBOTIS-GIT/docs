...
1. PWM Control Mode is similar to the Wheel Mode of [AX](/docs/dxl/model_reference/ax_series/ax-12w#cw-compliance-margin) and [RX](/docs/dxl/model_reference/rx_series/rx-10#moving-speed-32) series.
...
**NOTE** : When Operating Mode(11) changes to another mode, Gains and other Mode-related values will be reset to values corresponding to the selected Operating Mode(11).

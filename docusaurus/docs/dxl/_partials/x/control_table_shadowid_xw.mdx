{/*
control_table_shadowid.mdx for the XW series.
The XW series has no LED(65) register, so the e-Manual demonstrates Secondary ID
with Torque Enable(64) instead of LED(65).
*/}

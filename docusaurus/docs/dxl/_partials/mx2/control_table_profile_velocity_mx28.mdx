{/*
control_table_profile_velocity.mdx for MX-28(2.0), which the e-Manual excludes from the
Current-based Position Control Mode list that MX-64(2.0) and MX-106(2.0) get.
*/}

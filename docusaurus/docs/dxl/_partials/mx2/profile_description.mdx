...
The following explains how the Profile processes [Goal Position(116)] instructions in Current-based Position Control Mode, Position Control mode, and Extended Position Control Mode.

{/*
control_table_shutdown.mdx for the PRO(A) models and RH-P12-RN, whose registers sit at
Shutdown(63), Torque Enable(512) and Hardware Error Status(518) rather than the
PRO addresses 48 / 562 / 892.
*/}
...
If those errors are detected,  [Torque Enable(512)] is cleared to ‘0’ and the motor's output becomes 0 [%].

{/*
485_ttl_connection.mdx for the MX models, which are also sold in RS-485 form.
The e-Manual withholds the RS-485 Communication section from the AX series only.
*/}

...
| <a href="/img/dxl/axial_radial_load_pro.png" target="_blank">Radial Load</a> | 280 [N] (10 [mm] away from the horn)      |
| <a href="/img/dxl/axial_radial_load_pro.png" target="_blank">Axial Load</a>  | 100 [N]          |
...
## Performance Graph
![](/img/dxl/pro/l42-10-s300-r_performance_graph.jpg)
...
[Protocol]: /docs/dxl/protocol2#reboot
...
![](/img/dxl/pro/l42_position_controller.png)
...
|:-------------:|:------------------:|:--------------:|:--------------------------------------------------------------------------------------------------------------:|
| L42-10-S300-R | 0&deg; ~ 360 &deg; |   0 ~ 4,095    | ![](/img/dxl/pro/l42_angle_position.png)<br />![](/img/dxl/pro/l42_goal_angle_formula.png) |
...
+ FRP42-H110K, FRP42-H120K Set
  ...
  ![](/img/dxl/pro/frp42-h110k-h120k.png)

...
**NOTE**: 
- [DYNAMIXEL SDK](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_sdk/overview/) and other ROBOTIS software is available to download at the [en.robotis.com](http://en.robotis.com/) Download Center. 
- For more information on the ROBOTIS Software, see [Software](https://emanual.robotis.com/docs/en/software/)
- To assemble DYNAMIXEL Starter Set (U2D2 + U2D2 Power Hub Board + SMPS), see [How to Assemble](https://emanual.robotis.com/docs/en/parts/interface/u2d2_power_hub/#how-to-assemble)
...
**NOTE**: 
- [Use of Serial Monitor with DYNAMIXEL Shield](https://emanual.robotis.com/docs/en/parts/interface/dynamixel_shield/#use-of-serial-monitor-with-dynamixel-shield)
- ROBOTIS provides DYNAMIXEL library for DYNAMIXEL Shield, it can help you to use DYNAMIXEL easily.
- Check the [controller compatibility](https://emanual.robotis.com/docs/en/parts/controller/controller_compatibility/#software) chart to see which servos, sensors, peripherals, and software are compatible with which controller.
...
[U2D2 Power Hub Board]: https://emanual.robotis.com/docs/en/parts/interface/u2d2_power_hub/
[Software]: https://emanual.robotis.com/docs/en/software/
[OpenCM9.04]: https://emanual.robotis.com/docs/en/parts/controller/opencm904/
[The OpenCM 485 Expansion Board]: https://emanual.robotis.com/docs/en/parts/controller/opencm485exp/
[OpenCR1.0]: https://emanual.robotis.com/docs/en/parts/controller/opencr10/
...
[RC-100]: https://emanual.robotis.com/docs/en/parts/communication/rc-100/
[LN-101]: https://emanual.robotis.com/docs/en/parts/interface/ln-101/

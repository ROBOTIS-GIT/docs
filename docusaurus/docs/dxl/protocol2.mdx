...
sidebar_label: "DYNAMIXEL Protocol 2.0"
---
...
* [DYNAMIXEL Y](https://emanual.robotis.com/docs/en/dxl/y)
* [DYNAMIXEL P](https://emanual.robotis.com/docs/en/dxl/p)
* [DYNAMIXEL X](https://emanual.robotis.com/docs/en/dxl/x)
* [DYNAMIXEL MX](https://emanual.robotis.com/docs/en/dxl/mx)


:::note

**Note**: MX(2.0) is a special firmware for the DYNAMIXEL MX series providing support for DYNAMIXEL Protocol 2.0. MX(2.0) firmware can be uploaded to your servo using [Firmware Recovery](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/) in DYNAMIXEL Wizard 2.0.
...
* [CM-50](https://emanual.robotis.com/docs/en/parts/controller/cm-50/)
...
![](/img/dxl/protocol2/protocol20_bytetobytetime.png)
...
![](/img/dxl/protocol2/protocol20_packet_example_02.png)
...
- RAM data can be restored by configuring the **Startup Configuration(60)** setting. Refer to [Restoring RAM Area](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#restoring-ram-area) for more information.
...
[Control Table]: https://emanual.robotis.com/docs/en/faq/faq_dynamixel/

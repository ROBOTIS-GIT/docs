...
- Supported products : DYNAMIXEL [MX-12W(V41), MX-28/64/106(V40), MX(2.0)](/docs/dxl/model_reference/mx_series/mx_series) and [X Series](/docs/dxl/model_reference/x_series/x_series) (excluding XL-320)
...
- Supported products : DYNAMIXEL [MX, MX(2.0)](/docs/dxl/model_reference/mx_series/mx_series) and [X Series](/docs/dxl/model_reference/x_series/x_series) (excluding XL-320)

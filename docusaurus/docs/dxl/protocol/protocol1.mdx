...
#### Example
##### Conditions
- ID broadcast(RX-64) : Set the unknown DYNAMIXEL's ID as "1" by writing 1 to ID(3)
...
- Supported products : DYNAMIXEL [MX-12W(V41), MX-28/64/106(V40), MX(2.0)](/docs/dxl/model_reference/mx_series) and [X Series](/docs/dxl/model_reference/x_series) (excluding XL-320)
...
- Supported products : DYNAMIXEL [MX, MX(2.0)](/docs/dxl/model_reference/mx_series) and [X Series](/docs/dxl/model_reference/x_series) (excluding XL-320)
...
**WARNING**: Note that a parameter field construction of [Bulk Read in DYNAMIXEL Protocol 2.0](/docs/dxl/protocol/protocol2#bulk-read) differs from the parameter field construction of the Bulk Read in Protocol 1.0.

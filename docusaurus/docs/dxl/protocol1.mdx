...
sidebar_label: "DYNAMIXEL Protocol 1.0"
---
...
- Supported products : DYNAMIXEL [MX-12W(V41), MX-28/64/106(V40), MX(2.0)](https://emanual.robotis.com/docs/en/dxl/mx/) and [X Series](https://emanual.robotis.com/docs/en/dxl/x/) (excluding XL-320)
...
- Supported products : DYNAMIXEL [MX, MX(2.0)](https://emanual.robotis.com/docs/en/dxl/mx/) and [X Series](https://emanual.robotis.com/docs/en/dxl/x/) (excluding XL-320)
...
**WARNING**: Note that a parameter field construction of [Bulk Read in DYNAMIXEL Protocol 2.0](https://emanual.robotis.com/docs/kr/dxl/protocol2/#bulk-read) differs from the parameter field construction of the Bulk Read in Protocol 1.0.
...
![](/img/dxl/protocol1/protocol1_example_06.png)

![](/img/dxl/protocol1/protocol1_example_07.png)

![](/img/dxl/protocol1/protocol1_example_08.png)

![](/img/dxl/protocol1/protocol1_example_09.png)

![](/img/dxl/protocol1/protocol1_example_10.png)

![](/img/dxl/protocol1/protocol1_example_11.png)

![](/img/dxl/protocol1/protocol1_example_12.png)

![](/img/dxl/protocol1/protocol1_example_13.png)

![](/img/dxl/protocol1/protocol1_example_15.png)

![](/img/dxl/protocol1/protocol1_example_16.png)

![](/img/dxl/protocol1/protocol1_example_17.png)

![](/img/dxl/protocol1/protocol1_example_18.png)

![](/img/dxl/protocol1/protocol1_example_19.png)

![](/img/dxl/protocol1/protocol1_example_20.png)

![](/img/dxl/protocol1/protocol1_example_21.png)
...
[Compatibility Table]: https://emanual.robotis.com/docs/en/popup/faq_protocol_compatibility_table/

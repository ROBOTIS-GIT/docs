...
Connect your controller to a PC via the USB cable.
  ...
  ![](/img/faq/usb_driver_install/connect_pc.webp)
...
3. Right-Click the downloaded folder to extract.  
  ![](/img/faq/usb_driver_install/extracting_driver.webp)

4. Click on **Install**  
  ![](/img/faq/usb_driver_install/install_inf.webp)

5. Click on **Open**  
  ![](/img/faq/usb_driver_install/installing_driver.webp)
...
3. Open **Device Manager**, and find **ROBOTIS Virtual COM Port**.  
  ![](/img/faq/usb_driver_install/device_manager.webp)

4. Right-click on **ROBOTIS Virtual COM Port** and click on **Update Driver Software**.  
  ![](/img/faq/usb_driver_install/manual_installation_01.webp)

5. Select **Browse my computer for driver software**.  
  ![](/img/faq/usb_driver_install/manual_installation_02.webp)

6. Click on **Browse**.  
  ![](/img/faq/usb_driver_install/manual_installation_02_1.webp)  

7. Locate the folder that contains driver files.  
  ![](/img/faq/usb_driver_install/manual_installation_03.webp)  

8. Click **Next**. Successful installation will say “Windows has successfully updated your driver software”  
  ![](/img/faq/usb_driver_install/manual_installation_04.webp)
...
![](/img/faq/usb_driver_install/check_resisterd_port.webp)

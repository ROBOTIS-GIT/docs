...
**NOTE**: To check which products support which DYNAMIXEL Protocol (1.0 or 2.0), see the [DYNAMIXEL Protocol Compatibility Table](/docs/dxl/protocol/faq_protocol_compatibility_table) 

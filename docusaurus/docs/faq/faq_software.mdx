...
If you are operating DYNAMIXEL from your PC with [U2D2] or [USB2DYNAMIXEL], You can use [DYNAMIXEL SDK](/docs/software/dynamixel/dynamixel_sdk/overview)(C, C++, C#, Java, MATLAB, LabVIEW, Python, ROS) or [R+ Task] or [R+ Task 2.0]
...
Please check the [e-Manual](https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc#errors)

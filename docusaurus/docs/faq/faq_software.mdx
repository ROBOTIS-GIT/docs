...
If you are operating DYNAMIXEL from your PC with [U2D2] or [USB2DYNAMIXEL], You can use [DYNAMIXEL SDK](/docs/software/dynamixel_sdk/overview)(C, C++, C#, Java, MATLAB, LabVIEW, Python, ROS) or [R+ Task] or [R+ Task 2.0]

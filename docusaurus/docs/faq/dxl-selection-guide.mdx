...
<details>
<summary>
![](/img/icon_unfold.png) **Tip**: **Looking for a solution to combining TTL and RS-485 of DYNAMIXEL in your system ?**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) **Tip**: **Communication Circuit of TTL based DYNAMIXEL**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.png) **Tip**: **Communication Circuit of RS-485 based DYNAMIXEL**
</summary>
...
**NOTE**: For allowable current to a daisy chain of DYNAMIXELs in your system, visit your product e-Manual and see the **Connector Information** (e.g,[XD540-T150 Connector Information](/docs/dxl/x/xd540-t150#connector-information))  
...
**NOTE**: 
The DYNAMIXEL [Controller Compatibility Chart](/docs/parts/controller/controller_compatibility) provides a convenient way to quickly check which controllers are compatible with each of ROBOTIS' sensors, servos, and software.
...
![](/img/parts/interface/u2d2_01.png)
...
**NOTE**: When combined with the [OpenCM 485 EXP Board](/docs/parts/controller/opencm485exp) the OpenCM 9.04 can drive RS-485 DYNAMIXELs as well as TTL based DYNAMIXEL.
...
## Educational
### CM Series
CM Series are designed for the [Educational Kits](/docs/edu) to support our dedicated [educational software](#educational-software). 

Most of CM Series controllers provide the OLLO Ports where [dedicated sensors for CM series](https://emanual.robotis.com/docs/en/parts/all_sensors/) can be mounted and easily controled by using R+ software. 
...
**NOTE**: To see a full range of controllers provided by ROBOTIS, visit our [Controllers](https://emanual.robotis.com/docs/en/parts/all-controller/) page.
...
**NOTE**: Not all sensors are compatible with each CM series, check out the compatible sensors with each CM series at [Parts Compatibility](/docs/parts/controller/controller_compatibility#parts)

:::


## Other Controllers
ROBOTIS provides a range of [Educational Kits](/docs/edu) and [DYNAMIXEL System](/docs/platform) that accompany a dedicated controller.

See all the range of [Controllers](https://emanual.robotis.com/docs/en/parts/all-controller/) for more information.
...
Check out the [Software Compatibility](/docs/parts/controller/controller_compatibility#software) which software is supportive with your selection.

## Test & Management
### DYNAMIXEL Wizard 2.0
[DYNAMIXEL Wizard 2.0](/docs/software/dynamixel/dynamixel_wizard2) is an optimized tool for managing DYNAMIXEL’s from various operating systems (Linux / Mac / Windows). [U2D2](#u2d2) or [Compatible controller](/docs/parts/controller/controller_compatibility) is required to use.
...
### R+ Manager 2.0
[R+ Manager 2.0](/docs/software/rplus2/manager) is one of the [R+ Software Suite](#r-software-suite) for you to maintanance Educational Kits including [CM-Series](#cm-series) and its supported DYNAMIXELs. 
...
[DYNAMIXEL SDK](/docs/software/dynamixel/dynamixel_sdk/overview) is a software development kit to support a variety programming language(C, C++, C#, Python, Java, Matlab and LabVIEW) on major OS(Linux, Windows, Mac). The provided APIs will allow you to manipulate data of DYNAMIXEL with ease. 
...
Educational software is ROBOTIS dedicated software for our [educational kits](/docs/edu) and [CM Series](#cm-series). 
...
### R+ Software Suite
The R+ (Roboplus) Software suite is ROBOTIS' first party robot controller software offering. R+ is offered in a variety of forms to enable users to start the programming style they feel most comfortable with. See provided [R+ Software](/docs/software#roboplus-r).
...
[R+ 3.0 software]: /docs/software/rplustask3

...
## Other Controllers
ROBOTIS provides a range of Educational Kits and [DYNAMIXEL System](/docs/systems) that accompany a dedicated controller.
...
[DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0) is an optimized tool for managing DYNAMIXEL’s from various operating systems (Linux / Mac / Windows). [U2D2](#u2d2) or Compatible controller is required to use.

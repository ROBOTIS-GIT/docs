...
### R+ Manager 2.0
[R+ Manager 2.0](/docs/software/dynamixel_wizard_2_0) is one of the [R+ Software Suite](#r-software-suite) for you to maintain Educational Kits including [CM-Series](#cm-series) and its supported DYNAMIXELs. 

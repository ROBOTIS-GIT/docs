...
[DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0) is an optimized tool for managing DYNAMIXEL’s from various operating systems (Linux / Mac / Windows). [U2D2](#u2d2) or [Compatible controller](/docs/parts/controller/controller_compatibility) is required to use.
...
### R+ Manager 2.0
[R+ Manager 2.0](/docs/software/dynamixel_wizard_2_0) is one of the [R+ Software Suite](#r-software-suite) for you to maintanance Educational Kits including [CM-Series](#cm-series) and its supported DYNAMIXELs. 

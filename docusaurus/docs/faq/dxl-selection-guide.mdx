...
<details>
<summary>
![](/img/icon_unfold.webp) **Tip**: **Looking for a solution to combining TTL and RS-485 of DYNAMIXEL in your system ?**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.webp) **Tip**: **Communication Circuit of TTL based DYNAMIXEL**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.webp) **Tip**: **Communication Circuit of RS-485 based DYNAMIXEL**
</summary>
...
**NOTE**: For allowable current to a daisy chain of DYNAMIXELs in your system, visit your product e-Manual and see the **Connector Information** (e.g,[XD540-T150 Connector Information](/docs/dxl/model_reference/x_series/xd540-t150#connector-information))  
...
## Other Controllers
ROBOTIS provides a range of [Educational Kits](/docs/edu) and [DYNAMIXEL System](/docs/systems) that accompany a dedicated controller.
...
### R+ Manager 2.0
[R+ Manager 2.0](https://emanual.robotis.com/docs/en/software/rplus2/manager) is one of the [R+ Software Suite](#r-software-suite) for you to maintanance Educational Kits including [CM-Series](#cm-series) and its supported DYNAMIXELs. 

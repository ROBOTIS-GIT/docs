...
See the Controller Compatibility Chart for information on DYNAMIXEL controller compatibility.
...
3. Open the BT-210 eManual page
4. Follow the instructions for **Step 5** in the AT Command section of the page to change the configured PIN.

...
- See [Product Compatibility Guide](/docs/parts/controller/controller_compatibility).

# How to download Task Code to my controller?
- See [Download Task Code](/docs/faq/download_task_code).

# [Task Rule Check](https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc#rule-check)
...
**R+ 1.0**
  - [R+ Task](https://emanual.robotis.com/docs/en/software/rplus/task/)
  - [R+ Motion](https://emanual.robotis.com/docs/en/software/rplus/motion/)
  - [R+ Manager](https://emanual.robotis.com/docs/en/software/rplus/manager/)
...
**R+ 2.0**
  ...
  - [R+ Design 2.0](https://emanual.robotis.com/docs/en/software/rplus2/design)
...
- See [Product Compatibility Guide](/docs/parts/controller/controller_compatibility), and choose the right software which is compatible with your controller in use.

:::

  
# What is the meaning of error codes when I use R+ Task 1.0
- See [Error Messages](https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc#error-messages).

# What shall I do if the rule check error shows up while I am writing RoboPlus Task code?
- See [Rule Check](https://emanual.robotis.com/docs/en/software/rplus1/task/task_misc#rule-check).
...
- [1:N Communication](/docs/parts/communication/zig-110#11-communication).
- [N:N Communication](/docs/parts/communication/zig-110#1n-communication).
...
[Change System Preferences]: /docs/popup/general/change_system_preference_osx

...
sidebar_label: "Gyro Sensor (GS-12)"
sidebar_position: 50
tags: [parts, sensor]
---

![](/img/parts/sensors/gs-12_product.png)

> Gyro Sensor(GS-12)

![](/img/parts/sensors/gyro_new.jpg)
...
# Pinout
![](/img/parts/sensors/gs-12_pinout.png)
...
- You can READ the value using the [User’s Device Parameter] in RoboPlus Task.
  ...
  ![](/img/parts/sensors/gs-12_01.png)
...
- You may sample it out like below. It reads 10 values per 0.1 sec and makes an average. This value can be used as the standard value.
  ...
  ![](/img/parts/sensors/gs-12_02.png)
...
[User’s Device Parameter]: /docs/software/rplus1/task/programming_02#user-devices/

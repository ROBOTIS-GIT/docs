...
- For more detailes about Instruction Packet, see [DYNAMIXEL Protocol 1.0](/docs/dxl/protocol1#instruction-packet) or [Protocol 2.0](/docs/dxl/protocol2#instruction-packet) depending on what DYNAMIXEL is in use. 
...
# Layout
![](/img/parts/interface/dxl_bridge/dxl_bridge_layout_front.png)  

> Layout - Front

![](/img/parts/interface/dxl_bridge/dxl_bridge_layout_back.png)

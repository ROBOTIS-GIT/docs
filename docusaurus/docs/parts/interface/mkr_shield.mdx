...
![](/img/parts/interface/mkr_shield/mkr_shield_product.jpg)
...
|            Cables            | ![](/img/parts/interface/mkr_shield/dc_jack_polarity.png)<br />DC Jack Harness (Type A, O.D: 5.5 [mm], I.D: 2.5 [mm])<br />Convertible cable for XL-320 |
...
![](/img/parts/interface/mkr_shield/pinmap.png)
...
![](/img/parts/interface/mkr_shield/mkr_pinmap.png)
...
The USB connection from PC supplies power and serial communication to the MKR board to upload the Arduino sketch, while 12V SMPS supplies power to connceted DYNAMIXEL.  
 ![](/img/parts/interface/mkr_shield/DXL_MKRShield_info01.jpg)
...
Or else, use the [Robot Cable-X3P convertible].  
 ![](/img/parts/interface/mkr_shield/DXL_MKRShield_info02.jpg)
...
:::
 ...
 ![](/img/parts/interface/mkr_shield/DXL_MKRShield_info03.jpg)

After uploading the program, 1 cell Lithium battery(3.7V) can be used to power the Arduino MKR board and XL330.  
 ![](/img/parts/interface/mkr_shield/DXL_MKRShield_info04.jpg)

# Power Select Jumper
|                                                              Use VIN(DXL) from external power source(SMPS)                                                               |                                                                                  Use +5V from Arduino MKR                                                                                  |
|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|                                                     ![](/img/parts/interface/mkr_shield/select_vindxl.png)                                                     |                                                                ![](/img/parts/interface/mkr_shield/select_5v.png)                                                                |
...
### Connection Diagram
![](/img/parts/interface/mkr_shield/examples_can2dynamixel_diagram.jpg)
...
- **ID** : DYNAMIXEL ID
- **DLC** : Size of Data
- **Data** : [Instruction](/docs/dxl/protocol2#instruction)(1 Byte) + [Parameters](/docs/dxl/protocol2#parameters)(0 ~ 7 Byte)
...
![](/img/parts/interface/mkr_shield/can2dynamixel_ixxat_cananalyser3_mini_example.png)
...
### Connection Diagram
![](/img/parts/interface/mkr_shield/examples_rcpwm2dynamixel_diagram.png)

### Wiring
The RC receiver and the DYNAMIXEL Shield MKR can be connected as below.

![connection_diagram](/img/parts/interface/mkr_shield/connection_diagram.jpg)

# Download
- [DYNAMIXEL Shield MKR Schematic(PDF)](https://www.robotis.com/service/download.php?no=1988)  
  ![](/img/parts/interface/mkr_shield/mkr_schematic.png)
...
[mx-28t/at]: /docs/dxl/mx/mx-28
[mx-28t/at(2.0)]: /docs/dxl/mx/mx-28-2
[mx-64t/at]: /docs/dxl/mx/mx-64
[mx-64t/at(2.0)]: /docs/dxl/mx/mx-64-2
[mx-106t/at]: /docs/dxl/mx/mx-106
[mx-106t/at(2.0)]: /docs/dxl/mx/mx-106-2
[xl-320]: /docs/dxl/x/xl320
[xl330-m077-t]: /docs/dxl/x/xl330-m077
[xl330-m288-t]: /docs/dxl/x/xl330-m288
[xl430-w250-t]: /docs/dxl/x/xl430-w250
[2xl430-w250-t]: /docs/dxl/x/2xl430-w250
[xc430-w150-t]: /docs/dxl/x/xc430-w150
[xc430-w240-t]: /docs/dxl/x/xc430-w240
[xc430-t150bb-t]: /docs/dxl/x/xc430-t150bb
[xc430-t240bb-t]: /docs/dxl/x/xc430-t240bb
[2xc430-w250-t]: /docs/dxl/x/2xc430-w250
...
[xm430-w210-t]: /docs/dxl/x/xm430-w210
[xm430-w350-t]: /docs/dxl/x/xm430-w350
[xh430-w210-t]: /docs/dxl/x/xh430-w210
[xm540-w150-t]: /docs/dxl/x/xm540-w150
[xm540-w270-t]: /docs/dxl/x/xm540-w270
[xh430-w350-t]: /docs/dxl/x/xh430-w350
[xh540-w150-t]: /docs/dxl/x/xh540-w150
[xh540-w270-t]: /docs/dxl/x/xh540-w270

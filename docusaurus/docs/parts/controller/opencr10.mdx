...
![](/img/parts/controller/opencr10/opencr_product.png)
...
![](/img/parts/controller/opencr10/arduino_pinmap_01.png)
...
![](/img/parts/controller/opencr10/arduino_pinmap_03.png)
...
## Dip Switch
![](/img/parts/controller/opencr10/arduino_pinmap_04.png)
...
![](/img/parts/controller/opencr10/arduino_pinmap_05.png)
...
![](/img/parts/controller/opencr10/arduino_pinmap_06.png)

## Push Switch
![](/img/parts/controller/opencr10/arduino_pinmap_08.png)
...
![](/img/parts/controller/opencr10/exam_pwm_01.png)
...
![](/img/parts/controller/opencr10/ex_eeprom_01.png)
...
![](/img/parts/controller/opencr10/ex_eeprom_02.png)

![](/img/parts/controller/opencr10/ex_eeprom_03.png)
...
1. To update OpenCR's firmware, open the front cover of OP3 and connect USB to PC as shown below.
    ...
    ![](/img/parts/controller/opencr10/op3_01.png)
...
4. In the Arduino IDE Examples, select the firmware for OP3.
    ...
    ![](/img/parts/controller/opencr10/op3_02.png)
...
5. Click on the icon in the Arduino IDE that displays the red circle in the following figure to build and download the firmware. When the download is completed, the firmware is automatically executed.
    ...
    ![](/img/parts/controller/opencr10/op3_03.png)
...
2. Select File-> Save.
    ...
    ![](/img/parts/controller/opencr10/op3_05.png)

3. Since the example provided is Read-Only, select OK to save it as a new file.

    ![](/img/parts/controller/opencr10/op3_06.png)
...
4. Save it to a new folder and edit it. Once editing is complete, repeat the process of building and downloading the firmware.
    ...
    ![](/img/parts/controller/opencr10/op3_09.png)
...
![](/img/parts/controller/opencr10/tilt_sensor.png)
...
![](/img/parts/controller/opencr10/rotation_sensor.png)
...
![](/img/parts/controller/opencr10/cap_sensor.jpg)
...
![](/img/parts/controller/opencr10/flame_sensor.jpg)
...
![](/img/parts/controller/opencr10/joystick_sensor.png)
...
![](/img/parts/controller/opencr10/bootloader_01.png)

## Boot Sequence
![](/img/parts/controller/opencr10/bootloader_03.png)
...
![](/img/parts/controller/opencr10/bootloader_04.png)
...
![](/img/parts/controller/opencr10/bootloader_05.png)

![](/img/parts/controller/opencr10/bootloader_06.png)
...
![](/img/parts/controller/opencr10/bootloader_07.png)
...
![](/img/parts/controller/opencr10/bootloader_08.png)
...
![](/img/parts/controller/opencr10/bootloader_10.png)
...
![](/img/parts/controller/opencr10/dfu_device_manager.png)
...
![](/img/parts/controller/opencr10/arduino_mac_07.png)
...
![](/img/parts/controller/opencr10/arduino_mac_08.png)
...
![](/img/parts/controller/opencr10/bootloader_12.png)
...
![](/img/parts/controller/opencr10/bootloader_11.png)
...
3. Go to `Options` > `List All Devices`.
    ...
    ![](/img/parts/controller/opencr10/zadig_01.png)

4. Select **STM32 BOOTLOADER** and install **WinUSB** driver.

    ![](/img/parts/controller/opencr10/zadig_02.png)
...
- Set `0` (or not input status) to download the firmware.
  ...
  ![](/img/parts/controller/opencr10/arduino_bin_export.png)
...
|         Diagram          |        ![](/img/dxl/jst_b3beha_diagram.png)        |        ![](/img/dxl/jst_b4beha_diagram.png)        |
|         Housing          |   ![](/img/dxl/JST_EHR-3.png)<br />[JST EHR-03]    |   ![](/img/dxl/JST_EHR-4.png)<br />[JST EHR-04]    |
|        PCB Header        | ![](/img/dxl/JST_B3B_EH-A.png)<br />[JST B3B-EH-A] | ![](/img/dxl/JST_B4B-EH-A.png)<br />[JST B4B-EH-A] |

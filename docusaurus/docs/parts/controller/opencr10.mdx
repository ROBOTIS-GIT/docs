...
**NOTE**: [The OpenCR 1.0 e-Manual](https://emanual.robotis.com/docs/en/parts/controller/opencr10_jp/) in Japanese (日本語) is available for the Japanese. 

:::


![](/img/parts/controller/opencr10/opencr_product.webp)
...
![](/img/parts/controller/opencr10/arduino_pinmap_01.webp)
...
![](/img/parts/controller/opencr10/arduino_pinmap_03.webp)
...
## Dip Switch
![](/img/parts/controller/opencr10/arduino_pinmap_04.webp)
...
![](/img/parts/controller/opencr10/arduino_pinmap_05.webp)
...
## ROBOTIS 5-pin Connector
![](/img/parts/controller/opencr10/arduino_pinmap_06.webp)

## Push Switch
![](/img/parts/controller/opencr10/arduino_pinmap_08.webp)
...
**CAUTION**: Since Serial3 is used for DYNAMIXEL, its usage differs from other serial ports. (For more information, please refer to DYNAMIXEL Workbench.)
...
![](/img/parts/controller/opencr10/exam_pwm_01.webp)
...
![](/img/parts/controller/opencr10/ex_eeprom_01.webp)
...
![](/img/parts/controller/opencr10/ex_eeprom_02.webp)

![](/img/parts/controller/opencr10/ex_eeprom_03.webp)
...
1. To update OpenCR's firmware, open the front cover of OP3 and connect USB to PC as shown below.
    ...
    ![](/img/parts/controller/opencr10/op3_01.webp)
...
4. In the Arduino IDE Examples, select the firmware for OP3.
    ...
    ![](/img/parts/controller/opencr10/op3_02.webp)
...
5. Click on the icon in the Arduino IDE that displays the red circle in the following figure to build and download the firmware. When the download is completed, the firmware is automatically executed.
    ...
    ![](/img/parts/controller/opencr10/op3_03.webp)
...
2. Select File-> Save.
    ...
    ![](/img/parts/controller/opencr10/op3_05.webp)

3. Since the example provided is Read-Only, select OK to save it as a new file.

    ![](/img/parts/controller/opencr10/op3_06.webp)
...
4. Save it to a new folder and edit it. Once editing is complete, repeat the process of building and downloading the firmware.
    ...
    ![](/img/parts/controller/opencr10/op3_09.webp)
...
![](/img/parts/controller/opencr10/tilt_sensor.webp)
...
![](/img/parts/controller/opencr10/rotation_sensor.webp)
...
![](/img/parts/controller/opencr10/cap_sensor.webp)
...
![](/img/parts/controller/opencr10/flame_sensor.webp)
...
### Joystick Sensor
This is a joystick test on the OpenCR board.

![](/img/parts/controller/opencr10/joystick_sensor.webp)

- Specification
  - [Joystick Sensor Specification](https://www.dfrobot.com/wiki/index.php/Joystick_Module_For_Arduino_(SKU:DFR0061))
  - Interface : Analog

#### Code
Joystick is used to get the output value according to the input.  
...
## DYNAMIXEL Workbench
- [DYNAMIXEL Workbench examples](/docs/software/dynamixel_workbench#opencr-and-opencm-tutorials)

## OpenMANIPULATOR
- [OpenMANIPULATOR examples](https://emanual.robotis.com/docs/en/platform/openmanipulator/#how-to-control-on-opencr)
...
![](/img/parts/controller/opencr10/bootloader_01.webp)

## Boot Sequence
![](/img/parts/controller/opencr10/bootloader_03.webp)
...
![](/img/parts/controller/opencr10/bootloader_04.webp)
...
![](/img/parts/controller/opencr10/bootloader_05.webp)

![](/img/parts/controller/opencr10/bootloader_06.webp)
...
![](/img/parts/controller/opencr10/bootloader_07.webp)
...
![](/img/parts/controller/opencr10/bootloader_08.webp)
...
![](/img/parts/controller/opencr10/bootloader_10.webp)
...
![](/img/parts/controller/opencr10/dfu_device_manager.webp)


:::warning

### Burn Bootloader
#### Burn Bootloader(Linux)
...
![](/img/parts/controller/opencr10/arduino_mac_07.webp)
...
![](/img/parts/controller/opencr10/arduino_mac_08.webp)


:::warning

#### Burn Bootloader(Windows)
**CAUTION** : Update the bootloader if version has been updated.
...
![](/img/parts/controller/opencr10/bootloader_12.webp)
...
![](/img/parts/controller/opencr10/bootloader_11.webp)
...
3. Go to `Options` > `List All Devices`.
    ...
    ![](/img/parts/controller/opencr10/zadig_01.webp)

4. Select **STM32 BOOTLOADER** and install **WinUSB** driver.

    ![](/img/parts/controller/opencr10/zadig_02.webp)
...
- Set `0` (or not input status) to download the firmware.
  ...
  ![](/img/parts/controller/opencr10/arduino_bin_export.webp)

  > Exporting compiled binary file from Arduino IDE
...
## Execution Result
![](/img/parts/controller/opencr10/downloader_01.webp)

## Download Executable File
Executable file can be downloaded at the provided link.
...
# Reference
## Recovery Mode
If corrupted or incomplete firmware is downloaded and the board freezes or does not work, you must enter a boot loader to be able to download the normal firmware. See [Boot Sequence](/docs/parts/controller/opencr10#boot-sequence) for more information.

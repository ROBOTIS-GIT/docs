...
## DYNAMIXEL Workbench
- [DYNAMIXEL Workbench examples](/docs/software/dynamixel/dynamixel_workbench#opencr-and-opencm-tutorials)
...
# Reference
## Recovery Mode
If currupted or incompleted firmware is downloaded and the board freezes or does not work, you must enter a boot loader to be able to download the normal firmware. See [Boot Sequence](/docs/parts/controller/opencr10#boot-sequence) for more information.

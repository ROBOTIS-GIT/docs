...
**NOTE**: The OpenCR 1.0 e-Manual in Japanese (日本語) is available for the Japanese. 
...
**WARNING** : Please turn off the power switch before connecting power source(battery or SMPS) to the product.

...
id: cm-530
title: "CM-530"
sidebar_label: "CM-530"
sidebar_position: 50
tags: [parts, controller]
---

# Introduction
![](/img/parts/controller/cm-530/cm-530_product.png)
...
# Layout
![](/img/parts/controller/cm-530/cm-530_01.png)
...
![](/img/parts/controller/cm-530/cm-530_06.png)

### External 5-Pin Port

The pin composition of CM-530 external port is as below.

![](/img/parts/controller/cm-530/cm-530_07.png)

![](/img/parts/controller/cm-530/cm-530_08.png)
...
![](/img/parts/controller/cm-530/cm-530_09.png)
...
![](/img/parts/controller/cm-510/cm-510_13.png)
...
![](/img/parts/controller/cm-530/cm-530_02.jpg)
...
![](/img/parts/controller/cm-5/cm-5_04.jpg)

- RoboPlus Task

![](/img/parts/controller/cm-5/cm-5_05.jpg)

- RoboPlus Manager

![](/img/parts/controller/cm-5/cm-5_06.jpg)
...
![](/img/parts/controller/cm-530/cm-530_03.jpg)

# Wireless Communication
[ZIG-110]/[BT-110]/[BT-410] Wireless Communication Module can be connected to CM-530.

![](/img/parts/controller/cm-530/cm-530_04.jpg)

![](/img/parts/controller/cm-530/cm-530_05.jpg)
...
1. Take the battery out
  ...
  ![](/img/parts/controller/cm-530/cm_530_battery_charge_01.png)

2. Connect the charger

  ![](/img/parts/controller/cm-530/cm_530_battery_charge_02.png)

3. Charge

  Charging(Red LED), Complete(Green LED)

  ![](/img/parts/controller/cm-530/cm_530_battery_charge_03.png)


- You can connect the robot to an external power source through SMPS.

  ![](/img/parts/controller/cm-530/cm_530_battery_charge_04.png)

- The battery is equipped with a connector to charge the battery and another to move the robot

  ![](/img/parts/controller/cm-530/cm_530_battery_charge_05.jpg)
...
[Embedded C]: /docs/software/embedded_sdk/embedded_c_cm530
...
[AX-Series Pin Assignment]: /docs/dxl/ax/ax-12a#pin-assignment/

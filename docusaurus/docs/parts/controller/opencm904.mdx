...
**NOTE** [R+Manager 2.0 Firmware Recovery](/docs/software/dynamixel_wizard_2_0#firmware-recovery).
...
## Using DYNAMIXEL-X
To use ROBOTIS [software](/docs/software/overview#roboplus-r) (R+ Task, R+ Motion 및 R+ Manager) with [DYNAMIXEL-X](/docs/dxl/model_reference/x_series#x-series) series, [Configuring DYNAMIXEL Channle](#configuring-dynamixel-channel) is required.
...
**NOTE**: 
- [Keep a version of firmware up-to-date](/docs/software/dynamixel_wizard_2_0#firmware-update).  

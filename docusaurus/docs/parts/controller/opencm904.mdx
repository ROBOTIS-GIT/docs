...
**NOTE**: [The OpenCM 9.04 e-Manual](https://emanual.robotis.com/docs/en/parts/controller/opencm904_jp/) in Japanese (日本語) is available for the Japanese. 

:::


# Introduction
![](/img/parts/controller/opencm904/opencm904_product.webp)
...
# Hardware
## Memory Map
![](/img/parts/controller/opencm904/memory_map.webp)
...
![](/img/parts/controller/opencm904/opencm904_01.webp)


## Layout/Pin Map
![](/img/parts/controller/opencm904/opencm904_02.webp)
...
![](/img/parts/controller/opencm904/opencm9.04_1-1.webp)

> 4-pin communication port pinmap

![](/img/parts/controller/opencm904/opencm904_04.webp)

> Example : Wireless communication between OpenCM9.04 and a smartphone

![](/img/parts/controller/opencm904/opencm904_05.webp)

> Example : Bluetooth communication using OpenCM9.04 and RC100

![](/img/parts/controller/opencm904/opencm904_06.webp)

> Example : Zigbee communication using OpenCM9.04 and RC100

![](/img/parts/controller/opencm904/opencm904_07.webp)
...
![](/img/parts/controller/opencm904/opencm904_08.webp)
...
![](/img/parts/controller/opencm904/opencm904_09.webp)
...
![](/img/parts/controller/opencm904/opencm904_10.webp)
...
![](/img/parts/controller/opencm904/opencm904_11.webp)
...
![](/img/parts/controller/opencm904/opencm904_12.webp)

> 5-pin port number and instructions

![](/img/parts/controller/opencm904/opencm904_13.webp)
...
![](/img/parts/controller/opencm904/opencm904_15.webp)

> JP2 jumper location and instructions

![](/img/parts/controller/opencm904/opencm904_16.webp)
...
![](/img/parts/controller/opencm904/opencm904_20.webp)

> Picture A

![](/img/parts/controller/opencm904/opencm904_21.webp)
...
![](/img/parts/controller/opencm904/opencm904_22.webp)

> CAUTION: Remove either the battery connector or +-header-pin power

![](/img/parts/controller/opencm904/opencm904_23.webp)

> CAUTION: Don’t used different types of batteries

![](/img/parts/controller/opencm904/opencm904_24.webp)
...
![](/img/parts/controller/opencm904/opencm904_27.webp)
...
#### Run the Arduino IDE (Linux)
To run the Arduino IDE on Linux platform, type into the terminal as follows.
```text
arduino
```

#### Porting the OpenCM9.04 board to the Arduino IDE (Linux)
##### Preferences (Linux)
...
##### Install the OpenCM9.04 package via Boards Manager (Linux)
Click Tools → Board → Boards Manager.

![](/img/parts/controller/opencm904/opencm9.04_linux_2.webp)
...
![](/img/parts/controller/opencm904/opencm9.04_linux_6.webp)

### Install on Mac
#### Install the Arduino IDE (Mac)
Download the latest version of Arduino IDE from the official arduino homepage, and install it. Currently, the OpenCM9.04 will be on service in the version 1.6.4 or later.

[https://www.arduino.cc/en/Main/Software](https://www.arduino.cc/en/Main/Software)

#### Run the Arduino IDE (Mac)
To run the Arduino IDE on Mac platform, click the Arduino IDE icon as follows.

![](/img/parts/controller/opencm904/arduino_mac_01.webp)

![](/img/parts/controller/opencm904/arduino_mac_02.webp)

#### Porting the OpenCM9.04 board to the Arduino IDE (Mac)
##### Preferences (Mac)
After Arduino IDE is run, click File → Preferences in the top menu of the IDE. When the Preferences window appears, copy and paste following link to the Additional Boards Manager URLs textbox. (This step may take about 20 min.)
...
##### Install the OpenCM9.04 package via Boards Manager (Mac)
Click Tools → Board → Boards Manager.

![](/img/parts/controller/opencm904/opencm9.04_mac_2.webp)
...
![](/img/parts/controller/opencm904/opencm9.04_mac_6.webp)
...
#### Porting the OpenCM 9.04 board to the Arduino IDE (Windows)
##### Preferences (Windows)
After Arduino IDE is run, click File → Preferences in the top menu of the IDE. When the Preferences window appears, copy and paste following link to the Additional Boards Manager URLs textbox. (This step may take about 20 min.)

[https://raw.githubusercontent.com/ROBOTIS-GIT/OpenCM9.04/master/arduino/opencm_release/package_opencm9.04_index.json](https://raw.githubusercontent.com/ROBOTIS-GIT/OpenCM9.04/master/arduino/opencm_release/package_opencm9.04_index.json)

![](/img/parts/controller/opencm904/opencm904_win_1.webp)

##### Install the OpenCM9.04 package via Boards Manager (Windows)
Click Tools → Board → Boards Manager.
...
[getTorqueEnableStat()]: /docs/popup/arduino_api/getTorqueEnableStat
...
![](/img/parts/controller/opencm904/buzzer_bb.webp)
...
![](/img/parts/controller/opencm904/ex_eeprom_02.webp)

![](/img/parts/controller/opencm904/ex_eeprom_03.webp)
...
### Connection with Servo
![](/img/parts/controller/opencm904/servo_bb.webp)
...
### Connection with SD Card
- SD Card Connection(SPI port)

  ![](/img/parts/controller/opencm904/sdcard_bb.webp)

### Arduino code for SD Card
...
![](/img/parts/controller/opencm904/AD304-2T.webp)
...
# References
## Recovery Mode
- If the board does not work due to corrupted firmware, you can force downloading default firmware from Roboplus Manager 1.0 / 2.0. Sketches also can be downloaded from Arduino IDE.
- Disconnect other power sources and devices from OpenCM9.04. While holding down the User Button of OpenCM9.04, connect the board directly to PC with USB cable.
  ...
  ![](/img/software/mobile/mini_firmware_02.webp)
  > User Button
...
- If you enter recovery mode as shown below, the green LED will be turned on. When download is completed normally, the board will be reset and the green LED is turned off.
  ...
  ![](/img/parts/controller/opencm904/recovery_led.webp)


:::note

**NOTE** [R+Manager 2.0 Firmware Recovery](/docs/software/dynamixel/dynamixel_wizard2#firmware-recovery).
...
## Using DYNAMIXEL-X
To use ROBOTIS [software](/docs/software#roboplus-r) (R+ Task, R+ Motion 및 R+ Manager) with [DYNAMIXEL-X](/docs/dxl/model_reference/x_series#x-series) series, [Configuring DYNAMIXEL Channle](#configuring-dynamixel-channel) is required.
...
**NOTE**: With [OpenCM485 EXP Board](/docs/parts/controller/opencm485exp), DYNAMIXEL-X with 24V and RS-485 Communication Port can be used.  
![](/img/software/rplus2/manager/rplusmanager2_30_kr.webp)  
...
**NOTE**: 
- [Keep a version of firmware up-to-date](/docs/software/dynamixel/dynamixel_wizard2#firmware-update).  
...
1. Open R+ Manager, and select **OpenCM 9.04** in the **Home** tab.
    ...
    ![](/img/software/rplus2/manager/rplus_manager2_dxl_channel_setting_01.webp)

2. Select **Update & Test**.  

    ![](/img/software/rplus2/manager/rplus_manager2_dxl_channel_setting_02.webp)
...
3. When the control table appears, select an DYNAMIXEL's bus channel on the list of **Dynamixel Channel**. For example, select **EXP Board(X-Series)** to use DYNAMIXEL-X series on the expansion board.
    ...
    ![](/img/software/rplus2/manager/rplus_manager2_dxl_channel_setting_03.webp)
...
## Dimension
![](/img/parts/controller/opencm904/opencm904_28.webp)
...
[How to install ROBOTIS virtual COM port for Windows]: /docs/popup/usb_driver_install
...
[RoboPlus Motion]: https://emanual.robotis.com/docs/en/software/rplus1/motion
[RoboPlus Manager]: https://emanual.robotis.com/docs/en/software/rplus1/manager
[Number of pressed Start button]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#button-count/
[Start button]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#button-count/
[LN-101]: /docs/parts/interface/ln-101
[ZIG-110A]: /docs/parts/communication/zig-110
[BT-110A]: /docs/parts/communication/bt-110
[BT-210]: /docs/parts/communication/bt-210
[BT-410]: /docs/parts/communication/bt-410
[Automatic Turn-off]: https://emanual.robotis.com/docs/en/software/rplus1/task/programming_02#powersave-timer/
...
[ROBOTIS-MINI Controller Firmware Update]: https://emanual.robotis.com/docs/en/edu/mini/#firmware-update/
[Arduino IDE]: /docs/parts/controller/opencm904#arduino-ide
[DYNAMIXEL SDK]: /docs/software/dynamixel/dynamixel_sdk/overview
[DYNAMIXELWorkbench]: http://wiki.ros.org/dynamixel_workbench
[Arduino Libraries]: /docs/parts/controller/opencm904#library-api
[Arduino Official Guide]: https://www.arduino.cc/en/Guide/Libraries

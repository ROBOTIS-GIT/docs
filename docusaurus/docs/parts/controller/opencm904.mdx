...
**NOTE** [R+Manager 2.0 Firmware Recovery](https://emanual.robotis.com/docs/en/software/rplus2/manager#firmware-recovery).
...
## Using DYNAMIXEL-X
To use ROBOTIS [software](/docs/software#roboplus-r) (R+ Task, R+ Motion 및 R+ Manager) with [DYNAMIXEL-X](/docs/dxl/model_reference/x_series/x_series#x-series) series, [Configuring DYNAMIXEL Channle](#configuring-dynamixel-channel) is required.
...
**NOTE**: 
- [Keep a version of firmware up-to-date](https://emanual.robotis.com/docs/en/software/rplus2/manager#firmware-update).  

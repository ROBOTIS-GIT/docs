...
# Introduction
![](/img/parts/controller/opencm904/opencm904_product.png)
...
# Hardware
## Memory Map
![](/img/parts/controller/opencm904/memory_map.png)
...
![](/img/parts/controller/opencm904/opencm904_01.png)


## Layout/Pin Map
![](/img/parts/controller/opencm904/opencm904_02.png)
...
![](/img/parts/controller/opencm904/opencm9.04_1-1.jpg)

> 4-pin communication port pinmap

![](/img/parts/controller/opencm904/opencm904_04.png)

> Example : Wireless communication between OpenCM9.04 and a smartphone

![](/img/parts/controller/opencm904/opencm904_05.png)

> Example : Bluetooth communication using OpenCM9.04 and RC100

![](/img/parts/controller/opencm904/opencm904_06.png)

> Example : Zigbee communication using OpenCM9.04 and RC100

![](/img/parts/controller/opencm904/opencm904_07.png)
...
![](/img/parts/controller/opencm904/opencm904_08.png)
...
![](/img/parts/controller/opencm904/opencm904_09.png)
...
![](/img/parts/controller/opencm904/opencm904_10.png)
...
![](/img/parts/controller/opencm904/opencm904_11.png)
...
![](/img/parts/controller/opencm904/opencm904_12.png)

> 5-pin port number and instructions

![](/img/parts/controller/opencm904/opencm904_13.png)
...
![](/img/parts/controller/opencm904/opencm904_15.png)

> JP2 jumper location and instructions

![](/img/parts/controller/opencm904/opencm904_16.png)
...
![](/img/parts/controller/opencm904/opencm904_20.jpg)

> Picture A

![](/img/parts/controller/opencm904/opencm904_21.jpg)
...
![](/img/parts/controller/opencm904/opencm904_22.jpg)

> CAUTION: Remove either the battery connector or +-header-pin power

![](/img/parts/controller/opencm904/opencm904_23.jpg)

> CAUTION: Don’t used different types of batteries

![](/img/parts/controller/opencm904/opencm904_24.png)
...
![](/img/parts/controller/opencm904/opencm904_27.png)
...
![](/img/parts/controller/opencm904/opencm9.04_linux_6.png)
...
![](/img/parts/controller/opencm904/arduino_mac_01.png)

![](/img/parts/controller/opencm904/arduino_mac_02.png)
...
![](/img/parts/controller/opencm904/opencm9.04_mac_1.png)

##### Install the OpenCM9.04 package via Boards Manager (Mac)
Click Tools → Board → Boards Manager.

![](/img/parts/controller/opencm904/opencm9.04_mac_2.png)

Type OpenCM9.04 into the textbox to find the OpenCM9.04 by ROBOTIS package. After it finds out, click Install.

![](/img/parts/controller/opencm904/opencm9.04_mac_3.png)

After the installation, “INSTALLED” will be appeared.

![](/img/parts/controller/opencm904/opencm9.04_mac_4.png)
...
![](/img/parts/controller/opencm904/opencm9.04_mac_6.png)
...
![](/img/parts/controller/opencm904/opencm904_win_1.png)

##### Install the OpenCM9.04 package via Boards Manager (Windows)
Click Tools → Board → Boards Manager.

![](/img/parts/controller/opencm904/opencm904_win_2.png)

Type OpenCM9.04 into the textbox to find the OpenCM9.04 by ROBOTIS package. After it finds out, click Install.

![](/img/parts/controller/opencm904/opencm904_win_3.png)

After the installation, “INSTALLED” will be appeared.

![](/img/parts/controller/opencm904/opencm904_win_4.png)

See if OpenCM9.04 Board is now on the list of Tools → Board. Click this to import the OpenCM9.04 Board source.

![](/img/parts/controller/opencm904/opencm904_win_5.png)
...
![](/img/parts/controller/opencm904/oencm904_upload_01.png)
...
![](/img/parts/interface/dynamixel_shield/library_manager_01.png)
...
![](/img/parts/controller/opencm904/buzzer_bb.png)
...
![](/img/parts/controller/opencm904/ex_eeprom_02.png)

![](/img/parts/controller/opencm904/ex_eeprom_03.png)
...
![](/img/parts/controller/opencm904/servo_bb.png)
...
- SD Card Connection(SPI port)
  ...
  ![](/img/parts/controller/opencm904/sdcard_bb.png)
...
![](/img/parts/controller/opencm904/AD304-2T.jpg)
...
- Disconnect other power sources and devices from OpenCM9.04. While holding down the User Button of OpenCM9.04, connect the board directly to PC with USB cable.
  ...
  ![](/img/software/mobile/mini_firmware_02.jpg)
  > User Button
...
- If you enter recovery mode as shown below, the green LED will be turned on. When download is completed normally, the board will be reset and the green LED is turned off.
  ...
  ![](/img/parts/controller/opencm904/recovery_led.jpg)


:::note

**NOTE** [R+Manager 2.0 Firmware Recovery](/docs/software/rplus2/manager#firmware-recovery).
...
![](/img/software/rplus2/manager/rplusmanager2_30_kr.jpg)  
...
## Dimension
![](/img/parts/controller/opencm904/opencm904_28.png)
...
[RoboPlus Motion]: /docs/software/rplus1/motion
[RoboPlus Manager]: /docs/software/rplus1/manager
...
[Firmware Update]: /docs/software/rplus1/manager#firmware-update/

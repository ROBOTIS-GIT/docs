...
OpenCM9.04 with OpenCM 485 EXP can use all types of DYNAMIXEL.
...
| Embedded SDK(CM-510/530/700) |   X    |    X    |    X     |    X     |    X     |    X     |    ✓     |    ✓     |    X     |    ✓     |    X     |                  X                  |      X      |    X     |
|         [Arduino IDE]         |   X    |    X    |    X     |    X     |    X     |    X     |    X     |    X     |    X     |    X     |    X     |                  ✓                  |      X      |    ✓     |

:::info

- Users can build their own manipulator with ROBOTIS Manipulator library offered by ROBOTIS.
- Users can build their own firmware of CM-510/530/700 with Embedded SDK offered by ROBOTIS.
...
[R+ Task 1.0]: /docs/software/rplus_1_0/rplus_task/getting_started
[R+ Manager 1.0]: /docs/software/rplus_1_0/rplus_manager
[R+ Motion  1.0]: /docs/software/rplus_1_0/rplus_motion

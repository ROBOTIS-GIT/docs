...
![](/img/parts/controller/rb-86/rb_86_overview.jpg)
...
# Layout
![rb_86_label](/img/parts/controller/rb-86/rb_86_label.jpg)
...
![rb_86_unpluged_md](/img/parts/controller/rb-86/rb_86_unpluged_md_en.PNG)
...
![rb_86_cross_hn](/img/parts/controller/rb-86/rb_86_cross_hn.png)
...
1. Navigate to the STEAMCUP website.
   ...
   ![rb_86_pc_google](/img/parts/controller/rb-86/rb_86_pc_google.jpg)

2. Click on the hamburger menu in the upper right corner, sign up, and log in.

   ![rb_86_pc_hamburger](/img/parts/controller/rb-86/rb_86_pc_hamburger_en.jpg)

3. Click on `Add Robot`.

   ![rb_86_pc_add_rb](/img/parts/controller/rb-86/rb_86_pc_add_rb_en.jpg)


4. Select the controller you want to connect to from the Bluetooth device selection window and proceed with pairing.

   ![rb_86_pc_04_pairing](/img/parts/controller/rb-86/rb_86_pc_04_pairing_en.jpg)
...
1. Download the STEAMCUP app from the Google Play Store or App Store.
   ...
   ![rb_86_mob_download](/img/parts/controller/rb-86/rb_86_mob_download_en.jpg)

2. Run the STEAMCUP app, sign up, and log in.

3. Click on `Add Robot` and select the controller you want to connect to.

   ![rb_86_mob_add_rb](/img/parts/controller/rb-86/rb_86_mob_add_rb_en.jpg)
...
2. Click on the RB-86 icon.
   ...
   ![rb_86_icon](/img/parts/controller/rb-86/rb_86_icon_en.jpg)

3. Click on the Firmware Recovery/Update button.

   ![rb_86_click](/img/parts/controller/rb-86/rb_86_click_en.jpg)

4. Follow the wireless firmware update instructions.

   ![rb_86_recovery](/img/parts/controller/rb-86/rb_86_recovery_en.jpg)
...
2. Select the remote controller icon to open the virtual remote controller.
    ...
    ![rb_86_control](/img/parts/controller/rb-86/rb_86_control_en.jpg)
...
- When running either of the following R-Block blocks, the RB-86 will automatically attempt to correct straightness during motion.
    ...
    ![rb_86_foward](/img/parts/controller/rb-86/rb_86_foward_en.jpg)
    ![rb_86_backward](/img/parts/controller/rb-86/rb_86_backward_en.jpg)

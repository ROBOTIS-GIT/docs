...
![](/img/parts/controller/rb-86/rb_86_overview.webp)
...
# Layout
![rb_86_label](/img/parts/controller/rb-86/rb_86_label.webp)
...
![rb_86_unpluged_md](/img/parts/controller/rb-86/rb_86_unpluged_md_en.webp)
...
- Connect to an RB-86 controller in Recovery mode by clicking "Add Robot" in the STEAMCUP app. ([Mobile Device Connection](/docs/parts/controller/rb-86#connect-from-mobile))
...
![rb_86_cross_hn](/img/parts/controller/rb-86/rb_86_cross_hn.webp)
...
1. Navigate to the STEAMCUP website.
   ...
   ![rb_86_pc_google](/img/parts/controller/rb-86/rb_86_pc_google.webp)

2. Click on the hamburger menu in the upper right corner, sign up, and log in.

   ![rb_86_pc_hamburger](/img/parts/controller/rb-86/rb_86_pc_hamburger_en.webp)

3. Click on `Add Robot`.

   ![rb_86_pc_add_rb](/img/parts/controller/rb-86/rb_86_pc_add_rb_en.webp)


4. Select the controller you want to connect to from the Bluetooth device selection window and proceed with pairing.

   ![rb_86_pc_04_pairing](/img/parts/controller/rb-86/rb_86_pc_04_pairing_en.webp)
...
1. Download the STEAMCUP app from the Google Play Store or App Store.
   ...
   ![rb_86_mob_download](/img/parts/controller/rb-86/rb_86_mob_download_en.webp)

2. Run the STEAMCUP app, sign up, and log in.

3. Click on `Add Robot` and select the controller you want to connect to.

   ![rb_86_mob_add_rb](/img/parts/controller/rb-86/rb_86_mob_add_rb_en.webp)
...
2. Click on the RB-86 icon.
   ...
   ![rb_86_icon](/img/parts/controller/rb-86/rb_86_icon_en.webp)

3. Click on the Firmware Recovery/Update button.

   ![rb_86_click](/img/parts/controller/rb-86/rb_86_click_en.webp)

4. Follow the wireless firmware update instructions.

   ![rb_86_recovery](/img/parts/controller/rb-86/rb_86_recovery_en.webp)
...
2. Select the remote controller icon to open the virtual remote controller.
    ...
    ![rb_86_control](/img/parts/controller/rb-86/rb_86_control_en.webp)
...
- When running either of the following R-Block blocks, the RB-86 will automatically attempt to correct straightness during motion.
    ...
    ![rb_86_foward](/img/parts/controller/rb-86/rb_86_foward_en.webp)
    ![rb_86_backward](/img/parts/controller/rb-86/rb_86_backward_en.webp)

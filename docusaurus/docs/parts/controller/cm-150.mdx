...
- Write a task code and control robot’s components with [R+ Task](v1.1.0.0 or higher) or [R+ Task 2.0](/docs/software/rplus2/task)
...
![](/img/parts/controller/cm-100/cm-100_005.jpg)

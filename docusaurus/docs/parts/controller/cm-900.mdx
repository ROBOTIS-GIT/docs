...
id: cm-900
title: "CM-900"
sidebar_label: "CM-900"
sidebar_position: 61
tags: [parts, controller]
---

# Introduction
![](/img/parts/controller/cm-900/cm-900_product.webp)
...
# Layout
![](/img/parts/controller/cm-900/cm-900_01.webp)
...
2. Choose `ROBOTIS\drivers` directory
    ...
    ![](/img/parts/controller/cm-900/cm-900_02.gif)
 
3. Choose "install this driver software anyways"

    ![](/img/parts/controller/cm-900/cm-900_03.gif)
 
4. Check for COM port number

    ![](/img/parts/controller/cm-900/cm-900_04.gif)
...
3. Go to "Tools" > "Serial Port" and select the correct port number(refer to Windows Device Manager)
    ...
    ![](/img/parts/controller/cm-900/cm-900_05.gif)
 
4. Select the corresponding hardware version

    ![](/img/parts/controller/cm-900/cm-900_06.gif)
 
5. Pick any example

    ![](/img/parts/controller/cm-900/cm-900_07.gif)
...
6. Choose 1 of the 2buttons
  ...
  - The examples are read-only
    ...
    ![](/img/parts/controller/cm-900/cm-900_08.webp)
    
    ![](/img/parts/controller/cm-900/cm-900_09.webp)
...
7. Check USB data via serial monitor
    ...
    ![](/img/parts/controller/cm-900/cm-900_10.webp)

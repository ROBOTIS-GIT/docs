...
## Terminal VIN
The included terminal block provides compatibility with a wide range of input power sources.  
...
![](/img/parts/controller/openrb-150/openrb-150_connection_example01_1.webp)

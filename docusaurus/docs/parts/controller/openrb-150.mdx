...
# Overview
![](/img/parts/controller/openrb-150/openrb_fonts.png)  
...
![](/img/parts/controller/openrb-150/openrb-150_switch.png)
...
![](/img/parts/controller/openrb-150/openrb-150_jumper.png)  
> Terminal VIN jumper setting

![](/img/parts/controller/openrb-150/openrb-150_power_inputs.png)  
...
![](/img/parts/controller/openrb-150/openrb-150_power_xt60.png)  
...
|:------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------:|
| ![](/img/parts/controller/openrb-150/openrb-150_power_jumper_5v.png) | ![](/img/parts/controller/openrb-150/openrb-150_power_jumper_terminal.png) |
...
|         Diagram          |        ![](/img/dxl/jst_b3beha_diagram.png)        |
|         Housing          |   ![](/img/dxl/JST_EHR-3.png)<br />[JST EHR-03]    |
|        PCB Header        | ![](/img/dxl/JST_B3B_EH-A.png)<br />[JST B3B-EH-A] |
...
![](/img/parts/interface/dxl_bridge/dxl_bridge_product_front.png)
...
![](/img/parts/controller/openrb-150/openrb-150_serial_port.png)
...
![](/img/parts/controller/openrb-150/openrb-150_leds.png)
...
## USB C
  ![](/img/parts/controller/openrb-150/openrb-150_power_usb.png)

## VIN  
  ![](/img/parts/controller/openrb-150/openrb-150_power_vin.png)

## Terminal VIN  
  ![](/img/parts/controller/openrb-150/openrb-150_power_terminal_vin.png)
...
![](/img/parts/controller/openrb-150/openrb-150_connection_example03.png)
...
![](/img/parts/controller/openrb-150/openrb-150_wizard2_connection.png)  
...
![](/img/parts/controller/openrb-150/openrb-150_wizard2_connection02.png)  
> Various baudrates up to 1 Mbps are supported

![](/img/parts/controller/openrb-150/openrb-150_wizard2_fw_recovery.png)  
> DYNAMIXEL Firmware Recovery and Update are supported

![](/img/parts/controller/openrb-150/openrb-150_wizard2_graph.png)  
> Graphing feature is supported

![](/img/parts/controller/openrb-150/openrb-150_wizard2_packet.png)  
...
1. Download the `Linux 64 bit` version of Arduino IDE from the official Arduino download page.  
  ![](/img/icon_download.png) [https://www.arduino.cc/en/software](https://www.arduino.cc/en/software)
...
![](/img/parts/controller/openrb-150/openrb-150_board_manager_index.png)
...
![](/img/parts/controller/openrb-150/arduino_samd_board_manager.png)
...
![](/img/parts/controller/openrb-150/openrb-150_board_manager.png)
...
[X Series]: /docs/dxl/x
[MX Series]: /docs/dxl/mx
[AX Series]: /docs/dxl/ax
[P Series]: /docs/dxl/p

...
- Recover controller firmware with [RoboPlus Manager] (v1.0.30.0 or higher) or [RoboPlus Manager 2.0](/docs/software/dynamixel/dynamixel_wizard2)
...
# Layout
![](/img/parts/controller/cm-200/cm_200_label_01.webp)
...
![](/img/parts/controller/cm-200/cm_200_04.webp)
...
![](/img/parts/controller/cm-200/cm_200_05.webp)


:::note

**Note**: You can use a smart phone to download motion and task files wirelessly to CM-200 using R+ m.Motion, see [Motion Download](https://emanual.robotis.com/docs/en/software/rplus_mobile/mmotion#motion-download) for more information.
...
**Note**: You can use smart device to download motion and task files to CM-200 wirelessly using R+ m.Motion, see [Motion Download](https://emanual.robotis.com/docs/en/software/rplus_mobile/mmotion#motion-download) and [Task Download](https://emanual.robotis.com/docs/en/software/rplus_mobile/mtask20#task-download) for more information.
...
[RoboPlus Manager 2.0]: /docs/software/dynamixel/dynamixel_wizard2

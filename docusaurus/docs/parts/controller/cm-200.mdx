...
- Recover controller firmware with [RoboPlus Manager] (v1.0.30.0 or higher) or [RoboPlus Manager 2.0](/docs/software/dynamixel_wizard_2_0)
...
[RoboPlus Manager 2.0]: /docs/software/dynamixel_wizard_2_0

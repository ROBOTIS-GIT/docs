...
# Introduction
![](/img/parts/controller/cm-200/cm_200.jpg)

> CM-200

- Can connect and control SMART device (reduction motors, servo motors, touch sensors, IR sensor, LED mobules, etc)
- Recover controller firmware with [RoboPlus Manager] (v1.0.30.0 or higher) or [RoboPlus Manager 2.0](/docs/software/rplus2/manager)
...
# Layout
![](/img/parts/controller/cm-200/cm_200_label_01.jpg)
...
![](/img/parts/controller/cm-200/cm_200_04.jpg)

![](/img/parts/controller/cm-200/cm_200_label_02.jpg)
...
![](/img/parts/controller/cm-200/cm_200_label_03.jpg)
...
![](/img/parts/controller/cm-200/cm_200_power.jpg)

# How to Operate
![](/img/parts/controller/cm-200/cm_200_operate.jpg)
...
![](/img/parts/controller/cm-200/cm_200_05.jpg)


:::note

**Note**: You can use a smart phone to download motion and task files wirelessly to CM-200 using R+ m.Motion, see [Motion Download](/docs/software/rplus_mobile/mmotion#motion-download) for more information.
...
![](/img/parts/controller/cm-200/cm_200_06.jpg)

![](/img/parts/controller/cm-200/cm_200_07.jpg)


:::note

**Note**: You can use smart device to download motion and task files to CM-200 wirelessly using R+ m.Motion, see [Motion Download](/docs/software/rplus_mobile/mmotion#motion-download) and [Task Download](/docs/software/rplus_mobile/mtask20#task-download) for more information.
...
[RoboPlus Manager 2.0]: /docs/software/rplus2/manager
[R+ Task]: /docs/software/rplus1/task/getting_started
[R+ Task 2.0]: /docs/software/rplus2/task#download-task-code/
[R+ Task 3.0]: https://emanual.robotis.com/docs/en/software/rplustask3/
[R+ Motion]: /docs/software/rplus1/motion

...
![](/img/parts/controller/cm-50/cm-50_product.webp)
...
- [How to update controller firmware](/docs/software/dynamixel/dynamixel_wizard2#firmware-update)
...
## RC-200
[RC-200](/docs/parts/communication/rc-200) supports IR communication with controller.
...
1. Install [R+ m.Task 2.0](https://emanual.robotis.com/docs/en/software/rplus_mobile/mtask20#app-installation) on the smart device.
2. Start the CM-50 controller with [Tuning Mode](#tuning-mode).
3. Connect the BT-210 or BT-410 Slave module to CM-50 controller.
4. Run R+ m.Task 2.0 then use [Remote Controller Program] to connect the CM-50 controller.
5. Follow the [Tuning Guide](#tuning-guide) to tune the motor speed, then save the configuration.
...
[R+Block]: https://emanual.robotis.com/docs/en/software/rplus2/rplus2_block
[RoboPlus Task 2.0]: https://emanual.robotis.com/docs/en/software/rplus2/task
...
[Remote Controller Program]: https://emanual.robotis.com/docs/en/software/rplus_mobile/mtask20#remote-controller/

...
![](/img/parts/controller/cm-50/cm-50_product.png)
...
- [How to update controller firmware](/docs/software/rplus2/manager#firmware-update)
...
1. Install [R+ m.Task 2.0](/docs/software/rplus_mobile/mtask20#app-installation) on the smart device.
2. Start the CM-50 controller with [Tuning Mode](#tuning-mode).
3. Connect the BT-210 or BT-410 Slave module to CM-50 controller.
...
[R+Block]: /docs/software/rplus2/rplus2_block
[RoboPlus Task 2.0]: /docs/software/rplus2/task
...
[Remote Controller Program]: /docs/software/rplus_mobile/mtask20#remote-controller/

...
## Introduction
![](/img/software/dynamixel/dynamixel_workbench/DYNAMIXEL_WORKBENCH_LOGO.webp)
...
![](/img/software/dynamixel/dynamixel_workbench/opencr_arduino_setup.webp)
...
![](/img/software/dynamixel/dynamixel_workbench/opencm_arduino_setup.webp)
...
![](/img/parts/controller/opencm904/opencm485exp_01.webp)
...
![](/img/software/dynamixel/dynamixel_workbench/controller_service_call.webp)
...
1. Open `o_Find_Dynamixel`
    ...
    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_1.webp)  

1. Select Port

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_2.webp)  

1. Push `Upload` button or `CTRL+U`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_3.webp)  

1. You can show if the firmware upload successfully

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_4.webp)  

1. Push `Serial Monitor` button

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_5.webp)  

1. Serial monitor starts to scan and find DYNAMIXEL

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_6.webp)  
...
1. Serial monitor shows dynamixel monitor
    ...
    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_7.webp)  

1. Type `begin 57600`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_8.webp)  

1. Type `scan 10`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_9.webp)  

1. Type `torque_on 1` and `torque_on 2`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_10.webp)  

1. Type `sync_write_handler 1 Goal_Position`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_11.webp)  

1. Type `sync_write 1 2 0 2048 2048` then DYNAMIXEL will rotate

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_12.webp)  

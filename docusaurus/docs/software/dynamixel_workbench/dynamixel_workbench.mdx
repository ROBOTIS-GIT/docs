...
## Introduction
![](/img/software/dynamixel_workbench/dynamixel_workbench/DYNAMIXEL_WORKBENCH_LOGO.webp)
...
- Downloads [Arduino IDE](/docs/software/arduino_ide) for uploding firmware to OpenCR and OpenCM

#### OpenCR Arduino IDE

![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_arduino_setup.webp)

In order to use Exameples for OpenCM 9.04 in Arduino, Porting OpenCM9.04 Board to Arduino IDE is required.  

- [Porting the OpenCR1.0 board to the Arduino IDE](/docs/parts/controller/opencr10#porting-to-arduino-idelinux)

#### OpenCM Arduino IDE

![](/img/software/dynamixel_workbench/dynamixel_workbench/opencm_arduino_setup.webp)
...
- [Linux](/docs/software/dynamixel_sdk/library_setup/cpp#cpp-linux)  
- [macOS](/docs/software/dynamixel_sdk/library_setup/cpp#cpp-macos)  
...
[How to Setup](/docs/parts/interface/u2d2)
...
![](/img/software/dynamixel_workbench/dynamixel_workbench/opencm485exp_01.webp)

# Tutorials
- [ROS](/docs/software/dynamixel_workbench#ros-tutorials)
    - [Find Dynamixels](/docs/software/dynamixel_workbench#find-dynamixels)
    - [Controllers](/docs/software/dynamixel_workbench#controllers)
    - [Operators](/docs/software/dynamixel_workbench#operators)

    - [OpenCR and OpenCM](/docs/software/dynamixel_workbench#opencr-and-opencm-tutorials)
    - [o_Find_Dynamixel](/docs/software/dynamixel_workbench#o_find_dynamixel)
    - [p_Monitor](/docs/software/dynamixel_workbench#p_monitor)

- [Linux and macOS](/docs/software/dynamixel_workbench#linux-and-macos)
    - [Examples](/docs/software/dynamixel_workbench#examples)
    - [position](/docs/software/dynamixel_workbench#position)
    - [bulk_read_write](/docs/software/dynamixel_workbench#bulk_read_write)
...
**TIP**: If you can't find any DYNAMIXEL, please check usb port, power. Even if it can't find anything, please check firmware to use ROBOTIS software ([R+ Manager 2.0](/docs/software/rplus_manager_2_0) or [R+ Manager 1.0](/docs/software/rplus_1_0/rplus_manager))
...
Let's take a look at the `joint_2_0.yaml` file. This file indicates configuration for 2 DYNAMIXEL. The first DYNAMIXEL has the name of 'pan' and id is '1' whereas the second DYNAMIXEL has the name of 'tilt' and id is '2'. Both DYNAMIXEL will be set [Return_Delay_time](/docs/dxl/model_reference/x_series/xm_series/xm430-w350#return-delay-time9) to zero(0) and [Operating_Mode](/docs/dxl/model_reference/x_series/xm_series/xm430-w350#operating-mode11) to Position Control Mode(3).
...
-`Torque Enable`, which is the data of [Control Table](/docs/faq/faq_dynamixel) of DYNAMIXEL, is not supposed to be set by users, but it's enabled by itself during initialization.  
...
![](/img/software/dynamixel_workbench/dynamixel_workbench/controller_service_call.webp)
...
1. Open `o_Find_Dynamixel`
    ...
    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_1.webp)  

1. Select Port

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_2.webp)  

1. Push `Upload` button or `CTRL+U`

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_3.webp)  

1. You can show if the firmware upload successfully

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_4.webp)  

1. Push `Serial Monitor` button

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_5.webp)  

1. Serial monitor starts to scan and find DYNAMIXEL

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_6.webp)  
...
1. Serial monitor shows dynamixel monitor
    ...
    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_7.webp)  

1. Type `begin 57600`

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_8.webp)  

1. Type `scan 10`

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_9.webp)  

1. Type `torque_on 1` and `torque_on 2`

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_10.webp)  

1. Type `sync_write_handler 1 Goal_Position`

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_11.webp)  

1. Type `sync_write 1 2 0 2048 2048` then DYNAMIXEL will rotate

    ![](/img/software/dynamixel_workbench/dynamixel_workbench/opencr_example_12.webp)  
...
### bool clearBulkReadParam(void)
**Description**  
Clear every parameter for bulkRead  
...
[dynamixel_workbench_msgs/DynamixelInfo]: /docs/software/dynamixel_workbench/msgs/dynamixel_workbench_msgs_DynamixelInfo
[dynamixel_workbench_msgs/DynamixelCommand]: /docs/software/dynamixel_workbench/msgs/dynamixel_workbench_msgs_DynamixelCommand
[dynamixel_workbench_msgs/DynamixelStateList]: /docs/software/dynamixel_workbench/msgs/dynamixel_workbench_msgs_DynamixelStateList
[open_manipulator_msgs/GetJointPosition]: /docs/systems/openmanipulator_x/msgs/open_manipulator_msgs_GetJointPosition
[open_manipulator_msgs/GetKinematicsPose]: /docs/systems/openmanipulator_x/msgs/open_manipulator_msgs_GetKinematicsPose
[open_manipulator_msgs/SetJointPosition]: /docs/systems/openmanipulator_x/msgs/open_manipulator_msgs_SetJointPosition
[open_manipulator_msgs/SetKinematicsPose]: /docs/systems/openmanipulator_x/msgs/open_manipulator_msgs_SetKinematicsPose
[How to set Industrial filter into joint trajectory]: /docs/software/dynamixel_workbench/how_to_set_smoothing_filter
[DYNAMIXEL SDK]: /docs/software/dynamixel_sdk/
[DYNAMIXEL Wizard 2.0]: /docs/software/dynamixel_wizard_2_0/introduction
[R+ Manager 2.0]: /docs/software/rplus_manager_2_0

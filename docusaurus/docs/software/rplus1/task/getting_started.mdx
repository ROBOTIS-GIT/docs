---
id: getting_started
title: "R+ Task 1.0 - Getting Started"
...
[rule check error messages]: /docs/software/rplus1/task/task_misc#rule-check/
[Error Messages]: /docs/software/rplus1/task/task_misc#error-messages/

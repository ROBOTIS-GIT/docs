...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_001.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_005.png)
...
1. When the controller is connected, the controller's firmware version will be retrieved. If a newer firmware is available, it will ask whether to download the latest firmware.
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_006.png)

2. When the 'OK' button is pressed, it will begin updating the firmware.

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_007.png)

3. You can check your controller's model number and firmware version.

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_008.png)
...
4. Press the "Next" button to begin updating your firmware. Be careful not to turn the power off or disconnect the cable while the firmware is being updated.
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_009.png)

5. Once the firmware has been updated, Press the "Finish" button to return to the controller maintenance page.

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_010.png)
...
1. Connect the controller to the PC using LN-101.
    ...
    ![](/img/software/rplus_1_0/rplus_manager/ln101_connect.jpg)
...
2. Run RoboPlus Manager and open the controller firmware management wizard. On the menu bar, click the firmware management button to run the firmware wizard.  
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_011.gif)

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_012.gif)
...
3. Select the port number for connecting the controller.  
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_013.gif)
...
5. Check the controller information.  
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_014.gif)

6. Firmware Recovery

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_015.gif)

7. Check the results of the firmware recovery

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_016.gif)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_017.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_018.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_019.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_020.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_021.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_022.png)
...
![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_023.png)
...
1. Attach Zig-100 to Zig2Serial and connect Zig2Serial to the PC's serial port.(Please refer to ZIG2Serial for connection)  
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_024.png)
...
2. Select the port to which Zig2Serial is connected and click the "Zig2Serial Management" icon.  
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_025.png)

3. The following screen is displayed when the "Zig2Serial Management" icon is pressed.  Click the "Zigbee Setting" button.

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_026.png)

4. Press the reset button within 3 seconds of clicking "OK".

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_027.png)
...
5. When the Zigbee module is connected, a window to set functions is displayed.
  ...
  - Can set to "Wait" mode.
    ...
    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_028.png)

6. If no ZIg100 module is detected, check whether the module has been connected properly.

    ![](/img/software/rplus_1_0/rplus_manager/roboplus_manager_029.png)

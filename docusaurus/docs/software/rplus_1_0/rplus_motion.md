...
![](/img/software/rplus1/motion/roboplus_motion_001.png)
...
![](/img/software/rplus1/motion/roboplus_motion_002.png)
...
![img_install](/img/software/roboplus_install_en.png)
...
![](/img/software/rplus1/motion/roboplus_motion_003.png)
...
![](/img/software/rplus1/motion/roboplus_motion_004.png)
...
2. Select the communication port to use.  
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_005.png)

3. Connect with the robot. Choose the "Connect Robot" menu.

    ![](/img/software/rplus1/motion/roboplus_motion_006.png)
...
4. Disconnect the Robot.  
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_007.png)
...
- Errors may occur when trying to play motions.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_011.png)
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_012.png)
...
![](/img/software/rplus1/motion/roboplus_motion_013.png)
...
![](/img/software/rplus1/motion/roboplus_motion_014.png)
...
![](/img/software/rplus1/motion/roboplus_motion_015.png)
...
![](/img/software/rplus1/motion/roboplus_motion_016.png)
...
- To select actuators in consecutive order.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_017.png)
...
- To select actuators separately.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_018.png)
...
- To select all actuators.
  - Press the button in the upper left corner.
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_019.png)

  - Click on the "Select All" menu.

    ![](/img/software/rplus1/motion/roboplus_motion_020.png)
...
![](/img/software/rplus1/motion/roboplus_motion_030.png)

![](/img/software/rplus1/motion/roboplus_motion_031.png)

- Copy Pose: Click on "Copy" or press Ctrl+C.

  ![](/img/software/rplus1/motion/roboplus_motion_032.png)

- Paste Pose: Click on "Paste" or press Ctrl+V.

  ![](/img/software/rplus1/motion/roboplus_motion_033.png)
...
![](/img/software/rplus1/motion/roboplus_motion_034.png)

![](/img/software/rplus1/motion/roboplus_motion_035.png)
...
![](/img/software/rplus1/motion/roboplus_motion_036.png)
...
![](/img/software/rplus1/motion/roboplus_motion_037.png)
...
![](/img/software/rplus1/motion/roboplus_motion_038.png)
...
1. Exchange  
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_041.jpg)

    ![](/img/software/rplus1/motion/roboplus_motion_042.png)

2. Symmetry  
    A symmetric pose based on the selected side is created.

    ![](/img/software/rplus1/motion/roboplus_motion_043.png)

    ![](/img/software/rplus1/motion/roboplus_motion_044.png)
...
![](/img/software/rplus1/motion/roboplus_motion_045.png)
...
![](/img/software/rplus1/motion/roboplus_motion_046.png)
...
![](/img/software/rplus1/motion/roboplus_motion_047.png)
...
- Left Foot : Located at the center of the left foot, used to move only the left foot.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_048.png)
...
![](/img/software/rplus1/motion/roboplus_motion_056.png)
...
![](/img/software/rplus1/motion/roboplus_motion_059.png)

#### Insert Step

A new step is inserted above the selected step.

![](/img/software/rplus1/motion/roboplus_motion_060.png)

#### Delete Step

The selected step is deleted from the list.

![](/img/software/rplus1/motion/roboplus_motion_061.png)

#### Move Step

The selected step may be moved up or down.

![](/img/software/rplus1/motion/roboplus_motion_062.png)
...
- The value can be changed using the upper scroll bar.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_063.png)
...
- The value can be changed using the lower scroll bar.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_064.png)
...
![](/img/software/rplus1/motion/roboplus_motion_065.png)

#### Cut Step

The selected step is cut.

![](/img/software/rplus1/motion/roboplus_motion_066.png)

#### Paste Step

The copied or cut step is pasted.  The value in the selected step is overwritten.

![](/img/software/rplus1/motion/roboplus_motion_067.png)
...
![](/img/software/rplus1/motion/roboplus_motion_068.png)
...
- To choose pages in consecutive order
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_069.png)
...
- To choose pages separately
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_070.png)
...
- To choose all pages
  - Press the button in the upper left corner
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_071.png)
...
![](/img/software/rplus1/motion/roboplus_motion_072.png)

Enter the number of the next page in the "Next" column.  

![](/img/software/rplus1/motion/roboplus_motion_073.png)
...
![](/img/software/rplus1/motion/roboplus_motion_074.png)

Enter the number of the exit page in the "Exit" column.

![](/img/software/rplus1/motion/roboplus_motion_075.png)
...
![](/img/software/rplus1/motion/roboplus_motion_076.png)

#### Cut Page

The selected page is cut.

![](/img/software/rplus1/motion/roboplus_motion_077.png)

#### Paste page

The copied or cut page is pasted.  The contents of selected page is overwritten.

![](/img/software/rplus1/motion/roboplus_motion_078.png)
...
![](/img/software/rplus1/motion/roboplus_motion_079.png)
...
- This is the playback speed of the page during motion execution.  Unlike "Step Time," this applies to the entire page.
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_080.png)
...
- The value is between 0 and 127. (Default is 32.)
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_081.png)
...
- Level 7: Very High
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_082.png)
...
1. Connect the robot to the PC to see the Robot Motion window.
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_083.png)

    ![](/img/software/rplus1/motion/roboplus_motion_084.png)

2. After selecting the Robot Motion window, click on "Save As".

    ![](/img/software/rplus1/motion/roboplus_motion_085.png)
...
![](/img/software/rplus1/motion/roboplus_motion_086.png)
...
![](/img/software/rplus1/motion/roboplus_motion_092.png)
...
![](/img/software/rplus1/motion/roboplus_motion_093.png)
...
![](/img/software/rplus1/motion/roboplus_motion_094.png)
...
![](/img/software/rplus1/motion/roboplus_motion_095.png)

### Change All Values

Use this function to change the value of the selected ID.

![](/img/software/rplus1/motion/roboplus_motion_096.png)
...
![](/img/software/rplus1/motion/roboplus_motion_097.png)
...
![](/img/software/rplus1/motion/roboplus_motion_098.png)
...
![](/img/software/rplus1/motion/roboplus_motion_099.png)

This function is available in the following windows:
- Pose of Step

  ![](/img/software/rplus1/motion/roboplus_motion_100.png)

- Pose of Robot

  ![](/img/software/rplus1/motion/roboplus_motion_101.png)

- Edit Motion Offset

  ![](/img/software/rplus1/motion/roboplus_motion_102.png)

- 3D drawing of robot

  ![](/img/software/rplus1/motion/roboplus_motion_103.png)
...
![](/img/software/rplus1/motion/roboplus_motion_104.png)
...
![](/img/software/rplus1/motion/roboplus_motion_108.jpg)
...
![](/img/software/rplus1/motion/roboplus_motion_109.png)
...
![](/img/software/rplus1/motion/roboplus_motion_110.png)
...
- T: 3x4 matrix that contains movement and rotation information for 3D display.  
  ...
  ![](/img/software/rplus1/motion/roboplus_motion_111.png)
...
- type: Define what type of motor a part is.
  - If the whole body moves, define the motor's type as "body." (Horn is fixed in this case)
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_112.png)
  ...
  - If the motor's body is fixed and only its horn moves, define "body" to the part you want to fix and define "horn" to the part you want it to move.
    ...
    ![](/img/software/rplus1/motion/roboplus_motion_113.png)
...
|Name|Diagram|File|
|:---:|:---:|:---:|
|F1|![](/img/software/rplus1/motion/roboplus_motion_114.png)|f1.igs|
|F2|![](/img/software/rplus1/motion/roboplus_motion_115.png)|f2.igs|
|F3|![](/img/software/rplus1/motion/roboplus_motion_116.png)|f3.igs|
|F4|![](/img/software/rplus1/motion/roboplus_motion_117.png)|f4.igs|
|F5|![](/img/software/rplus1/motion/roboplus_motion_118.png)|f5.igs|
|F6|![](/img/software/rplus1/motion/roboplus_motion_119.png)|f6.igs|
|F7|![](/img/software/rplus1/motion/roboplus_motion_120.png)|f7.igs|
|F8|![](/img/software/rplus1/motion/roboplus_motion_121.png)|f8.igs|
|F9|![](/img/software/rplus1/motion/roboplus_motion_122.png)|f9.igs|
|F10|![](/img/software/rplus1/motion/roboplus_motion_123.png)|f10.igs|
|F11|![](/img/software/rplus1/motion/roboplus_motion_124.png)|f11.igs|
|F12|![](/img/software/rplus1/motion/roboplus_motion_125.png)|f12.igs|
|F15 + F16|![](/img/software/rplus1/motion/roboplus_motion_126.png)|f15.igs|
|F51|![](/img/software/rplus1/motion/roboplus_motion_127.png)|f51.igs|
|F52|![](/img/software/rplus1/motion/roboplus_motion_128.png)|f52.igs|
|F53|![](/img/software/rplus1/motion/roboplus_motion_129.png)|f53.igs|
|F56|![](/img/software/rplus1/motion/roboplus_motion_130.png)|f56.igs|
|F57|![](/img/software/rplus1/motion/roboplus_motion_131.png)|f57.igs|
|F58|![](/img/software/rplus1/motion/roboplus_motion_132.png)|f58.igs|
|F60|![](/img/software/rplus1/motion/roboplus_motion_133.png)|f60.igs|
|WA|![](/img/software/rplus1/motion/roboplus_motion_134.png)|wa,igs|
|BU|![](/img/software/rplus1/motion/roboplus_motion_135.png)|bu.igs|
|CM-5|![](/img/software/rplus1/motion/roboplus_motion_136.png)|cm-5.igs|
|ADAPTOR-CM5|![](/img/software/rplus1/motion/roboplus_motion_137.png)|adaptor_cm5.igs|
|BATTERY|![](/img/software/rplus1/motion/roboplus_motion_138.png)|battery.igs|
|AX-12|![](/img/software/rplus1/motion/roboplus_motion_139.png)|ax-12.igs|
|AX-12 Horn|![](/img/software/rplus1/motion/roboplus_motion_140.png)|ax-12_horn.igs|
|AX-S1|![](/img/software/rplus1/motion/roboplus_motion_141.png)|ax-s1.igs|
...
![](/img/software/rplus1/motion/roboplus_motion_142.png)
...
![](/img/software/rplus1/motion/roboplus_motion_143.png)
...
![](/img/software/rplus1/motion/roboplus_motion_144.png)
...
[Joint Offset Parameter]: /docs/software/rplus_1_0/rplus_task/programming_02#joint-offset

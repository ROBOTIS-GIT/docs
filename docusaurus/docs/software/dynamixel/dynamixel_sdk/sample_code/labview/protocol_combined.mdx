...
- Control Panel
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/sample_code/labview/protocol_combined/protocol_combined.png)

- Block Diagram

  ![](/img/software/dynamixel/dynamixel_sdk/sample_code/labview/protocol_combined/block_diagram.png)

...
- Open the Visual Studio Code and create a python file in your workspace.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/vscodepython.png)
...
- Run the code through Visual Studio Code.
  ...
  ![](/img/software/dynamixel/dynamixel_sdk/basic_read_write_tutorial/runbutton.png)

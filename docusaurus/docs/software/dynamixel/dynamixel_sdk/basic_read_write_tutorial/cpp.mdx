---
id: cpp
title: "Basic Read/Write Tutorial (C++)"
sidebar_label: "C++"
sidebar_position: 2
tags: [dynamixel_sdk, tutorial, basic_read_write, cpp]
---
...
```
  ...
  - `address` : The address of the data you want to write. Refer to the [**Control Table**](/docs/dxl/model_reference/x_series/xc430-w240#control-table) of your DYNAMIXEL model, which can be found in its **specification manual** or **Dynamixel Wizard 2.0**. In this example, we use X series.

...
```
  ...
  - `address` : The address of the data you want to write. Refer to the [**Control Table**](/docs/dxl/x/xc430-w240#control-table) of your DYNAMIXEL model, which can be found in its **specification manual** or **Dynamixel Wizard 2.0**. In this example, we use X series.

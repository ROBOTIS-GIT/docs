...
# Introduction
![](/img/software/dynamixel/dynamixel_workbench/DYNAMIXEL_WORKBENCH_LOGO.png)
...
![](/img/platform/turtlebot3/logo/logo_ros.png)
...
![](/img/software/dynamixel/dynamixel_workbench/opencr_arduino_setup.png)
...
![](/img/software/dynamixel/dynamixel_workbench/opencm_arduino_setup.png)
...
![](/img/software/dynamixel/dynamixel_workbench/controller_service_call.png)
...
1. Open `o_Find_Dynamixel`
    ...
    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_1.png)  

1. Select Port

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_2.png)  

1. Push `Upload` button or `CTRL+U`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_3.png)  

1. You can show if the firmware upload successfully

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_4.png)  

1. Push `Serial Monitor` button

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_5.png)  

1. Serial monitor starts to scan and find DYNAMIXEL

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_6.png)  
...
1. Serial monitor shows dynamixel monitor
    ...
    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_7.png)  

1. Type `begin 57600`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_8.png)  

1. Type `scan 10`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_9.png)  

1. Type `torque_on 1` and `torque_on 2`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_10.png)  

1. Type `sync_write_handler 1 Goal_Position`

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_11.png)  

1. Type `sync_write 1 2 0 2048 2048` then DYNAMIXEL will rotate

    ![](/img/software/dynamixel/dynamixel_workbench/opencr_example_12.png)  
...
[XC430-W150BB]: https://emanual.robotis.com/docs/en/dxl/x/xc430-w150bb/
[XC430-W240BB]: https://emanual.robotis.com/docs/en/dxl/x/xc430-w240bb/

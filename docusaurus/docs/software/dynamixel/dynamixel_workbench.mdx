...
**NOTE**: [The DYNAMIXEL Workbench e-Manual](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_workbench_jp/) in Japanese (日本語) is available for the Japanese. 
...
- [Porting the OpenCM9.04 board to the Arduino IDE](/docs/parts/controller/opencm904#porting-the-opencm904-board-to-the-arduino-ide)
...
**TIP**: Please follow a [link](/docs/parts/controller/opencm485exp) for getting more information about pin


![](/img/parts/controller/opencm904/opencm485exp_01.webp)

# Tutorials
- [ROS](/docs/software/dynamixel/dynamixel_workbench#ros-tutorials)
    - [Find Dynamixels](/docs/software/dynamixel/dynamixel_workbench#find-dynamixels)
    - [Controllers](/docs/software/dynamixel/dynamixel_workbench#controllers)
    - [Operators](/docs/software/dynamixel/dynamixel_workbench#operators)

    - [OpenCR and OpenCM](/docs/software/dynamixel/dynamixel_workbench#opencr-and-opencm-tutorials)
    - [o_Find_Dynamixel](/docs/software/dynamixel/dynamixel_workbench#o_find_dynamixel)
    - [p_Monitor](/docs/software/dynamixel/dynamixel_workbench#p_monitor)

- [Linux and macOS](/docs/software/dynamixel/dynamixel_workbench#linux-and-macos)
    - [Examples](/docs/software/dynamixel/dynamixel_workbench#examples)
    - [position](/docs/software/dynamixel/dynamixel_workbench#position)
    - [bulk_read_write](/docs/software/dynamixel/dynamixel_workbench#bulk_read_write)
...
**TIP**: If you can't find any DYNAMIXEL, please check usb port, power. Even if it can't find anything, please check firmware to use ROBOTIS software ([R+ Manager 2.0](/docs/software/dynamixel/dynamixel_wizard2/) or [R+ Manager 1.0](/docs/software/dynamixel/dynamixel_wizard2/))
...
[dynamixel_workbench_msgs/DynamixelInfo]: /docs/popup/dynamixel_workbench_msgs_DynamixelInfo
[dynamixel_workbench_msgs/DynamixelCommand]: /docs/popup/dynamixel_workbench_msgs_DynamixelCommand
[dynamixel_workbench_msgs/DynamixelStateList]: /docs/popup/dynamixel_workbench_msgs_DynamixelStateList
[open_manipulator_msgs/GetJointPosition]: /docs/popup/open_manipulator_msgs_GetJointPosition
[open_manipulator_msgs/GetKinematicsPose]: /docs/popup/open_manipulator_msgs_GetKinematicsPose
...
[How to set Industrial filter into joint trajectory]: /docs/popup/how_to_set_smoothing_filter
...
[XC430-W150BB]: https://emanual.robotis.com/docs/en/dxl/model_reference/x_series/xc430-w150bb/
[XC430-W240BB]: https://emanual.robotis.com/docs/en/dxl/model_reference/x_series/xc430-w240bb/

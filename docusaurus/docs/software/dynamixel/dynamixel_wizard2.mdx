...
![](/img/software/dynamixel/wizard2/wizard2_main_003.png)


# Introduction
![](/img/software/dynamixel/wizard2/wizard2_main_000.jpg)
...
![](/img/software/dynamixel/wizard2/wizard2_main_001.png)
...
3. Click on `Next` button to proceed installation.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_setup_win_01.png)  

    ![](/img/software/dynamixel/wizard2/new_wizard2_setup_win_02.png)
...
2. Right click on the downloaded dmg file and select `Open` from the mene.  
  ![](/img/software/dynamixel/wizard2/wizard2_setup_mac_01.png)
3. Launch the `DynamixelWizard2Setup_x64` file.  
  ![](/img/software/dynamixel/wizard2/wizard2_setup_mac_02.png)
4. If a warning message pops up, select `Open` to proceed installation.  
  ![](/img/software/dynamixel/wizard2/wizard2_setup_mac_03.png)
5. Click `Next` to continue and follow the setup instruction.  
  ![](/img/software/dynamixel/wizard2/wizard2_setup_mac_04.png)

# Uninstall Software
## Uninstall: Windows
1. From Windows Settings, select Apps.

    ![](/img/software/dynamixel/wizard2/wizard2_setup_win_02.png)

2. In the Apps & features tab, find `Dynamixel Wizard 2` and select `Uninstall`.

    ![](/img/software/dynamixel/wizard2/wizard2_setup_win_03.png)

3. Select `Remove all components` and proceed by clicking `Next` button.

    ![](/img/software/dynamixel/wizard2/wizard2_setup_win_04.png)
...
2. Select `Remove all components` and click `Next` to proceed.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_setup_linux_03.png)
...
![](/img/software/dynamixel/wizard2/new_wizard2_main_002.png)
...
![](/img/software/dynamixel/wizard2/new_wizard2_graph_001.png)
...
![](/img/software/dynamixel/wizard2/new_wizard2_packet_001.png)
...
1. Go to `Tools` > `Options` or use shortcut key `F4`.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_011.png)
    
    

2. Select `Scan` from the left column menu to display scan options.

    ![](/img/software/dynamixel/wizard2/new_wizard2_options_001.png)
...
1. Go to `Device` > `Scan` to start searching connected DYNAMIXEL's.
    ...
    **NOTE** : If Open failed is shown up, please check whether communication port is connected at the **Main Toolbar** or not, then button `Disconnect` to avoid port collision.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_012.png)

2. Detected DYNAMIXEL's are listed on the left column.
    
    ![](/img/software/dynamixel/wizard2/new_wizard2_001.png)
...
2. Detected DYNAMIXEL's are classified according to communication ports, baudrates, and products. Select a group or device to run the test.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_002.png)
...
3. `Factory Reset` button in the Sub Menu on the right column will reset DYNAMIXEL to factory status(ID and Baudrate will not be reset).  
  ...
  `LED` switch will toggle the LED of DYNAMIXEL.  
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_003.png)
    
    

4. Click the `Torque` button to enable DYNAMIXEL Torque.

    ![](/img/software/dynamixel/wizard2/wizard2_torque_on.png)  
...
5. Select `Goal Position` or `Goal Velocity` item in the control table in the middle column.
    ...
    **NOTE**: Read the control table of your DYNAMIXEL as the item can be different depending on the model and Operating Mode of the DYNAMIXEL.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_004.png)
...
6. Position controlling interface will appear on the buttom right corner of the program.
    ...
    **WARNING** : Please be cautious when changing values as DYNAMIXEL can rotate or move.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_004_position_mode_joypad.png)
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_004_velocity_mode_joypad.png)  
...
2. Select `Graph` from the left column menu to display scan options.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_002.png)

    

3. Click `>` button to add item. (`<` can remove item)

    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_003.png)

    

4. Double-click an item, to call `Read Item Settings` box.

    ![](/img/software/dynamixel/wizard2/wizard2_graph_004.png)

5. `Read Item Settings` customizes a line color with Y axis number. 

    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_004_1.png)
    ...
    **NOTE**: `Scale` and `Offset` are no longer appearing at the option box above, from the latest version of software. Adjust these factors at the [Graph Window](#graph-window) in real time. (See the additional explanation at Y-Axis below)
    ...
    - Y-Axis: it adds Y-axis to a selected item. The Maximum is 10.    
      ...
      ![](/img/software/dynamixel/wizard2/wizard2_graph_004_y_axis_02_new.png)
...
1. Go to `View` > `Graph` to display the graph window.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_013.png)
...
2. Click `Start` button in the graph window to start plotting data.
    ...
    **WARNING** : If there isn't any detected or connected device, `Start` button will be disabled. Please scan DYNAMIXEL first.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_start_001.png)
...
3. After start plotting, enable Torque first then change `Goal Position` to see how `Present Position` data is plotted in real time.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_graph_start_005.png)

    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_start_006.png)

    

4. Disable the plotting graph by clicking the certain item on the right side of the graph window.  

    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_start_004.png)

    

5. Use the features to control graph window.
    
    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_start_002.png)
...
1. Go to `View` > `Packet` to display the packet window.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_014.png)
...
2. Set the communication port and baudrate then click `Open` to open the port.
  Once the port is successfully opened, DYNAMIXEL protocol minitoring on the port will begin.
    ...
    **NOTE** : If Open failed is shown up, please check whether communication port is connected at the **Main Toolbar** or not, then button `Disconnect` to avoid port collision.  
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_packet_002.png)
...
3. Select Protocol Type and instruction to use. In this example, `Write` instruction for Protocol Type `2.0` is selected.
    ...
    **NOTE** : Protocol Type can be different depending on a model of DYNAMIXEL. Confirm [Protocol Type](/docs/popup/faq_protocol_compatibility_table) of your DYNAMIXEL.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_packet_003.png)
...
4. Specific data can be written on the instuction as shown below.
  In this example, LED will be turned on by writing `1` to LED control address.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_packet_004.png)
...
5. Assembled packet can be found at `Packet Details` section in the bottom of packet window.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_packet_005.png)

6. Transmit the assembled packet with `Send` button.

    ![](/img/software/dynamixel/wizard2/new_wizard2_packet_006.png)
    
    

7. Clicking the sent packet shows the detailed packet information.

    ![](/img/software/dynamixel/wizard2/new_wizard2_packet_007.png)
...
![](/img/software/dynamixel/wizard2/new_wizard2_update_notification.png)
...
1. Go to `Tools` > `Firmware Update`
    ...
    **NOTE** : If no DYNAMIXELS are detected, the `Firmware Update` option will not be available. 
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_015.png)
    
    

2. Firmware update will begin with a brief instruction. Please do NOT disconnect or turn off DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_update_001.png)

3. Click `Next` to begin firmware update. Be careful not to disconnect or turn off DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_update_002.png)

4. Confirm the firmware update result.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_update_004.png)

## Firmware Update All
1. Go to `Tools` > `Firmware Update All`

    ![](/img/software/dynamixel/wizard2/new_wizard2_016.png)

    

2. Select all or desired DYNAMIXEL's, then click `Next` button.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_update_all_001.png)

3. Firmware of selected DYNAMIXEL's are updated.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_update_all_002.png)

4. Wait until update is completed for all DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_update_all_003.png)

## Firmware Recovery
1. Go to `Tools` > `Firmware Recovery`

    ![](/img/software/dynamixel/wizard2/new_wizard2_017.png)
    
    

2. Firmware recovery will begin with a brief instruction. Please do **NOT** disconnect or turn off DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_001.png)
...
3. During the firmware recovery mode, DYNAMIXEL Wizard 2.0 cannot identify the model information of DYNAMIXEL, so correct model has to be selected manually. Selecting wrong model can cause malfunction or serious hardware damage.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_002.png)

4. Select a desired firmware version.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_003.png)
...
5. The proper communication port that is connected to DYNAMIXEL has to be selected manually. If the port is in use, it has to be released first.
    ...
    **WARNING** : Only one DYNAMIXEL should be connected to the port when recoverying DYNAMIXEL firmware.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_004.png)

6. Toggle the power of DYNAMIXEL to be detected from DYNAMIXEL Wizard 2.0.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_005.png)

7. If DYNAMIXEL is successfully detected, wizard begins firmware recovery. Please do **NOT** disconnect or turn off DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_006.png)

8. Confirm the firmware recovery result.

    ![](/img/software/dynamixel/wizard2/wizard2_firmware_recovery_007.png)
...
**Supported DYNAMIXEL**
- [DYNAMIXEL-X](/docs/dxl/x) (Firmware **v45** or **above**, For X330 Series: Firmware **v46** or **above**) 
- [DYNAMIXEL-P](/docs/dxl/p) (Firmware **v12** or **above**)
...
1. Go to `Tool` > `ID Inspection`
    ...
    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step1_01.png)   

2. Select your right USB port and Baud rates, and click on `Scan`

    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step1_02.png)  

3. Once DYNAMIXEL scan is started, state of scanning DYNAMIXEL is displayed.

    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step2_01.png)  
...
4. Click on `Next` for "ID Setting"
    ...
    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step2_02.png)  

    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step3_01.png)  


5. Select an item (colored red) and assign new ID from the right box to resolve ID overlapping.

    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step3_02.png)  
...
6. If new ID are saved to the items of DYNAMIXEL, it will be colored green. Once completed, click on `Apply`.
    ...
    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step4_01.png)  

7. Click on `Finish` to exit the `ID Inspection` window.

    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_step4_02.png)  

8. Confirm the DYNAMIXEL Wizard 2.0 scans DYNAMIXELs successfully.

    ![](/img/software/dynamixel/wizard2/id_inspection/id_inspection_done.png)  
...
2. Make sure to turn off the Torque of DYNAMIXEL. Otherwise, backup will fail.
    ...
    ![](/img/software/dynamixel/wizard2/backup/backup_torque_off.png)
    
3. Select `Tool` > `Control Table` > `Backup` 

    ![](/img/software/dynamixel/wizard2/backup/backup_click_backup.png)
    
4. Check if the `Backup Ready(147)` address is set to `1` after backup.  

    ![](/img/software/dynamixel/wizard2/backup/backup_backup_enabled.png)

### Restoring EEPROM Area
1. Go to `Tool` > `Control Table` > `Restore EEPROM`

    ![](/img/software/dynamixel/wizard2/backup/backup_click_restore.png)
...
1. Set the **Restore RAM** bit of the `Startup Configuration` as below.
   ...
   ![](/img/software/dynamixel/wizard2/backup/backup_enable_restore_ram.png)
...
4. Enter the value
    ...
    **NOTE** : Press `Enter` key to apply the value.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_008.png)
...
1. Go to `Help` > `About Dynamixel Firmware`
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_009.png)

2. Firmware version, release date, update note of the selected DYNAMIXEL can be found.

    ![](/img/software/dynamixel/wizard2/wizard2_010.png)
...
1. Go to `Tool` > `Calibration`
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_cali_001.png)

    
    
    **NOTE**: `Calibration` itme will be disabled at the menu for non-supported DYNAMIXEL such as [AX Series](/docs/dxl#ax-series)
...
2. Calibration will begin with a brief instruction.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_cali_002.png)

3. Toggle the power of DYNAMIXEL to be detected from DYNAMIXEL Wizard 2.0.

    ![](/img/software/dynamixel/wizard2/wizard2_cali_005.png)
...
4. If DYNAMIXEL is successfully detected, calibration firmware will start being installed. Please do NOT disconnect or turn off DYNAMIXEL.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_cali_006.png)

    ![](/img/software/dynamixel/wizard2/wizard2_cali_007.png)

5. Calibrate the first position.

    ![](/img/software/dynamixel/wizard2/wizard2_cali_008.png)

6. Calibrate the second position.

    ![](/img/software/dynamixel/wizard2/wizard2_cali_009.png)

7. Calibrate the third position.

    ![](/img/software/dynamixel/wizard2/wizard2_cali_010.png)

8. Calibrate the fourth position.

    ![](/img/software/dynamixel/wizard2/wizard2_cali_011.png)

9. Clibration is completed.

    ![](/img/software/dynamixel/wizard2/wizard2_cali_012.png)
...
1. Go to `Tool` > `Self-Diagnosis`
    ...
    **NOTE** : `Self-Diagnosis` item will be disabled at the menu for non-suppored DYNAMIXEL such as [RX Series](/docs/dxl#rx-series)
    

    ![](/img/software/dynamixel/wizard2/wizard2_self_001.png)
...
2. Self diagnosis will begin with a brief instruction.
    ...
    **WARNING** : DYNAMIXEL will be factory reset during self diagnosis.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_self_002.png)

3. Confirm the model name and firmware version of DYNAMIXEL to perform diagnosis.

    ![](/img/software/dynamixel/wizard2/wizard2_self_003.png)

4. Check the hardware error status of DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_self_004.png)

5. Check the operating temperature of DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_self_005.png)

6. Check the input voltage of DYNAMIXEL.

    ![](/img/software/dynamixel/wizard2/wizard2_self_006.png)

7. Check if the LED on DYNAMIXEL is blinking.

    ![](/img/software/dynamixel/wizard2/wizard2_self_007.png)

8. Check if DYNAMIXEL horn is at the center.

    ![](/img/software/dynamixel/wizard2/wizard2_self_008.png)

9. Proceed to performance test. 

    ![](/img/software/dynamixel/wizard2/wizard2_self_009_position.png)&#123;: width="400px"&#125;
    > **Position Test** : Goal Position represents red line and Present Position represents green line.

    ![](/img/software/dynamixel/wizard2/wizard2_self_009_velocity.png)&#123;: width="400px"&#125;
    > **Velocity Test** : Safe area represents a green zone. 

10. Confirm the self diagnosis result.

    ![](/img/software/dynamixel/wizard2/wizard2_self_010.png)
...
1. Open `Device Manager`. Go to `Ports` item and right click on the relative serial port to select `Properties`.
    ...
    ![](/img/software/dynamixel/wizard2/wizard2_graph_008_en.png)

2. In the Properties window, go to `Port Settings` tab and click `Advanced` button.

    ![](/img/software/dynamixel/wizard2/wizard2_graph_009_en.png)

3. Set the `Latency Timer (msec)` to `1ms` and click `OK` to confirm the change.

    ![](/img/software/dynamixel/wizard2/wizard2_graph_010_en.png)
...
1. Open the graph options window to set `Interval` to `1ms`. Then, mark on the `Read only selected item for Speed` option.
    ...
    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_005.png)

    

2. Set the baudrate of DYNAMIXEL to maximum and set `Return Delay Time` to `0`.
    
    ![](/img/software/dynamixel/wizard2/new_wizard2_graph_007.png)
...
- In case of Packet, it saves every monitored packets.  
    ...
    ![](/img/software/dynamixel/wizard2/logging/wizard2_logging.png)
...
![](/img/software/dynamixel/wizard2/logging/wizard2_graph_logging.png)
...
![](/img/software/dynamixel/wizard2/logging/wizard2_packet_logging.png)

[Basic Features > Graph]: #graph
[Protocol 1.0]: /docs/dxl/protocol1
[Protocol 2.0]: /docs/dxl/protocol2
[AX-12W]: /docs/dxl/ax/ax-12w
[AX-12+/12A]: /docs/dxl/ax/ax-12a
[AX-18F/18A]: /docs/dxl/ax/ax-18a
[EX-106+]: /docs/dxl/ex/ex-106+
[DX-113]: /docs/dxl/dx/dx-113
[DX-116]: /docs/dxl/dx/dx-116
[DX-117]: /docs/dxl/dx/dx-117
[RX-10]: /docs/dxl/rx/rx-10
[RX-24F]: /docs/dxl/rx/rx-24f
[RX-28]: /docs/dxl/rx/rx-28
[RX-64]: /docs/dxl/rx/rx-64
[MX-12W]: /docs/dxl/mx/mx-12w
[MX-28]: /docs/dxl/mx/mx-28
[MX-28(2.0)]: /docs/dxl/mx/mx-28-2
[MX-64]: /docs/dxl/mx/mx-64
[MX-64(2.0)]: /docs/dxl/mx/mx-64-2
[MX-106]: /docs/dxl/mx/mx-106
[MX-106(2.0)]: /docs/dxl/mx/mx-106-2
[XL320]: /docs/dxl/x/xl320
[XL330-M288]: /docs/dxl/x/xl330-m288
[XL330-M077]: /docs/dxl/x/xl330-m077
[XL430-W250]: /docs/dxl/x/xl430-w250
[2XL430-W250]: /docs/dxl/x/2xl430-w250
[XC430-W150]: /docs/dxl/x/xc430-w150
[XC430-W240]: /docs/dxl/x/xc430-w240
[XC430-T150BB]: /docs/dxl/x/xc430-t150bb
[XC430-T240BB]: /docs/dxl/x/xc430-t240bb
[2XC430-W250]: /docs/dxl/x/2xc430-w250
[XC330-T288]: /docs/dxl/x/xc330-t288
[XC330-T181]: /docs/dxl/x/xc330-t181
[XC330-M288]: /docs/dxl/x/xc330-m288
[XC330-M181]: /docs/dxl/x/xc330-m181
[XM430-W210]: /docs/dxl/x/xm430-w210
[XM430-W350]: /docs/dxl/x/xm430-w350
[XH430-W210]: /docs/dxl/x/xh430-w210
[XM540-W150]: /docs/dxl/x/xm540-w150
[XM540-W270]: /docs/dxl/x/xm540-w270
[XH430-W350]: /docs/dxl/x/xh430-w350
[XH430-V210]: /docs/dxl/x/xh430-v210
[XH430-V350]: /docs/dxl/x/xh430-v350
[XH540-W150]: /docs/dxl/x/xh540-w150
[XH540-W270]: /docs/dxl/x/xh540-w270
[XH540-V150]: /docs/dxl/x/xh540-v150
[XH540-V270]: /docs/dxl/x/xh540-v270
[XD540-T270-R]: /docs/dxl/x/xd540-t270
[XD540-T150-R]: /docs/dxl/x/xd540-t150
[XD430-T350-R]: /docs/dxl/x/xd430-t350
[XD430-T210-R]: /docs/dxl/x/xd430-t210
[XW430-T200]: /docs/dxl/x/xw430-t200
[XW430-T333]: /docs/dxl/x/xw430-t333
[XW540-T140]: /docs/dxl/x/xw540-t140
[XW540-T260]: /docs/dxl/x/xw540-t260
...
[H54-200-S500-R(A)]: /docs/dxl/pro/h54-200-s500-ra
[H54-100-S500-R(A)]: /docs/dxl/pro/h54-100-s500-ra
[H42-20-S300-R(A)]: /docs/dxl/pro/h42-20-s300-ra
...
[L54-50-S500-R]: /docs/dxl/pro/l54-50-s500-r
[L54-50-S290-R]: /docs/dxl/pro/l54-50-s290-r
[L54-30-S500-R]: /docs/dxl/pro/l54-30-s500-r
[L54-30-S400-R]: /docs/dxl/pro/l54-30-s400-r
[L42-10-S300-R]: /docs/dxl/pro/l42-10-s300-r
[PH42-020-S300-R]: /docs/dxl/p/ph42-020-s300-r
[PH54-100-S500-R]: /docs/dxl/p/ph54-100-s500-r
[PH54-200-S500-R]: /docs/dxl/p/ph54-200-s500-r
[PM54-060-S250-R]: /docs/dxl/p/pm54-060-s250-r
[PM54-040-S250-R]: /docs/dxl/p/pm54-040-s250-r
[PM42-010-S260-R]: /docs/dxl/p/pm42-010-s260-r

---
id: opencm904_ex_dynamixelworkbench
title: "DYNAMIXELWorkbench"
---
...
This class includes functions(register, sync and bulk communication) for controlling DYNAMIXEL using [DYNAMIXEL SDK](/docs/software/dynamixel_sdk/overview).

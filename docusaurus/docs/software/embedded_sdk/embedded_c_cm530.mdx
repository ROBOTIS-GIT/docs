...
![](/img/software/sdk/embedded_050.png)
...
![](/img/software/sdk/embedded_051.png)

![](/img/software/sdk/embedded_052.png)
...
![](/img/software/sdk/embedded_053.png)
...
![](/img/software/sdk/embedded_054.png)
...
![](/img/software/sdk/embedded_055.png)
...
![](/img/software/sdk/embedded_056.png)
...
![](/img/software/sdk/embedded_057.png)
...
![](/img/software/sdk/embedded_058.png)

![](/img/software/sdk/embedded_059.png)
...
![](/img/software/sdk/embedded_065.png)
...
![](/img/software/sdk/embedded_066.png)
 
![](/img/software/sdk/embedded_067.png)
...
![](/img/software/sdk/embedded_068.png)

![](/img/software/sdk/embedded_069.png)
...
![](/img/software/sdk/embedded_070.png)
...
![](/img/software/sdk/embedded_071.png)
 
Click on Browse select 01 LED and click on Verify.

![](/img/software/sdk/embedded_072.png)
 
After selecting the project go to Project – Clean, Build

![](/img/software/sdk/embedded_073.png)
 
To see progress check the terminal window.  
If progress is not as shown below then check the working development environment.

![](/img/software/sdk/embedded_074.png)
...
![](/img/software/sdk/embedded_075.png)
...
![](/img/software/sdk/embedded_076.png)
...
![](/img/software/sdk/embedded_077.png)
...
![](/img/software/sdk/embedded_080.png)
...
![](/img/software/sdk/embedded_081.png)
...
1. changing stm32.ld
    ...
    ![](/img/software/sdk/embedded_082.png)
 
2. changing the vector table

    ![](/img/software/sdk/embedded_083.png)
...
- Result
  - Press the w for welcome and g key for goodbye.
    ...
    ![](/img/software/sdk/embedded_084.png)
...
- Theory
  - The controller controls rotation direction with MOT1+ and MOT1- via SIG_MOT1+ and SIG_MOT1-
    ...
    ![](/img/software/sdk/embedded_085.png)
    
    ![](/img/software/sdk/embedded_086.png)
...
- Theory
  ...
  - Refer to [controller’s port](#hardware-port-map) for port and pin number in  06 OLLO MOTOR ROTATE\APP\src\main.c
    ...
    ![](/img/software/sdk/embedded_087.png)
    
    ![](/img/software/sdk/embedded_088.png)
...
- Result
  - From any port the controller can read the position value of the servo motor. The range is from 0 to 0x03FF. The following illustration is with a servo motor in port 3.
    ...
    ![](/img/software/sdk/embedded_089.png)
...
- Theory
  ...
  - Refer to [controller’s port](#hardware-port-map) for port and pin number in 09 DXL READ_WRITE\APP\src\main.c
    ...
    ![](/img/software/sdk/embedded_090.png)
...
- Theory
  ...
  - The microcontroller and RC-100 comm are in USART channel 5
    ...
    ![](/img/software/sdk/embedded_091.png)

...
![](/img/software/sdk/embedded_030.png)
...
![](/img/software/sdk/embedded_031.png)
...
![](/img/software/sdk/embedded_032.png)

#### CM-700

![](/img/software/sdk/embedded_033.png)
...
![](/img/software/sdk/embedded_034.jpg)
...
![](/img/software/sdk/embedded_035.png)
...
2. From the Build menu click on [Build Solution] to run the build command.
    ...
    ![](/img/software/sdk/embedded_039.gif)
...
3. When build succeeded message appears on the output window then compiling is complete. The firmware’s hex file can be found in the default folder from the project’s folder.
    ...
    ![](/img/software/sdk/embedded_040.gif)
...
![](/img/software/sdk/embedded_041.png)
...
![](/img/software/sdk/embedded_044.png)
...
![](/img/software/sdk/embedded_045.png)
...
```
    ...
    ![](/img/software/sdk/embedded_046.png)
...
- Result
  - If you input "u", the result is printed out by adding 1 to currently memorized number, while if you input "d", it is printed out by subtracting 1.
    ...
    ![](/img/software/sdk/embedded_047.png)
...
```
  ...
  ![](/img/software/sdk/embedded_048.png)
...
```
    ...
    ![](/img/software/sdk/embedded_049.png)
...
[RoboPlus Terminal]: https://emanual.robotis.com/docs/en/software/rplus1/task/terminal/

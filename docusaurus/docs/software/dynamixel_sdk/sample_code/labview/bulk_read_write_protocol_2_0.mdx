...
- Control Panel
  ...
  ![](/img/software/dynamixel_sdk/sample_code/labview/bulk_read_write_protocol_2_0/bulk_read_write2.webp)

- Block Diagram

  ![](/img/software/dynamixel_sdk/sample_code/labview/bulk_read_write_protocol_2_0/block_diagram.webp)

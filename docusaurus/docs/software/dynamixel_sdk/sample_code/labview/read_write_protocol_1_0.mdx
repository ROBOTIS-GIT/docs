...
- Control Panel
  ...
  ![](/img/software/dynamixel_sdk/sample_code/labview/read_write_protocol_1_0/read_write1.webp)

- Block Diagram

  ![](/img/software/dynamixel_sdk/sample_code/labview/read_write_protocol_1_0/block_diagram.webp)

...
For more information on the DYNAMIXEL protocol refer to the [Protocol 1.0](/docs/dxl/protocol/protocol1) and [Protocol 2.0](/docs/dxl/protocol/protocol2) documentation for full technical details.

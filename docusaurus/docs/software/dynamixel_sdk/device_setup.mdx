...
1. [Install Dynamixel Wizard 2.0](/docs/software/dynamixel_wizard_2_0/installation#software-installation)
2. [Scan the motor and Operate it](/docs/software/dynamixel_wizard_2_0/basic_features)
3. [Check and set the motor ID](/docs/software/dynamixel_wizard_2_0/advanced_features#id-inspection)
4. [If the firmware is outdated, update it.](/docs/software/dynamixel_wizard_2_0/basic_features#firmware-update)

...
![](/img/software/rplus_task_3_0/task_parameters/port_nickname_01.png)  

The following is an example of using the Port Nickname.  

![](/img/software/rplus_task_3_0/task_parameters/port_nickname_02.png)  
![](/img/software/rplus_task_3_0/task_parameters/port_nickname_03.png)
...
- **Power** : The value ranges from 0 to 1023, where 0 means stop and 1023 is 100% power capacity.  
  ![](/img/software/rplus_task_3_0/task_parameters/task3_070.png)

The following example is controlling the geared motor.

![](/img/software/rplus_task_3_0/task_parameters/task3_071.png)

The following example is using the geared motor to move the robot forward.

![](/img/software/rplus_task_3_0/task_parameters/task3_072.png)
...
- Servo Mode : The Servo Motor can be set as Wheel or Joint mode.  
  ![](/img/software/rplus_task_3_0/task_parameters/servo_mode_selection.png)

  - Wheel Mode : Set the speed of the servo motor.  
    ![](/img/software/rplus_task_3_0/task_parameters/task3_073.png)

  - Joint Mode : Set the position of the servo motor.  
    ![](/img/software/rplus_task_3_0/task_parameters/task3_074.png)

The following is an example of controlling the servo motor with Wheel Mode.

![](/img/software/rplus_task_3_0/task_parameters/servo_velocity.png)

The following is an example of controlling the servo motor with Joint Mode.

![](/img/software/rplus_task_3_0/task_parameters/servo_joint.png)

CM-550 doesn't require to set the Servo Mode as wheel control value or joint control value can be used in the option.  

![](/img/software/rplus_task_3_0/task_parameters/cm550_servo_ex.png)
...
- User can turn on/off the Right LED or Left LED.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_077.png)

The following is an example of controlling the LED module.

![](/img/software/rplus_task_3_0/task_parameters/task3_078.png)
...
- The following is an example of using the touch sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_079.png)
...
- The following is an example of using the infrared sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_080.png)
...
- The following is an example of using the magnetic sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_084.png)
...
- The following is an example of using the temperature sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_085.png)
...
- The following is an example of using the motion detection sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_086.png)
...
- The following is an example of using the temperature and humidity sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_087.png)
...
- The following is an example of using the illuminance sensor.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_088.png)
...
- The following is an example of using the user device.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_089.png)
...
![](/img/software/rplus_task_3_0/task_parameters/motion_control_tab_menu.png)
...
![](/img/software/rplus_task_3_0/task_parameters/motion_control_namelist.png)

![](/img/software/rplus_task_3_0/task_parameters/motion_control_namelist_2.png)

The following is an example of using the Motion Index Number.

![](/img/software/rplus_task_3_0/task_parameters/task3_090.png)
...
![Motion_Link](/img/software/rplus_task_3_0/task_parameters/Motion_Next_Page.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_091.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_092.png)

The following is an example of configuring a specific joint to not be affected by the Motion data values.

![](/img/software/rplus_task_3_0/task_parameters/task3_093.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_094.png)

Pressing different buttons on the Remote Controller will execute their corresponding Motions.

![](/img/software/rplus_task_3_0/task_parameters/task3_095.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_099.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_100.png)

The following is an example of using buttons for OpenCM9.04.

![](/img/software/rplus_task_3_0/task_parameters/task3_101.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_096.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_097.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_098.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_102.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_103.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_104.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_105.png)

#### Remocon TXD
This function is used when the Controller transmits data to other devices.

![](/img/software/rplus_task_3_0/task_parameters/task3_106.png)

#### Remocon Data Arrived
If the Controller receives data, this address is updated to True.

![](/img/software/rplus_task_3_0/task_parameters/task3_107.png)

#### My ID
This address configures the ZIGBee ID of the controller.

![](/img/software/rplus_task_3_0/task_parameters/task3_108.png)

#### Remocon ID
This address configures the ZIGBee ID of the remote controller.  

![](/img/software/rplus_task_3_0/task_parameters/task3_109.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_110.png)

The following is an example of processing a wireless data received from the Controller.

![](/img/software/rplus_task_3_0/task_parameters/task3_111.png)

The following is an example of the Controller sending data to the outside.

![](/img/software/rplus_task_3_0/task_parameters/task3_112.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_113.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_114.png)

#### Delay
CM-550 supports `Delay` function that can simplifies the combined usage of `Timer` and `WAIT WHILE`.

![](/img/software/rplus_task_3_0/task_parameters/cm550_delay_01.png)

![](/img/software/rplus_task_3_0/task_parameters/cm550_delay_02.png)  

The following is an example of replacing `Timer` and `WAIT WHILE` with `Delay` function with CM-550.

![](/img/software/rplus_task_3_0/task_parameters/cm550_delay_03.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_115.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_116.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_117.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_118.png)  
![](/img/software/rplus_task_3_0/task_parameters/task3_119.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_216.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_120.png)
...
The `Position Value` control can be used to designate the angle position as shown below.  
  ![](/img/software/rplus_task_3_0/task_parameters/task3_121.png)
...
The `Speed Value` control can be used to designate the rotation direction and power value as shown below.  
  ![](/img/software/rplus_task_3_0/task_parameters/task3_122.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_214.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_215.png)

#### Goal Current / Goal Torque
Configure the current or torque limit of DYNAMIXEL.  
![](/img/software/rplus_task_3_0/task_parameters/task3_207.png)

#### Present Position
Read the Present Position of DYNAMIXEL.  
![](/img/software/rplus_task_3_0/task_parameters/task3_208.png)

#### Present Velocity
Read the Present Velocity of DYNAMIXEL.  
![](/img/software/rplus_task_3_0/task_parameters/task3_209.png)

#### Present Load
Read the direction and amount of load currently applied to DYNAMIXEL.  
![](/img/software/rplus_task_3_0/task_parameters/task3_210.png)

#### Present Input Voltage
Read the present voltage supplied to DYNAMIXEL.  
![](/img/software/rplus_task_3_0/task_parameters/task3_211.png)

#### Present Temperature
Read the present temperature of DYNAMIXEL.  
![](/img/software/rplus_task_3_0/task_parameters/task3_212.png)

#### Is Moving
Identify if DYNAMIXEL is in motion. Returns True while in motion.  
![](/img/software/rplus_task_3_0/task_parameters/task3_213.png)
...
|:---------:|:-------------------------:|:-------------------------------------------------------:|
|     0     |  Start SyncWrite Packet   | ![](/img/software/rplus_task_3_0/task_parameters/sync_write_01.png) |
|     1     |  Build SyncWrite Packet   | ![](/img/software/rplus_task_3_0/task_parameters/sync_write_02.png) |
|     2     | Transmit SyncWrite Packet | ![](/img/software/rplus_task_3_0/task_parameters/sync_write_03.png) |
...
![](/img/software/rplus_task_3_0/task_parameters/task3_123.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_217.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_124.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_126.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_129.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_130.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_132.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_133.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_135.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_137.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_139.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_142.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_144.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_146.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_148.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_151.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_156.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_161.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_162.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_163.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_166.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_170.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_173.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_176.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_178.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_181.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_184.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_187.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_190.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_192.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_193.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_194.png)  
...
![](/img/software/rplus_task_3_0/task_parameters/task3_202.png)
...
- The following is an example of using a variable.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_203.png)
...
- The valid value range is -2,147,483,648 ~ 4,294,967,295.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_204.png)
...
- False: 0, True: 1.
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_205.png)
...
- The valid value range is 0 ~ 4,294,967,295 (Hex : 00 00 00 00 ~ FF FF FF FF).
  ...
  ![](/img/software/rplus_task_3_0/task_parameters/task3_206.png)

### Motor Mode
This parameter is used to switch the SM-10 operating mode between Wheel mode and Joint mode.  
![](/img/software/rplus_task_3_0/task_parameters/task3_219.png)
...
![](/img/software/rplus_task_3_0/task_parameters/task3_218.png)

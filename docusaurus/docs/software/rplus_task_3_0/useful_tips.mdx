...
3. You can check the locations at which the selected variable (or function) has been used in the “Reference Results” field
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_info_01.png)  
...
5. If you click the "Rename" button at the top, you can change the name of the variable (or function) for the whole source code.
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_info_02.png)  
    ![](/img/software/rplus_task_3_0/useful_tips/motion_info_03.png)
...
2. Type the search word in the search bar that appears on top.  
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_info_04.png)  
...
4. If you click on an item in the list, it will move to that line.  
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_info_05.png)
...
![](/img/software/rplus_task_3_0/useful_tips/motion_info_06.png)
...
- Click the `Insert Music` button and select the audio file.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_musicplay.png)

- Click the `Music Play` button to play the music.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_musicplay_03.png)

- Specify the music section to play.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_musicplay_02.png)
...
1. Move to the Home tab and select the controller to use, and click on the `Add Joint` button.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_user_01.png)  

2. Select the type of joint (motor) to use and set its ID. Click `Apply` to add the joint to the joint list.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_user_02.png)  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_user_03.png)  
...
3. Once the joint list is completed and the new project is created, the custom robot will be shown on the screen.  
  ...
  ![](/img/software/rplus_task_3_0/useful_tips/motion_user_04.png)  
...
1. Move to the Home tab, and click on the `3D Robot` button on the left.
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_3d_01.png)

2. Click on the `Change 3D Robot` button on the bottom, and select the robot to change to.

    ![](/img/software/rplus_task_3_0/useful_tips/motion_3d_02.png)
...
2. Click on the `Mirroring` button.
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_mirror_02.png)

3. The selected joints’ values will now be entered (mirrored) onto the horizontally symmetrical joint on the opposite side.

    ![](/img/software/rplus_task_3_0/useful_tips/motion_mirror_03.png)
...
2. Click on the `Mirroring` button.
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_mirror_04.png)

3. The selected joints will now have their values exchanged with each other.

    ![](/img/software/rplus_task_3_0/useful_tips/motion_mirror_05.png)
...
1. Move to the `Motion Download` tab, select a Motion Group for editing its Index Number, and click on the `Edit Motion Group` button.
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_call_01.png)
...
2. Select the Motion Number you would like to edit the Index (or Exit Index) number for, change the number, and click the `Enter` key.
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_call_02.png)
...
1. Move to the `Home` tab and click on the `Offset` button.  
    ![](/img/software/rplus_task_3_0/useful_tips/motion_offset_01.png)  
2. Connect the robot. (Refer to [Connect to Robot](#connect-to-robot))  
3. Turn on the Sync Mode.  
    ![](/img/software/rplus_task_3_0/useful_tips/motion_offset_02.png)  
4. Set the initial pose, check the robot, and edit the offset pose.  
    ![](/img/software/rplus_task_3_0/useful_tips/motion_offset_03.png)  
...
7. Click on the `Download Offsets` button to save the offset onto the robot’s controller.  
    ![](/img/software/rplus_task_3_0/useful_tips/motion_offset_04.png)  
...
1. Run R+ Task 3.0 and click `Open` button.  
    ...
    ![](/img/software/rplus_task_3_0/useful_tips/motion_trans_01.png)

2. Select the mtn or mtnx file to convert.

   ![](/img/software/rplus_task_3_0/useful_tips/motion_trans_02.png)

3. The below message will appear to confirm the file conversion. Click `OK`.

    ![](/img/software/rplus_task_3_0/useful_tips/motion_trans_03.png)

4. Select the 3D robot to use the motion file and click `OK`.

    ![](/img/software/rplus_task_3_0/useful_tips/motion_trans_04.png)

5. Save the converted mtn3 file.

    ![](/img/software/rplus_task_3_0/useful_tips/motion_trans_05.png)
...
![](/img/software/rplus_task_3_0/useful_tips/motion_anglemark_01.png)  
![](/img/software/rplus_task_3_0/useful_tips/motion_anglemark_02.png)
...
1. Click the `Insert landscape` button and select the file to apply.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_background_01.png)  

2. DYNAMIXEL can be deployed over the image to help identifying joint.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_background_02.png)  

3. Click the `DYNAMIXEL Relocation` icon to hold DYNAMIXEL at current location.  
  ![](/img/software/rplus_task_3_0/useful_tips/motion_background_03.png)  

## Initial Pose

Click the `Set Initial Pose` button to set all joint to initial position.  
![](/img/software/rplus_task_3_0/useful_tips/motion_position_init.png)

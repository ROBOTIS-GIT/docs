...
![](/img/software/rplus_task_3_0/task_instructions/task3_026.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_027.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_028.png)

The following is the code that force terminates at `END PROGRAM` line.

![](/img/software/rplus_task_3_0/task_instructions/task3_029.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_030.png)

The following code shows `START PROGRAM` and `IF` blocks.

![](/img/software/rplus_task_3_0/task_instructions/task3_031.png)

The following code shows when the blocks can be omitted.

![](/img/software/rplus_task_3_0/task_instructions/task3_032.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_033.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_034.png)

### Compute

- This instruction computes two values to give one result. (C = A + B)

  ![](/img/software/rplus_task_3_0/task_instructions/task3_035.png)

- Add(+), Subtract(-), Multiply(\*), Divide(/), Modulo(%), And(&), Or(\|) can be used.  
  ![](/img/software/rplus_task_3_0/task_instructions/task3_036.png)  
...
![](/img/software/rplus_task_3_0/task_instructions/task3_037.png)
...
- This instruction is used when reading or writing a value to a device.
  ...
  ![](/img/software/rplus_task_3_0/task_instructions/task3_038.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_039.png)

The following is an example of setting the speed value of Geared Motor connected to Port 1.

![](/img/software/rplus_task_3_0/task_instructions/task3_040.png)
...
- Variables and constants can only be used in the expression.
  ...
  ![](/img/software/rplus_task_3_0/task_instructions/multiple_expression_1.png)

- The Multi Compute creates invisible temporary variables in the controller that consumes variable memory area.

  ![](/img/software/rplus_task_3_0/task_instructions/multiple_expression_2.png)

- Using an invalid expression will return the error message.

  ![](/img/software/rplus_task_3_0/task_instructions/multiple_expression_3.png)
...
- The right example will run the Mode2 only and skip the Mode1.
  ...
  ![](/img/software/rplus_task_3_0/task_instructions/task3_041.png)

- Label and Jump must exist inside the same function block.

  ![](/img/software/rplus_task_3_0/task_instructions/task3_042.png)

## Condition

This instruction controls the flow of program based on the True/False result of Conditional Clause.

![](/img/software/rplus_task_3_0/task_instructions/task3_043.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_044.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_045.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_046.png)

Begin / End Blocks can be omitted when there's only one instruction in the block.

![](/img/software/rplus_task_3_0/task_instructions/task3_047.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_048.png)

Begin / End Blocks can be omitted when there's only one instruction in the block.

![](/img/software/rplus_task_3_0/task_instructions/task3_049.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_050.png)

Begin / End Blocks can be omitted when there's only one instruction in the block.

![](/img/software/rplus_task_3_0/task_instructions/task3_051.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_052.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_053.png)

Begin / End Blocks can be omitted when there's only one instruction in the block.

![](/img/software/rplus_task_3_0/task_instructions/task3_054.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_055.png)

The following is an example of using `LOOP WHILE` and a variable to print the number 100 for 10 times.

![](/img/software/rplus_task_3_0/task_instructions/task3_056.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_057.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_058.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_062.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_063.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_064.png)

The following is the process of selecting a function to call.

![](/img/software/rplus_task_3_0/task_instructions/task3_065.png)

Functions cannot call itself within the same function.

![](/img/software/rplus_task_3_0/task_instructions/task3_066.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_067.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_068.png)
...
![](/img/software/rplus_task_3_0/task_instructions/task3_069.png)

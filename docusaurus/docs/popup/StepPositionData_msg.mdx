...
title: "StepPositionData msg"
sidebar_label: "StepPositionData msg"
...
Position related Step Data Parameters
  ...
  * `float32     foot_z_swap`  
  ...
  &emsp;&emsp;
    ![foot_z_wap](/img/systems/op3/op3_walking_module_image152.webp)

  * `float32     body_z_swap`  
  &emsp;&emsp; The swept distance by the body on the Z axis while THORMANG3 is walking. Unit in meter.  
  &emsp;&emsp;
    ![body_z_wap](/img/systems/op3/op3_walking_module_image154.webp)
...
[thormang3_walking_module_msgs/PoseXYZRPY]: /docs/systems/msgs/PoseXYZRPY_msg#posexyzrpy_msg
[thormang3_walking_module_msgs/PoseZRPY]: /docs/systems/msgs/PoseZRPY_msg#posezrpy-msg

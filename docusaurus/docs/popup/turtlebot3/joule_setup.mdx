...
**NOTE**: If you want to use Intel® RealSense™, please check related appendix for [Intel® RealSense™](/docs/systems/turtlebot3/more_info/realsense#realsense)
...
Replace the `localhost` in the ROS_MASTER_URI address with the IP address acquired from [Remote PC Network Configuration](/docs/systems/turtlebot3/quick_start_guide/pc_setup#network-configuration). Also replace the `localhost` in the ROS_HOSTNAME address with the IP address acquired from the above terminal window, which is the IP address of TurtleBot3.
...
[step_by_step_to_install_ubuntu_on_joule]: /docs/popup/turtlebot3/joule_setup
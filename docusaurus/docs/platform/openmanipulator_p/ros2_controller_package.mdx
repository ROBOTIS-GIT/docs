---
id: ros2_controller_package
title: "[ROS 2] Controller Package"
sidebar_position: 14
...
OpenMANIPULATOR-P controller provides basic manipulation of OpenMANIPULATOR-P. You can control DYNAMIXEL's of OpenMANIPULATOR-P and check states of OpenMANIPULATOR-P through [messages](/docs/platform/openmanipulator_p/ros2_controller_package#message-list) of the controller.  
...
**NOTE**:
- If you launched the [OpenMANIPULATOR-P controller](/docs/platform/openmanipulator_p/ros2_controller_package#launch-controller) before launching the open_manipulator_p_controller file, the robot model on RViz would be synchronized with the actual robot.
...
- Make sure ROS dependencies are installed before performing these instructions - [Install ROS Packages](/docs/platform/openmanipulator_p/ros2_setup#install-ros-packages) 
- Make sure to run the [OpenMANIPULATOR-P controller](/docs/platform/openmanipulator_p/ros2_controller_package#launch-controller) instructions before running the instructions below.

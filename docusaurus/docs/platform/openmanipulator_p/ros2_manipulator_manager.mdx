---
id: ros2_manipulator_manager
title: "[ROS 2] Manipulator Manager"
sidebar_position: 21
...
**NOTE**:
If you have a gripper([RH-P12-RN(A)](https://emanual.robotis.com/docs/en/platform/rh_p12_rna/)), Download the [source code of RH-P12-RN](https://github.com/ROBOTIS-GIT/RH-P12-RN.git) from GitHub and add the gripper module to the framework([Example](http://emanual.robotis.com/docs/en/software/robotis_framework_packages/tutorials/#tutorials)).
...
If you have a gripper([RH-P12-RN(A)](https://emanual.robotis.com/docs/en/platform/rh_p12_rna/)), see below.
```
...
[BOM]: https://emanual.robotis.com/docs/en/popup/turtlbot3_bom/

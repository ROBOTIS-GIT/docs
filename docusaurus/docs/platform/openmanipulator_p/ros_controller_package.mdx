...
if DYNAMIXEL aren't recoginized, please check firmware with ROBOTIS software ([R+ Manager 2.0](/docs/software/rplus2/manager) or [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel/dynamixel_wizard2#firmware-update))

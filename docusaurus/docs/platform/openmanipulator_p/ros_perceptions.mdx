...
#### Astra Pro
![](/img/platform/openmanipulator_x/OpenManipulator_camera_Astra_pro.png)  
...
#### Realsense D435
![](/img/platform/openmanipulator_x/OpenManipulator_camera_Realsense_D435.png)  
...
![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/Pi-Camera-front.jpg)

- See more details about [Raspberry Pi Camera V2](https://emanual.robotis.com/docs/en/platform/turtlebot3/appendix_raspi_cam/#overview)

- See more details about [Camera Sepecification](https://emanual.robotis.com/docs/en/platform/turtlebot3/appendix_raspi_cam/#specifications)

##### Setup Raspberry Pi Camera
:::warning

**Warning!**: Raspberry pi must be installed before setting up the Raspberry Pi Camera V2. See [Raspberry Pi 3 Setup](https://emanual.robotis.com/docs/en/platform/turtlebot3/raspberry_pi_3_setup/) in order to install it.
...
1. **[Raspberry Pi]** Setting up the camera hardware.
    ...
    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-1.png)

2. Select **3 Interfacing Options**.

    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-2.png)

3. Select **P1 Camera**.
    
    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-3.png)

4. Enable camera interface.

    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-4.png)    
    
    ![](/img/platform/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-5.png)
...
- Make sure to run the [Openmanipulator controller](/docs/platform/openmanipulator_x/ros_controller_package#launch-controller) instructions before use of the instruction
...
![](/img/platform/openmanipulator_x/OpenManipulator_AR_Marker.png)

...
5. Change the baud rate from 34 (576000 bps) to 1 (1 Mbps).
  ...
  ![](/img/platform/op/op_232.jpg)

6. After replacement is done. Run [DXL Monitor] and reset all DYNAMIXEL.

[DXL Monitor]: /docs/platform/op/development#dynamixel-monitor
...
3. Temporarily disconnect ALL currently connected cables. You can choose any TTL port. Do not disconnect the power cable from sub-controller to main controller. Doing so will not allow Dynamixel Wizard proper DYNAMIXEL search.
  ...
  ![](/img/platform/op/op_234.jpg)

  ![](/img/platform/op/op_235.jpg)
...
[Shut down DARWIN-OP]: /docs/platform/op/getting_started#shutdown
...
[killall]: /docs/platform/op/development#terminate-demo-program
...
[Color and White Balance Settings]: /docs/platform/op/getting_started#camera-calibration
...
[Layout]: /docs/platform/op/getting_started#layout
...
[DYNAMIXEL Monitor]: /docs/platform/op/development#dynamixel-monitor
[Firmware Installer]: /docs/platform/op/development#firmware-installer

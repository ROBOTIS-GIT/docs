...
| :---------------------------------------------------------- | :------- | :------------------------ | :------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| XL430-W250-T ([e-Manual](/docs/dxl/x/xl430-w250))       | 2        | XL430-W250-T              | 2        | [ROBOTIS SHOP](http://en.robotis.com/shop_en/item.php?it_id=902-0135-000)                                                                                                              |
...
![](/img/platform/turtlebot3/friends/All_friends.jpg)
...
- Get source codes and make friends! Go to `Examples` → `turtlebot3` → `turtlebot3_friends` on Arduino IDE for OpenCR.
  ...
  ![](/img/platform/turtlebot3/friends/ide.png)
...
![](/img/platform/turtlebot3/friends/friends_open_manipulator_waffle_pi.png)
...
![](/img/platform/turtlebot3/friends/friends_segway.png)
...
![](/img/platform/turtlebot3/friends/friends_conveyor.png)
...
![](/img/platform/turtlebot3/friends/friends_monster.png)
...
![](/img/platform/turtlebot3/friends/friends_tank.png)
...
![](/img/platform/turtlebot3/friends/friends_omni.png)
...
![](/img/platform/turtlebot3/friends/friends_mecanum.png)
...
![](/img/platform/turtlebot3/friends/friends_bike.png)
...
![](/img/platform/turtlebot3/friends/friends_road_train.png)
...
![](/img/platform/turtlebot3/friends/friends_real.png)
...
![](/img/platform/turtlebot3/friends/friends_carrier.png)

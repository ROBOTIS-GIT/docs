...
|:--------------------|:--------|:-----------------------------------------------------|
| **Actuator**        |         | DYNAMIXEL [XM430-W350-T](https://emanual.robotis.com/docs/en/dxl/x/xm430-w350/) |
| **Input Voltage**   | V       | 12                                                   |
...
- [OpenMANIPULATOR-X](/docs/platform/openmanipulator_x/overview) 
...
- [OpenMANIPULATOR-P](/docs/platform/openmanipulator_p/overview)

...
## Dimension
![](/img/platform/openmanipulator_x/OpenManipulator_Chain_spec_side.png)
...
## Inertia
![](/img/platform/openmanipulator_x/manipulator-x-inertia.PNG)

Total Mass : 711.37 gram

### Joint 1
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint1.PNG)
...
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint2.PNG)
...
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint3.PNG)
...
![](/img/platform/openmanipulator_x/manipulator-x-inertia_joint4.PNG)
...
![](/img/platform/openmanipulator_x/omx_urdf_graph.png)  
...
![](/img/platform/openmanipulator_x/rviz_om_view.png) 

...
import PerceptionsCameraJazzy from '@site/docs/_partials/platform/openmanipulator_x/perceptions_camera_jazzy.mdx';
import PerceptionsCameraHumble from '@site/docs/_partials/platform/openmanipulator_x/perceptions_camera_humble.mdx';
import PerceptionsInstallCameraPackageJazzy from '@site/docs/_partials/platform/openmanipulator_x/perceptions_install_camera_package_jazzy.mdx';
import PerceptionsInstallCameraPackageHumble from '@site/docs/_partials/platform/openmanipulator_x/perceptions_install_camera_package_humble.mdx';

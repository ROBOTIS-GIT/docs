---
id: robotis_ros_packages
title: "ROBOTIS ROS Packages"
sidebar_position: 4
tags: [op3]
---
...
import RobotisRosPackagesRev2 from '@site/docs/_partials/platform/op3/robotis_ros_packages_rev2.mdx';
...
- Walking parameters
 ...
 - YAML format
   - x_offset: offset in the x-direction (front and back) [m]  
     ![](/img/platform/op3/op3_walking_module_image142.jpg)

   - y_offset: offset in the y-direction (left and right) [m]  
     ![](/img/platform/op3/op3_walking_module_image143.jpg)

   - z_offset: offset in the z-direction (up and down) [m]  
     ![](/img/platform/op3/op3_walking_module_image144.jpg)

   - roll_offset: roll offset (x-coordinate) [degree]  
     ![](/img/platform/op3/op3_walking_module_image145.jpg)

   - pitch_offset: pitch offset (y-coordinate) [degree]  
     ![](/img/platform/op3/op3_walking_module_image146.jpg)

   - yaw_offset: yaw offset (z-coordinate) [degree]  
     ![](/img/platform/op3/op3_walking_module_image2.gif)
   ...
   - hip_pitch_offset: pitch offset (y-coordinate) at the hip level. Values are for DYNAMIXEL position values for hip pitch joints. [degree]  
     ![](/img/platform/op3/op3_walking_module_image147.jpg)

   - period_time: Time required for ROBOTIS-OP3 to complete two full steps (left and right foot) [ms]  
     ![](/img/platform/op3/op3_walking_module_image148.jpg)
   ...
   - dsp_ratio: Time ratio of the period when both feet are touching the ground to the period of time with only one foot on the ground in each walking cycle.  
     ![](/img/platform/op3/op3_walking_module_image149.jpg)

   - foot_height: foot elevation during walk [m]  
     ![](/img/platform/op3/op3_walking_module_image152.jpg)

   - swing_right_left: swing to either left or right during walk [m]  
     ![](/img/platform/op3/op3_walking_module_image153.jpg)

   - swing_top_down: up and down body swing during walk [m]  
     ![](/img/platform/op3/op3_walking_module_image154.jpg)
   ...
   - pelvis_offset: roll offset (x-coordinate) at the pelvis level. Values are for DYNAMIXEL position values for hip roll joints [degree]  
     ![](/img/platform/op3/op3_walking_module_image155.jpg)
...
##### using the `dynamic_reconfigure`  
  ![](/img/platform/op3/ball_detector_node_02.png)
...
![](/img/platform/op3/op3_urdf_rviz.png)
...
![](/img/platform/op3/thormang3_action_editor_tui.jpg)
...
![](/img/platform/op3/thormang3_action_editor_tui_command_list.jpg)
...
2. Find the page where the "walking_init page" is by typing "list"  
    ...
    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example1.jpg)

3. Exit the list and go to any blank page by typing "page [x]"(for example, page 15).

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example2.jpg)

4. Copy page 1 to page [x].  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example3.jpg)

5. Go to "walking_init" pose by typing "play"  
6. Turn off the torque of ID 2, 4 and 8 by typing "off 2 4 8"  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example4.jpg)

7. After getting the desired pose turn torque on again by typing on, insert the pose to step 1 by typing "i 1"  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example5.jpg)

8. Edit "Pause Time", "Time" of STP1 and "Page Step" as shown below.  

    ![](/img/platform/op3/thormang3_action_editor_tui_action_editing_example6.jpg)
...
![](/img/platform/op3/op3_gui_diagram.png)
...
[std_msgs/msg/Int32]: /docs/popup/op3_ros2/std_msgs_int32_message
[std_msgs/msg/String]: /docs/popup/op3_ros2/std_msgs_string
[std_msgs/msg/Bool]: /docs/popup/op3_ros2/std_msgs_bool_msg
[std_msgs/msg/Float64]: /docs/popup/op3_ros2/std_msgs_float64_msg
[std_msgs/msg/Header]: /docs/popup/op3_ros2/std_msgs_Header
[sensor_msgs/msg/JointState]: /docs/popup/op3_ros2/sensor_msgs_JointState_msg
[sensor_msgs/msg/Imu]: /docs/popup/op3_ros2/sensor_msgs_Imu_msg
[sensor_msgs/msg/Image]: /docs/popup/op3_ros2/sensor_msgs_Image
[sensor_msgs/msg/CameraInfo]: /docs/popup/op3_ros2/sensor_msgs_CameraInfo_msg
[geometry_msgs/msg/Point]: /docs/popup/op3_ros2/geometry_msgs_Point_msg
[geometry_msgs/msg/Pose]: /docs/popup/op3_ros2/geometry_msgs_Pose_msg
[geometry_msgs/msg/PoseStamped]: /docs/popup/op3_ros2/geometry_msgs_PoseStamped_msg
[robotis_controller_msgs/msg/StatusMsg]: /docs/popup/op3_ros2/StatusMsg_msg
[robotis_controller_msgs/msg/JointCtrlModule]: /docs/popup/JointCtrlModule_msg
[robotis_controller_msgs/msg/GetJointModule]: /docs/popup/GetJointModule_srv
[op3_action_module_msgs/msg/StartAction]: /docs/popup/op3_ros2/op3_StartAction_msg
[op3_action_module_msgs/srv/IsRunning]: /docs/popup/op3_ros2/op3_IsRunning_srv
[op3_offset_tuner_msgs/msg/JointOffsetData]: /docs/popup/op3_JointOffsetData_msg
[op3_offset_tuner_msgs/msg/JointTorqueOnOffArray]: /docs/popup/op3_JointTorqueOnOffArray_msg
[op3_offset_tuner_msgs/msg/GetPresentJointOffsetData]: /docs/popup/op3_GetPresentJointOffsetData_srv
[op3_tuning_module_msgs/msg/JointOffsetData]: /docs/popup/op3_tuning_module_msgs_JointOffsetData_msg
[op3_tuning_module_msgs/msg/JointTorqueOnOffArray]: /docs/popup/op3_tuning_module_msgs_JointTorqueOnOffArray_msg
[op3_tuning_module_msgs/msg/GetPresentJointOffsetData]: /docs/popup/op3_tuning_module_msgs_GetPresentJointOffsetData_srv
[robotis_controller_msgs/msg/SetModule]: /docs/popup/SetModule_srv
[robotis_controller_msgs/msg/LoadOffset]: /docs/popup/LoadOffset_srv
[op3_walking_module_msgs/msg/WalkingParam]: /docs/popup/op3_WalkingParam_msg
[WalkingParam.msg]: /docs/popup/op3_WalkingParam_msg
[op3_walking_module_msgs/msg/GetWalkingParam]: /docs/popup/op3_GetWalkingParam_srv
[GetWalkingParam.srv]: /docs/popup/op3_GetWalkingParam_srv
[SetWalkingParam.srv]: /docs/popup/op3_SetWalkingParam_srv
[GetJointPose.srv]: /docs/popup/op3_GetJointPose_srv
[GetKinematicsPose.srv]: /docs/popup/op3_GetKinematicsPose_srv
[GetPreviewMatrix.srv]: /docs/popup/op3_GetPreviewMatrix_srv
[JointOffsetData.msg]: /docs/popup/op3_JointOffsetData_msg
[JointOffsetPositionData.msg]: /docs/popup/op3_JointOffsetPositionData_msg
[JointTorqueOnOff.msg]: /docs/popup/op3_JointTorqueOnOff_msg
...
[ball_detector/circleSetStamped]: /docs/popup/ball_detector_CircleSetStamped_msg
[JointOffsetData.msg]: /docs/popup/op3_tuning_module_msgs_JointOffsetData_msg
[JointOffsetPositionData.msg]: /docs/popup/op3_tuning_module_msgs_JointOffsetPositionData_msg
[JointTorqueOnOff.msg]: /docs/popup/op3_tuning_module_msgs_JointTorqueOnOff_msg
[JointTorqueOnOffArray.msg]: /docs/popup/op3_tuning_module_msgs_JointTorqueOnOffArray_msg
[GetPresentJointOffsetData.srv]: /docs/popup/op3_tuning_module_msgs_GetPresentJointOffsetData_srv
</TabItem>
...
[op3_manager]: /docs/platform/op3/robotis_ros_packages#op3-manager
[op3_action_module]: /docs/platform/op3/robotis_ros_packages#op3_action_module
[op3_base_module]: /docs/platform/op3/robotis_ros_packages#op3_base_module
[op3_head_control_module]: /docs/platform/op3/robotis_ros_packages#op3_head_control_module
[op3_walking_module]: /docs/platform/op3/robotis_ros_packages#op3_walking_module
[op3_online_walking_module]: /docs/platform/op3/robotis_ros_packages#op3_online_walking_module
[open_cr_module]: /docs/platform/op3/robotis_ros_packages#open_cr_module
...
[op3_offset_tuner_server]: /docs/platform/op3/robotis_ros_packages#op3_offset_tuner_server
[op3_offset_tuner_client]: /docs/platform/op3/robotis_ros_packages#op3_offset_tuner_client
[`usb_cam`]: http://wiki.ros.org/usb_cam
[HSV color]: https://en.wikipedia.org/wiki/HSL_and_HSV
[How to execute Default Demo]: /docs/platform/op3/tutorials#how-to-exectue-default-demo
[How to execute GUI program]: /docs/platform/op3/tutorials#how-to-exectue-gui-program
[URDF-ROS Wiki]: http://wiki.ros.org/urdf
[Connect to ROS]: http://gazebosim.org/tutorials?cat=connect_ros

[op3_gui_demo]: /docs/platform/op3/robotis_ros_packages#op3_gui_demo
[How to use walking tuner]: /docs/platform/op3/tutorials#how-to-use-walking-tuner
[How to use offset tuner]: /docs/platform/op3/tutorials#how-to-use-offset-tuner
[Installing ROBOTIS ROS Package]: /docs/platform/op3/recovery#installing-robotis-ros-packages
[/op3_walking_module/config/param.yaml]: /docs/popup/op3_walking_module_param_yaml
[/op3_base_module/data/ini_pose.yaml]: /docs/popup/op3_base_module_ini_pose_yaml
[OPENCR]: /docs/platform/common/arduino_examples_op3#opencr-op3
[op3_direct_control_module]: /docs/platform/op3/robotis_ros_packages#op3_direct_control_module
[op3_tuning_module]: /docs/platform/op3/robotis_ros_packages#op3_tuning_module
[How to use tuner client]: /docs/platform/op3/tutorials#how-to-use-tuner-client
...
[How to use ball detector]: /docs/platform/op3/tutorials#how-to-use-ball-detector

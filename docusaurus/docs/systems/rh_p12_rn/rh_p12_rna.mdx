...
You can choose the desired firmware version by using **Firmware Recovery** of [R+Manager 2.0](/docs/software/dynamixel/dynamixel_wizard2#firmware-recovery) or [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel/dynamixel_wizard2#firmware-recovery)

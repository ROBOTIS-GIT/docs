import DxlWarning from '@site/docs/dxl/_partials/pro/warning.mdx';
import DxlControlTable from '@site/docs/dxl/_partials/pro/control_table_proa.mdx';
import DxlPControlTable7Id from '@site/docs/dxl/_partials/pro/p_control_table_7_id.mdx';
import DxlPControlTable8BaudRate from '@site/docs/dxl/_partials/pro/p_control_table_8_baud_rate.mdx';
import DxlPControlTable9ReturnDelayTime from '@site/docs/dxl/_partials/pro/p_control_table_9_return_delay_time.mdx';
import DxlPControlTable12SecondaryId from '@site/docs/dxl/_partials/pro/p_control_table_12_secondary_id.mdx';
import DxlPControlTable13ProtocolType from '@site/docs/dxl/_partials/pro/p_control_table_13_protocol_type.mdx';
import DxlPControlTable24MovingThreshold from '@site/docs/dxl/_partials/pro/p_control_table_24_moving_threshold.mdx';
import DxlPControlTable31TemperatureLimit from '@site/docs/dxl/_partials/pro/p_control_table_31_temperature_limit.mdx';
import DxlPControlTable32VoltageLimit from '@site/docs/dxl/_partials/pro/p_control_table_32_voltage_limit.mdx';
import DxlPControlTable36PwmLimit from '@site/docs/dxl/_partials/pro/p_control_table_36_pwm_limit.mdx';
import DxlPControlTable56ExternalPort from '@site/docs/dxl/_partials/pro/p_control_table_56_external_port.mdx';
import DxlControlTableShutdown from '@site/docs/dxl/_partials/pro/control_table_shutdown.mdx';
import DxlPControlTable168Indirect from '@site/docs/dxl/_partials/pro/p_control_table_168_indirect.mdx';
import DxlControlTableTorqueEnable from '@site/docs/dxl/_partials/pro/control_table_torque_enable_proa.mdx';
import DxlPControlTable513Led from '@site/docs/dxl/_partials/pro/p_control_table_513_led.mdx';
import DxlPControlTable516StatusReturnLevel from '@site/docs/dxl/_partials/pro/p_control_table_516_status_return_level.mdx';
import DxlPControlTable517RegisteredInstruction from '@site/docs/dxl/_partials/pro/p_control_table_517_registered_instruction.mdx';
import DxlPControlTable518HardwareErrorStatus from '@site/docs/dxl/_partials/pro/p_control_table_518_hardware_error_status.mdx';
import DxlPControlTable546BusWatchdog from '@site/docs/dxl/_partials/pro/p_control_table_546_bus_watchdog.mdx';
import DxlPControlTable548GoalPwm from '@site/docs/dxl/_partials/pro/p_control_table_548_goal_pwm_rh.mdx';
import DxlPControlTable568RealtimeTick from '@site/docs/dxl/_partials/pro/p_control_table_568_realtime_tick.mdx';
import DxlPControlTable570Moving from '@site/docs/dxl/_partials/pro/p_control_table_570_moving.mdx';
import DxlPControlTable572PresentPwm from '@site/docs/dxl/_partials/pro/p_control_table_572_present_pwm.mdx';
import DxlPControlTable574PresentCurrent from '@site/docs/dxl/_partials/pro/p_control_table_574_present_current.mdx';
import DxlPControlTable576PresentVelocity from '@site/docs/dxl/_partials/pro/p_control_table_576_present_velocity.mdx';
import DxlPControlTable592PresentInputVoltage from '@site/docs/dxl/_partials/pro/p_control_table_592_present_input_voltage.mdx';
import DxlPControlTable594PresentTemperature from '@site/docs/dxl/_partials/pro/p_control_table_594_present_temperature.mdx';
import DxlFccClassB from '@site/docs/dxl/_partials/pro/fcc_class_b.mdx';
import DxlCommonLink from '@site/docs/dxl/_partials/pro/common_link.mdx';

# Introduction
![](/img/systems/rh_p12_rn/rh_p12_rn/rh-p12-rn_product_new.webp)
...
You can choose the desired firmware version by using **Firmware Recovery** of [R+Manager 2.0](/docs/software/dynamixel_wizard_2_0/basic_features#firmware-recovery) or [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0/basic_features#firmware-recovery)
...
|:---:|:---------------------------------------------------------------:|:----------:|:--------------:|
|  0  | ![](/img/systems/rh_p12_rn/rh_p12_rn/rh-p12-rn_finger_old.webp) | 0 ~ 109 mm |       .        |
|  1  | ![](/img/systems/rh_p12_rn/rh_p12_rn/rh-p12-rn_finger_new.webp) | 0 ~ 106 mm | Nov 04th, 2019 |
...
<DxlPControlTable32VoltageLimit max={300} />
...
<DxlPControlTable56ExternalPort img="/img/common/rh_p12_rn_external_port.png" />


<a id="shutdown"></a>
### Shutdown(63)
<DxlControlTableShutdown shutdown={63} torqueEnable={512} hwError={518} />
...
![](/img/systems/rh_p12_rn/rh_p12_rn/rh_p12_rn_a_position.webp)
...
|:----------:|:------------------------------------------------------------------:|:-------------------------------------------------------------------:|
| RH-P12-RN  | ![](/img/systems/rh_p12_rn/rh_p12_rn/rh_p12_rn_position_open.webp) | ![](/img/systems/rh_p12_rn/rh_p12_rn/rh_p12_rn_position_close.webp) |
...
![](/img/systems/rh_p12_rn/rh_p12_rn/rh-p12-rn_assembly.webp)
...
|    Diagram     |       ![](/img/common/jst_b4beha_diagram.webp)       |             ![](/img/common/molex_5304706_diagram.webp)              |
|    Housing     |                        [JST EHR-04]                        |    ![](/img/common/molex_510210600.webp)<br />[MOLEX 51021-0600]     |
|   PCB Header   | ![](/img/systems/rh_p12_rn/rh_p12_rn/jst_b4beha.webp)<br />[JST B4B-EH-A] |    ![](/img/common/molex_530470610.webp)<br />[MOLEX 53047-0610]     |

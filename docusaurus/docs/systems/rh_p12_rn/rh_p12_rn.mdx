...
import DxlControlTable from '@site/docs/dxl/_partials/pro/control_table.mdx';
...
import DxlControlTableTorqueEnable from '@site/docs/dxl/_partials/pro/control_table_torque_enable.mdx';

...
!<a href="/img/systems/rh_p12_rn/linux_example_execute.webp" target="_blank">img</a>

If RH-P12-RN is configured as **Current-based Position Control Mode**, below image will be displayed.  

!<a href="/img/systems/rh_p12_rn/linux_example_position_mode.webp" target="_blank">img</a>

If RH-P12-RN is configured as **Current Control Mode**, below image will be displayed.  

!<a href="/img/systems/rh_p12_rn/linux_example_current_mode.webp" target="_blank">img</a>
...
!<a href="/img/systems/rh_p12_rn/ros_example_position_mode.webp" target="_blank">img</a>

If RH-P12-RN is configured as **Current Control Mode**, below GUI window will be displayed.  

!<a href="/img/systems/rh_p12_rn/ros_example_current_mode.webp" target="_blank">img</a>

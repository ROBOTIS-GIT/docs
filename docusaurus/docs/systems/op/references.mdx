...
import FccClassA from '@site/docs/_partials/systems/op/fcc_class_a.mdx';
...
![](/img/systems/op/op_system_blockdiagram.webp)
...
For more information on the connector, please refer to the [MX-28 Connector Information](/docs/dxl/model_reference/mx_series/mx-28#connector-information).
...
![](/img/systems/op/op_256.webp)

> The positions of central axis and sensor at Dawin

![](/img/systems/op/op_257.webp)

> Gyroscope

![](/img/systems/op/op_258.webp)

> Accelerometer

| ![](/img/systems/op/op_259.webp) | ![](/img/systems/op/op_260.webp) |
|:------------------------------------------:|:------------------------------------------:|
...
![](/img/systems/op/op_dimension.webp)
...
![](/img/systems/op/op_dynamics.webp)
...
- Modifications
  ...
  - firmware installer : separate firmware of the controller and actuator

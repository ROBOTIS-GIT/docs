...
5. Change the baud rate from 34 (576000 bps) to 1 (1 Mbps).
  ...
  ![](/img/systems/op/op_232.webp)

6. After replacement is done. Run [DXL Monitor] and reset all DYNAMIXEL.

[DXL Monitor]: /docs/systems/op/development#dynamixel-monitor
Click [Dynamixel Wizard] for more information.

[Dynamixel Wizard]: https://emanual.robotis.com/docs/en/software/rplus1/dynamixe_wizard/
#### Method B
...
3. Temporarily disconnect ALL currently connected cables. You can choose any TTL port. Do not disconnect the power cable from sub-controller to main controller. Doing so will not allow Dynamixel Wizard proper DYNAMIXEL search.
  ...
  ![](/img/systems/op/op_234.webp)

  ![](/img/systems/op/op_235.webp)
...
[Shut down DARWIN-OP]: /docs/systems/op/getting_started#shutdown
...
[killall]: /docs/systems/op/development#terminate-demo-program
...
[Color and White Balance Settings]: /docs/systems/op/getting_started#camera-calibration
...
[Layout]: /docs/systems/op/getting_started#layout
...
[DYNAMIXEL Monitor]: /docs/systems/op/development#dynamixel-monitor
[Firmware Installer]: /docs/systems/op/development#firmware-installer

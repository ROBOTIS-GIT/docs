...
```
![](/img/systems/manipulator_h/manipulator_h_rviz.webp)
...
**TIP**:
- If you can't load DYNAMIXEL's, please check your DYNAMIXEL's settings using [this page](/docs/systems/manipulator_h/getting_started#prerequisite).
...
![](/img/systems/manipulator_h/manipulator_h_gui.webp)  
...
```
![](/img/systems/manipulator_h/manipulator_h_gazebo.webp)  

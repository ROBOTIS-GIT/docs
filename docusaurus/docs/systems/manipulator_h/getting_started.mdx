...
![](/img/systems/manipulator_h/manipulator_h_006.webp)

### Power Cable
The power cable supplies power to the Manipulator.

![](/img/systems/manipulator_h/manipulator_h_007.webp)
...
![](/img/systems/manipulator_h/manipulator_h_008.webp)
...
![](/img/systems/manipulator_h/manipulator_h_009.webp)

- Rest and fix joint 1 of the Manipulator.

![](/img/systems/manipulator_h/manipulator_h_010.webp)

![](/img/systems/manipulator_h/manipulator_h_011.webp)
...
![](/img/systems/manipulator_h/manipulator_h_012.webp)

![](/img/systems/manipulator_h/manipulator_h_013.webp)

![](/img/systems/manipulator_h/manipulator_h_014.webp)

![](/img/systems/manipulator_h/manipulator_h_015.webp)
...
![](/img/systems/manipulator_h/manipulator_h_016.webp)
...
![](/img/systems/manipulator_h/manipulator_h_017.webp)
...
:::
  ...
  ![](/img/systems/manipulator_h/manipulator_h_018.webp)

- Install and run RoboPlus; click on DYNAMIXEL Wizard button to start DYNAMIXEL Wizard.

  ![](/img/systems/manipulator_h/manipulator_h_019.webp)
...
- USB2DYNAMIXEL to the PC after wiring is complete. From the PC check the COM port number of USB2DYNAMIXEL.
  ...
  ![](/img/systems/manipulator_h/manipulator_h_020.webp)

  ![](/img/systems/manipulator_h/manipulator_h_021.webp)

  ![](/img/systems/manipulator_h/manipulator_h_022.webp)
...
**CAUTION** : Always ensure before powering on. While power is on do not change wires; otherwise it may cause undesired operations.
  ...
  ![](/img/systems/manipulator_h/manipulator_h_023.webp)

  ![](/img/systems/manipulator_h/manipulator_h_024.webp)
...
- The picture on the left is the COM port number of USB2DYNAMIXEL (which should be connected to the arm). Click on the   to continue
  ...
  ![](/img/systems/manipulator_h/manipulator_h_025.webp)
...
- Once connected make sure that 1000000bps box is checked and “DXL 2.0” is selected. Then click on Search. The arm’s default baud rate is 1 Mbps.
  ...
  ![](/img/systems/manipulator_h/manipulator_h_026.webp)

  ![](/img/systems/manipulator_h/manipulator_h_027.webp)
...
- Once search is complete the arm’s components (DYNAMIXEL PROs) are listed on the left. Click on an individual DYNAMIXEL PRO to display the contents of its Control Table.
  ...
  ![](/img/systems/manipulator_h/manipulator_h_028.webp)

  ![](/img/systems/manipulator_h/manipulator_h_029.webp)
...
- DYNAMIXEL Pro will only move (operate) when Torque Mode is on. So always make sure the Torque Mode is on prior to sending moving commands.  
  ...
  ![](/img/systems/manipulator_h/manipulator_h_030.webp)

  ![](/img/systems/manipulator_h/manipulator_h_031.webp)

  ![](/img/systems/manipulator_h/manipulator_h_032.webp)

  ![](/img/systems/manipulator_h/manipulator_h_033.webp)
...
- Turn ‘Torque Enable’ on to all joints. The pose of the arm will become rigid (check by applying a small force). Afterwards click on joint 6.
  ...
  ![](/img/systems/manipulator_h/manipulator_h_034.webp)
...
- Set Goal Position back to 0 to set position to its original position.
  ...
  ![](/img/systems/manipulator_h/manipulator_h_035.webp)
...
|:----------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| H54-200-S500-R<br />H54-100-S500-R | -180 ~ 180 (deg) → -251000 ~ 251000<br />![](/img/systems/manipulator_h/manipulator_h_036.webp)<br />![](/img/systems/manipulator_h/manipulator_h_037.gif) |
|           H42-20-S300-R            | -180 ~ 180 (deg) → -151875 ~ 151875<br />![](/img/systems/manipulator_h/manipulator_h_038.webp)<br />![](/img/systems/manipulator_h/manipulator_h_039.gif) |
|           L54-50-S500-R            | -180 ~ 180 (deg) → -125700 ~ 125700<br />![](/img/systems/manipulator_h/manipulator_h_040.webp)<br />![](/img/systems/manipulator_h/manipulator_h_041.gif) |
|           L54-30-S500-R            | -180 ~ 180 (deg) → -144180 ~ 144180<br />![](/img/systems/manipulator_h/manipulator_h_042.webp)<br />![](/img/systems/manipulator_h/manipulator_h_043.gif) |
|           L42-20-S300-R            |   -180 ~ 180 (deg) → -2048 ~ 2048<br />![](/img/systems/manipulator_h/manipulator_h_044.webp)<br />![](/img/systems/manipulator_h/manipulator_h_045.gif)   |

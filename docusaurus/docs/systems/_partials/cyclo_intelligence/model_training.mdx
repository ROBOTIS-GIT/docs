...
Fine-tunes from the released base checkpoint, passed with `--policy.path`.
...
**Defaults to a full fine-tune**, as shown below. Set either flag to `true` to freeze that encoder and train less.

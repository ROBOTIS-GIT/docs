...
<p style={{textAlign: 'center', fontStyle: 'italic', color: '#888', fontSize: '14px', marginBottom: '20px'}}>
...
![System Architecture](/img/systems/omx/technical_story/system_architecture.png)
...
| :---: | :---: |
| <img src="/img/systems/omx/technical_story/pen_link.png" alt="Physical Pen Setup" width="550" /> | <img src="/img/systems/omx/technical_story/TCP.jpg" alt="Pen Link Visualization" width="350" /> |
...
4.  **Visual Debugging**: By adding visualization elements (`<visual>`) to the virtual link, you can verify in real-time whether the pen tip's position in RViz matches the actual hardware. Use the command below to instantly verify if the modified URDF reflects your intentions visually.
    ...
    ```
![TCP Calibration Result](/img/systems/omx/technical_story/pen_point.png)
...
![Original Image](/img/systems/omx/technical_story/person.jpeg)
...
1.  **Step 1 (Image Analysis and Preprocessing)**:
    *   **Bilateral Filter**: Unlike simple Gaussian blur, it effectively removes only noise while preserving edge information.
        ![Bilateral Filter](/img/systems/omx/technical_story/bilateral_filter.jpg)
...
![Skeletonization Result](/img/systems/omx/technical_story/skeletonization.jpg)
...
![Line Extraction Flow](/img/systems/omx/technical_story/stage_2_line_extraction.jpg)
...
3.  **Step 3 (Adaptive Smoothing & Optimization)**:
  ...
  ![Robotic Trajectory](/img/systems/omx/technical_story/trajectory.jpg)
...
1. **Verify Workspace & Flow**: Visually monitor the drawing process in RViz to ensure the robot stays within its operating limits.
   ...
   ```
   ![RViz Monitoring](/img/systems/omx/technical_story/drawing_circle.gif)
...
![Generated Trajectories](/img/systems/omx/technical_story/trajectories.gif)
...
![Real Robot Drawing](/img/systems/omx/technical_story/drawing_person.gif)

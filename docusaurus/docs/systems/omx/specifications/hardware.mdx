...
![omx](/img/systems/omx/specifications/hardware/main_image.png)
...
![](/img/systems/omx/specifications/hardware/hw_overview_omx_l.png)
...
## [OMX-L] Layout
![](/img/systems/omx/specifications/hardware/omx_leader_layout.png)
...
|      | <a href="https://www.printables.com/model/1696210-omx-leader" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', alignItems: 'center', gap: '0.25em', whiteSpace: 'nowrap'}}><img src="/img/systems/omx/specifications/hardware/printables_logo_no_background.png" alt="" width="13" height="13" decoding="async" />Download in Printables</a> |
| STL |  <a href="https://cad.onshape.com/documents?nodeId=3&resourceType=filter&q=_all:ROBOTIS%20OMX-AI%20" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', alignItems: 'center', gap: '0.25em', whiteSpace: 'nowrap'}}><img src="/img/systems/omx/specifications/hardware/onshape_logo_nobg.png" alt="" width="14" height="14" decoding="async" />Download in Onshape</a> |

## [OMX-F] Hardware Overview
![](/img/systems/omx/specifications/hardware/hw_overview_omx_f.png)
...
## [OMX-F] Layout
![](/img/systems/omx/specifications/hardware/omx_follower_layout.png)
...
|      | <a href="https://www.printables.com/model/1696214-omx-follower" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', alignItems: 'center', gap: '0.25em', whiteSpace: 'nowrap'}}><img src="/img/systems/omx/specifications/hardware/printables_logo_no_background.png" alt="" width="13" height="13" decoding="async" />Download in Printables</a> |
| STL |  <a href="https://cad.onshape.com/documents?nodeId=3&resourceType=filter&q=_all:ROBOTIS%20OMX-AI%20" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', alignItems: 'center', gap: '0.25em', whiteSpace: 'nowrap'}}><img src="/img/systems/omx/specifications/hardware/onshape_logo_nobg.png" alt="" width="14" height="14" decoding="async" />Download in Onshape</a> |
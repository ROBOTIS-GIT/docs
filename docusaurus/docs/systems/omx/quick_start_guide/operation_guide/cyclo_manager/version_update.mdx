...
Use Version Update to update OMX software packages and container images from Cyclo Manager.
...
Use **Package Update** when the OMX software repository has a newer supported version.
...
![Version Management](/img/systems/omx/quick_start_guide/operation_guide/cyclo_manager/version_management.png)

When you click the **Update** button, Cyclo Manager runs the update workflow:

![Update1](/img/systems/omx/quick_start_guide/operation_guide/cyclo_manager/version_update1.png)

1. Stop the running containers.

![Update2](/img/systems/omx/quick_start_guide/operation_guide/cyclo_manager/version_update2.png)

2. Choose a strategy for local changes.

![Update3](/img/systems/omx/quick_start_guide/operation_guide/cyclo_manager/version_update3.png)

3. Choose the files you want to preserve.

![Update4](/img/systems/omx/quick_start_guide/operation_guide/cyclo_manager/version_update4.png)

4. The Git repository is pulled and the container is created.

![Update5](/img/systems/omx/quick_start_guide/operation_guide/cyclo_manager/version_update5.png)

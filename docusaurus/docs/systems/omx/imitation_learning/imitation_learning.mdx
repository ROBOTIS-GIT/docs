...
<img src="/img/systems/omx/imitation_learning/end_to_end_imitation_learning_workflow.png" alt="Imitation Learning Workflow" style={{width: '100%'}} />
...
<a href="/docs/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/dataset_preparation" class="button-shortcut">
<span>Option 1</span>

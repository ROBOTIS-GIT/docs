...
[Set up Physical AI Tools Docker Container](/docs/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/prerequisites#setup-physical-ai-tools-docker-container)
...
(Refer to the [Dataset Preparation > Recording > 1. Open the Web UI](/docs/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording#_1-open-the-web-ui))
...
Enter **Task Instruction** and **Policy Path** in the **Task Info Panel**, located on the right side of the page.
  ...
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/model_inference/task_info.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omx/imitation_learning/physical_ai_tools/model_inference/browse_button.png" alt="Web UI" style={{width: '30%'}} />
<br />
<img src="/img/systems/omx/imitation_learning/physical_ai_tools/model_inference/file_browser.png" alt="Web UI" style={{width: '100%'}} />
:::
...
Click the `Download Policy` button to open a popup for downloading a policy model. 
  ...
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/model_inference/download_policy_button.png" alt="Web UI" style={{width: '50%'}} />
  <br />
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/model_inference/download_policy_modal.png" alt="Web UI" style={{width: '70%'}} />
...
The downloaded model path is automatically filled into Policy Path. 
  ...
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/model_inference/downloaded_path_filled.png" alt="Web UI" style={{width: '30%'}} />
...
To begin inference, use the **Control Panel** located at the bottom of the page:
  ...
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/control_panel.png" alt="Web UI" style={{width: '100%'}} />
...
<a href="/docs/systems/omx/resources/open_source" class="button-shortcut">
<span>Overview</span>
</a>
</div>

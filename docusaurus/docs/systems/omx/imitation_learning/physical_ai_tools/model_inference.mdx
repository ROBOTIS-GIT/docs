...
Enter **Task Instruction** and **Policy Path** in the **Task Info Panel**, located on the right side of the page.
  ...
  <img src="/img/systems/omx/imitation_learning/web_ui/inference/task_info.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omx/imitation_learning/web_ui/inference/browse_button.png" alt="Web UI" style={{width: '30%'}} />
<br />
<img src="/img/systems/omx/imitation_learning/web_ui/inference/file_browser.png" alt="Web UI" style={{width: '100%'}} />
:::
...
Click the `Download Policy` button to open a popup for downloading a policy model. 
  ...
  <img src="/img/systems/omx/imitation_learning/web_ui/inference/download_policy_button.png" alt="Web UI" style={{width: '50%'}} />
  <br />
  <img src="/img/systems/omx/imitation_learning/web_ui/inference/download_policy_modal.png" alt="Web UI" style={{width: '70%'}} />
...
The downloaded model path is automatically filled into Policy Path. 
  ...
  <img src="/img/systems/omx/imitation_learning/web_ui/inference/downloaded_path_filled.png" alt="Web UI" style={{width: '30%'}} />

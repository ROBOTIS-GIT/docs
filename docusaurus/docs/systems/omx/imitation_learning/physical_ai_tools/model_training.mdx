...
Once [preparing your dataset](/docs/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation) is done, the policy model can be trained using the Web UI.

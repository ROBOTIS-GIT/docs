...
```
  ...
  <img src="/img/systems/omx/imitation_learning/web_ui/record/task_info_repo_id_omx_f.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<img src="/img/systems/omx/imitation_learning/data_visualization.png" alt="Web UI" style={{width: '100%'}} />

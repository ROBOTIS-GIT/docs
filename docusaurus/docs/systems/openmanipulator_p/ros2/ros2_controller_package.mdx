...
OpenMANIPULATOR-P controller provides basic manipulation of OpenMANIPULATOR-P. You can control DYNAMIXEL's of OpenMANIPULATOR-P and check states of OpenMANIPULATOR-P through [messages](/docs/systems/openmanipulator_p/ros2/ros2_controller_package#message-list) of the controller.  
...
- Make sure ROS dependencies are installed before performing these instructions. - [Install ROS 2 Packages](/docs/systems/openmanipulator_p/ros2/ros2_setup#install-ros-2-packages).
...
- The test is done on `ROS 2 Dashing Diademata` installed in `Ubuntu 18.04`
- Make sure ROS dependencies are installed before performing these instructions. - [Install ROS 2 Packages](/docs/systems/openmanipulator_p/ros2/ros2_setup#install-ros-2-packages).
- Make sure to run the [OpenMANIPULATOR-P controller](/docs/systems/openmanipulator_p/ros2/ros2_controller_package#launch-controller) instructions before use of the instruction
...
**NOTE**:
- If you launched the [OpenMANIPULATOR-P controller](/docs/systems/openmanipulator_p/ros2/ros2_controller_package#launch-controller) before launching the open_manipulator_p_controller file, the robot model on RViz would be synchronized with the actual robot.
...
- Make sure ROS dependencies are installed before performing these instructions - [Install ROS Packages](/docs/systems/openmanipulator_p/ros2/ros2_setup#install-ros-packages) 
- Make sure to run the [OpenMANIPULATOR-P controller](/docs/systems/openmanipulator_p/ros2/ros2_controller_package#launch-controller) instructions before running the instructions below.

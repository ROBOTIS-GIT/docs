...
**NOTE**:
If you have a gripper([RH-P12-RN(A)](/docs/systems/rh_p12_rn/rh_p12_rna)), Download the [source code of RH-P12-RN](https://github.com/ROBOTIS-GIT/RH-P12-RN.git) from GitHub and add the gripper module to the framework([Example](/docs/software/robotis_framework_packages/tutorials)).

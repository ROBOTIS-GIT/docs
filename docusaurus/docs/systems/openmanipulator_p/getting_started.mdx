...
{/* include: en/dxl/model_reference/p_series/jst_485_pro_plus.md */}


### U2D2
[U2D2](/docs/parts/interface/u2d2) is a small size USB communication converter that enables to control and operate DYNAMIXEL with PC. Connect the [U2D2](/docs/parts/interface/u2d2) to the PC via USB hub.

![](/img/systems/openmanipulator_p/getting_started/u2d2.webp)
...
|:------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| PH54-200-S500-R<br />PH54-100-S500-R | -180 ~ 180 (deg) → -501923 ~ 501923<br />![](/img/systems/openmanipulator_p/getting_started/h54p_goal_position.webp)<br />![](/img/systems/openmanipulator_p/getting_started/h54p_goal_angle.webp) |
|           PH42-020-S300-R            | -180 ~ 180 (deg) → -303750 ~ 303750<br />![](/img/systems/openmanipulator_p/getting_started/h42p_goal_position.webp)<br />![](/img/systems/openmanipulator_p/getting_started/h42p_goal_angle.webp) |

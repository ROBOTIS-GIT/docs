...
|                                              Item                                              | Quantity |
|:----------------------------------------------------------------------------------------------:|:--------:|
|                            [Gripper](https://emanual.robotis.com/docs/en/platform/rh_p12_rna/)                            |    1     |
| [Base Plate Frame](http://www.robotis-shop-en.com/?act=shop_en.goods_view&GS=2538&GC=GD070002) |    1     |

## Setup
### Wiring

![](/img/systems/openmanipulator_p/wiring.webp)
...
![](/img/systems/openmanipulator_p/u2d2.webp)
...
|:------------------------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| PH54-200-S500-R<br />PH54-100-S500-R | -180 ~ 180 (deg) → -501923 ~ 501923<br />![](/img/systems/openmanipulator_p/h54p_goal_position.webp)<br />![](/img/systems/openmanipulator_p/h54p_goal_angle.webp) |
|           PH42-020-S300-R            | -180 ~ 180 (deg) → -303750 ~ 303750<br />![](/img/systems/openmanipulator_p/h42p_goal_position.webp)<br />![](/img/systems/openmanipulator_p/h42p_goal_angle.webp) |

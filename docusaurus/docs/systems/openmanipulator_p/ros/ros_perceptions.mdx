...
#### Astra Pro
![](/img/systems/openmanipulator_p/ros/ros_perceptions/OpenManipulator_camera_Astra_pro.webp)  
...
#### Realsense D435
![](/img/systems/OpenManipulator_camera_Realsense_D435.webp)  
...
1. **[Raspberry Pi]** Setting up the camera hardware.
    ...
    ![](/img/systems/openmanipulator_p/ros/ros_perceptions/pi-cam-hardware-setting-1.webp)

2. Select **3 Interfacing Options**.

    ![](/img/systems/openmanipulator_p/ros/ros_perceptions/pi-cam-hardware-setting-2.webp)

3. Select **P1 Camera**.
    
    ![](/img/systems/openmanipulator_p/ros/ros_perceptions/pi-cam-hardware-setting-3.webp)

4. Enable camera interface.

    ![](/img/systems/openmanipulator_p/ros/ros_perceptions/pi-cam-hardware-setting-4.webp)    
    
    ![](/img/systems/openmanipulator_p/ros/ros_perceptions/pi-cam-hardware-setting-5.webp)
...
![](/img/systems/openmanipulator_p/ros/ros_perceptions/OpenManipulator_AR_Marker.webp)

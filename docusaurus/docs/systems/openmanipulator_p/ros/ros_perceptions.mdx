...
#### Astra Pro
![](/img/systems/openmanipulator_x/OpenManipulator_camera_Astra_pro.webp)  
...
#### Realsense D435
![](/img/systems/openmanipulator_x/OpenManipulator_camera_Realsense_D435.webp)  
...
- See more details about [Raspberry Pi Camera V2](/docs/systems/turtlebot3/more_info/raspberry_pi_camera#overview)

- See more details about [Camera Sepecification](/docs/systems/turtlebot3/more_info/raspberry_pi_camera#specifications)

##### Setup Raspberry Pi Camera
:::warning

**Warning!**: Raspberry pi must be installed before setting up the Raspberry Pi Camera V2. See [Raspberry Pi 3 Setup](/docs/systems/turtlebot3/quick_start_guide/sbc_setup) in order to install it.
...
1. **[Raspberry Pi]** Setting up the camera hardware.
    ...
    ![](/img/systems/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-1.webp)

2. Select **3 Interfacing Options**.

    ![](/img/systems/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-2.webp)

3. Select **P1 Camera**.
    
    ![](/img/systems/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-3.webp)

4. Enable camera interface.

    ![](/img/systems/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-4.webp)    
    
    ![](/img/systems/turtlebot3/more_info/appendix_raspi_cam/pi-cam-hardware-setting-5.webp)
...
**Warning!**: Before running `rqt_image_view` in Remote PC, be sure Raspberry Pi and Remote PC are connected under the same IP address. If not, refer to [Raspberry Pi 3 Setup](/docs/systems/turtlebot3/quick_start_guide/sbc_setup#5-network-configuration) and [Remote PC Setup](/docs/systems/turtlebot3/quick_start_guide/pc_setup) and connect the board and PC under the same IP address. Otherwise, `rqt_image_view` screen will not show any images from the camera.
...
- Make sure to run the [Openmanipulator controller](/docs/systems/openmanipulator_x/ros_controller/ros_controller_package#launch-controller) instructions before use of the instruction
...
![](/img/systems/openmanipulator_x/OpenManipulator_AR_Marker.webp)

...
- Make sure to run the [Openmanipulator controller](/docs/systems/openmanipulator_x/ros_controller_package#launch-controller) instructions before use of the instruction

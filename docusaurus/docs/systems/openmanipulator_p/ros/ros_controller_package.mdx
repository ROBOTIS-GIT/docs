...
You can control each joint of OpenMANIPULATOR-P and check states of OpenMANIPULATOR-P through [messages](/docs/systems/openmanipulator_p/ros/ros_controller_package#message-list) by utilizing an exclusive controller program.
...
`use_platform`  
- Sets to **true/false** to use [Simulation](/docs/systems/openmanipulator_p/ros/ros_simulation#ros-simulation) feature. 
  - **true** for using an actual robot. 
  - **false** for using an virtual robot in [Gazebo](/docs/systems/openmanipulator_p/ros/ros_simulation#controller-for-gazebo) (3D robotics simulator).
...
- More information on these parmeters is available at [MoveIt!](/docs/systems/openmanipulator_p/ros/ros_operation#moveit).

## Launch Controller
After setting those parameters, launch OpenMANIPULATOR-P controller to start [[ROS] Operation](/docs/systems/openmanipulator_p/ros/ros_operation#ros-operation).
...
<img src="/img/systems/openmanipulator_p/open_manipulator_start_pose.webp" width="250" />
...
if DYNAMIXEL aren't recoginized, please check firmware with ROBOTIS software ([R+ Manager 2.0](/docs/software/dynamixel_wizard_2_0/introduction) or [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0/basic_features#firmware-update))
...
**NOTE**:
- If you launched the [OpenMANIPULATOR-P controller](/docs/systems/openmanipulator_p/ros/ros_controller_package#launch-controller) before launching the open_manipulator_p_controller file, the robot model on RViz would be synchronized with the actual robot.
...
- The test is done on `ROS Melodic Morenia`installed in `Ubuntu 18.04`.
- Make sure ROS dependencies are installed before performing these instructions - [Install ROS Packages](/docs/systems/openmanipulator_p/ros/ros_setup#install-ros-packages) 
- Make sure to launch the [OpenMANIPULATOR-P controller](/docs/systems/openmanipulator_p/ros/ros_controller_package#launch-controller) before use of the instruction
...
![](/img/systems/openmanipulator_p/rqt1.webp)  
...
[std_msgs/Empty]: /docs/systems/openmanipulator_p/msgs/std_msgs_Empty_msg
[moveit_msgs/DisplayTrajectory]: /docs/systems/openmanipulator_p/msgs/moveit_msgs_DisplayTrajectory_msg
[moveit_msgs/MoveGroupActionGoal]: /docs/systems/openmanipulator_p/msgs/moveit_msgs_MoveGroup_action
[moveit_msgs/ExecuteTrajectoryActionGoal]: /docs/systems/openmanipulator_p/msgs/moveit_msgs_ExecuteTrajectory_action

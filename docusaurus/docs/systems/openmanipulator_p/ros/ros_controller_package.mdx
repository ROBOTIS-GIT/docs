...
if DYNAMIXEL aren't recoginized, please check firmware with ROBOTIS software ([R+ Manager 2.0](/docs/software/dynamixel_wizard_2_0) or [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0#firmware-update))

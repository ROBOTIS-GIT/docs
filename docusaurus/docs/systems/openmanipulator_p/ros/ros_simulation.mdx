...
Load OpenManipulator-PRO on Gazebo simulator and click on Play `▶` button.
  ...
  ![](/img/systems/openmanipulator_p/launch_gazebo.webp)
...
Open an [open_manipulator_p_control_gui](/docs/systems/openmanipulator_p/ros/ros_operation#gui-program) to control OpenMANIPULATOR-P

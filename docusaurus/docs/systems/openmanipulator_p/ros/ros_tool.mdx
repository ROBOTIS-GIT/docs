...
![](/img/systems/openmanipulator_p/ros/ros_tool/open_manipulator_gripper_operation_01.webp)


To activate RH-P12-RN (Gripper), Click the `Gripper open` button.


![](/img/systems/openmanipulator_p/ros/ros_tool/open_manipulator_gripper_operation_02.webp)


- [GUI Program e-Manual](/docs/systems/openmanipulator_p/ros/ros_operation#ros-operation)  
...
- [Teleoperation e-Manual](/docs/systems/openmanipulator_p/ros/ros_operation#teleoperation)

#### MoveIt!
```bash 
$ roslaunch open_manipulator_p_controllers joint_trajectory_controller.launch sim:=false with_gripper:=true
```
- [MoveIt! e-Manual](/docs/systems/openmanipulator_p/ros/ros_operation#moveit)
...
- [Launch Gazebo e-Manual](/docs/systems/openmanipulator_p/ros/ros_simulation#launch-gazebo)
...
```
- [Controller for Gazebo e-Manual](/docs/systems/openmanipulator_p/ros/ros_simulation#controller-for-gazebo)

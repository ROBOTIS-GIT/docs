...
- See more details about [Raspberry Pi Camera V2](/docs/systems/turtlebot3/appendix_raspi_cam#overview)

- See more details about [Camera Sepecification](/docs/systems/turtlebot3/appendix_raspi_cam#specifications)

...
## Dimension
![](/img/systems/openmanipulator_p/dimension.webp)

If you have a gripper([RH-P12-RN(A)](https://emanual.robotis.com/docs/en/platform/rh_p12_rna/)), see below.

![](/img/systems/openmanipulator_p/dimension_with_gripper.webp)

## Workspace
![](/img/systems/openmanipulator_p/ws1.webp)
  
![](/img/systems/openmanipulator_p/ws2.webp)  

## Home Position
The diagram below shows the “home position” of DYNAMIXEL-P from OpenMANIPULATOR-P.

![](/img/systems/openmanipulator_p/home_position.webp)

## D-H Configuration
![](/img/systems/openmanipulator_p/d_h_configuration.webp)
...
|:----:|:---------------:|:---------------:|:----------------:|:----------------:|:---------------------------------------------------------------:|
|  1   |        0        |     -&pi;/2     |        0         |        0         |                                0                                |
|  2   |     265.69      |        0        |        0         |        0         | ![](/img/systems/openmanipulator_p/d_h_eq_001.gif) |
|  3   |       30        |     -&pi;/2     |        0         |        0         | ![](/img/systems/openmanipulator_p/d_h_eq_002.gif) |
|  4   |        0        |     -&pi;/2     |       258        |        0         |                                0                                |
|  5   |        0        |     -&pi;/2     |        0         |        0         |                                0                                |
|  6   |        0        |        0        |        0         |        0         |                                0                                |
...
![](/img/systems/openmanipulator_p/mass1.webp)

Total Mass : 5,324g

### Link 1

![](/img/systems/openmanipulator_p/mass2.webp)
...
![](/img/systems/openmanipulator_p/mass3.webp)
...
![](/img/systems/openmanipulator_p/mass4.webp)
...
![](/img/systems/openmanipulator_p/mass5.webp)
...
![](/img/systems/openmanipulator_p/mass6.webp)

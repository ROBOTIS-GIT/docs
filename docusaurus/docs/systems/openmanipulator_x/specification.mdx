...
|:--------------------|:--------|:-----------------------------------------------------|
| **Actuator**        |         | DYNAMIXEL [XM430-W350-T](/docs/dxl/model_reference/x_series/xm_series/xm430-w350) |
| **Input Voltage**   | V       | 12                                                   |
...
## Dimension
![](/img/systems/openmanipulator_x/specification/OpenManipulator_Chain_spec_side.webp)


## Inertia
![](/img/systems/openmanipulator_x/specification/manipulator-x-inertia.webp)

Total Mass : 711.37 gram

### Joint 1
![](/img/systems/openmanipulator_x/specification/manipulator-x-inertia_joint1.webp)
...
![](/img/systems/openmanipulator_x/specification/manipulator-x-inertia_joint2.webp)
...
![](/img/systems/openmanipulator_x/specification/manipulator-x-inertia_joint3.webp)
...
![](/img/systems/openmanipulator_x/specification/manipulator-x-inertia_joint4.webp)
...
![](/img/systems/openmanipulator_x/specification/omx_urdf_graph.webp)  
...
![](/img/systems/openmanipulator_x/specification/rviz_om_view.webp) 

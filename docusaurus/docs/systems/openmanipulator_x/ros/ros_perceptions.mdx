...
import PerceptionsCameraJazzy from '@site/docs/systems/openmanipulator_x/_partials/perceptions_camera_jazzy.mdx';
import PerceptionsCameraHumble from '@site/docs/systems/openmanipulator_x/_partials/perceptions_camera_humble.mdx';
import PerceptionsInstallCameraPackageJazzy from '@site/docs/systems/openmanipulator_x/_partials/perceptions_install_camera_package_jazzy.mdx';
import PerceptionsInstallCameraPackageHumble from '@site/docs/systems/openmanipulator_x/_partials/perceptions_install_camera_package_humble.mdx';

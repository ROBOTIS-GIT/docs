...
$ rqt
```
 <img src="/img/systems/openmanipulator_x/ros_controller/ros_controller_msg/rqt_om.webp" width="1000" />
...
Unchecked Topics will not be monitored. To monitor topics, select the checkbox.  
 ...
 <img src="/img/systems/openmanipulator_x/ros_controller/ros_controller_msg/rqt_1.webp" width="1000" />

If you would like to see more details about a specific topic, click on the ▶ icon next to the checkbox to expand.  

 <img src="/img/systems/openmanipulator_x/ros_controller/ros_controller_msg/rqt_2.webp" width="1000" />


#### Published Topic List
A list of topics that the open_manipulator_controller publishes.

![](/img/systems/openmanipulator_x/ros_controller/ros_controller_msg/topic_monitor.webp)

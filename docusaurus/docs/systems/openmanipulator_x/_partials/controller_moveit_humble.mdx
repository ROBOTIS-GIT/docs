...
Before launching MoveIt 2, ensure that the `hardware.launch.py` from [Launch Controller](/docs/systems/openmanipulator_x/ros_controller/ros_controller_package#launch-controller) is running in a separate terminal.  
Then launch **MoveIt!** with the following command.  
```bash
$ ros2 launch open_manipulator_x_moveit_config moveit_core.launch.py
```
  ![](/img/systems/openmanipulator_x/ros_controller/ros_controller_experiment/moveit2_example.webp)  
...
For more information on Gazebo, See [Simulation](/docs/systems/openmanipulator_x/ros/ros_simulation)

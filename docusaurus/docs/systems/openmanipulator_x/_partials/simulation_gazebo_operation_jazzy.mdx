In order to control the simulated OpenMANIPULATOR-X, launch the [OpenMANIPULATOR-X control GUI](/docs/systems/openmanipulator_x/ros/ros_operation#gui-program) or [Keyboard teleoperation](/docs/systems/openmanipulator_x/ros/ros_operation#keyboard)  
...
- GUI Program
  ...
  **Terminal 3** - Launch GUI program:
  ...
  ```
  ![](/img/systems/openmanipulator_x/ros/ros_simulation/OpenManipulator_x_GUI.webp)

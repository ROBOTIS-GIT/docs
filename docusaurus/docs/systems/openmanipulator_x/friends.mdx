...
<img src="/img/systems/openmanipulator_x/friends/OpenManipulator_friends.webp" width="760" />
...
:::
  ...
  **Friends List**
  ...
  - [OpenMANIPULATOR SCARA](/docs/systems/openmanipulator_x/friends#openmanipulator-scara)
  - [OpenMANIPULATOR Link](/docs/systems/openmanipulator_x/friends#openmanipulator-link)
  - [OpenMANIPULATOR Planar](/docs/systems/openmanipulator_x/friends#openmanipulator-planar)
  - [OpenMANIPULATOR Delta](/docs/systems/openmanipulator_x/friends#openmanipulator-delta)
  - [OpenMANIPULATOR Stewart](/docs/systems/openmanipulator_x/friends#openmanipulator-stewart)
  - [OpenMANIPULATOR Linear](/docs/systems/openmanipulator_x/friends#openmanipulator-linear)

## OpenMANIPULATOR SCARA
![](/img/systems/openmanipulator_x/friends/OpenManipulator_SCARA.webp)

### Specification

![](/img/systems/openmanipulator_x/friends/OpenManipulator_SCARA_Capture.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_SCARA_spec_side.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_SCARA_OnShape.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_SCARA_Processing.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Link.webp)

### Specification

![](/img/systems/openmanipulator_x/friends/OpenManipulator_Link_Capture.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Link_spec.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Link_OnShape.webp)
...
**Tip**: If an error of `cmd_read_board_name fail: 0xF020` occurs constantly during upload, please refer to [OpenCR e-manual](/docs/parts/controller/opencr10#recovery-mode) to enter the firmware recovery mode and upload the source code again after entering mode.

:::


#### Processing
Set the Processing IDE referring to [Processing Setup](/docs/systems/openmanipulator_x/quick_start_guide/basic_operation#launch-controller).
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_link_Processing.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Planar.webp)

### Specification

![](/img/systems/openmanipulator_x/friends/OpenManipulator_Planar_Capture.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Planar_spec.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Planar_OnShape.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Delta.webp)

### Specification

![](/img/systems/openmanipulator_x/friends/OpenManipulator_Delta_Capture.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Delta_spec.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Delta_OnShape.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Stewart.webp)

### Specification

![](/img/systems/openmanipulator_x/friends/OpenManipulator_Stewart_Capture.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Stewart_spec_side.webp)
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Stewart_spec_bottom.webp)
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Stewart_spec_top.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Stewart_OnShape.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Linear.webp)

### Specification

![](/img/systems/openmanipulator_x/friends/OpenManipulator_Linear_Capture.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Linear_spec.webp)
...
![](/img/systems/openmanipulator_x/friends/OpenManipulator_Linear_OnShape.webp)
...
[open_manipulator_msgs/SetActuatorState]: /docs/systems/openmanipulator_x/msgs/open_manipulator_msgs_SetActuatorState
[open_manipulator_msgs/SetDrawingTrajectory]: /docs/systems/openmanipulator_x/msgs/open_manipulator_msgs_SetDrawingTrajectory

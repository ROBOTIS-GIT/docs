...
The OMY can be simulated in various environments using different model formats. These models describe the robot arm and gripper for testing and visualization.
...
![OMY URDF model in RViz or Gazebo](/img/systems/omy/simulation/simulation/omy_urdf.png)
...
<figure style={{margin: '1.5rem auto', textAlign: 'center'}}>
  <img src="/img/systems/omy/simulation/simulation/omy_mjcf.png" alt="OMY loaded in MuJoCo" style={{width: '100%', maxWidth: '480px', height: 'auto'}} />
  <figcaption>OMY in MuJoCo</figcaption>
</figure>
...
*   **Link**: [OMY MJCF on GitHub](https://github.com/ROBOTIS-GIT/open_manipulator/tree/main/open_manipulator_description/mujoco/omy)
...
![OMY USD model in NVIDIA Isaac Sim (Coming Soon)](/img/systems/omy/simulation/simulation/omy_isaac_sim.png)
...
*   **Link**: [OMY USD on GitHub](https://github.com/ROBOTIS-GIT/cyclo_lab/tree/main/source/cyclo_lab/data/robots/OMY)
...
![OMY in NVIDIA Isaac Lab](/img/systems/omy/simulation/simulation/omy_isaac_lab.gif)
...
*   **Link**: [Cyclo Lab on GitHub](https://github.com/ROBOTIS-GIT/cyclo_lab/)

<a href="/docs/systems/omy/simulation/isaac_sim_lab" className="button-shortcut">
<span>Cyclo Lab Information</span>
</a>

...
Once [preparing your dataset](/docs/systems/omy/imitation_learning/dataset_preparation/dataset_preparation) is done, the policy model can be trained using either the Web UI or the LeRobot CLI.

You can choose one of the following options:

<div style={{display: 'flex', justifyContent: 'flex-start', gap: '30px'}}>
<a href="#model-training-with-web-ui" className="button-shortcut">
<span>Option 1</span>
<span>Web UI (Recommended)</span>
</a>

<a href="#model-training-with-lerobot-cli" className="button-shortcut">
<span>Option 2</span>
...
[Setup Physical AI Tools Docker Container](/docs/systems/omy/imitation_learning/dataset_preparation/prerequisites#setup-physical-ai-tools-docker-container)
...
(Refer to the [Dataset Preparation > Web UI > 1. Open the Web UI](/docs/systems/omy/imitation_learning/dataset_preparation/recording#_1-open-the-web-ui) for more details.)

On the **Home** page, select the type of robot you are using.

  <img src="/img/systems/omy/imitation_learning/web_ui/home/robot_type_selection.png" alt="Web UI" style={{width: '50%', display: 'block', margin: '0 auto'}} />

#### c. Train the Policy

Go to the `Training` page and follow the steps below:

  <img src="/img/systems/omy/imitation_learning/web_ui/training/page.png" alt="Web UI" style={{width: '100%'}} />

At the bottom of the page, select either **New Training** or **Resume Training**.

  <img src="/img/systems/omy/imitation_learning/web_ui/training/training_mode.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/checkpoint_path_to_resume.png" alt="Web UI" style={{width: '60%'}} />

<img src="/img/systems/omy/imitation_learning/web_ui/training/select_checkpoint_path.png" alt="Web UI" style={{width: '80%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/dataset_selection.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/policy_selection.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/output_folder_input.png" alt="Web UI" style={{width: '50%'}} />

</TabItem>
<TabItem value="additional-options" label="Additional options">

<img src="/img/systems/omy/imitation_learning/web_ui/training/additional_options.png" alt="Web UI"  style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/button_start_training.png" alt="Web UI" style={{width: '30%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/button_resume_training.png" alt="Web UI" style={{width: '35%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/training/training_loss.png" alt="Web UI" style={{width: '50%', display: 'block', margin: '0 auto'}} />

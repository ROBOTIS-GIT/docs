...
Once [preparing your dataset](/docs/systems/omy/imitation_learning/dataset_preparation) is done, the policy model can be trained using either the Web UI or the LeRobot CLI.

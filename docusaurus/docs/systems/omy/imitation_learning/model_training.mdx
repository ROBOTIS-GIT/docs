...
On the **Home** page, select the type of robot you are using.
  ...
  <img src="/img/systems/omy/imitation_learning/robot_type_selection.png" alt="Web UI" style={{width: '50%', display: 'block', margin: '0 auto'}} />

#### c. Train the Policy

Go to the `Training` page and follow the steps below:

  <img src="/img/systems/omy/imitation_learning/model_training/page.png" alt="Web UI" style={{width: '100%'}} />

At the bottom of the page, select either **New Training** or **Resume Training**.

  <img src="/img/systems/omy/imitation_learning/model_training/training_mode.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/checkpoint_path_to_resume.png" alt="Web UI" style={{width: '60%'}} />

<img src="/img/systems/omy/imitation_learning/model_training/select_checkpoint_path.png" alt="Web UI" style={{width: '80%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/dataset_selection.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/policy_selection.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/output_folder_input.png" alt="Web UI" style={{width: '50%'}} />

</TabItem>
<TabItem value="additional-options" label="Additional options">

<img src="/img/systems/omy/imitation_learning/model_training/additional_options.png" alt="Web UI"  style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/button_start_training.png" alt="Web UI" style={{width: '30%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/button_resume_training.png" alt="Web UI" style={{width: '35%'}} />
...
<img src="/img/systems/omy/imitation_learning/model_training/training_loss.png" alt="Web UI" style={{width: '50%', display: 'block', margin: '0 auto'}} />

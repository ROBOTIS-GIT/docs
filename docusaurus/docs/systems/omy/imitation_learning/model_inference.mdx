...
(Refer to the [Dataset Preparation > Recording > 1. Open the Web UI](/docs/systems/omy/imitation_learning/dataset_preparation/recording#_1-open-the-web-ui))

On the **Home** page, select the type of robot you are using.

  <img src="/img/systems/omy/imitation_learning/web_ui/home/robot_type_selection.png" alt="Web UI" style={{width: '40%'}} />
...
Enter **Task Instruction** and **Policy Path** in the **Task Info Panel**, located on the right side of the page.
  ...
  <img src="/img/systems/omy/imitation_learning/web_ui/inference/task_info.png" alt="Web UI" style={{width: '50%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/inference/browse_button.png" alt="Web UI" style={{width: '30%'}} />
<br />
<img src="/img/systems/omy/imitation_learning/web_ui/inference/file_browser.png" alt="Web UI" style={{width: '100%'}} />
:::
...
Click the `Download Policy` button to open a popup for downloading a policy model. 
  ...
  <img src="/img/systems/omy/imitation_learning/web_ui/inference/download_policy_button.png" alt="Web UI" style={{width: '50%'}} />
  <br />
  <img src="/img/systems/omy/imitation_learning/web_ui/inference/download_policy_modal.png" alt="Web UI" style={{width: '70%'}} />
...
The downloaded model path is automatically filled into Policy Path. 
  ...
  <img src="/img/systems/omy/imitation_learning/web_ui/inference/downloaded_path_filled.png" alt="Web UI" style={{width: '30%'}} />

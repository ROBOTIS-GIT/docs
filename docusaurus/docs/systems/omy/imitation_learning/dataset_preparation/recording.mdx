...
<div className="UI" style={{width: '80%', margin: '0 auto'}}>
  <img src="/img/systems/omy/imitation_learning/web_ui/url_omy.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
- Once accessed, the following screen will appear with the `Disconnected` status.
  ...
  <img src="/img/systems/omy/imitation_learning/web_ui/home/initial_page.png" alt="Web UI" style={{width: '100%'}} />
...
<div className="UI" style={{width: '60%', margin: '0 auto'}}>
  <img src="/img/systems/omy/imitation_learning/web_ui/home/robot_type_selection.png" alt="Web UI" style={{width: '100%'}} />
</div>

After clicking the `Set Robot Type` button, the status will change to `Connected`.

   <img src="/img/systems/omy/imitation_learning/web_ui/home/connected_omy_f3m.png" alt="Web UI" style={{width: '100%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/record/page.png" alt="Web UI" style={{width: '100%'}} />
...
2. Choose a topic from the popup window.
  ...
  <div className="UI" style={{width: '60%', margin: '0 auto'}}>
  <img src="/img/systems/omy/imitation_learning/web_ui/record/select_image_topic.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<div style={{display: 'flex', justifyContent: 'center', gap: '40px'}}>
  <div style={{textAlign: 'center'}}>
    <img src="/img/systems/omy/imitation_learning/web_ui/record/task_info_filled.png" alt="Web UI" style={{width: '95%', maxWidth: '300px'}} />
...
<div style={{display: 'flex', justifyContent: 'center', gap: '40px'}}>
  <div style={{textAlign: 'center'}}>
    <img src="/img/systems/omy/imitation_learning/web_ui/record/task_info_multi_task_filled.png" alt="Web UI" style={{width: '95%', maxWidth: '300px'}} />
    <p><em>Filled Panel</em></p>
  </div>
</div>
...
<TabItem value="single-task-record" label="Single Task Record">
  ...
  <img src="/img/systems/omy/imitation_learning/web_ui/record/control_panel.png" alt="Web UI" style={{width: '100%'}} />
...
<img src="/img/systems/omy/imitation_learning/web_ui/record/control_panel_multi_task.png" alt="Web UI" style={{width: '100%'}} />

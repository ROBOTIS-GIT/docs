...
```
  ...
  <div className="UI" style={{width: '50%', margin: '0 auto'}}>
  <img src="/img/systems/omy/imitation_learning/web_ui/record/task_info_repo_id.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<img src="/img/systems/omy/imitation_learning/data_visualization.png" alt="Web UI" style={{width: '100%'}} />

...
- [ROBOTIS Soma-retargeter repository](https://github.com/ROBOTIS-GIT/soma-retargeter)
- [AI Sapiens submodule source](https://github.com/ROBOTIS-GIT/ai_sapiens)
- [NVIDIA upstream Soma-retargeter repository](https://github.com/NVIDIA/soma-retargeter)

...
For example, the current K1 mimic run behavior is declared as:

```yaml
mimic_run:
  kind: mimic
  asset: mimic/run
  motion: run_kimodo_k1_23dof.csv
```
...
| `MimicRun` | Runs the run mimic policy and motion reference. |
| `MimicSwallowBalance` | Runs the swallow-balance mimic policy and motion reference. |
| `MimicGangnamStyle` | Runs the Gangnam-style mimic policy and motion reference. |
| `MimicRunComOffset10cm` | Runs the run mimic policy variant with the COM-offset asset. |
...
| --- | --- |
| `200` | `MimicRun` |
| `201` | `MimicSwallowBalance` |
| `202` | `MimicGangnamStyle` |
| `203` | `MimicRunComOffset10cm` |
...
<pre className="sim2real-config-snippet language-yaml"><code className="language-yaml">
<span>state_behaviors:</span>
<span className="sim2real-config-snippet__existing">  mimic_run:                                  # already exists</span>
<span className="sim2real-config-snippet__existing">    kind: mimic</span>
<span className="sim2real-config-snippet__existing">    asset: mimic/run</span>
<span className="sim2real-config-snippet__existing">    motion: run_kimodo_k1_23dof.csv</span>
...
<span>state_machine:</span>
<span>  states:</span>
<span className="sim2real-config-snippet__existing">    MimicRun:                                 # already exists</span>
<span className="sim2real-config-snippet__existing">      parent: Mimic</span>
<span className="sim2real-config-snippet__existing">      run: mimic_run</span>
...
<span>    table:</span>
<span className="sim2real-config-snippet__existing">      200: MimicRun                           # already exists</span>

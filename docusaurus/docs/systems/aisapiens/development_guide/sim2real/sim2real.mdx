...
<span>      <span className="sim2real-config-snippet__number">202</span>: <span className="sim2real-config-snippet__value">MyMimicMotion</span>                      <span className="sim2real-config-snippet__comment"># 3. Add an RC selector code.</span></span>
</code></pre>

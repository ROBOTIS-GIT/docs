...
For the detailed joint order and `JointPositionGainsCommand` message definition, see [ROS 2 Package Structure and Topic Description](/docs/systems/aisapiens/development_guide/ros2_package_structure/).

...
![](/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_camera_calibration_rqt_image_view.webp)

<details>
<summary>
![](/img/common/icon_unfold.webp) **Click to expand : Extrinsic Camera Calibration for use of actual TurtleBot3**
</summary>
...
```
    ...
    ![](/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_rpi_extrinsic_calibration_rqt.webp)

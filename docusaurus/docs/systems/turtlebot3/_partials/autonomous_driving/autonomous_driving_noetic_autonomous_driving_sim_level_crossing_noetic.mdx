...
7. Select two topics: `/detect/image_level_color_filtered/compressed`, `/detect/image_level/compressed`.
    ![](/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_detect_level.webp)
...
![](/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_level_reconfigure.webp)

10. Open `level.yaml` file located at ***turtlebot3_autorace_detect/param/level/***.

    ![](/img/systems/turtlebot3/autonomous_driving/autonomous_driving/noetic_level_yaml.webp)

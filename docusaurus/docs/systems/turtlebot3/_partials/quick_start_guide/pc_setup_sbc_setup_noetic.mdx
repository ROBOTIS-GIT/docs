import QuickStartRosGpgKeyExpirationIncident from '@site/docs/systems/turtlebot3/_partials/quick_start_guide/pc_setup_ros_gpg_key_expiration_incident.mdx';
...
[![](/img/common/icon_download.webp) **Download** `Raspberry Pi 3B+` ROS Noetic image](https://www.robotis.com/service/download.php?no=2008)
...
[![](/img/common/icon_download.webp) **Download** `Raspberry Pi 4B (2GB or 4GB)` ROS Noetic image](https://www.robotis.com/service/download.php?no=2066)
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/rpi_imager.gif)  
1. Click `CHOOSE OS`.  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/disks.gif)  
...
[![](/img/common/icon_download.webp) Download or install GParted GUI tool](https://gparted.org/download.php)

![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/gparted.gif)  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/network_setup.gif)  
...
<QuickStartRosGpgKeyExpirationIncident />
...
$ source ~/.bashrc  
  ```  
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/ros1_sbc_netcfg.gif)  

### NEW LDS-02 Configuration

|LDS-01|LDS-02|
|:---:|:---:|
|![](/img/systems/turtlebot3/lds_small.webp)|![](/img/systems/turtlebot3/lds_ld08_small.webp)|
...
<details>
<summary>
![](/img/common/icon_unfold.webp) **Click to expand : Manual SBC Setup Instructions**
</summary>
...
1. ![](/img/common/icon_download.webp) Download the proper `Ubuntu 20.04.1(Focal) Preinstalled Server` image on your PC.

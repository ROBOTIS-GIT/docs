...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/jazzy-noetic/micro_sd_reader.webp)
...
[![](/img/common/icon_download.webp) **Download** Raspberry Pi Imager from raspberrypi.org](https://www.raspberrypi.org/software/)
...
![](/img/common/icon_unfold.webp) **Click here to expand more details about How to install Raspberry Pi Imager.**
</summary>  
Install either the `deb` or `apt` rpi-imager release.

1. `deb`  
Download deb file  
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sbc_setup1.webp)  
  ```bash
$ cd Downloads
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sbc_setup_jazzy.webp)  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sbc_config_set.webp)  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sbc_config_set2.webp)
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sbc_config_set3.webp)  
...
1. Boot Up the Raspberry Pi  
  ...
  ![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sbc_setup3.webp)  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/jazzy-noetic/ros2_sbc_netcfg.webp)  
...
<details>
<summary>
![](/img/common/icon_unfold.webp) **Click here to expand more details about how to connect through ssh**
</summary>
...
```  
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sshd_config2.webp)  
...
$ ifconfig
```  
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/sshd_config3.webp)  
...
<details>
<summary>
![](/img/common/icon_unfold.webp) **If you are using the TurtleBot3 2GB, make sure to create swap memory for building packages.** Otherwise, you may run out of memory and package building may fail.
</summary>
...
$ free -h
```  
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/swap.webp)
</details>
...
|:---:|:---:|:---:|
|![](/img/systems/turtlebot3/lds_small.webp)|![](/img/systems/turtlebot3/lds_ld08_small.webp)|![](/img/systems/turtlebot3/lds_coind4_small.webp)|  
...
### Raspberry Pi Camera
![](/img/systems/Pi-Camera-front.webp)
...
<details>
<summary>
![](/img/common/icon_unfold.webp) **Method 1. Using the camera-ros package**  
</summary>
...
<details>
<summary>
![](/img/common/icon_unfold.webp) **Method 2. Using the v4l2-camera package**
</summary>
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/rpi_config1.webp)  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/rpi_config2.webp)  
...
![](/img/systems/turtlebot3/quick_start_guide/sbc_setup/camera_name.webp)  
...
> **More Info**  
For detailed specifications and advanced settings, please check the [13.More Info - 13.1.Appendixes - Raspberry Pi Camera](/docs/systems/turtlebot3/more_info/raspberry_pi_camera) for a comprehensive guide on hardware capabilities and software features. 

> **Camera Calibration**  
If you plan to use advanced vision features like camera calibration, you can find the detailed instructions [here](/docs/systems/turtlebot3/more_info/raspberry_pi_camera#camera-calibration).  

> **Trouble Shooting**  
If the error message `Unable to open camera calibration file` appears, check the solution [here](/docs/systems/turtlebot3/more_info/raspberry_pi_camera#trouble-shooting).  
...
Next Step : [OpenCR Setup](/docs/systems/turtlebot3/quick_start_guide/opencr_setup#opencr-setup)

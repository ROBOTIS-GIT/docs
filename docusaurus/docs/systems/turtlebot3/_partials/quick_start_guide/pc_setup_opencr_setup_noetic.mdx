...
![](/img/systems/turtlebot3/quick_start_guide/opencr_setup/opencr_setup.webp)  
...
6. A successful firmware upload for the TurtleBot3 Burger will look like this:  
  ![](/img/systems/turtlebot3/quick_start_guide/opencr_setup/shell01.webp)
...
<details>
<summary>
![](/img/common/icon_unfold.webp) Click here to expand more details about firmware uploads using the **Arduino IDE**
</summary>
...
10. Upload the TurtleBot3 firmware sketch with `Ctrl` + `U` or the upload icon.  
  ![](/img/systems/turtlebot3/o2.webp)  
  ![](/img/systems/turtlebot3/o3.webp)
...
![](/img/systems/turtlebot3/quick_start_guide/opencr_setup/opencr_models.webp)

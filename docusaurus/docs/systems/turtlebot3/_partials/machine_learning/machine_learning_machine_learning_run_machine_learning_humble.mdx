...
```  
    !<a href="/img/systems/turtlebot3/machine_learning/action_graph.webp" target="_blank">action_graph</a>  
<br />
...
```  
    **NOTE**: The graph is recorded from the time you run the node. For full recording, turn it on before you start learning.
    ...
    !<a href="/img/systems/turtlebot3/machine_learning/result_graph.webp" target="_blank">result_graph</a>  
<br />
...
[http://localhost:6006](http://localhost:6006)  
    ![](/img/systems/turtlebot3/machine_learning/tensorboard.webp)

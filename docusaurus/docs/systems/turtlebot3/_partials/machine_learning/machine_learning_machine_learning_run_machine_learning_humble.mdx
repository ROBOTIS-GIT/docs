...
```  
    ![action_graph](/img/systems/turtlebot3/machine_learning/machine_learning/action_graph.webp)  
<br />
...
```  
    **NOTE**: The graph is recorded from the time you run the node. For full recording, turn it on before you start learning.
    ...
    ![result_graph](/img/systems/turtlebot3/machine_learning/machine_learning/result_graph.webp)  
<br />

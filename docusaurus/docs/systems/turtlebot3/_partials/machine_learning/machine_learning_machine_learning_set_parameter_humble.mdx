...
| ![](/img/systems/turtlebot3/machine_learning/sample_360.webp) | ![](/img/systems/turtlebot3/machine_learning/sample_24.webp) |
|:-----------------------------------------------------------------------:|:----------------------------------------------------------------------:|
...
yaw_reward = 1 - (2 * abs(self.goal_angle) / math.pi)
```  
<img src="/img/systems/turtlebot3/machine_learning/yaw_reward.webp" width="700" />

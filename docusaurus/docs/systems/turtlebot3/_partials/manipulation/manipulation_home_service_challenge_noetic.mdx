...
```
    **NOTE**: Specify `${TB3_MODEL}`: `waffle`, `waffle_pi` before excuting the command. Set the permanent export setting by following [Export TURTLEBOT3_MODEL](/docs/systems/turtlebot3/quick_start_guide/export_turtlebot3_model) instruction.
    ...
    ![turtlebot3_manipulation_view](/img/systems/turtlebot3/manipulation/home_service_challenge/TurtleBot3_with_Open_Manipulator.webp)
...
```
    ...
    ![simulation_rviz](/img/systems/turtlebot3/manipulation/home_service_challenge/simulation_rviz.webp)
...
```
   ...
   ![gazebo](/img/systems/turtlebot3/manipulation/home_service_challenge/simulation_gazebo.webp)

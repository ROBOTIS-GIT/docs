Be sure to read [SLAM](/docs/systems/turtlebot3/slam#slam) manual before use of the following instruction.
...
```
  ...
  ![](/img/systems/turtlebot3/manipulation/manipulation/open_manipulator_slam.webp)

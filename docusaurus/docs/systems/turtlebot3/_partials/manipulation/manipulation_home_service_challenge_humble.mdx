...
```
    ...
    !<a href="/img/systems/turtlebot3/manipulation/home_service_challenge/gazebo_simulation.webp" target="_blank">gazebo_simulation</a>
...
```
    ...
    !<a href="/img/systems/turtlebot3/manipulation/home_service_challenge/navigation2_rviz.webp" target="_blank">simulation_rviz</a>
...
1. Approaching the target.
  - For the approach to the target with precise, TurtleBot3 wheels are directly controlled by computing target's location from AR marker. (Used Topic : `/target_maker_id`, `/cmd_vel`) Try twice for reliable performance.
    ...
    !<a href="/img/systems/turtlebot3/manipulation/home_service_challenge/demo1.webp" target="_blank">demo1</a>
...
3. Navigating to the next room where the object will be placed.
   -Reach the next room saved in a yaml file using the Nav2 package.
    ...
    !<a href="/img/systems/turtlebot3/manipulation/home_service_challenge/demo2.webp" target="_blank">demo2</a>
...
6. Returning to the starting point using the Nav2 package.
   ...
   !<a href="/img/systems/turtlebot3/manipulation/home_service_challenge/demo3.webp" target="_blank">demo3</a>

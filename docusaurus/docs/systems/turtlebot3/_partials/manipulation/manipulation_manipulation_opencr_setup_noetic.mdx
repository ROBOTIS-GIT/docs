...
![](/img/systems/turtlebot3/manipulation/manipulation/open_manipulator_gazebo_1.webp)
...
<details>
<summary>
![](/img/common/icon_unfold.webp) Click here to expand more details about the firmware upload using **Arduino IDE**
</summary>

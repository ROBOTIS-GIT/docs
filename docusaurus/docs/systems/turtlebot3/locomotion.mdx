...
| :---------------------------------------------------------- | :------- | :------------------------ | :------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| XL430-W250-T ([e-Manual](/docs/dxl/model_reference/x_series/xl430-w250))       | 2        | XL430-W250-T              | 2        | [ROBOTIS SHOP](http://en.robotis.com/shop_en/item.php?it_id=902-0135-000)                                                                                                              |
| ROBOT CABLE-X4P 240mm                                       | 2        | ROBOT CABLE-X4P 240mm     | 2        | [ROBOTIS SHOP](http://en.robotis.com/shop_en/item.php?it_id=903-0245-000)                                                                                                              |
| OpenCR1.0 ([e-Manual](/docs/parts/controller/opencr10)) | 1        | OpenCR1.0                 | 1        | [ROBOTIS SHOP](http://en.robotis.com/shop_en/item.php?it_id=903-0257-000)                                                                                                              |
...
![](/img/systems/turtlebot3/friends/All_friends.webp)
...
- Get source codes and make friends! Go to `Examples` → `turtlebot3` → `turtlebot3_friends` on Arduino IDE for OpenCR.
  ...
  ![](/img/systems/turtlebot3/friends/ide.webp)
...
![](/img/systems/turtlebot3/friends/friends_open_manipulator_waffle_pi.webp)
...
- [OpenManipulator Wiki](https://emanual.robotis.com/docs/en/platform/openmanipulator/)
- **Video**:
...
![](/img/systems/turtlebot3/friends/friends_segway.webp)
...
![](/img/systems/turtlebot3/friends/friends_conveyor.webp)
...
![](/img/systems/turtlebot3/friends/friends_monster.webp)
...
![](/img/systems/turtlebot3/friends/friends_tank.webp)
...
![](/img/systems/turtlebot3/friends/friends_omni.webp)
...
![](/img/systems/turtlebot3/friends/friends_mecanum.webp)
...
![](/img/systems/turtlebot3/friends/friends_bike.webp)
...
![](/img/systems/turtlebot3/friends/friends_road_train.webp)
...
![](/img/systems/turtlebot3/friends/friends_real.webp)
...
![](/img/systems/turtlebot3/friends/friends_carrier.webp)

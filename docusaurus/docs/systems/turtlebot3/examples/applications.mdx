...
4. **[Remote PC]** Set the environment variable for the TurtleBot3 Burger and launch `turtlebot3_follow_filter`.
...
```
    ...
    ![](/img/systems/turtlebot3/examples/panorama_view.webp)
...
```
    ...
    **NOTE**: Specify `${TB3_MODEL}`: `burger`, `waffle`, `waffle_pi` before excuting the command. Set the permanent export setting by following [Export TURTLEBOT3_MODEL](/docs/systems/turtlebot3/quick_start_guide/export_turtlebot3_model) instruction.
...
```
    ...
    ![](/img/systems/turtlebot3/examples/scan.webp)

    - `/scan_spot`

    ![](/img/systems/turtlebot3/examples/scan_spot.webp)
...
```
    ...
    ![](/img/systems/turtlebot3/examples/multi_turtlebot_rqt.webp)
...
[virtual slam by multiple turtlebot3s]: /docs/systems/turtlebot3/simulation/gazebo_simulation#2-excute-slam

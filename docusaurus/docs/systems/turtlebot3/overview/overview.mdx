...
![](/img/systems/turtlebot3/overview/overview/logo_raspberry_pi.webp) **Rasbperry Pi 4**  
...
![](/img/systems/turtlebot3/overview/overview/logo_nvidia.webp) **Jetson Nano**  
...
<details>
<summary>
![](/img/common/icon_unfold.webp) TurtleBot3 is a collaborative project...
</summary>
...
- TurtleBot3 Providers  
  ![](/img/systems/turtlebot3/logo_platform_providers.webp)

- TurtleBot3 Partners and Research Collaborators  
  ![](/img/systems/turtlebot3/logo_platform_sponsors.webp)

  \* Each collaboration member's web page can be found [here][partners].

- TurtleBot3 Distributors  
  ![](/img/systems/turtlebot3/logo_platform_players.webp)
...
<details>
<summary>
![](/img/common/icon_unfold.webp) Check out these ROS and TurtleBot3 Publications:
</summary>
...
<details>
<summary>
![](/img/common/icon_unfold.webp) Click to expand recent news.
</summary>
...
[openmanipulator]: /docs/systems/openmanipulator_x/overview

...
![](/img/systems/turtlebot3/faq/computer_name.webp)
...
![](/img/systems/turtlebot3/faq/connection_ssh.webp)
...
As shown in the below image, find `Examples` > `turtlebot3` > `turtlebot3_setup` > `turtlebot3_setup_motor` and open the example.  
    ...
    ![](/img/systems/turtlebot3/faq/dynamixel_setup_1.webp)
...
Click the `Serial Monitor` icon in the upper right corner as shown in the below image.  
    ...
    ![](/img/systems/turtlebot3/faq/dynamixel_setup_2.webp)
...
When the setup is completed, `OK` message is printed on the screen.
    ...
    ![](/img/systems/turtlebot3/faq/dynamixel_setup_5.webp)
...
For example, to test the left DYNAMIXEL, enter `3` as shown in below, or enter `4` for the right wheel test.
    ...
    ![](/img/systems/turtlebot3/faq/dynamixel_setup_6.webp)
...
- [Locomotion (TurtleBot3 Friends)](/docs/systems/turtlebot3/locomotion#turtlebot3-friends-car)
...
![](/img/systems/turtlebot3/faq/download_the_stl_files_01.webp)

![](/img/systems/turtlebot3/faq/download_the_stl_files_02.webp)
...
![](/img/systems/turtlebot3/faq/nvstorage.webp)

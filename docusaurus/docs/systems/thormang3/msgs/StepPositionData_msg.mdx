...
Position related Step Data Parameters
  ...
  * `float32     foot_z_swap`  
  ...
  &emsp;&emsp;
  !<a href="/img/systems/op3/op3_walking_module_image152.webp" target="_blank">foot_z_wap</a>

  * `float32     body_z_swap`  
  &emsp;&emsp; The swept distance by the body on the Z axis while THORMANG3 is walking. Unit in meter.  
  &emsp;&emsp;
  !<a href="/img/systems/op3/op3_walking_module_image154.webp" target="_blank">body_z_wap</a>
...
[thormang3_walking_module_msgs/PoseXYZRPY]: /docs/systems/thormang3/msgs/PoseXYZRPY_msg
[thormang3_walking_module_msgs/PoseZRPY]: /docs/systems/thormang3/msgs/PoseZRPY_msg

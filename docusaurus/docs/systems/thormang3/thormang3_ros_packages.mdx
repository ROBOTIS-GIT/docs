---
id: thormang3_ros_packages
title: "THORMANG3 ROS Packages"
sidebar_position: 4
tags: [thormang3]
---
...
`Reference` : [Creating new robot manager](/docs/software/robotis_framework_packages/tutorials#creating-new-robot-manager)
...
[std_msgs/Int32]: /docs/popup/std_msgs_int32_message
[std_msgs/String]: /docs/popup/std_msgs_string
[std_msgs/Bool]: /docs/popup/std_msgs_bool_msg
[std_msgs/Float64]: /docs/popup/std_msgs_Float64_msg
[geometry_msgs/Pose]: /docs/popup/geometry_msgs_Pose_msg
[geometry_msgs/WrenchStamped]: /docs/popup/geometry_msgs_WrenchStamped_msg
[sensor_msgs/PointCloud2]: /docs/popup/sensor_msgs_PointCloud2_msg
[sensor_msgs/Imu]: /docs/popup/sensor_msgs_IMU_msg
[sensor_msgs/JointState]: /docs/popup/sensor_msgs_JointState_msg
[visualization_msgs/MarkerArray]: /docs/popup/visualization_msgs_MarkerArray_msg
[StartAction.msg]: /docs/popup/StartAction_msg
[robotis_controller_msgs/StatusMsg]: /docs/popup/StatusMsg_msg
[robotis_controller_msgs/JointCtrlModule]: /docs/popup/JointCtrlModule_msg
[robotis_controller_msgs/GetJointModule]: /docs/popup/GetJointModule_srv
[robotis_controller_msgs/Status]: /docs/popup/StatusMsg_msg
[thormang3_action_module]: /docs/systems/thormang3/thormang3_ros_packages#thormang3-action-module
[thormang3_action_module_msgs/StartAction]: /docs/popup/StartAction_msg
[thormang3_action_module_msgs/IsRunning]: /docs/popup/thormang3_action_module_msgs_IsRunning_srv
...
[thormang3_offset_tuner_msgs/JointOffsetData.msg]: /docs/popup/JointOffsetData_msg
[thormang3_offset_tuner_msgs/JointOffsetPositionData.msg]: /docs/popup/JointOffsetPositionData_msg
[thormang3_offset_tuner_msgs/JointTorqueOnOff.msg]: /docs/popup/JointTorqueOnOff_msg
[thormang3_offset_tuner_msgs/JointTorqueOnOffArray.msg]: /docs/popup/JointTorqueOnOffArray_msg
[thormang3_offset_tuner_msgs/GetPresentJointOffsetData.srv]: /docs/popup/GetPresentJointOffsetData_srv
[thormang3_manipulation_module_msgs/KinematicsPose]: /docs/popup/KinematicsPose_msg
[thormang3_manipulation_module_msgs/JointPose]: /docs/popup/JointPose_msg
[thormang3_manipulation_module]: /docs/systems/thormang3/thormang3_ros_packages#thormang3-manipulation-module
[thormang3_manipulation_module_msgs/GetJointPose]: /docs/popup/GetJointPose_srv
[thormang3_manipulation_module_msgs/GetKinematicsPose]: /docs/popup/GetKinematicsPose_srv
[thormang3_feet_ft_module]: /docs/systems/thormang3/thormang3_ros_packages#thormang3-feet-ft-module
[thormang3_feet_ft_module_msgs/BothWrench]: /docs/popup/BothWrench_msg
[thormang3_foot_step_generator/FootStepCommand]: /docs/popup/FootStepCommand_msg
[thormang3_foot_step_generator/Step2DArray]: /docs/popup/Step2DArray_msg
[thormang3_walking_module_msgs/GetReferenceStepData]: /docs/popup/GetReferenceStepData_srv
[thormang3_walking_module]: /docs/systems/thormang3/thormang3_ros_packages#thormang3-walking-module
[thormang3_walking_module_msgs/GetReferenceStrpData]: /docs/popup/GetReferenceStepData_srv
[thormang3_walking_module_msgs/AddStepDataArray]: /docs/popup/AddStepDataArray_srv
[thormang3_walking_module_msgs/SetBalanceParam]: /docs/popup/SetBalanceParam_srv
[thormang3_walking_module_msgs/IsRunning]: /docs/popup/thormang3_walking_module_msgs_IsRunning_srv
[thormang3_walking_module_msgs/WalkingStart]: /docs/popup/StartWalking_srv
[thormang3_walking_module_msgs/RemoveExistingStepData]: /docs/popup/RemoveExistingStepData_srv
[thormang3_walking_module_msgs/StepData]: /docs/popup/StepData_msg
[thormang3_walking_module_msgs/BalanceParam]: /docs/popup/BalanceParam_msg
[thormang3_head_control_module]: /docs/systems/thormang3/thormang3_ros_packages#thormang3-head-control-module
[thormang3_head_control_module_msgs/HeadJointPose]: /docs/popup/HeadJointPose_msg
[robotis_controller_msgs/SyncWriteItem]: /docs/popup/SyncWriteItem_msg
[robotis_controller_msgs/SetModule]: /docs/popup/SetModule_srv
[robotis_controller_msgs/LoadOffset]: /docs/popup/LoadOffset_srv
[thormang3_tuning_module_msgs/JointOffsetData.msg]: /docs/popup/JointOffsetData2_msg
[thormang3_tuning_module_msgs/JointOffsetPositionData.msg]: /docs/popup/JointOffsetPositionData2_msg
[thormang3_tuning_module_msgs/JointsOffsetPositionData.msg]: /docs/popup/JointsOffsetPositionData_msg
[thormang3_tuning_module_msgs/JointTorqueOnOffArray.msg]: /docs/popup/JointTorqueOnOffArray2_msg
[thormang3_tuning_module_msgs/JointTorqueOnOff.msg]: /docs/popup/JointTorqueOnOff2_msg
[thormang3_tuning_module_msgs/GetPresentJointOffsetData.srv]: /docs/popup/GetPresentJointOffsetData2_srv
[JointPose.msg]: /docs/popup/JointPose_msg
[JointFeedBackGain.msg]: /docs/popup/JointFeedBackGain_msg
[thormang3_alarm_module_msgs/JointOverload.msg]: /docs/popup/JointOverload_msg
[thormang3_alarm_module_msgs/JointOverloadStatus.msg]: /docs/popup/JointOverloadStatus_msg
[IsRunning.srv]: /docs/popup/thormang3_action_module_msgs_IsRunning_srv
[laser_assembler/AssembleScan2]: /docs/popup/laser_assembler_AssembleScan2_srv
...
[KinematicsPose.msg]: /docs/popup/KinematicsPose_msg
[GetReferenceStepData.srv]: /docs/popup/GetReferenceStepData_srv
[AddStepDataArray.srv]: /docs/popup/AddStepDataArray_srv
[SetBalanceParam.srv]: /docs/popup/SetBalanceParam_srv
[BothWrench.msg]: /docs/popup/BothWrench_msg
[GetJointPose.srv]: /docs/popup/GetJointPose_srv
[GetKinematicsPose.srv]: /docs/popup/GetKinematicsPose_srv
[Remote Control(GUI Demo)]: /docs/systems/thormang3/thormang3_operation#gui-program
[FootStepCommand.msg]: /docs/popup/FootStepCommand_msg
[Step2D.msg]: /docs/popup/Step2D_msg
[Step2DArray.msg]: /docs/popup/Step2DArray_msg
[BalanceParam.msg]: /docs/popup/BalanceParam_msg
[DampingBalanceParam.msg]: /docs/popup/DampingBalanceParam_msg
[PoseXYZRPY.msg]: /docs/popup/PoseXYZRPY_msg
[PoseZRPY.msg]: /docs/popup/PoseZRPY_msg
[RobotPose.msg]: /docs/popup/RobotPose_msg
[StepData.msg]: /docs/popup/StepData_msg
[StepPositionData.msg]: /docs/popup/StepPositionData_msg
[StepTimeData.msg]: /docs/popup/StepTimeData_msg
[WalkingJointStatesStamped.msg]: /docs/popup/WalkingJointStatesStamped_msg
[RemoveExistingStepData.srv]: /docs/popup/RemoveExistingStepData_srv
[SetDampingBalanceParam.srv]: /docs/popup/SetDampingBalanceParam_srv
[SetJointFeedBackGain.srv]: /docs/popup/SetJointFeedBackGain_srv
[StartWalking.srv]: /docs/popup/StartWalking_srv
[HeadJointPose.msg]: /docs/popup/HeadJointPose_msg
...
[humanoid_nav_msgs/PlanFootsteps]: /docs/popup/humanoid_nav_msgs_planfootsteps_srv

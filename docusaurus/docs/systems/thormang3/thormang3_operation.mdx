...
3. Run Visualization Tool  
  ...
  ```
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_047.webp)
...
6. Check all joints are switched to selected mode.  
    ![](/img/systems/thormang3/thormang3_operation/thormang3_048.webp)
...
7. Initial Posture  
  ...
  Click `Robot Init Pose` button at the top of demo program(Effective regardless of current mode)  
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_049.webp)

    ![](/img/systems/thormang3/thormang3_operation/thormang3_050.webp)
...
1. Move to Robot Init Pose
  - Click `Robot Init Pose` button on the top.  
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_051.webp)
...
2. Measure FT Air  
  ...
  - **THORMANG3 must be hanging on the lift for this procedure.**
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_052.webp)
...
3. Measure FT Ground  
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_053.webp)
...
4. Apply Init FT
  ...
  - Measured Force Torque values in the air and on the ground are transmitted to [thormang3_feet_ft_module] and FT Sensor calibration is completed.
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_054.webp)

5. Save FT Calibration
  - If you want to save current calibration, click `Save FT calibration` button.

    ![](/img/systems/thormang3/thormang3_operation/thormang3_055.webp)
...
- Assemble LaserScan  
  ...
  Click `Make PointCloud` button in the `Basic Control` of the demo program.  
      ...
      ![](/img/systems/thormang3/thormang3_operation/thormang3_056.webp)
  ...
  3. Check the pointcloud  
    Assembled pointcloud can be seen on the RViz screen.  
      ...
      - Check PointCloud on the 3D screen  
        ...
        ![](/img/systems/thormang3/thormang3_operation/thormang3_057.webp)
...
- Head Joint Control  
  ...
  ![](/img/systems/thormang3/thormang3_operation/thormang3_058.webp)
...
![](/img/systems/thormang3/thormang3_operation/thormang3_059.webp)
...
![](/img/systems/thormang3/thormang3_operation/thormang3_060.webp)
...
1. Move to Robot Init Pose
  - Click the `Robot Init Pose` button.  
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_061.webp)
...
3. Set Mode
  - Click the `Walking Module` button to switch to Walking Mode.
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_062.webp)

4. Balance On
  - Select the `Walking` tab from the demo program.
  - Click `On` button in the `Balance Control`.

    ![](/img/systems/thormang3/thormang3_operation/thormang3_063.webp)
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_064.webp)
...
5. Walking Control
  ...
  - After configuring parameters, clicking one of Walking Directions will initiate walking of THORMANG3.
    ...
    ![](/img/systems/thormang3/thormang3_operation/thormang3_065.webp)

    - The procedure flows as below.

    ![](/img/systems/thormang3/thormang3_operation/thormang3_066.webp)


#### Walking with [thormang3_demo] and [footstep_planner]
A walking example that follows StepData using [footstep_planner].

![](/img/systems/thormang3/thormang3_operation/thormang3_067.webp)
...
![](/img/systems/thormang3/thormang3_operation/thormang3_075.webp)
...
### How to use GUI program
![](/img/systems/thormang3/thormang3_operation/thormang3_tuner_client_01.webp)    

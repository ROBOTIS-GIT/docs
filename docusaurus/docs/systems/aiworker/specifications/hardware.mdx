...
![hardware_overview](/img/systems/aiworker/specifications/hardware/hardware_overview.png)

## Product Components
![product_components](/img/systems/aiworker/specifications/hardware/product_components.png)
...
## Product Models
![model_name](/img/systems/aiworker/specifications/hardware/model_name.png)

## Follower Specification
![model_lineup](/img/systems/aiworker/specifications/hardware/model_lineup.png)
...
<div className="model-comparison">
    <div className="model-comparison__item">
        ...
        <div className="model-comparison__media">
            <img src="/img/systems/aiworker/specifications/hardware/model_ffw_lg2.png" alt="FFW-LG2 Model" className="model-comparison__image model-comparison__image--auto" />
        </div>
        <div className="model-comparison__media model-comparison__media--full">
            <img src="/img/systems/aiworker/specifications/hardware/model_ffw_lg2.gif" alt="FFW-LG2 Model Animation" className="model-comparison__image model-comparison__image--full" />
        </div>
    </div>
    <div className="model-comparison__item">
        <p className="model-comparison__title">FFW-LH5 Model</p>
        <div className="model-comparison__media">
            <img src="/img/systems/aiworker/specifications/hardware/model_ffw_lh5.png" alt="FFW-LH5 Model" className="model-comparison__image model-comparison__image--auto" />
        </div>
        <div className="model-comparison__media model-comparison__media--full">
            <img src="/img/systems/aiworker/specifications/hardware/model_ffw_lh5.gif" alt="FFW-LH5 Model Animation" className="model-comparison__image model-comparison__image--full" />
        </div>
    </div>
</div>
...
<a href="/img/systems/aiworker/specifications/hardware/joints.png" target="_blank">
  <img src="/img/systems/aiworker/specifications/hardware/joints.png" alt="Dimensions" width="100%" />
</a>
...
|----------------|------------------|-----------------------------------------------------------------------------------|
| Arm Joints 1 ~ 3 | DYNAMIXEL-Y      | [YM080-230-R099-RH](/docs/dxl/model_reference/y_series/ym080-230-r099-rh) |
| Arm Joints 4 ~ 6 | DYNAMIXEL-Y      | [YM070-210-R099-RH](/docs/dxl/model_reference/y_series/ym070-210-r099-rh) |
| Arm Joint 7    | DYNAMIXEL-P      | [PH42-020-S300-R](/docs/dxl/model_reference/p_series/ph42-020-s300-r)     |
| Gripper        | Robot Hands      | [RH-P12-RN](/docs/systems/rh_p12_rn/)              |
| Head Pitch     | DYNAMIXEL-X      | [XH540-V150-R](/docs/dxl/model_reference/x_series/xh_series/xh540-v150)             |
| Head Yaw       | DYNAMIXEL-X      | [XH430-V210-R](/docs/dxl/model_reference/x_series/xh_series/xh430-v210)             |
| Lift           | DYNAMIXEL-Y      | [YM080-230-B001-RH](/docs/dxl/model_reference/y_series/ym080-230-b001-rh) |
| Wheel Steer    | DYNAMIXEL-Y      | [YM070-210-R051-RH](/docs/dxl/model_reference/y_series/ym070-210-r051-rh) |

For detailed specifications of each DYNAMIXEL model, please visit the [ROBOTIS DYNAMIXEL website](https://dynamixel.com/).

## Dimension
### FFW-SG2
<a href="/img/systems/aiworker/specifications/hardware/dimension_ffw_sg2.png" target="_blank">
  <img src="/img/systems/aiworker/specifications/hardware/dimension_ffw_sg2.png" alt="Dimensions" width="100%" />
</a>
...
### FFW-BG2
<a href="/img/systems/aiworker/specifications/hardware/dimension_ffw_bg2.png" target="_blank">
  <img src="/img/systems/aiworker/specifications/hardware/dimension_ffw_bg2.png" alt="Dimensions" width="100%" />
</a>
...
### FFW-LG2
<a href="/img/systems/aiworker/specifications/hardware/dimension_ffw_lg2.png" target="_blank">
  <img src="/img/systems/aiworker/specifications/hardware/dimension_ffw_lg2.png" alt="Dimensions" width="100%" />
</a>
...
### FFW-LH5
<a href="/img/systems/aiworker/specifications/hardware/dimension_ffw_lh5.png" target="_blank">
  <img src="/img/systems/aiworker/specifications/hardware/dimension_ffw_lh5.png" alt="Dimensions" width="100%" />
</a>

## Workspace
The torso workspace is the same for both FFW-BG2 and FFW-SG2 models.

<a href="/img/systems/aiworker/specifications/hardware/workspace.png" target="_blank">
  <img src="/img/systems/aiworker/specifications/hardware/workspace.png" alt="Workspace" width="100%" />
</a>

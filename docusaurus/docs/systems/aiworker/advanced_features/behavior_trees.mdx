...
:::tip
For more details on setting up and operating the AI Worker, refer to the [Setup Overview](/docs/systems/aiworker/quick_start_guide/setup_overview/setup_overview) and [Operation Guide](/docs/systems/aiworker/quick_start_guide/operation_guide/operation_guide).
:::

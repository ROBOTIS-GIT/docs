...
In AI Worker, BTs are used to structure long-horizon tasks that require multiple steps, conditional decisions, retries, recovery behavior, and a clear execution order.

...
![Groot 2 Main Window](/img/systems/aiworker/advanced_features/behavior_trees/groot_main_page.png)
...
![Groot 2 Example Tree](/img/systems/aiworker/advanced_features/behavior_trees/groot_example_page.png)
:::
...
1. Open the XML file in Groot 2. As shown in the image below, you can see that `GraspObject` has been added to the Action nodes in the bottom-left palette.
   ...
   ![Groot 2 Example Tree 2](/img/systems/aiworker/advanced_features/behavior_trees/groot_example_page_2.png)
...
2. Add nodes from the palette to the canvas. Click and drag the desired action from the palette and drop it onto the canvas.
   ...
   ![Groot 2 Example Tree 3](/img/systems/aiworker/advanced_features/behavior_trees/groot_example_page_3.png)

3. Connect nodes to build your behavior hierarchy.

   ![Groot 2 Example Tree 4](/img/systems/aiworker/advanced_features/behavior_trees/groot_example_page_4.png)

4. Set parameters for each action node.

   ![Groot 2 Example Tree 5](/img/systems/aiworker/advanced_features/behavior_trees/groot_example_page_5.png)

...
<div style={{position: 'relative', paddingBottom: '56.25%', height: '0', overflow: 'hidden', maxWidth: '100%', margin: '20px 0', borderRadius: '8px'}}>
  <iframe
    ...
    src="https://www.youtube.com/embed/Wst9WuLq7vU"
...
<div style={{textAlign: 'center', margin: '20px 0 16px 0'}}>
  <img src="/img/systems/aiworker/resources/technical_story/centerpose/architecture.jpg" alt="CenterPose pick-and-place architecture: ZED camera to Isaac ROS CenterPose to Vision Pick & Place to AI Worker" style={{maxWidth: '100%', borderRadius: '8px', background: '#fff'}} />

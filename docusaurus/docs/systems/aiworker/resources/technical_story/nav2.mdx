...
- **Architecture Overview**  
  <div style={{textAlign: 'center', margin: '20px 0 16px 0'}}>
    <img src="/img/systems/aiworker/resources/technical_story/nav2/nav2_architecture.png" alt="Nav2 stack architecture overview" style={{maxWidth: '100%', borderRadius: '8px', border: '2px solid #667eea'}} />
...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px', margin: '12px 0 6px 0'}}>
  <img src="/img/systems/aiworker/navigation_curve.gif" alt="Navigation curve execution" style={{width: '100%', borderRadius: '8px', border: '2px solid #667eea', background: '#0f0f13'}} />
  <img src="/img/systems/aiworker/aiw_rviz2.gif" alt="RViz navigation visualization" style={{width: '100%', borderRadius: '8px', border: '2px solid #667eea', background: '#0f0f13'}} />
</div>
...
<div style={{textAlign: 'center', margin: '14px 0 10px 0'}}>
  <img src="/img/systems/aiworker/resources/technical_story/nav2/flow.svg" alt="BT decision flow for controller switching" style={{maxWidth: '100%', borderRadius: '8px', border: '2px solid #667eea', background: '#0f0f13'}} />
</div>

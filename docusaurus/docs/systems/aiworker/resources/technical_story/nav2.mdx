...
<div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '14px', margin: '12px 0 10px 0', alignItems: 'start'}}>
  <div>
    <img src="/img/systems/aiworker/technical_story/RPP-running.gif" alt="RPP controller run" style={{width: '100%', borderRadius: '10px', border: '2px solid #667eea', background: '#0f0f13'}} />
  ...
  <div>
    <img src="/img/systems/aiworker/technical_story/MPPI-running.gif" alt="MPPI holonomic run" style={{width: '100%', borderRadius: '10px', border: '2px solid #667eea', background: '#0f0f13'}} />

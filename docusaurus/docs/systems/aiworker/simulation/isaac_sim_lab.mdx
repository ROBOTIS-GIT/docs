...
#### FFW-BG2 Reach Task
**Sim2Sim**
![AI Worker in NVIDIA Isaac Lab](/img/systems/aiworker/simulation/isaac_sim_lab/ffw_bg2_isaac_lab2.png)
...
# Play
python scripts/reinforcement_learning/rsl_rl/play.py --task Cyclo-Reach-FFW-BG2-Play-v0 --num_envs=16
```

### Imitation Learning

Cyclo Lab supports imitation learning pipelines for ROBOTIS robots. Using the AI Worker as an example, you can collect demonstration data, process it, convert it into the Lerobot dataset format, and run inference or training using **physical_ai_tools**.
...
<div class="video-container">
  <video controls preload="metadata" style={{width: '100%', maxWidth: '900px', borderRadius: '10px'}}>
    <source src="/img/systems/aiworker/simulation/ffw_sg2_isaac_real_imitation_learning.mp4" type="video/mp4" />
...
2. **Dataset Processing and Generation**
  ...
  # Annotate dataset
   ...
   --task Cyclo-Real-Mimic-Pick-Place-FFW-SG2-v0 \
   --auto \
...
4. **Training and Inference with physical_ai_tools**
  ...
  <a href="/docs/systems/aiworker/imitation_learning/model_training" class="button-shortcut">

...
![FFW BG2 Simulation](/img/systems/aiworker/simulation/gazebo/ffw_bg2_gazebo.png)


### FFW_SG2

![FFW SG2 Simulation](/img/systems/aiworker/simulation/gazebo/ffw_sg2_gazebo.png)
...
*   **Launch Moveit:**
    ...
    ```
<img src="/img/systems/aiworker/simulation/gazebo/ffw_moveit.gif" alt="AI Worker MoveIt" />
...
1. **Start Gazebo simulation:** Use one of the Gazebo launch commands.
    ...
    <TabItem value="sh5" label="SH5 Type">
...
![Gazebo Nav2 View](/img/systems/aiworker/simulation/gazebo/gazebo_view1.png)
...
2. **Launch Nav2:**
   ...
   - **Build a map with SLAM Toolbox:**
     ```bash
     ros2 launch ffw_navigation navigation.launch.py use_slam:=true use_sim_time:=true rviz:=true
     ```
   ...
   ![Nav2 SLAM Mapping](/img/systems/aiworker/simulation/gazebo/nav2_slamtoolbox1.gif)
   ...
   ![Saved map example](/img/systems/aiworker/simulation/gazebo/my_map.png)

...
![AI Worker URDF model in RViz or Gazebo](/img/systems/aiworker/simulation/simulation/ffw_bg2_urdf.png)
...
<div style={{display: 'flex', flexWrap: 'wrap', gap: '1rem'}}>
  {['BG2', 'SG2', 'SH5'].map(model => (
    <figure key={model} style={{flex: '1 1 160px', margin: 0, textAlign: 'center'}}>
      <img src={`/img/systems/aiworker/simulation/simulation/ffw_${model.toLowerCase()}_mjcf.png`} alt={`AI Worker ${model} loaded in MuJoCo`} style={{width: '100%', height: 'auto'}} />
...
*   **Link**: [AI Worker MJCF on GitHub](https://github.com/ROBOTIS-GIT/ai_worker/tree/main/ffw_description/mujoco)
...
![AI Worker USD model in NVIDIA Isaac Sim (Coming Soon)](/img/systems/aiworker/simulation/simulation/ffw_bg2_isaac_sim.png)
...
*   **Link**: [AI Worker USD on GitHub](https://github.com/ROBOTIS-GIT/cyclo_lab/tree/main/source/cyclo_lab/data/robots/FFW)
...
![AI Worker in NVIDIA Isaac Lab](/img/systems/aiworker/simulation/simulation/ffw_bg2_isaac_lab.gif)

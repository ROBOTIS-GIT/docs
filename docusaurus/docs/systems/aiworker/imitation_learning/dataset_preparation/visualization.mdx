...
```
  ...
  <img src="/img/systems/aiworker/imitation_learning/web_ui/record/task_info_repo_id_ffw.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<img src="/img/systems/aiworker/imitation_learning/data_visualization.png" alt="Web UI" style={{width: '100%'}} />

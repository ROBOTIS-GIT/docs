...
Watch the following UI walkthrough before using Action Canvas. If the embedded player does not open, [watch it on YouTube](https://www.youtube.com/watch?v=jRcUuwxFk_Y&t=31s).

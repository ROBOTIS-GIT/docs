---
title: Action Canvas
description: Build, save, and run AI Worker Tasks performed at one work location.
---
...
Working in one area does not mean the robot must remain completely still. It can turn or make local movements as part of the Task. If the robot needs to travel between several work areas and perform a different Task at each location, use [Mission Canvas](/docs/systems/aiworker/autonomy_studio/mission_canvas/mission) instead. Put simply, Action Canvas defines **what the robot does here**; Mission Canvas also defines **where it goes next**.

Watch the following UI walkthrough before using Action Canvas. Playback starts at `0:31`, where the Action Canvas guide begins. If the embedded player does not open, [watch it on YouTube](https://www.youtube.com/watch?v=jRcUuwxFk_Y&t=31s).

<iframe width="560" height="315" src="https://www.youtube.com/embed/jRcUuwxFk_Y?start=31" title="Action Canvas UI walkthrough" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>

## Open Action Canvas

Before opening Action Canvas, complete the [Autonomy Studio setup and safety checks](/docs/systems/aiworker/autonomy_studio/overview#prerequisites).

1. Open the Cyclo Intelligence web UI.
2. In the application sidebar, click **Autonomy Studio**.
3. Select **Action Canvas**.

   ![Action Canvas option in the Autonomy Studio workspace chooser](/img/systems/aiworker/autonomy_studio/action_canvas/action_canvas_button.png)
...
![Back arrow in the Action Canvas application bar](/img/systems/aiworker/autonomy_studio/action_canvas/back_arrow_button.png)
...
![Action Canvas workspace](/img/systems/aiworker/autonomy_studio/action_canvas/action_canvas_home.png)
...
| **Step palette** | Choose a Step from **Flow Controls** or **Actions**. If a new custom Step has been added to the system, such as a newly developed robot action, turn on the Task Engine and click **Refresh Steps** to make it available in the palette. |
...
![Clear button in the Action Canvas header](/img/systems/aiworker/autonomy_studio/action_canvas/clear.png)

...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/waypoint_on_map.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/waypoint_at_robot.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/edit_waypoints.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/build_mission_route.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/reorder_route.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/remove_waypoint_route.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/clear_route.mp4" type="video/mp4" />
</video>

#### Create a Closed Loop

<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/closed_loop.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/open_waypoint_task.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/understand_waypoint_task_file.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/run_mission.mp4" type="video/mp4" />
</video>
...
<video controls autoPlay muted loop playsInline preload="metadata" style={{width: '100%', height: 'auto'}} aria-label="Create a Waypoint at the robot's current position">
  <source src="/img/systems/aiworker/autonomy_studio/mission_canvas/mission/run_another_mission.mp4" type="video/mp4" />
</video>

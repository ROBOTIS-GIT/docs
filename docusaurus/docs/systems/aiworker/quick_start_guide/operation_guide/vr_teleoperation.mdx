...
<div style={{display: 'flex', flexWrap: 'wrap', gap: '12px'}}>
  <img src="/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/menu_meta.png" alt="menu_meta" width="22%" />
  <img src="/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/headset_settings_meta.png" alt="headset_settings_meta" width="22%" />
  <img src="/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/developer_mode_meta.png" alt="developer_mode_meta" width="22%" />
  <img src="/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/developer_mode_toggle_meta.png" alt="developer_mode_toggle_meta" width="22%" />
</div>
...
![Quest power and sleep settings](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/power_setting_meta.png)

2. Play area : Settings → Environment setup → Boundary → Stationary boundary size → Large.

![Stationary boundary set to Large](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/boundary_large_meta.png)
...
![Browser advanced / certificate bypass](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/advance_webpage.png)

![Proceed to site (unsafe)](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/proceed_webpage.png)
...
![Enter VR button](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/enter_vr_webpage.png)

The session is ready when **passthrough** becomes active and **axis markers** appear on your hands.

![Passthrough with hand axes](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/pass_meta.png)
...
![Activate VR publisher](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/vr_squeeze_buttons.png)
...
![Activate VR controller](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/vr_a_x.png)
...
![SG2 Slow Start](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/sg2_vr_slow_start.gif)
...
![SH5 gesture](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/gesture.png)
...
![SH5 Slow Start](/img/systems/aiworker/quick_start_guide/operation_guide/vr_teleoperation/sh5_vr_slow_start.gif)

...
AI Worker uses Zenoh as RMW since version 2.0.0, so you need to bring up the Zenoh daemon before bringing up the robot. For how Zenoh fits into the AI Worker ROS 2 stack, see [Zenoh Communication](/docs/systems/aiworker/quick_start_guide/setup_overview/zenoh_communication).
:::

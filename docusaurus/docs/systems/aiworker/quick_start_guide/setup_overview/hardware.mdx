...
![Back of the BG2 Base](/img/systems/aiworker/quick_start_guide/back_of_the_BG2_base.png)
...
![Back of the BG2 Body](/img/systems/aiworker/quick_start_guide/back_of_the_BG2_body.png)
...
![Back of the SG2 Base](/img/systems/aiworker/quick_start_guide/back_of_the_SG2_base.png)
...
![Back of the SG2 body](/img/systems/aiworker/quick_start_guide/back_of_the_SG2_body.png)
The back of the Follower body includes several ports for system access and external connections:
...
![remote_e_stop](/img/systems/aiworker/quick_start_guide/remote_e_stop.png)
...
![hand_mount_bracket](/img/systems/aiworker/quick_start_guide/hand_mount_bracket.png)

2. Reorient the Mounting Bracket: Unscrew the mounting bolts on the `FRP42-A110K` bracket and rotate it by 90°. Align the bracket and mount the bolts into the highlighted holes as shown in the image above.

<img src="/img/systems/aiworker/quick_start_guide/hand_cable_port.png" width="350"/>

3. Connect the Communication Cable: Plug the `4-pin JST cable` into the port located on the `ROBOTIS Hand`. Ensure the connector is fully seated to prevent signal loss or intermittent connectivity.

4. Secure the `ROBOTIS Hand`: Align the hand with the rotated `FRP42-A110K` bracket and tighten the mounting screws.

<img src="/img/systems/aiworker/quick_start_guide/hand_attached.jpg" width="350"/>

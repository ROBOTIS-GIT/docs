...
⚠️ For **ID 81 (lift joint)**, you must set the `Max Position Limit(76)` to 0, and `Min Position Limit(84)` to -50000.
  ![lift limit](/img/systems/aiworker/support/troubleshooting_guide/lift_pos_limit.png)

⚠️ For **ID 81 (lift joint)**, under `Advanced` section, set `Gear Ratio Numerator(96)` to 131072, and `Gear Ratio Denominator(100)` to 125.

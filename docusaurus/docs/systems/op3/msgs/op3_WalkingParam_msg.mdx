---
id: op3_WalkingParam_msg
title: "op3_WalkingParam_msg"
sidebar_position: 25
tags: [msgs]
---
...
&emsp;&emsp;
![](/img/systems/op3/msgs/op3_WalkingParam_msg/op3_walking_module_image150.webp)
* `float32 y_move_amplitude`  
&emsp;&emsp; Differential distance (y-direction) between ROBOTIS-OP3's left and right foot during walk [m]  
&emsp;&emsp;
![](/img/systems/op3/msgs/op3_WalkingParam_msg/op3_walking_module_image151.webp)
* `float32 z_move_amplitude`  
...
&emsp;&emsp;
![](/img/systems/op3/msgs/op3_WalkingParam_msg/op3_walking_module_image3.gif)

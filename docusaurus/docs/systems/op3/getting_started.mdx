...
import GettingStartedRev2 from '@site/docs/_partials/systems/op3/getting_started_rev2.mdx';
...
![](/img/systems/op3/op3_connection.webp)   
...
#### How to Connect
 - **SSH**
   ...
   ![](/img/systems/op3/op3_connection_ssh2.webp)

...
import GettingStartedRev2 from '@site/docs/systems/op3/_partials/getting_started_rev2.mdx';
...
![](/img/systems/op3/getting_started/op3_connection.webp)   
...
#### How to Connect
 - **SSH**
   ...
   ![](/img/systems/op3/getting_started/op3_connection_ssh2.webp)

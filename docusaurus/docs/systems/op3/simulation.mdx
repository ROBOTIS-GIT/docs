...
import SimulationRev2 from '@site/docs/systems/op3/_partials/simulation_rev2.mdx';
...
![](/img/systems/op3/simulation/op3_gazebo2.webp)
...
![](/img/systems/op3/simulation/op3_webots.webp)

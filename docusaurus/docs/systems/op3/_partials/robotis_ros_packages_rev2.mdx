...
- Walking parameters
 ...
 - YAML format
   - x_offset: offset in the x-direction (front and back) [m]  
     ...
     ![](/img/systems/op3/op3_walking_module_image142.webp)

   - y_offset: offset in the y-direction (left and right) [m]  

     ![](/img/systems/op3/op3_walking_module_image143.webp)

   - z_offset: offset in the z-direction (up and down) [m]  

     ![](/img/systems/op3/op3_walking_module_image144.webp)

   - roll_offset: roll offset (x-coordinate) [degree]  

     ![](/img/systems/op3/op3_walking_module_image145.webp)

   - pitch_offset: pitch offset (y-coordinate) [degree]  

     ![](/img/systems/op3/op3_walking_module_image146.webp)

   - yaw_offset: yaw offset (z-coordinate) [degree]  

     ![](/img/systems/op3/op3_walking_module_image2.gif)
   ...
   - pelvis_offset: roll offset (x-coordinate) at the pelvis level. Values are for DYNAMIXEL position values for hip roll joints [degree]  
     ...
     ![](/img/systems/op3/op3_walking_module_image155.webp)
...
![](/img/systems/op3/ball_detector_node_02.webp)
...
![](/img/systems/op3/robotis_ros_packages/op3_urdf_rviz.webp)
...
![](/img/systems/op3/thormang3_action_editor_tui.webp)
...
![](/img/systems/op3/thormang3_action_editor_tui_command_list.webp)
...
2. Find the page where the "walking_init page" is by typing "list"  
    ...
    ![](/img/systems/op3/thormang3_action_editor_tui_action_editing_example1.webp)

3. Exit the list and go to any blank page by typing "page [x]"(for example, page 15).

    ![](/img/systems/op3/thormang3_action_editor_tui_action_editing_example2.webp)

4. And copy the page 1 to page [x].  

    ![](/img/systems/op3/thormang3_action_editor_tui_action_editing_example3.webp)

5. Go to "walking_init" pose by typing "play"  
6. Turn off the torque of ID 2, 4 and 8 by typing "off 2 4 8"  

    ![](/img/systems/op3/thormang3_action_editor_tui_action_editing_example4.webp)

7. After getting the desired pose turn torque on again by simple typing on. And insert the pose to step 1 by typing "i 1"  

    ![](/img/systems/op3/thormang3_action_editor_tui_action_editing_example5.webp)

8. Edit "Pause Time", "Time" of STP1 and "Page Step" as shown below.  

    ![](/img/systems/op3/thormang3_action_editor_tui_action_editing_example6.webp)
...
![](/img/systems/op3/op3_gui_diagram.webp)
...
![](/img/systems/op3/robotis_ros_packages/op3_walk_tuner.webp)
...
[std_msgs/Header]: /docs/systems/op3/msgs/std_msgs_Header
[sensor_msgs/JointState]: /docs/systems/msgs/sensor_msgs_JointState_msg
[sensor_msgs/Imu]: /docs/systems/msgs/sensor_msgs_IMU_msg
[sensor_msgs/Image]: /docs/systems/op3/msgs/sensor_msgs_Image
[sensor_msgs/CameraInfo]: /docs/systems/op3/msgs/sensor_msgs_CameraInfo_msg
[geometry_msgs/Point]: /docs/systems/op3/msgs/geometry_msgs_Point_msg
[geometry_msgs/Pose]: /docs/systems/msgs/geometry_msgs_Pose_msg
[geometry_msgs/PoseStamped]: /docs/systems/op3/msgs/geometry_msgs_PoseStamped_msg
...
[op3_action_module_msgs/IsRunning]: /docs/systems/op3/msgs/op3_IsRunning_srv
[op3_offset_tuner_msgs/JointOffsetData]: /docs/systems/op3/msgs/op3_JointOffsetData_msg
[op3_offset_tuner_msgs/JointTorqueOnOffArray]: /docs/systems/op3/msgs/op3_JointTorqueOnOffArray_msg
[op3_offset_tuner_msgs/GetPresentJointOffsetData]: /docs/systems/op3/msgs/op3_GetPresentJointOffsetData_srv
[op3_tuning_module_msgs/JointOffsetData]: /docs/systems/op3/msgs/op3_tuning_module_msgs_JointOffsetData_msg
[op3_tuning_module_msgs/JointTorqueOnOffArray]: /docs/systems/op3/msgs/op3_tuning_module_msgs_JointTorqueOnOffArray_msg
[op3_tuning_module_msgs/GetPresentJointOffsetData]: /docs/systems/op3/msgs/op3_tuning_module_msgs_GetPresentJointOffsetData_srv
...
[StartAction.msg]: /docs/systems/op3/msgs/op3_StartAction_msg
[IsRunning.srv]: /docs/systems/op3/msgs/op3_IsRunning_srv
[op3_walking_module_msgs/WalkingParam]: /docs/systems/op3/msgs/op3_WalkingParam_msg
[WalkingParam.msg]: /docs/systems/op3/msgs/op3_WalkingParam_msg
[op3_walking_module_msgs/GetWalkingParam]: /docs/systems/op3/msgs/op3_GetWalkingParam_srv
[GetWalkingParam.srv]: /docs/systems/op3/msgs/op3_GetWalkingParam_srv
[SetWalkingParam.srv]: /docs/systems/op3/msgs/op3_SetWalkingParam_srv
[FootStepArray.msg]: /docs/systems/op3/msgs/op3_FootStepArray_msg
[FootStepCommand.msg]: /docs/systems/op3/msgs/op3_FootStepCommand_msg
[JointPose.msg]: /docs/systems/op3/msgs/op3_JointPose_msg
[KinematicsPose.msg]: /docs/systems/op3/msgs/op3_KinematicsPose_msg
[Step2D.msg]: /docs/systems/op3/msgs/op3_Step2D_msg
[Step2DArray.msg]: /docs/systems/op3/msgs/op3_Step2DArray_msg
[GetJointPose.srv]: /docs/systems/op3/msgs/op3_GetJointPose_srv
[GetKinematicsPose.srv]: /docs/systems/op3/msgs/op3_GetKinematicsPose_srv
[GetPreviewMatrix.srv]: /docs/systems/op3/msgs/op3_GetPreviewMatrix_srv
[JointOffsetData.msg]: /docs/systems/op3/msgs/op3_JointOffsetData_msg
[JointOffsetPositionData.msg]: /docs/systems/op3/msgs/op3_JointOffsetPositionData_msg
[JointTorqueOnOff.msg]: /docs/systems/op3/msgs/op3_JointTorqueOnOff_msg
[JointTorqueOnOffArray.msg]: /docs/systems/op3/msgs/op3_JointTorqueOnOffArray_msg
[GetPresentJointOffsetData.srv]: /docs/systems/op3/msgs/op3_GetPresentJointOffsetData_srv
[ball_detector/circleSetStamped]: /docs/systems/op3/msgs/ball_detector_CircleSetStamped_msg
[JointOffsetData.msg]: /docs/systems/op3/msgs/op3_tuning_module_msgs_JointOffsetData_msg
[JointOffsetPositionData.msg]: /docs/systems/op3/msgs/op3_tuning_module_msgs_JointOffsetPositionData_msg
[JointTorqueOnOff.msg]: /docs/systems/op3/msgs/op3_tuning_module_msgs_JointTorqueOnOff_msg
[JointTorqueOnOffArray.msg]: /docs/systems/op3/msgs/op3_tuning_module_msgs_JointTorqueOnOffArray_msg
[GetPresentJointOffsetData.srv]: /docs/systems/op3/msgs/op3_tuning_module_msgs_GetPresentJointOffsetData_srv
[PreviewRequest.msg]: /docs/systems/op3/msgs/op3_PreviewRequest_msg
[PreviewResponse.msg]: /docs/systems/op3/msgs/op3_PreviewResponse_msg
[op3_online_walking_module_msgs/WalkingParam]: /docs/systems/op3/msgs/op3_online_WalkingParam_msg
[op3_online_walking_module_msgs/JointPose]: /docs/systems/op3/msgs/op3_JointPose_msg
[op3_online_walking_module_msgs/KinematicsPose]: /docs/systems/op3/msgs/op3_KinematicsPose_msg
[op3_online_walking_module_msgs/FootStepCommand]: /docs/systems/op3/msgs/op3_FootStepCommand_msg
[op3_online_walking_module_msgs/WalkingParam]: /docs/systems/op3/msgs/op3_online_WalkingParam_msg
[op3_online_walking_module_msgs/Step2DArray]: /docs/systems/op3/msgs/op3_Step2DArray_msg
[op3_online_walking_module_msgs/GetJointPose]: /docs/systems/op3/msgs/op3_GetJointPose_srv
[op3_online_walking_module_msgs/GetKinematicsPose]: /docs/systems/op3/msgs/op3_KinematicsPose_msg
[op3_online_walking_module_msgs/GetPreviewMatrix]: /docs/systems/op3/msgs/op3_GetPreviewMatrix_srv
[FootStepArray.msg]: /docs/systems/op3/msgs/op3_FootStepArray_msg
[FootStepCommand.msg]: /docs/systems/op3/msgs/op3_FootStepCommand_msg
[JointPose.msg]: /docs/systems/op3/msgs/op3_JointPose_msg
[KinematicsPose.msg]: /docs/systems/op3/msgs/op3_KinematicsPose_msg
...
[How to use ball detector]: /docs/systems/op3/tutorials#how-to-use-ball-detector
[op3_direct_control_module]: /docs/systems/op3/robotis_ros_packages#op3_direct_control_module
[/op3_base_module/data/ini_pose.yaml]: /docs/systems/op3/op3_base_module_ini_pose_yaml
[op3_online_walking_module]: /docs/systems/op3/robotis_ros_packages#op3-online-walking-module
[robotis_controller_msgs/SyncWriteItem]: /docs/systems/msgs/SyncWriteItem_msg
[open_cr_module]: /docs/systems/op3/robotis_ros_packages#open_cr_module
[OPENCR]: /docs/systems/op3/arduino_examples_op3#opencr-op3
[op3_head_control_module]: /docs/systems/op3/robotis_ros_packages#op3-head-control-module
[op3_gui_demo]: /docs/systems/op3/robotis_ros_packages#op3-gui-demo
[How to execute GUI program]: /docs/systems/op3/tutorials#how-to-exectue-gui-program
[How to use walking tuner]: /docs/systems/op3/tutorials#how-to-use-walking-tuner
[Connect to ROS]: http://gazebosim.org/tutorials?cat=connect_ros
[op3_base_module]: /docs/systems/op3/robotis_ros_packages#op3_base_module
[op3_manager]: /docs/systems/op3/robotis_ros_packages#op3-manager
[op3_offset_tuner_client]: /docs/systems/op3/robotis_ros_packages#op3-offset-tuner-client
[op3_action_module]: /docs/systems/op3/robotis_ros_packages#op3-action-module
[op3_walking_module]: /docs/systems/op3/robotis_ros_packages#op3_walking_module
...
[How to execute Default Demo]: /docs/systems/op3/tutorials#how-to-exectue-default-demo
[How to use tuner client]: /docs/systems/op3/tutorials#how-to-use-tuner-client
[op3_offset_tuner_server]: /docs/systems/op3/robotis_ros_packages#op3-offset-tuner-server
[/op3_walking_module/config/param.yaml]: /docs/systems/op3/op3_walking_module_param_yaml
[op3_tuning_module]: /docs/systems/op3/robotis_ros_packages#op3-tuning-module
[Installing ROBOTIS ROS Package]: /docs/systems/op3/recovery#installing-robotis-ros-packages
[Introduction to Humanoid Robotics]: http://www.springer.com/gp/book/9783642545351
[How to use offset tuner]: /docs/systems/op3/tutorials#how-to-use-offset-tuner

...
import RecoveryRev2 from '@site/docs/_partials/systems/op3/recovery_rev2.mdx';
...
1. Go to boot manager : Press **F10**  
	![](/img/systems/op3/op3_recovery_01_nuc10.webp)  
2. Select the boot device : Recovery USB media  
	![](/img/systems/op3/op3_recovery_02_nuc10.webp)  
3. Select the image : `Clonezilla live (VGA 800x600)`  
	![](/img/systems/op3/op3_recovery_03_nuc10.webp)  
4. Recovery will automatically start, and the PC will turn off when it's done.  
	![](/img/systems/op3/op3_recovery_04_nuc10.webp)  


[How to Install Linux Mint]: https://linuxmint-installation-guide.readthedocs.io/en/latest/index.html
[ROS Installation]: /docs/systems/common/op3_robot_operating_system#how-to-install-ros
[ROS Environment and Network Settings]: /docs/systems/common/op3_robot_operating_system#setup
[Setting for automatic startup]: /docs/systems/op3/getting_started#how-to-kill-the-demo-program
[sourceforge.net]: https://sourceforge.net/projects/darwinop/files/Software/Main%20Controller/Recovery%20USB/

[humanoid_navigation]: /docs/systems/thormang3/thormang3_ros_packages#humanoid_navigation
[How to Use the Web Setting Tool]: /docs/systems/op3/tutorials#how-to-use-web-setting-tool
[Running the demo at the startup]: /docs/systems/op3/getting_started#running-the-demo-at-startup
</TabItem>
...
[e-manual]: /docs/systems/op3/recovery#recovery-of-robotis-op3

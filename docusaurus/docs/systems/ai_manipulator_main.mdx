...
|:--------------------|:--------|:-----------------------------------------------------|
| **Actuator**        |         | DYNAMIXEL [XM430-W350-T](/docs/dxl/model_reference/x_series/xm430-w350) |
| **Input Voltage**   | V       | 12                                                   |
...
- [OpenMANIPULATOR-X](/docs/systems/openmanipulator_x/overview) 
...
- [OpenMANIPULATOR-P](/docs/systems/openmanipulator_p/overview)

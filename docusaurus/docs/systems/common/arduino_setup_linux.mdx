...
[USB port settings]: /docs/systems/common/arduino_setup_linux#usb-port-settings
[Compiler Settings]: /docs/systems/common/arduino_setup_linux#complier-settings
[Install the Arduino IDE]: /docs/systems/common/arduino_setup_linux#install-the-arduino-ide
[Run the Arduino IDE]: /docs/systems/common/arduino_setup_linux#run-the-arduino-ide
[Porting the OpenCR board to the Arduino IDE]: /docs/systems/common/arduino_setup_linux#porting-the-opencr-board-to-the-arduino-ide
[Install the OpenCR package via Boards Manager]: /docs/systems/common/arduino_setup_linux#install-the-opencr-package-via-boards-manager
[Modemmanager removal]: /docs/systems/common/arduino_setup_linux#modemmanager-removal
[Bootloader writing]: /docs/systems/common/arduino_setup_linux#bootloader-writing

...
<img src="/img/systems/hx5_d20/quick_start_guide/example_hand_motion.gif" alt="ROBOTIS Hand example motion" style={{display: 'block', margin: '0 auto', maxWidth: '100%'}} />
...
<img src="/img/systems/hx5_d20/quick_start_guide/keyboard_teleop.gif" alt="ROBOTIS Hand keyboard teleop demo" style={{display: 'block', margin: '16px auto 0', maxWidth: '100%'}} />

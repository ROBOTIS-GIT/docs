...
<figure style={{margin: '1.5rem auto', textAlign: 'center'}}>
  <img src="/img/systems/hx5_d20/simulation/simulation/hands_mjcf.png" alt="Left and right HX5-D20 hands loaded in MuJoCo" style={{width: '100%', maxWidth: '640px', height: 'auto'}} />
  <figcaption>HX5-D20 left and right hands in MuJoCo</figcaption>
</figure>

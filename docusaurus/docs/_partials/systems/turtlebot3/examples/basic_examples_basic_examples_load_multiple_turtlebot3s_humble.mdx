...
<iframe width="640" height="360" src="https://www.youtube.com/embed/IVut8qZOrEk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  - **What is Load Multiple TurtleBot3s example?**  
    ...
    ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/explain1.webp)  
    - You can assign a unique namespace to each TurtleBot3's `node`, `topic`, `frame` so you can identify each TurtleBot3.  
    ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/explain2.webp)  
...
- You can see three TurtleBot3s as in the picture below.  
   ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/multi_robot_gazebo.webp)  
<br />

- Nodes and topics are completely separated by namespace.  
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/node_graph_gazebo.webp)  
...
- Frames are completely saparated by namespace.  
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/frames_graph_gazebo.webp)  
...
- **Change robot namespace.**  
  ...
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/multi_robot_code.webp)  
<br />
...
:::
  ...
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/multi_robot_turtlebot3_world.webp)  
...
```
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/imu_hpp.webp)  

```bash
$ nano ~/turtlebot3_ws/src/ld08_driver/src/lipkg.cpp  
```
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/lipkg_cpp.webp)  
<br />
...
- Nodes and topics are completely separated by namespace.  
  ![](/img/systems/turtlebot3/examples/basic_examples/load_multiple_turtlebot3s/node_graph_reality.webp)  

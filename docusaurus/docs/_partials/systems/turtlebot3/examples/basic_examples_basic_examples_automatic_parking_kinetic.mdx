...
```
    ...
    **NOTE**: Specify `${TB3_MODEL}`: `burger`, `waffle`, `waffle_pi` before excuting the command. You can permanently configure your TurtleBot model according to the [Export TURTLEBOT3_MODEL](/docs/systems/turtlebot3/quick_start_guide/export_turtlebot3_model) instructions.

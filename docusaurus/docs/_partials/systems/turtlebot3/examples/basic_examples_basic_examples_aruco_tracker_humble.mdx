...
ArUco markers are divided into multiple dictionaries to balance the number of markers, identification reliability, and detection speed. In this example, we used the `DICT_5X5_250` dictionary. Prepare an image of an ArUco marker and measure the size of the marker.  
      ...
      !<a href="/img/systems/turtlebot3/examples/basic_examples/aruco_tracker/aruco_marker.webp" target="_blank">ArUco marker</a>  
<br />
...
Run camera_node. To use camera module, you must follow [SBC Setup](/docs/systems/turtlebot3/quick_start_guide/sbc_setup#raspberry-pi-camera) and camera calibration. If you don't perform the calibration correctly, tracking will not work properly.  
- For `camera-ros`  
**[TurtleBot3 SBC]**  
```bash
...
- description: An integer value for the size of the marker to use. Unit of meters.  
    ...
    **[Remote PC]**
    ...
    ```
    !<a href="/img/systems/turtlebot3/examples/basic_examples/aruco_tracker/aruco_tracker_rviz.webp" target="_blank">ArUco Tracker RViz</a>

...
**NOTE**:
- A working camera is required to run this example. Depending on your system setup, you can use a Raspberry Pi Camera with a compatible driver such as `camera-ros` or `v4l2-camera`. Please refer to [SBC Setup](/docs/systems/turtlebot3/quick_start_guide/sbc_setup#raspberry-pi-camera) to use the Pi Camera.
...
> Final panorama: stitched_result.jpg  
  ...
  ![](/img/systems/turtlebot3/examples/basic_examples/panorama/panorama_stitched_result.webp)

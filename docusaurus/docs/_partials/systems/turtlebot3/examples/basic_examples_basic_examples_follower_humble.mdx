...
```  
![](/img/systems/turtlebot3/examples/basic_examples/follower/gazebo.webp)  
...
![](/img/systems/turtlebot3/examples/basic_examples/follower/follower_launch.webp)
...
$ rviz2
```
![](/img/systems/turtlebot3/examples/basic_examples/follower/rviz_gazebo.webp)  
...
```
![](/img/systems/turtlebot3/examples/basic_examples/follower/rviz_gazebo2.webp)  

### Follower in real robot

1. Align the TurtleBot3s in a straight line and place them close together like below picture.  
![](/img/systems/turtlebot3/examples/basic_examples/follower/real_robot.webp)  
...
$ rviz2
```
![](/img/systems/turtlebot3/examples/basic_examples/follower/rviz_reality_robot.webp)

...
> **More Info**  
For detailed specifications and advanced settings, please check the [13.More Info - 13.1.Appendixes - Raspberry Pi Camera](/docs/systems/turtlebot3/appendix_raspi_cam) for a comprehensive guide on hardware capabilities and software features. 

> **Camera Calibration**  
If you plan to use advanced vision features like camera calibration, you can find the detailed instructions [here](/docs/systems/turtlebot3/appendix_raspi_cam#camera-calibration).  

> **Trouble Shooting**  
If the error message `Unable to open camera calibration file` appears, check the solution [here](/docs/systems/turtlebot3/appendix_raspi_cam#trouble-shooting).  
...
Next Step : [OpenCR Setup](/docs/systems/turtlebot3/opencr_setup#opencr-setup)

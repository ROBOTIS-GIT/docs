...
7. Select two topics on Image View Plugin: `/detect/image_level_color_filtered/compressed`, `/detect/image_level/compressed`.
    <img src="/img/systems/turtlebot3/autonomous_driving/noetic_detect_level.webp" width="1000" />

8. Adjust parameters in the `detect_level_crossing` on Dynamic Reconfigure Plugin
    <img src="/img/systems/turtlebot3/autonomous_driving/noetic_level_reconfigure.webp" width="1000" />
...
```
        ![](/img/systems/turtlebot3/autonomous_driving/humble_level_yaml.webp)

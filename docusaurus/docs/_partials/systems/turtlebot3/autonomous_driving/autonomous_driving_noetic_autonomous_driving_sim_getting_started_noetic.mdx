...
**Tip**: If you have an actual TurtleBot3, you can perform up to **[Lane Detection](#lane-detection)** from our Autonomous Driving package with your physical robot. For more details, click the expansion note (![](/img/icon_unfold.webp)**Click to expand:** ) at the end of the content in each sub section. 
...
<details>
<summary>
![](/img/icon_unfold.webp) **Click to expand : Prerequisites for use of actual TurtleBot3**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.webp) **Click to expand : Autorace Package Installation for an actual TurtleBot3**
</summary>

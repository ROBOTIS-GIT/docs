...
<details>
<summary>
![](/img/icon_unfold.webp) Read more about **How to load TurtleBot3 House**
</summary>
```bash
$ export TURTLEBOT3_MODEL=burger
...
3. Repeat step 1 and 2 until the LDS sensor data is overlaid on the saved map. 
  ![](/img/systems/turtlebot3/navigation/tb3_navigation2_rviz_01.webp)
4. Launch keyboard teleoperation node to precisely locate the robot on the map.
  ```bash
$ ros2 run turtlebot3_teleop teleop_keyboard
  ```
5. Move the robot back and forth a bit to collect the surrounding environment information and narrow down the estimated location of the TurtleBot3 on the map which is displayed with tiny green arrows.  
![](/img/systems/turtlebot3/navigation/tb3_amcl_particle_01.webp)
![](/img/systems/turtlebot3/navigation/tb3_amcl_particle_02.webp)
...
2. Click on the map to set the destination of the robot and drag the green arrow toward the direction where the robot will be facing. 
  ...
  ![](/img/systems/turtlebot3/navigation/tb3_navigation2_rviz_02.webp)
...
<details>
<summary>
![](/img/icon_unfold.webp) Read more about **Navigation2**
</summary>

...
![](/img/systems/turtlebot3/quick_start/sbc_setup/micro_sd_reader.webp)
...
[![](/img/icon_download.webp) **Download** Raspberry Pi Imager from raspberrypi.org](https://www.raspberrypi.org/software/)
...
![](/img/icon_unfold.webp) **Click here to expand more details about How to install Raspberry Pi Imager.**
</summary>  
Install either the `deb` or `apt` rpi-imager release.

1. `deb`  
Download deb file  
![](/img/systems/turtlebot3/quick_start/sbc_setup/sbc_setup1.webp)  
  ```bash
$ cd Downloads
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/sbc_setup_jazzy.webp)  
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/sbc_config_set.webp)  
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/sbc_config_set2.webp)
![](/img/systems/turtlebot3/quick_start/sbc_setup/sbc_config_set3.webp)  
...
1. Boot Up the Raspberry Pi  
  ...
  ![](/img/systems/turtlebot3/quick_start/sbc_setup/sbc_setup3.webp)  
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/ros2_sbc_netcfg.webp)  
...
<details>
<summary>
![](/img/icon_unfold.webp) **Click here to expand more details about how to connect through ssh**
</summary>
...
```  
![](/img/systems/turtlebot3/quick_start/sbc_setup/sshd_config2.webp)  
...
$ ifconfig
```  
![](/img/systems/turtlebot3/quick_start/sbc_setup/sshd_config3.webp)  
...
<details>
<summary>
![](/img/icon_unfold.webp) **If you are using the TurtleBot3 2GB, make sure to create swap memory for building packages.** Otherwise, you may run out of memory and package building may fail.
</summary>
...
$ free -h
```  
![](/img/systems/turtlebot3/quick_start/sbc_setup/swap.webp)
</details>
...
|:---:|:---:|:---:|
|![](/img/systems/turtlebot3/more_info/appendix_lds/lds_small.webp)|![](/img/systems/turtlebot3/more_info/appendix_lds/lds_ld08_small.webp)|![](/img/systems/turtlebot3/more_info/appendix_lds/lds_coind4_small.webp)|  
...
### Raspberry Pi Camera
![](/img/systems/turtlebot3/more_info/appendix_raspi_cam/Pi-Camera-front.webp)
...
<details>
<summary>
![](/img/icon_unfold.webp) **Method 1. Using the camera-ros package**  
</summary>
...
<details>
<summary>
![](/img/icon_unfold.webp) **Method 2. Using the v4l2-camera package**
</summary>
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/rpi_config1.webp)  
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/rpi_config2.webp)  
...
![](/img/systems/turtlebot3/quick_start/sbc_setup/camera_name.webp)  

...
![](/img/icon_unfold.webp) **Click here to expand more details about How to install ROS 2.**
</summary>
...
2. Copy the CLI commands located in the green box and paste into your terminal with `ctrl` + `shift` + `v`  
  ![](/img/systems/turtlebot3/quick_start/quick_start/ros2_install1-.webp)    
  
3. Generally, ros-jazzy-desktop is recommended for the `Remote PC`  
  ![](/img/systems/turtlebot3/quick_start/quick_start/ros2_install2-.webp)  

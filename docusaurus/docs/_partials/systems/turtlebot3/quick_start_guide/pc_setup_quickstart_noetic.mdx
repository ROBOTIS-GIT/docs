...
<details>
<summary>
![](/img/icon_unfold.webp) **Click here for details about building TurtleBot3 packages from source.**
</summary>
...
$ ifconfig
  ```  
  ![](/img/systems/turtlebot3/quick_start/quick_start/network_configuration2.webp)
...
3. Press `Ctrl`+`END` or `Alt`+`/` to move the cursor to the end of the line.  
  ...
  ![](/img/systems/turtlebot3/quick_start/quick_start/network_configuration3.webp)

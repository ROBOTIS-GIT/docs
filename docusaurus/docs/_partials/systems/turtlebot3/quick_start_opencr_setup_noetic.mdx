...
![](/img/systems/turtlebot3/quick_start/opencr_setup/opencr_setup.webp)  
...
6. A successful firmware upload for the TurtleBot3 Burger will look like this:  
  ![](/img/systems/turtlebot3/quick_start/opencr_setup/shell01.webp)
...
<details>
<summary>
![](/img/icon_unfold.webp) Click here to expand more details about firmware uploads using the **Arduino IDE**
</summary>
...
10. Upload the TurtleBot3 firmware sketch with `Ctrl` + `U` or the upload icon.  
  ![](/img/systems/turtlebot3/quick_start/opencr_setup/o2.webp)  
  ![](/img/systems/turtlebot3/quick_start/opencr_setup/o3.webp)
...
### OpenCR Test
**NOTE**: If the wheels do not move while performing the OpenCR Test, refer to the"**[TurtleBot3 DYNAMIXEL setup instructions](/docs/systems/turtlebot3/faq#setup-dynamixels-for-turtlebot3)**" to update the DYNAMIXEL's configuration.
...
![](/img/systems/turtlebot3/quick_start/opencr_setup/opencr_models.webp)

...
<details>
<summary>
![](/img/icon_unfold.webp) **Read more about How to predefine the TURTLEBOT3_MODEL**
</summary>
...
<details>
<summary>
![](/img/icon_unfold.webp) **Read more about Topic Monitor**
</summary>
...
$ rqt
  ```  
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_1.webp)
...
2. When the topic monitor is opened, the topic values are not monitored by default. Click the checkbox next to each topic to monitor the topic.  
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_2.webp)

3. To see more detailed topic messages, click the `▶` icon next to the checkbox.  
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_3.webp)
  ...
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_4.webp)
  ...
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_5.webp)
  ...
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_6.webp)

  - `/sensor_state` indicates a message containing encoder values, battery and torque.  
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_7.webp)

  - `/scan` indicates a message with LDS data.  
  ![](/img/systems/turtlebot3/quick_start/basic_operation/legacy/rqt_8.webp)


[teleoperation]: /docs/systems/turtlebot3/teleoperation
[basic_examples]: /docs/systems/turtlebot3/basic_examples
[additional_sensors]: /docs/systems/turtlebot3/additional_sensors
[bringup]: /docs/systems/turtlebot3/bringup#bringup
[rqt]: http://wiki.ros.org/rqt
[rc100]: /docs/parts/communication/rc-100
[bt410]: /docs/parts/communication/bt-410
[appendix_opencr1_0]: /docs/systems/turtlebot3/appendix_opencr1_0

...
- For easy maintanence and configuration of DYNAMIXEL, it is recommended to use [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel/dynamixel_wizard2) or [R+ Manager 2.0](/docs/software/dynamixel/dynamixel_wizard2/)

...
1. To manipulate the OpenMANIPULATOR, click the toggle button to `CONTROLLER ON`.  
  ![](/img/systems/openmanipulator_x/OpenManipulator_chain_processing_3.webp)
...
2. The user can manipulate the OpenMANIPULATOR-X in the [joint space].  
  ...
  ![](/img/systems/openmanipulator_x/OpenManipulator_chain_processing_4.webp)
...
3. The user can manipulate the OpenMANIPULATOR-X in the [task space].  
  ...
  ![](/img/systems/openmanipulator_x/OpenManipulator_chain_processing_5.webp)
...
The user can make the demonstration using hand guiding function.
  ...
  ![](/img/systems/openmanipulator_x/OpenManipulator_chain_processing_6.webp)

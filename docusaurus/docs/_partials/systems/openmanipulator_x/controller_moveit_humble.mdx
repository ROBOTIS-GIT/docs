...
Before launching MoveIt 2, ensure that the `hardware.launch.py` from [Launch Controller](/docs/systems/openmanipulator_x/ros_controller_package#launch-controller) is running in a separate terminal.  
...
For more information on Gazebo, See [Simulation](/docs/systems/openmanipulator_x/ros_simulation)

...
**NOTE**: For stable high speed communication over USB serial connections, you may need to adjust the [USB latency settings](/docs/software/dynamixel/dynamixel_wizard2#usb-latency-setting) in your PC's settings.

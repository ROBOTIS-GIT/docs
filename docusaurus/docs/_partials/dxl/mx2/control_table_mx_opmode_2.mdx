...
1. PWM Control Mode is similar to the Wheel Mode of DYNAMIXEL [AX](/docs/dxl/ax/ax-12w#cw-compliance-margin) and [RX](/docs/dxl/rx/rx-10#moving-speed-32) series.

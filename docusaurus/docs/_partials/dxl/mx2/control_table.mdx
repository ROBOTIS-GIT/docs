...
2. MX(2.0) Firmware inherits DYNAMIXEL-X function. Therefore, it supports [DYNAMIXEL Protocol 1.0](/docs/dxl/protocol1) and [DYNAMIXEL Protocol 2.0](/docs/dxl/protocol2), and various Operating Modes, Secondary ID, Drive Mode, Bus Watchdog, etc. Please refer to the control table for more details.

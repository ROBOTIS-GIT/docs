...
**Note** : When using a U2D2 [reduce the response latency of the USB port](/docs/software/dynamixel_wizard_2_0#graph-optimization) to ensure stable communication at higher Baud rates.

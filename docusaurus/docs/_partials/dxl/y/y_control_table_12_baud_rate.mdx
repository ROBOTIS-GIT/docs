...
**Note** : When using a U2D2 [reduce the response latency of the USB port](/docs/software/dynamixel/dynamixel_wizard2#graph-optimization) to ensure stable communication at higher Baud rates.

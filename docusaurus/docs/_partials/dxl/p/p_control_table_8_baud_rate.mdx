...
**NOTE**: For stable high speed communication over USB serial connections, you may need to adjust the [USB latency settings](/docs/software/dynamixel_wizard_2_0#usb-latency-setting) in your PC's settings.

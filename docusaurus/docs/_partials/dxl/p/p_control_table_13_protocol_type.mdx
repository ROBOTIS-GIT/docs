...
**WARNING**: [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0) is required to change the communications protocol of your DYNAMIXEL servo, as R+ Manager 2.0 does not support Modbus-RTU communication.

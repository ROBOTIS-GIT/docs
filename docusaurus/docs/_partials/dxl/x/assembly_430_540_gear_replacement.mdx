...
ROBOTIS recommends using the new [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel_wizard_2_0#calibration) calibration software rather than our legacy R+ Manager 2.0 software used in the video.

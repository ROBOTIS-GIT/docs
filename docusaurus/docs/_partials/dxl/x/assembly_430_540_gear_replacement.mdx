...
ROBOTIS recommends using the new [DYNAMIXEL Wizard 2.0](/docs/software/dynamixel/dynamixel_wizard2#calibration) calibration software rather than our legacy R+ Manager 2.0 software used in the video.

...
1. To manipulate the OpenMANIPULATOR, click the toggle button to `CONTROLLER ON`.  
  ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_3.png)
...
2. The user can manipulate the OpenMANIPULATOR-X in the [joint space].  
  ...
  ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_4.png)
...
3. The user can manipulate the OpenMANIPULATOR-X in the [task space].  
  ...
  ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_5.png)
...
The user can make the demonstration using hand guiding function.
  ...
  ![](/img/platform/openmanipulator_x/OpenManipulator_chain_processing_6.png)

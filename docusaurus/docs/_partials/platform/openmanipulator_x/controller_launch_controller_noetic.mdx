...
**NOTE**:  
OpenMANIPULATOR-X controller is compatible with [Protocol 2.0](/docs/dxl/protocol2).  
[Protocol 1.0](/docs/dxl/protocol1) does not support SyncRead instructions to access multiple DYNAMIXEL simultaneously.  

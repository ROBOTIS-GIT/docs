...
- For easy maintanence and configuration of DYNAMIXEL, it is recommended to use [DYNAMIXEL Wizard 2.0](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/) or [R+ Manager 2.0](http://emanual.robotis.com/docs/en/software/rplus2/manager/)
...
**NOTE**:  
OpenMANIPULATOR-X controller is compatible with [Protocol 2.0](https://emanual.robotis.com/docs/en/dxl/protocol2/).  
[Protocol 1.0](https://emanual.robotis.com/docs/en/dxl/protocol1/) does not support SyncRead instructions to access multiple DYNAMIXEL simultaneously.  
...
- `use_platform` : Condition to run the [Simulation](/docs/platform/openmanipulator_x/ros_simulation#ros-simulation). 
  - Set **true** when operating the actual OpenMANIPULATOR. 
  - Set **false** when running a virtual OpenMANIPULATOR in [Gazebo](/docs/platform/openmanipulator_x/ros_simulation#controller-for-gazebo) (3D robotics simulator).

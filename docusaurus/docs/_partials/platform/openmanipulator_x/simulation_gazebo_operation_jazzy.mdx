In order to control the simulated OpenMANIPULATOR-X, launch the [OpenMANIPULATOR-X control GUI](/docs/platform/openmanipulator_x/ros_operation#gui-program) or [Keyboard teleoperation](/docs/platform/openmanipulator_x/ros_operation#keyboard)  
...
- GUI Program
  ...
  **Terminal 3** - Launch GUI program:
  ...
  ```
  ![](/img/platform/openmanipulator_x/OpenManipulator_x_GUI.png)

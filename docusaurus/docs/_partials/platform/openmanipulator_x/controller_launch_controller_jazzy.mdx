...
<img src="/img/platform/openmanipulator_x/real_omx_init_pose.png" width="250" />
...
**TIP**:
- If you can't load DYNAMIXEL, please check firmware to use ROBOTIS software ([DYNAMIXEL Wizard 2.0](https://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_wizard2/#firmware-update))  
...
**NOTE**: open_manipulator_x controller is compatible with [Protocol 2.0](https://emanual.robotis.com/docs/en/dxl/protocol2/) which supports `MX 2.0`, `X` and `Pro` series. [Protocol 1.0](https://emanual.robotis.com/docs/en/dxl/protocol1/) does not support SyncRead instructions to access to multiple DYNAMIXEL's's simultaneously.

...
Before launching MoveIt 2, ensure that the `hardware.launch.py` from [Launch Controller](/docs/platform/openmanipulator_x/ros_controller_package#launch-controller) is running in a separate terminal.  
Then launch **MoveIt!** with the following command.  
```bash
$ ros2 launch open_manipulator_x_moveit_config moveit_core.launch.py
```
  ![](/img/platform/openmanipulator_x/moveit2_example.png)  

...
1. execution result screen  
    ...
    ![](/img/platform/op3/op3_manager_01.png)  
...
2. execution result of ROBOTIS-OP3(Init pose in RVIZ)  
    ...
    ![](/img/platform/op3/op3_manager_02.png)
...
- rviz screen  
  ...
  ![](/img/platform/op3/op3_bringup_visualization_01.png)  

  - TF Tree  

    ![](/img/platform/op3/op3_bringup_visualization_04.png)  
...
![](/img/platform/op3/op3_gui_initial_pose.png)
...
- Follow the below procedure to configure modules that control corresponding joint of ROBOTIS-OP3.  
    ...
    2. Confirm from the joint status table below the module buttons that corresponding joints are set correctly.  
      ![](/img/platform/op3/op3_gui_set_module.png)

- `Get Mode` button will report which module is assigned for each joint.  

  ![](/img/platform/op3/op3_gui_get_module.png)
...
![](/img/platform/op3/op3_gui_walking_tuner_01.png)

![](/img/platform/op3/op3_gui_walking_tuner_02.png)

##### Start / Stop Walking  
1. `start` button : Initiate walking  
2. `stop` button : Stop walking. When stopped, walking related parameters will be reset.  

  ![](/img/platform/op3/op3_gui_walking_tuner_03.png)
...
3. `Apply` button : Apply modified parameters from the GUI to `walking_module`.  
  ...
  ![](/img/platform/op3/op3_gui_walking_tuner_04.png)
...
2. Select `Motion` tab of the gui demo program.
    ...
    ![](/img/platform/op3/op3_gui_action_01.png)

3. Click the action button to play  

    ![](/img/platform/op3/op3_gui_action_02.png)
...
2. Select `Head Control` tab of the gui demo program.  
  ![](/img/platform/op3/op3_gui_control_head_01.png)
...
3. Change the value for the specific joint.  
  ...
  ![](/img/platform/op3/op3_gui_control_head_02.png)  
  ![](/img/platform/op3/op3_gui_control_head_03.png)  
...
- Preparation : Set the module and move to the tab
  ...
  2. Select `Online Walking` tab of the gui demo program.
    ...
    ![](/img/platform/op3/op3_online_walking_01.png)
...
- Controlling walking of ROBOTIS-OP3
  ...
  4. Send a walking command to `op3_manager`
    ...
    ![](/img/platform/op3/op3_online_walking_02.png)
...
![](/img/platform/op3/op3_offset_tuner_diagram.png)  
...
![](/img/platform/op3/op3_offset_tuner_diagram.png)  
- After   
![](/img/platform/op3/op3_tuner_diagram.png)  
...
!<a href="/img/platform/op3/op3_tuner_execution.png" target="_blank">launch image</a>
...
![](/img/platform/op3/op3_tuner_offset_01.png)  
1. go `Initial Pose`   
...
![](/img/platform/op3/op3_tuner_gain_01.png)  
1. go `Initial Pose`   
2. Select tab of `Kinematics Group`  
3. Click the `Refresh` Button for getting current states of joints  
...
1. Dynamic Reconfigure and Image View  
    ...
    - Open `Dynamic Reconfigure`   
      ...
      ![](/img/platform/op3/ball_detector_node_01.png)
...
2. Parameters    
  The description for each parameter will pop up when hovering the mouse cursor over each parameter.  
    ...
    ![](/img/platform/op3/ball_detector_node_03.png)
...
3. Description  
    ...
    - How to calibrate  
        ...
        - If you check the `use_second_filter` you can get an image which is detected with two HSV variations.   
          ...
          ![](/img/platform/op3/ball_detector_node_04.png)

        - If you check the `debug_image` you can check the HSV filtered, binary image.   

          ![](/img/platform/op3/ball_detector_node_05.png)
...
3. Set the walking parameters     
    ...
    ![](/img/platform/op3/op3_online_walking_footstep_01.png)

4. Set a interactive marker in rviz 3d screen and Move the marker to the target pose of feet.   

    ![](/img/platform/op3/op3_online_walking_footstep_02.png)

    ![](/img/platform/op3/op3_online_walking_footstep_04.png)

5. plan the path and send a walking message to ROBOTIS-OP3     

    ![](/img/platform/op3/op3_online_walking_footstep_03.png)

    ![](/img/platform/op3/op3_online_walking_footstep_05.png)
...
![](/img/platform/op3/op3_web_setting_01.png)
...
##### Ball Detector parameters  
  ![](/img/platform/op3/op3_web_setting_02.png)
...
##### Camera Setting parameters  
  ![](/img/platform/op3/op3_web_setting_06.png)
  > Modified parameter values will be saved automatically.  
...
![](/img/platform/op3/op3_manager_03.png)  
...
```  
 ...
 - rqt_graph  
   ![](/img/platform/op3/op3_read_write_graph.png)
...
[Robot Information file(.robot)]: /docs/software/robotis_framework_packages/tutorials#robot-information-file-robot
[Joint initialize file(.yaml)]: /docs/software/robotis_framework_packages/tutorials#joint-initialize-file-yaml
...
[op3_demo]: /docs/platform/op3/robotis_ros_packages#robotis-op3-demo
[op3_gui_demo]: /docs/platform/op3/robotis_ros_packages#op3-gui-demo
[How to use walking tuner]: /docs/platform/op3/tutorials#how-to-use-walking-tuner
[op3_action_module]: /docs/platform/op3/robotis_ros_packages#op3-action-module
[How to create the motions]: /docs/platform/op3/tutorials#how-to-create-the-motions
[op3_head_control_module]: /docs/platform/op3/robotis_ros_packages#op3-head-control-module
[Introduction to Humanoid Robotics]: http://www.springer.com/gp/book/9783642545351

[op3_online_walking_module]: /docs/platform/op3/robotis_ros_packages#op3-online-walking-module
[Online walking using footstep planner]: /docs/platform/op3/tutorials#how-to-control-upgraded-walking-using-footstep-planner
[op3_offset_tuner_server]: /docs/platform/op3/robotis_ros_packages#op3-offset-tuner-server
[op3_offset_tuner_client]: /docs/platform/op3/robotis_ros_packages#op3-offset-tuner-client
[op3_tuning_module]: /docs/platform/op3/robotis_ros_packages#op3-tuning-module
[op3_tuner_client]: /docs/platform/op3/robotis_ros_packages#op3-tuner-client
[op3_how_to_control_upgraded_walking]: /docs/platform/op3/tutorials#how-to-control-upgraded-walkingonline-walking
[humanoid_navigation]: /docs/platform/common/humanoid_navigation#humanoid-navigation
[How to run op3_manager]: /docs/platform/op3/robotis_ros_packages#op3-manager
...
[How to connect]: /docs/platform/op3/quick_start#example--ssh-client-for-windows
[detail of parameter]: /docs/platform/op3/tutorials#how-to-use-ball-detector

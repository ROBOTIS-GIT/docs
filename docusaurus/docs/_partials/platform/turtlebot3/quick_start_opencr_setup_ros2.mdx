...
![](/img/platform/turtlebot3/quick_start/opencr_setup/opencr_setup.png)  
...
6. A successful firmware upload for the TurtleBot3 Burger will look like this:  
  ![](/img/platform/turtlebot3/quick_start/opencr_setup/shell01.png)
...
<details>
<summary>
![](/img/icon_unfold.png) Click here to expand more details about firmware uploads using the **Arduino IDE**
</summary>
...
9. Upload the TurtleBot3 firmware sketch with `Ctrl` + `U` or the upload icon.  
  ![](/img/platform/turtlebot3/quick_start/opencr_setup/o2.png)  
  ![](/img/platform/turtlebot3/quick_start/opencr_setup/o3.png)
...
### OpenCR Test
**NOTE**: If the wheels do not move while performing the OpenCR Test, refer to the"**[TurtleBot3 DYNAMIXEL setup instructions](/docs/platform/turtlebot3/faq#setup-dynamixels-for-turtlebot3)**" to update the DYNAMIXEL's configuration.
...
![](/img/platform/turtlebot3/quick_start/opencr_setup/opencr_models.png)
